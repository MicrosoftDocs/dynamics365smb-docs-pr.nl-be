...
# <a name="procurement-quick-start" />Snel aan de slag met inkoop
...
## <a name="set-up-vendors" />Leveranciers instellen
...
### <a name="set-up-a-new-vendor" />Een nieuwe leverancier instellen
...
## <a name="create-new-purchase-orders" />Nieuwe inkooporders maken
...
### <a name="to-create-a-purchase-order" />Een inkooporder maken
...
## <a name="create-a-purchase-invoice" />Een inkoopfactuur maken
...
### <a name="how-to-create-and-post-a-purchase-invoice" />Een inkoopfactuur maken en boeken

...
ms.author: edupont
---
# <a name="make-drop-shipments" />Doorverzendingen uitvoeren
...
## <a name="to-create-a-sales-order-for-drop-shipment" />Een verkooporder voor doorverzending maken
...
## <a name="to-create-the-purchase-order-for-drop-shipment" />De inkooporder voor doorverzendingen maken
...
## <a name="to-create-multiple-purchase-orders-for-drop-shipments" />Meerdere inkooporders voor doorverzendingen maken
...
## <a name="to-view-the-linked-purchase-order-from-the-sales-order" />De gekoppelde inkooporder weergeven op basis van de verkooporder
...
## <a name="to-post-a-drop-shipment" />Een doorverzending boeken

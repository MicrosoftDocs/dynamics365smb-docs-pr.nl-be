...
ms.author: edupont
---
# <a name="convert-existing-locations-to-warehouse-locations" />Bestaande locaties converteren naar magazijnlocaties
...
## <a name="to-enable-an-existing-location-to-operate-as-a-warehouse-location" />Een bestaande vestiging als een magazijnvestiging laten functioneren

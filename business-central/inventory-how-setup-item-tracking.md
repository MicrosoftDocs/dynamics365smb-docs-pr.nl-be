...
ms.author: edupont
---
# <a name="set-up-item-tracking-with-serial-lot-and-package-numbers" />Artikeltracering instellen met serie-, lot- en pakketnummers
...
## <a name="numbers-and-item-tracking" />Aantallen en artikeltracering
...
## <a name="to-set-up-item-tracking-codes" />Artikeltraceringscodes instellen
...
## <a name="to-set-up-expiration-rules-for-serial-or-lot-numbers" />Vervalregels instellen voor serie- of lotnummers
...
## <a name="to-set-up-warranties-for-serial-or-lot-numbers" />Garanties instellen voor serie- of lotnummers
...
## <a name="to-set-up-items-for-tracking-with-the-correct-item-tracking-codes" />Artikelen voor tracering instellen met de juiste artikeltraceringscodes
...
## <a name="to-specify-opening-balances-for-the-items-you-track" />Beginsaldi opgeven voor de artikelen die u bijhoudt
...
### <a name="item-journals" />Artikeldagboeken
...
### <a name="warehouse-physical-inventory-journal-for-locations-where-directed-pick-and-put-away-is-turned-on" />Magazijninventarisatiedagboek voor vestigingen waar gerichte pick en opslag is ingeschakeld

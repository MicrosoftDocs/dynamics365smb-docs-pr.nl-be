...
4. Op de sneltabbladen  **Serienummer**,  **Lotnummer** en  **Pakkettracering**  kunt u het beleid voor het traceren van artikelen definiëren op basis van respectievelijk serie-, lot- en pakketnummers.  
...
Om artikeltracering in te schakelen, moet u eerst artikeltraceringscodes aan een artikel toewijzen. Er zijn twee manieren om artikeltraceringscodes toe te voegen: door de code uit een vooraf gedefinieerde lijst te selecteren of door een nieuwe unieke code toe te wijzen. Wijs de velden aan om een korte omschrijving te lezen.
...
## <a name="to-specify-opening-balances-for-the-items-you-track"></a>Om de openingsbalansen voor de artikelen te specificeren, volgt u

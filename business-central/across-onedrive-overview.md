...
# <a name="business-central-and-onedrive-for-business-integration" />Integratie van Business Central en OneDrive voor Bedrijven
...
## <a name="get-started-with-onedrive-features" />Aan de slag met OneDrive-functies
...
### <a name="open-and-share-in-onedrive" />Openen en delen in OneDrive
...
### <a name="save-excel-workbooks-and-report-files-in-onedrive" />Excel-werkmappen en -rapportbestanden in OneDrive opslaan

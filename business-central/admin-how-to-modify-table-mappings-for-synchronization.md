...
---
# <a name="mapping-the-tables-and-fields-to-synchronize"></a><a name="mapping-the-tables-and-fields-to-synchronize"></a>De te synchroniseren tabellen en velden toewijzen
...
## <a name="mapping-integration-tables"></a><a name="mapping-integration-tables"></a>Integratietabellen in kaart brengen
...
### <a name="additional-mappings"></a><a name="additional-mappings"></a>Aanvullende toewijzingen
...
### <a name="strategies-for-auto-resolving-conflicts"></a><a name="strategies-for-auto-resolving-conflicts"></a>Strategieën voor het automatisch oplossen van conflicten
...
## <a name="mapping-integration-fields"></a><a name="mapping-integration-fields"></a>Integratievelden toewijzen
...
### <a name="handle-differences-in-field-values"></a><a name="handle-differences-in-field-values"></a>Omgaan met verschillen in veldwaarden
...
### <a name="handle-missing-option-values"></a><a name="handle-missing-option-values"></a>Ontbrekende optiewaarden verwerken
...
## <a name="couple-records"></a><a name="couple-records"></a>Koppelrecords
...
## <a name="filter-records-and-rows"></a><a name="filter-records-and-rows"></a>Records en rijen filteren
...
## <a name="create-new-records"></a><a name="create-new-records"></a>Nieuwe records maken
...
### <a name="to-create-new-records-during-synchronization"></a><a name="to-create-new-records-during-synchronization"></a>Nieuwe records maken tijdens synchronisatie

1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Toewijzingen van integratietabellen** in en kies vervolgens de gerelateerde koppeling.
2. Wis in het tabeltoewijzingsitem in de lijst het veld **Alleen gekoppelde records synchr.**.  

## <a name="use-configuration-templates-on-table-mappings"></a><a name="use-configuration-templates-on-table-mappings"></a>Configuratiesjablonen gebruiken met tabeltoewijzingen
...
### <a name="to-specify-configuration-templates-on-a-table-mapping"></a><a name="to-specify-configuration-templates-on-a-table-mapping"></a>Configuratiesjablonen opgeven voor een tabeltoewijzing

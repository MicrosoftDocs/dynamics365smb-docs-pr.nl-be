...
---
# <a name="mapping-the-tables-and-fields-to-synchronize" />De te synchroniseren tabellen en velden toewijzen
...
## <a name="mapping-integration-tables" />Integratietabellen in kaart brengen
...
### <a name="additional-mappings" />Aanvullende toewijzingen
...
### <a name="strategies-for-auto-resolving-conflicts" />Strategieën voor het automatisch oplossen van conflicten
...
## <a name="mapping-integration-fields" />Integratievelden toewijzen
...
### <a name="handle-differences-in-field-values" />Omgaan met verschillen in veldwaarden
...
### <a name="handle-missing-option-values" />Ontbrekende optiewaarden verwerken
...
## <a name="couple-records" />Koppelrecords
...
## <a name="filter-records-and-rows" />Records en rijen filteren
...
## <a name="create-new-records" />Nieuwe records maken
...
### <a name="to-create-new-records-during-synchronization" />Nieuwe records maken tijdens synchronisatie

1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Toewijzingen van integratietabellen** in en kies vervolgens de gerelateerde koppeling.
2. Wis in het tabeltoewijzingsitem in de lijst het veld **Alleen gekoppelde records synchr.**.  

## <a name="use-configuration-templates-on-table-mappings" />Configuratiesjablonen gebruiken met tabeltoewijzingen
...
### <a name="to-specify-configuration-templates-on-a-table-mapping" />Configuratiesjablonen opgeven voor een tabeltoewijzing

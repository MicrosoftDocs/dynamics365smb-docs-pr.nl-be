...
ms.author: edupont
---
# <a name="design-details-posting-date-on-adjustment-value-entry" />Ontwerpdetails: Boekingsdatum op herwaarderingswaardepost
...
## <a name="how-posting-dates-are-assigned" />Hoe boekingsdatums worden toegewezen
...
#### <a name="item-ledger-entry" />Artikelpost
...
## <a name="common-problems-with-the-adjust-cost---item-entries-batch-job" />Veelvoorkomende problemen met de batchverwerking Kostprijs herwaarderen - Artikelposten
...
### <a name="posting-date-on-adjustment-value-entry-versus-posting-date-on-entry-causing-the-adjustment-such-as-revaluation-or-item-charge" />Boekingsdatum op Herwaarderingswaardepost versus Boekingsdatum op post die de correctie veroorzaakt, zoals Herwaardering of Artikeltoeslag

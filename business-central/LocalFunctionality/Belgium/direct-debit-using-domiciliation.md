...
ms.author: edupont
---
# <a name="direct-debit-using-domiciliation"></a><a name="direct-debit-using-domiciliation"></a>Incasso via domiciliëring
...
## <a name="set-up-domiciliations"></a><a name="set-up-domiciliations"></a>Domiciliëringen instellen
...
### <a name="to-set-up-domiciliation"></a><a name="to-set-up-domiciliation"></a>Domiciliëring instellen
...
## <a name="generate-domiciliation-suggestions"></a><a name="generate-domiciliation-suggestions"></a>Domiciliëringsvoorstellen genereren
...
### <a name="to-generate-domiciliation-suggestions"></a><a name="to-generate-domiciliation-suggestions"></a>Domiciliëringsvoorstellen genereren
...
## <a name="edit-and-delete-domiciliation-lines"></a><a name="edit-and-delete-domiciliation-lines"></a>Domiciliëringsregels bewerken en verwijderen
...
### <a name="to-edit-a-journal-line"></a><a name="to-edit-a-journal-line"></a>Een dagboekregel bewerken
...
### <a name="to-delete-a-journal-line"></a><a name="to-delete-a-journal-line"></a>Een dagboekregel verwijderen
...
## <a name="test-domiciliations"></a><a name="test-domiciliations"></a>Domiciliëringen testen
...
### <a name="to-print-a-domiciliation-test-report"></a><a name="to-print-a-domiciliation-test-report"></a>Een domiciliëringstestrapport afdrukken
...
## <a name="export-and-post-domiciliations"></a><a name="export-and-post-domiciliations"></a>Domiciliëringen exporteren en boeken
...
### <a name="to-export-and-post-domiciliations"></a><a name="to-export-and-post-domiciliations"></a>Domiciliëringen exporteren en boeken

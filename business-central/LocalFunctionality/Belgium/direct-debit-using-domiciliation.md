...
ms.author: edupont
---
# <a name="direct-debit-using-domiciliation" />Incasso via domiciliëring
...
## <a name="set-up-domiciliations" />Domiciliëringen instellen
...
### <a name="to-set-up-domiciliation" />Domiciliëring instellen
...
## <a name="generate-domiciliation-suggestions" />Domiciliëringsvoorstellen genereren
...
### <a name="to-generate-domiciliation-suggestions" />Domiciliëringsvoorstellen genereren
...
## <a name="edit-and-delete-domiciliation-lines" />Domiciliëringsregels bewerken en verwijderen
...
### <a name="to-edit-a-journal-line" />Een dagboekregel bewerken
...
### <a name="to-delete-a-journal-line" />Een dagboekregel verwijderen
...
## <a name="test-domiciliations" />Domiciliëringen testen
...
### <a name="to-print-a-domiciliation-test-report" />Een domiciliëringstestrapport afdrukken
...
## <a name="export-and-post-domiciliations" />Domiciliëringen exporteren en boeken
...
### <a name="to-export-and-post-domiciliations" />Domiciliëringen exporteren en boeken

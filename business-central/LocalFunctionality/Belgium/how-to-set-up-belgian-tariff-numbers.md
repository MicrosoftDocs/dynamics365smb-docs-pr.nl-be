...
ms.author: edupont
---
# <a name="set-up-belgian-tariff-numbers-in-the-belgian-version"></a><a name="set-up-belgian-tariff-numbers-in-the-belgian-version"></a><a name="set-up-belgian-tariff-numbers-in-the-belgian-version"></a>Belgische tariefcodes instellen in de Belgische versie
...
## <a name="to-set-up-tariff-numbers"></a><a name="to-set-up-tariff-numbers"></a><a name="to-set-up-tariff-numbers"></a>Tariefcodes instellen

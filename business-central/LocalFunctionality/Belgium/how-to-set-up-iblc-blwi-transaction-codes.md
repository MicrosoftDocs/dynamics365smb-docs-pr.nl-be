...
ms.author: edupont
---
# <a name="set-up-iblc-blwi-transaction-codes-in-the-belgian-version"></a><a name="set-up-iblc-blwi-transaction-codes-in-the-belgian-version"></a>IBLC-BLWI-transactiecodes instellen in de Belgische versie
...
## <a name="to-set-up-iblcblwi-transaction-codes"></a><a name="to-set-up-iblcblwi-transaction-codes"></a>IBLC-BLWI-transactiecodes instellen

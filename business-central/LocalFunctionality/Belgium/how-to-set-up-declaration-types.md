...
ms.author: edupont
---
# <a name="set-up-declaration-types-in-the-belgian-version"></a><a name="set-up-declaration-types-in-the-belgian-version"></a>Aangiftesoorten instellen in de Belgische versie
...
## <a name="to-set-up-declaration-types"></a><a name="to-set-up-declaration-types"></a>Aangiftesoorten instellen

...
ms.author: edupont
---
# <a name="set-up-bank-accounts-for-coda-in-the-belgian-version"></a><a name="set-up-bank-accounts-for-coda-in-the-belgian-version"></a>Bankrekeningen instellen voor CODA in de Belgische versie
...
## <a name="to-set-up-protocol-numbers-and-version-codes"></a><a name="to-set-up-protocol-numbers-and-version-codes"></a>Protocolnummers en versiecodes instellen

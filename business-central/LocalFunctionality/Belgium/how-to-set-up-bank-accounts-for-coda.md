...
ms.author: edupont
---
# <a name="set-up-bank-accounts-for-coda-in-the-belgian-version" />Bankrekeningen instellen voor CODA in de Belgische versie
...
## <a name="to-set-up-protocol-numbers-and-version-codes" />Protocolnummers en versiecodes instellen

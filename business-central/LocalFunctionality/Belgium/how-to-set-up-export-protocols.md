...
ms.author: edupont
---
# <a name="set-up-export-protocols-in-the-belgian-version"></a><a name="set-up-export-protocols-in-the-belgian-version"></a><a name="set-up-export-protocols-in-the-belgian-version"></a>Exportprotocollen instellen in de Belgische versie
...
## <a name="to-set-up-an-export-protocol"></a><a name="to-set-up-an-export-protocol"></a><a name="to-set-up-an-export-protocol"></a>Een exportprotocol instellen

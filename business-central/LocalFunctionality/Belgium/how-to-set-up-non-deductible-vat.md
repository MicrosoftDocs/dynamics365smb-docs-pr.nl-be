...
ms.author: edupont
---
# <a name="set-up-non-deductible-vat-in-the-belgian-version"></a><a name="set-up-non-deductible-vat-in-the-belgian-version"></a><a name="set-up-non-deductible-vat-in-the-belgian-version"></a>Niet-aftrekbare btw instellen in de Belgische versie
...
## <a name="to-set-up-the-non-deductible-vat-percentage"></a><a name="to-set-up-the-non-deductible-vat-percentage"></a><a name="to-set-up-the-non-deductible-vat-percentage"></a>Het niet-aftrekbare btw-percentage instellen

...
ms.author: edupont
---
# <a name="set-up-non-deductible-vat-in-the-belgian-version" />Niet-aftrekbare btw instellen in de Belgische versie
...
## <a name="to-set-up-the-non-deductible-vat-percentage" />Het niet-aftrekbare btw-percentage instellen

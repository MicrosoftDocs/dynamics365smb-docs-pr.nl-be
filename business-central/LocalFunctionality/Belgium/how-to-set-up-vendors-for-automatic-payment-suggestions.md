...
ms.author: edupont
---
# <a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version"></a><a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version"></a><a name="set-up-vendors-for-automatic-payment-suggestions-in-the-belgian-version"></a>Leveranciers voor automatische betalingsvoorstellen instellen in de Belgische versie
...
## <a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch"></a><a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch"></a><a name="to-set-up-a-vendor-to-be-included-in-the-payment-suggestion-batch"></a>Instellen dat een leverancier wordt opgenomen in de betalingsvoorstelbatch

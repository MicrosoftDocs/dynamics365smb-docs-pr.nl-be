...
ms.author: jswymer
---
# <a name="setting-up-and-troubleshooting-your-browser-to-work-with-business-central-web-client" />Uw browser instellen en er problemen mee oplossen om te werken met de Business Central-webclient
...
## <a name="allow-javascript-from-business-central" />JavaScript toestaan vanuit Business Central
...
## <a name="allow-cookies-from-business-central" />Cookies toestaan vanuit Business Central

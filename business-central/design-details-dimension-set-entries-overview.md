...
ms.author: edupont
---
# <a name="dimension-set-entries-overview"></a><a name="dimension-set-entries-overview"></a>Overzicht dimensiesetposten
...
## <a name="dimension-set-entries"></a><a name="dimension-set-entries"></a>Dimensiesetposten
...
## <a name="codeunit-408-dimension-management"></a><a name="codeunit-408-dimension-management"></a>Codeunit 408 Dimensiebeheer
...
## <a name="performance-improvement"></a><a name="performance-improvement"></a>Prestatieverbetering

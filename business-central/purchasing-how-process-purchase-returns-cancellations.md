...
ms.author: edupont
---
# <a name="process-purchase-returns-or-cancellations" />Inkoopretouren of annuleringen verwerken
...
## <a name="inventory-costing" />Voorraadwaardering
...
## <a name="to-create-a-purchase-credit-memo-from-a-posted-purchase-invoice" />Een nieuwe inkoopcreditnota maken vanuit een geboekte inkoopfactuur
...
## <a name="to-create-a-purchase-credit-memo-by-copying-a-posted-purchase-invoice" />Een nieuwe inkoopcreditnota maken door een geboekte inkoopfactuur te kopiëren.
...
## <a name="to-create-a-purchase-return-order-based-on-one-or-more-posted-purchase-documents" />Een inkoopretourorder maken op basis van een of meer geboekte inkoopdocumenten
...
## <a name="to-create-a-replacement-purchase-order-from-a-purchase-return-order" />Een vervangende inkooporder maken vanuit een inkoopretourorder
...
## <a name="to-create-a-purchase-allowance" />Een inkooptegoed maken
...
## <a name="to-combine-return-shipments" />Retourverzendingen combineren
...
### <a name="to-remove-open-purchase-return-orders-after-combined-return-shipment-posting" />Open inkoopretourorders verwijderen na gecombineerde boeking van retourverzendingen

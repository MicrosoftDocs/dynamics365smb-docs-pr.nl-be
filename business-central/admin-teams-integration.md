...
> [!NOTE]
> Om gecentraliseerde implementatie in te stellen, moet uw Teams-account ten minste de rol [Teams Administrator](/entra/identity/role-based-access-control/permissions-reference#teams-administrator] hebben.

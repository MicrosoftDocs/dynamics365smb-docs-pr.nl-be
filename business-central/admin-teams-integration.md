...
## <a name="installing-the-business-central-app-by-using-centralized-deployment" />De Business Central-app installeren met behulp van gecentraliseerde implementatie
...
## <a name="managing-privacy-and-compliance" />Beheer van privacy en compliance
...
### <a name="restricting-sharing-of-cards" />Het delen van kaarten beperken
...
### <a name="responding-to-data-requests" />Reageren op gegevensaanvragen
...
## <a name="show-or-hide-record-data-on-cards" />Toon of verberg recordgegevens op kaarten

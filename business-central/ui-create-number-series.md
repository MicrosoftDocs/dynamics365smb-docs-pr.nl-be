...
ms.author: edupont
---
# <a name="create-number-series" />Nummerreeksen maken
...
## <a name="gaps-in-number-series" />Hiaten in nummerreeksen
...
## <a name="behavior-of-the-no-field-on-documents-and-cards" />Werking van het veld Nr. in documenten en kaarten
...
## <a name="to-create-a-new-number-series" />Een nieuwe nummerreeks maken
...
## <a name="to-create-relationships-between-number-series" />Relaties maken tussen nummerreeksen
...
## <a name="to-set-up-where-a-number-series-is-used" />Instellen waar een nummerreeks wordt gebruikt
...
## <a name="see-related-microsoft-trainingtrainingmodulesnumber-series-trail-codes-dynamics-365-business-centralindex" />Zie gerelateerde [Microsoft-training](/training/modules/number-series-trail-codes-dynamics-365-business-central/index)

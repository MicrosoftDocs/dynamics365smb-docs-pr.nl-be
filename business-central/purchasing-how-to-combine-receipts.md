...
ms.author: edupont
---
# <a name="combine-receipts-on-a-single-invoice"></a><a name="combine-receipts-on-a-single-invoice"></a>Ontvangsten combineren op één factuur
...
## <a name="to-combine-receipts"></a><a name="to-combine-receipts"></a>Ontvangsten combineren
...
## <a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a><a name="to-remove-open-purchase-orders-after-combined-receipt-posting"></a>Open inkooporders verwijderen na gecombineerde ontvangstboeking

...
# <a name="consolidating-financial-data-from-multiple-companies" />Financiële gegevens uit meerdere bedrijven consolideren
...
## <a name="use-the-consolidated-trial-balance-report" />Gebruik het rapport Consolidatie - Proef- en saldibalans uitvoeren
...
## <a name="consolidate-data" />Gegevens consolideren
...
### <a name="to-test-the-data-before-you-consolidate" />De gegevens testen vóór consolidatie
...
### <a name="run-the-consolidation" />De consolidatie uitvoeren
...
## <a name="eliminate-repeated-transactions" />Herhaalde transacties verwijderen
...
## <a name="export-and-import-consolidated-data-between-databases" />Geconsolideerde gegevens exporteren en importeren tussen databases

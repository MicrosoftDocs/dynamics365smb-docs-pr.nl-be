...
# <a name="install-the-include-prodshortincludesprodshortmd-app-for-microsoft-teams" />De [!INCLUDE [prod_short](includes/prod_short.md)]-app installeren voor Microsoft Teams

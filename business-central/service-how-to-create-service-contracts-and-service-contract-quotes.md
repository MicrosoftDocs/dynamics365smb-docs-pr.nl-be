...
4. Voer in het veld **Klantnr.** het nummer in van de klant in het servicecontract.  
    ...
    > [!NOTE]  
    >  U kunt de creditnota vergelijken met het oorspronkelijke geboekte document op de pagina **Geboekte servicefacturen** . Kies het pictogram ![Lampje dat de functie Vertel me opent](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Geboekte servicefacturen** in en kies de desbetreffende koppeling.  
...
1. Kies het pictogram ![Lampje dat de functie Vertel me opent](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Servicecontracten** in en kies de desbetreffende koppeling. Open het betreffende servicecontract waarvoor u de eigenaar wilt wijzigen.  
...
1. Kies het pictogram ![Lampje dat de functie Vertel me opent](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Servicecontractprijzen bijwerken** in en kies de desbetreffende koppeling.
...
1. Kies het pictogram ![Lampje dat de functie Vertel me opent](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Vooruitbet. contractposten boeken** in en kies de desbetreffende koppeling.  

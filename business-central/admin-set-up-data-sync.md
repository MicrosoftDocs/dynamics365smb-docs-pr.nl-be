...
# <a name="get-ready-to-synchronize-master-data"></a><a name="get-ready-to-synchronize-master-data"></a>Bereid u voor om hoofdgegevens te synchroniseren
...
## <a name="uni-directional-synchronization-only"></a><a name="uni-directional-synchronization-only"></a>Alleen unidirectionele synchronisatie
...
## <a name="specify-the-source-company"></a><a name="specify-the-source-company"></a>Het bronbedrijf opgeven
...
## <a name="enable-or-disable-tables-and-fields"></a><a name="enable-or-disable-tables-and-fields"></a>Tabellen en velden in- of uitschakelen
...
### <a name="use-match-based-coupling"></a><a name="use-match-based-coupling"></a>Koppeling op basis van overeenkomsten gebruiken
...
## <a name="synchronize-for-the-first-time"></a><a name="synchronize-for-the-first-time"></a>Voor de eerste keer synchroniseren
...
## <a name="add-or-delete-tables-from-the-synchronization-tables-list"></a><a name="add-or-delete-tables-from-the-synchronization-tables-list"></a>Tabellen toevoegen aan of verwijderen uit de lijst met synchronisatietabellen

### <a name="add-a-table"></a><a name="add-a-table"></a>Een tabel toevoegen
...
### <a name="delete-a-table"></a><a name="delete-a-table"></a>Een tabel verwijderen
...
## <a name="use-export-and-import-to-share-a-synchronization-setup"></a><a name="use-export-and-import-to-share-a-synchronization-setup"></a>Exporteren en importeren gebruiken om een synchronisatie-instelling te delen

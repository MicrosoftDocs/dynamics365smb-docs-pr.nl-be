...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos"></a><a name="post-service-orders-and-credit-memos"></a>Serviceorders en creditnota's boeken
...
## <a name="to-post-a-service-order"></a><a name="to-post-a-service-order"></a>Serviceorders boeken
...
## <a name="to-batch-post-service-orders"></a><a name="to-batch-post-service-orders"></a>Serviceorders batchboeken
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Serviceorders** in en kies vervolgens de gerelateerde koppeling  
...
## <a name="to-post-a-service-credit-memo"></a><a name="to-post-a-service-credit-memo"></a>Servicecreditnota's boeken
...
## <a name="to-post-consumption-from-a-service-order"></a><a name="to-post-consumption-from-a-service-order"></a>Verbruik boeken vanuit een serviceorder
...
## <a name="to-post-shipments-from-service-orders"></a><a name="to-post-shipments-from-service-orders"></a>Verzendingen vanuit serviceorders boeken
...
## <a name="to-undo-posted-consumption"></a><a name="to-undo-posted-consumption"></a>Geboekt verbruik ongedaan maken
...
## <a name="to-post-service-lines"></a><a name="to-post-service-lines"></a>Serviceregels boeken

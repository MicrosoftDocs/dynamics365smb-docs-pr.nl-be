...
ms.author: edupont
---
# <a name="post-service-orders-and-credit-memos" />Serviceorders en creditnota's boeken
...
## <a name="to-post-a-service-order" />Serviceorders boeken
...
## <a name="to-batch-post-service-orders" />Serviceorders batchboeken
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Serviceorders** in en kies vervolgens de gerelateerde koppeling  
...
## <a name="to-post-a-service-credit-memo" />Servicecreditnota's boeken
...
## <a name="to-post-consumption-from-a-service-order" />Verbruik boeken vanuit een serviceorder
...
## <a name="to-post-shipments-from-service-orders" />Verzendingen vanuit serviceorders boeken
...
## <a name="to-undo-posted-consumption" />Geboekt verbruik ongedaan maken
...
## <a name="to-post-service-lines" />Serviceregels boeken

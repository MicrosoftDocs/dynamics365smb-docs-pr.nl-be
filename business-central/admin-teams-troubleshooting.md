...
# Problemen oplossen met Microsoft Teams-integratie met [!INCLUDE [prod_short](includes/prod_short.md)]
...
## De aanmeldkoppeling werkt niet
...
## De pagina Instellingen is leeg
...
## Ik ben van bedrijf veranderd, maar het lijkt niet te werken

Nadat u het bedrijf op de pagina **Instellingen** hebt gewijzigd, merkt u misschien dat de vervolgkeuzelijst met het opdrachtvak aangeeft dat u nog steeds naar het vorige bedrijf zoekt. Dit probleem treedt op wanneer u de pagina **Instellingen** rechtstreeks vanuit het opdrachtvenster opent. In dit geval is het bedrijf succesvol gewijzigd en zoekt u in feite in het bedrijf waarnaar u bent overgeschakeld. Het probleem is dat de vervolgkeuzelijst met het opdrachtvak nog niet is bijgewerkt. Sluit [!INCLUDE [prod_short.md](includes/prod_short.md)] of maak het los vanuit het opdrachtvenster en open de app dan opnieuw om er zeker van te zijn dat de vervolgkeuzelijst nauwkeurig het bedrijf weergeeft waarnaar u zoekt. 
...
## Fout 'Er is iets fout gegaan' bij het zoeken naar contacten
...
## De fout Kan de contact-/contactoverzicht-API niet vinden bij het zoeken naar contactpersonen
...
## Geen van mijn koppelingen breidt zich uit tot een kaart 
...
1. Zorg er eerst voor dat de [!INCLUDE [prod_short](includes/prod_short.md)]-app voor Teams is geïnstalleerd.
    ...
    Meld u aan bij de Teams-desktop-app of Teams in de browser om dit te controleren. Selecteer vervolgens aan de linkerkant **Apps** en zoek naar **[!INCLUDE [prod_short](includes/prod_short.md)]**. Als u de **[!INCLUDE [prod_short](includes/prod_short.md)]**-app vindt, selecteert u deze om de pagina met app-details te openen. Als de knop **Toevoegen** wordt weergegeven, is de app [!INCLUDE [prod_short](includes/prod_short.md)] niet geïnstalleerd. Zie voor meer informatie over het installeren van de app [De [!INCLUDE [prod_short](includes/prod_short.md)]-app voor Microsoft Teams](across-install-app-for-teams.md) installeren.

    > [!NOTE]
    > Gastgebruikers kunnen niet meteen apps installeren. Zie onze [veelgestelde vragen over samenwerken met gasten](teams-faq.md?tabs=collaborating#language) voor meer informatie over gastgebruikers. 

2. Controleer vervolgens of u bent aangemeld met de juiste identiteit.

    In Teams gaat u naar een chat, onder het vak voor het samenstellen van een bericht, klikt u met de rechtermuisknop op het pictogram [!INCLUDE [prod_short](includes/prod_short.md)] en kiest u vervolgens **Instellingen**. In het venster dat verschijnt, staat het gebruikersaccount waarmee u bent ingelogd. Controleer of dit het juiste gebruikersaccount is.
...
## Mijn koppeling breidt zich soms niet uit tot een kaart 
...
- Door netwerkproblemen stopt Teams geruisloos na 15 seconden met proberen de kaart weer te geven.
...
## Het detailvenster wordt geopend, maar toont een fout voordat details worden weergegeven
...
## Ik heb problemen met de camera of locatie in Teams
...
## Teams geeft verschillende talen weer voor mijn kaarten en kaartgegevens
...
## Ik heb een veld in het detailvenster bewerkt, maar mijn wijziging is niet opgeslagen
...
## Er is een nieuwe tegel verschenen in het startprogramma. Hoe verwijder ik deze?
...
Als beheerder met Microsoft Entra-beheerdersmachtigingen kunt u de tegel verbergen door de volgende stappen uit te voeren:
...
## Dubbele tekst in het venster Delen met Teams
...
## Kan niet aanmelden bij het venster Delen met Teams 
...
## Mijn kaarten hebben geen pop-outknop meer
...
## Kan een kaart niet vastzetten op tabblad
...
## Iemand heeft een tabblad toegevoegd, maar ik kan het tabblad niet zien
...
## Anderen zien een andere sortering of kolomindeling dan die de auteur van het tabblad ziet

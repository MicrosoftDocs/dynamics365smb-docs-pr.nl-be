...
# <a name="troubleshoot-microsoft-teams-integration-with-"></a>Problemen oplossen met Microsoft Teams-integratie met [!INCLUDE [prod_short](includes/prod_short.md)]
...
## <a name="unable-to-sign-in-to-the-share-to-teams-window"></a>Kan niet aanmelden bij het venster Delen met Teams

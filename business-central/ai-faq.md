...
# <a name="ai-powered-item-marketing-text-preview-with-copilot-faq" />Veelgestelde vragen over op AI gebaseerde artikelmarketingtekst (preview) met Copilot
...
### <a name="what-is-copilot" />Wat is Copilot?
...
### <a name="why-isnt-copilot-available-for-marketing-text-on-my-items-in-business-central" />Waarom is Copilot niet beschikbaar voor marketingtekst voor mijn artikelen in Business Central?
...
### <a name="is-copilot-available-for-preview-in-business-central-on-premises" />Is Copilot voor preview beschikbaar in Business Central on-premises?

Nee, dit wordt momenteel niet ondersteund in Business Central on-premises.

### <a name="how-does-copilot-work-where-does-the-suggested-text-come-from" />Hoe werkt Copilot en waar komt de voorgestelde tekst vandaan?
...
### <a name="whats-the-quality-of-the-text-suggested-by-copilot" />Wat is de kwaliteit van de tekst die door Copilot wordt voorgesteld?
...
### <a name="how-can-i-improve-the-suggestions-i-get-from-copilot" />Hoe kan ik de suggesties die ik krijg van Copilot verbeteren?
...
### <a name="what-if-im-not-satisfied-with-the-generated-text" />Wat als ik niet tevreden ben met de gegenereerde tekst?
...
### <a name="can-admins-disable-copilot-if-so-how" />Kunnen beheerders Copilot uitschakelen? Zo ja, hoe?
...
### <a name="does-copilot-work-with-languages-other-than-english" />Werkt Copilot met andere talen dan Engels?
...
### <a name="whats-done-about-abusive-and-harmful-text-suggestions" />Wat wordt er gedaan aan beledigende en schadelijke tekstsuggesties?
...
### <a name="can-i-opt-out-of-the-logging-and-human-review-process" />Kan ik me afmelden voor het vastleggen en het menselijke beoordelingsproces?
...
### <a name="what-data-does-the-capability-collect-how-is-the-data-used" />Welke gegevens worden door de functie verzameld? Hoe worden de gegevens gebruikt?

...
ms.author: jswymer
---
# <a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a><a name="power-bi-integration-component-and-architecture-overview-for-"></a>Power BI-integratieonderdeel en architectuuroverzicht voor [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="components"></a><a name="components"></a><a name="components"></a>Onderdelen
...
## <a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a><a name="whats-available-from-the-start"></a>Wat er vanaf het begin beschikbaar is
...
## <a name="architecture"></a><a name="architecture"></a><a name="architecture"></a>Architectuur
...
## <a name="general-flow"></a><a name="general-flow"></a><a name="general-flow"></a>Algemene stroom

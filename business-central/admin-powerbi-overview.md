...
---
# <a name="power-bi-integration-component-and-architecture-overview"></a>Power BI-integratieonderdeel en architectuuroverzicht voor [!INCLUDE[prod_short](includes/prod_short.md)]

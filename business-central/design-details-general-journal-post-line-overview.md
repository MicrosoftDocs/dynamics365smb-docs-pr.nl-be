...
ms.author: edupont
---
# <a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a><a name="general-journal-post-line-overview"></a>Overzicht dagboekboekingsregel
...
## <a name="old-architecture"></a><a name="old-architecture"></a><a name="old-architecture"></a>Oude architectuur
...
### <a name="new-architecture"></a><a name="new-architecture"></a><a name="new-architecture"></a>Nieuwe architectuur

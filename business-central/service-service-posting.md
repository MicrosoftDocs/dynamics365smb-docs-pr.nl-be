...
ms.author: edupont
---
# <a name="service-posting"></a><a name="service-posting"></a><a name="service-posting"></a>Serviceboekingen
...
## <a name="ship"></a><a name="ship"></a><a name="ship"></a>Verzenden
...
## <a name="invoice"></a><a name="invoice"></a><a name="invoice"></a>Factureren
...
## <a name="ship-and-invoice"></a><a name="ship-and-invoice"></a><a name="ship-and-invoice"></a>Verzenden en factureren
Met de optie verzenden en factureren kunt u tegelijkertijd een serviceverzending en een factuur verzenden.  

## <a name="ship-and-consume"></a><a name="ship-and-consume"></a><a name="ship-and-consume"></a>Verzenden en verbruiken
...
## <a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a><a name="to-view-information-about-a-posted-service-document"></a>Informatie over een geboekt servicedocument bekijken

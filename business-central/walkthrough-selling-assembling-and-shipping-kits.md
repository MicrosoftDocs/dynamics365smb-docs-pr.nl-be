...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Procedure: kits verkopen, assembleren en verzenden
...
### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Assemblageartikelen instellen
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Aangepaste assemblageartikelen verkopen
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Assemblageartikelen plannen
...
### <a name="assembling-items"></a><a name="assembling-items"></a><a name="assembling-items"></a>Artikelen samenstellen
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Assemblageartikelen vanuit de voorraad en die op order zijn geassembleerd verzenden
...
Sammy, die verantwoordelijk is voor de verzending, ontvangt drie magazijnverzendingsregels voor de verkooporder: één regel voor de drie zuivere ATO-eenheden, één regel voor de vijf ATO-eenheden op de gemengde verkooporderregel en één regel voor de tien ATS-eenheden op de gemengde verkooporderregel. Sammy maakt een magazijnpickdocument voor alle assemblage onderdelen die nodig zijn voor het samenstellen van het totaal van acht ATO-eenheden op het magazijnverzendingsdocument.  

John, de picker, haalt onderdelen voor alle ATO-hoeveelheden op van het magazijnverzendingsdocument en brengt deze naar het assemblagegebied. John voert de te verwerken hoeveelheid en registreert de magazijnpick.  

Linda assembleert de drie ATO-eenheden van Kit B. De onderdelen zijn al gepickt en Linda legt niet de uitvoer- en verbruikhoeveelheden vast en boekt niet de order, omdat beide acties automatisch worden uitgevoerd via de bijbehorende magazijnverzendingsregels.  
...
Op 27 januari verwerkt Linda twee assemblageorders voor kit A. De eerste order is de ATO-order voor vijf eenheden, die Linda op andere wijze verwerkt dan de ATO-order voor kit B, die ze op 23 januari heeft verwerkt. Voor deze order is Linda gemachtigd om zelf de magazijnverzendingsregel te openen en het voltooide assemblagewerk vast te leggen. De benodigde materialen zijn beschikbaar op de assemblageafdeling, aangezien zij zijn gepickt met de onderdelen voor Kit B.  

De tweede assemblageorder is de ATS-order voor tien eenheden die is gemaakt door het planningssysteem. Op deze ATS-order voert Linda alle betrokken acties uit vanaf de assemblageorder. Linda maakt een magazijnpickdocument voor de assemblageonderdelen die nodig zijn voor het samenstellen van de tien eenheden. Wanneer de pc's zijn geassembleerd, boekt Linda de assemblageorder en geeft daarmee aan dat de artikelen op voorraad zijn en kunnen worden gepickt voor verzending.  
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Voorbeeldgegevens voorbereiden
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>De assemblageartikelen maken
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>De assemblageartikelen verkopen
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planning voor de niet-beschikbare ATS-artikelen
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Het eerste ATO-aantal assembleren en verzenden
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>De tweede ATO-hoeveelheid assembleren en vastleggen
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Het ATS-aantal assembleren

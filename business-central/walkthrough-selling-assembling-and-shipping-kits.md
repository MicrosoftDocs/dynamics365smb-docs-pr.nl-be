...
ms.author: edupont
---
# <a name="walkthrough-selling-assembling-and-shipping-kits"></a><a name="walkthrough-selling-assembling-and-shipping-kits"></a>Procedure: kits verkopen, assembleren en verzenden
...
## <a name="about-this-walkthrough"></a><a name="about-this-walkthrough"></a>Informatie over deze procedure

In deze procedure worden de volgende taken gedemonstreerd:  

### <a name="setting-up-assembly-items"></a><a name="setting-up-assembly-items"></a>Assemblageartikelen instellen
...
### <a name="selling-customized-assembly-items"></a><a name="selling-customized-assembly-items"></a>Aangepaste assemblageartikelen verkopen
...
### <a name="planning-for-assembly-items"></a><a name="planning-for-assembly-items"></a>Assemblageartikelen plannen
...
### <a name="assembling-items"></a><a name="assembling-items"></a>Artikelen samenstellen
...
### <a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a><a name="shipping-assembly-items-from-stock-and-assembled-to-order"></a>Assemblageartikelen vanuit de voorraad en die op order zijn geassembleerd verzenden
...
## <a name="prepare-sample-data"></a><a name="prepare-sample-data"></a>Voorbeeldgegevens voorbereiden
...
### <a name="creating-the-assembly-items"></a><a name="creating-the-assembly-items"></a>De assemblageartikelen maken
...
### <a name="selling-the-assembly-items"></a><a name="selling-the-assembly-items"></a>De assemblageartikelen verkopen
...
### <a name="planning-for-the-unavailable-ats-items"></a><a name="planning-for-the-unavailable-ats-items"></a>Planning voor de niet-beschikbare ATS-artikelen
...
### <a name="assembling-and-shipping-the-first-ato-quantity"></a><a name="assembling-and-shipping-the-first-ato-quantity"></a>Het eerste ATO-aantal assembleren en verzenden
...
### <a name="assembling-and-recording-the-second-ato-quantity"></a><a name="assembling-and-recording-the-second-ato-quantity"></a>De tweede ATO-hoeveelheid assembleren en vastleggen
...
### <a name="assembling-the-ats-quantity"></a><a name="assembling-the-ats-quantity"></a>Het ATS-aantal assembleren
...
### <a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a><a name="shipping-the-remaining-items-partly-from-stock-and-partly-assembled-to-the-order"></a>De overige artikelen verzenden gedeeltelijk uit voorraad en gedeeltelijk geassembleerd op de order

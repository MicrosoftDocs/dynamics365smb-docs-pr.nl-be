...
ms.author: edupont
---
# <a name="register-new-customers"></a><a name="register-new-customers"></a><a name="register-new-customers"></a>Nieuwe klanten registreren
...
## <a name="adding-new-customers"></a><a name="adding-new-customers"></a><a name="adding-new-customers"></a>Nieuwe klanten toevoegen
...
### <a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a><a name="to-create-a-new-customer-card"></a>Een nieuwe klantenkaart maken
...
### <a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a><a name="to-save-the-customer-card-as-a-template"></a>De klantenkaart als sjabloon opslaan
...
## <a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a><a name="deleting-customer-cards"></a>Klantenkaarten verwijderen
...
## <a name="managing-credit-limits"></a><a name="managing-credit-limits"></a><a name="managing-credit-limits"></a>Kredietlimieten beheren
...
### <a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a><a name="to-specify-credit-limit-warnings"></a>Waarschuwingen voor kredietlimieten opgeven

...
ms.author: edupont
---
# <a name="register-new-customers" />Nieuwe klanten registreren
...
## <a name="adding-new-customers" />Nieuwe klanten toevoegen
...
### <a name="to-create-a-new-customer-card" />Een nieuwe klantenkaart maken
...
### <a name="to-save-the-customer-card-as-a-template" />De klantenkaart als sjabloon opslaan
...
## <a name="deleting-customer-cards" />Klantenkaarten verwijderen
...
## <a name="managing-credit-limits" />Kredietlimieten beheren
...
### <a name="to-specify-credit-limit-warnings" />Waarschuwingen voor kredietlimieten opgeven

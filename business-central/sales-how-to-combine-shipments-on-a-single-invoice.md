...
ms.author: edupont
---
# <a name="combine-shipments-on-a-single-invoice" />Verzendingen combineren op één factuur
...
## <a name="to-manually-combine-shipments-on-a-single-invoice" />Verzendingen handmatig op één factuur combineren
...
## <a name="to-automatically-combine-shipments-on-a-single-invoice" />Verzendingen automatisch op één factuur combineren
...
## <a name="to-remove-open-sales-orders-after-combined-shipment-posting" />Openstaande verkooporders verwijderen na boeking van een verzamelfactuur
...
## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics--business-central" />Zie gerelateerde [Microsoft-training](/training/modules/invoicing-customers-dynamics-365-business-central/)

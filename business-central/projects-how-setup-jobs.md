...
---
# <a name="set-up-jobs-prices-and-job-posting-groups" />Projecten, prijzen en projectboekingsgroepen instellen
...
## <a name="to-set-general-information-for-jobs" />Algemene gegevens voor projecten instellen
...
### <a name="to-set-up-job-usage-tracking" />Bijhouden van projectgebruik instellen
...
## <a name="to-set-up-prices-for-resources-items-and-general-ledger-accounts-for-jobs" />Prijzen instellen voor resources, artikelen en grootboekrekeningen voor projecten
...
## <a name="to-set-up-job-posting-groups" />Projectboekingsgroepen instellen

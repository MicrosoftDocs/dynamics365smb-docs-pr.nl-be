...
ms.author: jswymer
---
# <a name="viewing-database-locks"></a><a name="viewing-database-locks"></a>Databasevergrendelingen weergeven
...
## <a name="to-view-database-locks"></a><a name="to-view-database-locks"></a>Databasevergrendelingen weergeven

...
ms.author: edupont
---
# <a name="design-details-reconciliation-with-the-general-ledger" />Ontwerpdetails: Reconciliatie met het grootboek
...
## <a name="post-inventory-cost-to-gl-batch-job" />Batchverwerking Voorraadwaarde boeken naar GB
...
## <a name="automatic-cost-posting" />Autom. voorraadwaarde boeken
...
## <a name="account-types" />Rekeningsoorten

...
ms.author: edupont
---
# <a name="post-transactions-directly-to-the-general-ledger" />Transacties direct naar het grootboek boeken
...
## <a name="to-post-a-transaction-directly-to-a-general-ledger-account" />Een transactie direct naar het grootboek boeken

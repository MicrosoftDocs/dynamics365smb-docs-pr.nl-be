...
ms.author: edupont
---
# <a name="multiple-contracts" />Meervoudige contracten
...
## <a name="creating-multiple-contracts-per-service-item" />Meervoudige contracten maken per serviceartikel
...
## <a name="copying-documents" />Documenten kopiëren
...
## <a name="creating-service-orders-for-multiple-contracts" />Serviceorders maken voor meervoudige contracten

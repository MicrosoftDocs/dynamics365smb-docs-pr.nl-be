...
ms.author: edupont
---
# <a name="multiple-contracts"></a><a name="multiple-contracts"></a>Meervoudige contracten
...
## <a name="creating-multiple-contracts-per-service-item"></a><a name="creating-multiple-contracts-per-service-item"></a>Meervoudige contracten maken per serviceartikel
...
## <a name="copying-documents"></a><a name="copying-documents"></a>Documenten kopiëren
...
## <a name="creating-service-orders-for-multiple-contracts"></a><a name="creating-service-orders-for-multiple-contracts"></a>Serviceorders maken voor meervoudige contracten

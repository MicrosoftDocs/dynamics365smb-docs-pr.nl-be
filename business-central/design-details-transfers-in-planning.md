...
---
# <a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a><a name="design-details-transfers-in-planning"></a>Ontwerpdetails: Transfers in planning
...
## <a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a><a name="why-is-a-transfer-a-special-case"></a>Waarom is een transfer een speciaal geval?
...
## <a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a><a name="transfers-are-dependent-demand"></a>Transfers zijn afhankelijke vraag
...
## <a name="planning-sequence"></a><a name="planning-sequence"></a><a name="planning-sequence"></a>Planningsvolgorde
...
## <a name="transfer-level-code"></a><a name="transfer-level-code"></a><a name="transfer-level-code"></a>Transferniveaucode
...
## <a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a><a name="planning-transfers-without-sku"></a>Planningstransfers zonder SKU
...
## <a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a><a name="changing-quantity-with-reservations"></a>Aantal met reserveringen wijzigen
...
## <a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a><a name="changing-quantity-in-a-transfer-chain"></a>Aantal in een transferketen wijzigen
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Berekening van levertermijn
...
## <a name="safety-lead-time"></a><a name="safety-lead-time"></a><a name="safety-lead-time"></a>Veiligheidstijd
...
## <a name="reschedule"></a><a name="reschedule"></a><a name="reschedule"></a>Herplannen
...
## <a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a><a name="serial-and-lot-numbers-in-transfer-chains"></a>Serie- en lotnummers in transferketens

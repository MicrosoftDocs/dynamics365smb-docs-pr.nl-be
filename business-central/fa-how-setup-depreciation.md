...
# <a name="set-up-fixed-asset-depreciation" />Afschrijving van vaste activa instellen
...
## <a name="to-create-a-depreciation-book" />Een afschrijvingsboek maken
...
## <a name="to-assign-a-depreciation-book-to-a-fixed-asset" />Een afschrijvingsboek aan een vast activum toewijzen
...
## <a name="to-assign-a-depreciation-book-to-multiple-fixed-assets-with-a-batch-job" />Een afschrijvingsboek aan meerdere vaste activa toewijzen met een batchverwerking
...
## <a name="to-set-up-depreciation-posting-types" />Boekingssoorten voor afschrijving instellen
...
## <a name="to-set-up-default-templates-and-batches-for-fixed-asset-depreciation" />Standaardsjablonen en batches instellen voor afschrijvingsboeken voor vaste activa

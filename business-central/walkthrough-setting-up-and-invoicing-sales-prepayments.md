...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-invoicing-sales-prepayments" />Procedure: Vooruitbetalingen verkoop instellen en factureren
...
### <a name="to-set-up-number-series-for-prepayments" />Nummerreeks voor vooruitbetalingen instellen
...
### <a name="to-block-shipments-for-unpaid-prepayment" />Verzendingen blokkeren voor niet voldane vooruitbetalingen
...
### <a name="to-assign-default-prepayment-percentages-to-customers-and-items" />Standaardpercentages voorvooruitbetaling toewijzen aan klanten en artikelen
...
### <a name="to-specify-an-account-for-sales-prepayments-in-general-posting-setup" />Een vooruitbetalingsrekening verkoop opgeven in de boekingsgroepinstellingen
...
## <a name="create-an-order-that-requires-a-prepayment" />Een order maken waarvoor vooruitbetaling is vereist
...
### <a name="to-create-a-sales-order-with-a-prepayment" />Een verkooporder maken met een vooruitbetaling
...
## <a name="create-a-prepayment-invoice" />Een vooruitbetalingsfactuur maken
...
### <a name="to-create-a-prepayment-invoice" />Een vooruitbetalingsfactuur maken
...
## <a name="create-an-additional-prepayment-invoice" />Een extra vooruitbetalingsfactuur maken
...
### <a name="to-create-an-additional-prepayment-invoice" />Een extra vooruitbetalingsfactuur maken
...
## <a name="apply-the-prepayments" />De vooruitbetalingen vereffenen
...
### <a name="to-apply-a-payment-to-the-prepayment-invoices" />Een betaling vereffenen met vooruitbetalingsfacturen
...
## <a name="invoice-the-remaining-amount" />Het resterende bedrag factureren
...
### <a name="to-invoice-the-remaining-amount" />Het resterende bedrag factureren
...
## <a name="update-the-status-of-prepaid-orders-and-invoices-automatically" />De status van vooruitbetaalde orders en facturen automatisch bijwerken

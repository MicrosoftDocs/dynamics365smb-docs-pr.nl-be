...
ms.author: edupont
---
# <a name="categorize-items" />Artikelen categoriseren
...
## <a name="to-create-an-item-category" />Een artikelcategorie maken
...
## <a name="to-assign-an-item-category-to-an-item" />Een artikelcategorie aan een artikel toewijzen

...
ms.author: edupont
---
# <a name="categorize-items"></a><a name="categorize-items"></a>Artikelen categoriseren
...
## <a name="to-create-an-item-category"></a><a name="to-create-an-item-category"></a>Een artikelcategorie maken
...
## <a name="to-assign-an-item-category-to-an-item"></a><a name="to-assign-an-item-category-to-an-item"></a>Een artikelcategorie aan een artikel toewijzen

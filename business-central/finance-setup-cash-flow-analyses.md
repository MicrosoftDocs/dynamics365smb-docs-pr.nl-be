...
---
# <a name="setting-up-cash-flow-analysis"></a><a name="setting-up-cash-flow-analysis"></a>Cashflowanalyse instellen
...
## <a name="the-cash-cycle-and-income--expense-charts"></a><a name="the-cash-cycle-and-income--expense-charts"></a>De diagrammen Cashcyclus en Inkomsten en uitgaven
...
## <a name="set-up-the-cash-flow-chart"></a><a name="set-up-the-cash-flow-chart"></a>Het cashflowdiagram instellen
...
## <a name="set-up-cash-flow-forecasts"></a><a name="set-up-cash-flow-forecasts"></a>Cashflowprognoses instellen
...
## <a name="design-details"></a><a name="design-details"></a>Ontwerpdetails
...
### <a name="data-required-for-forecast"></a><a name="data-required-for-forecast"></a>Vereiste gegevens voor prognoses
...
#### <a name="receivables"></a><a name="receivables"></a>Tegoeden
...
#### <a name="payables"></a><a name="payables"></a>Schulden
...
#### <a name="tax"></a><a name="tax"></a>Belasting
...
## <a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="create-and-use-your-own-predictive-web-service-for-cash-flow-forecasts"></a><a name="AnchorText"></a>Uw eigen voorspellende webservice voor cashflowprognoses maken en gebruiken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/forecast-cash-flow-dynamics-365-business-central/index)

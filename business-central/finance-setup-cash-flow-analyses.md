...
---
# <a name="setting-up-cash-flow-analysis" /><a name="setting-up-cash-flow-analysis"></a>Cashflowanalyse instellen
...
## <a name="the-cash-cycle-and-income--expense-charts" /><a name="the-cash-cycle-and-income--expense-charts"></a>De diagrammen Cashcyclus en Inkomsten en uitgaven
...
## <a name="set-up-the-cash-flow-chart" /><a name="set-up-the-cash-flow-chart"></a>Het cashflowdiagram instellen
...
## <a name="set-up-cash-flow-forecasts" /><a name="set-up-cash-flow-forecasts"></a>Cashflowprognoses instellen
...
## <a name="design-details" /><a name="design-details"></a>Ontwerpdetails
...
### <a name="data-required-for-forecast" /><a name="data-required-for-forecast"></a>Vereiste gegevens voor prognoses
...
#### <a name="receivables" /><a name="receivables"></a>Tegoeden
...
#### <a name="payables" /><a name="payables"></a>Schulden
...
#### <a name="tax" /><a name="tax"></a>Belasting

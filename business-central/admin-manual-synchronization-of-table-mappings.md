...
# <a name="manually-synchronize-table-mappings" />Handmatig tabeltoewijzingen synchroniseren
...
## <a name="run-a-full-synchronization" />Een volledige synchronisatie uitvoeren
...
### <a name="to-run-a-full-synchronization" />Een volledige synchronisatie uitvoeren
...
## <a name="synchronizing-all-modified-records" />Alle gewijzigde records synchroniseren
...
### <a name="to-synchronize-data-for-all-tables" />Gegevens voor alle tabellen synchroniseren
...
## <a name="synchronize-individual-table-mappings" />Afzonderlijke tabeltoewijzingen synchroniseren
...
### <a name="to-synchronize-records-of-an-integration-table-mapping" />Records synchroniseren van een integratietabeltoewijzing

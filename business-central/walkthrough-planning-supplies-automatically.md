...
---
# Procedure: Goederen automatisch plannen
...
### Geselecteerde planningsparameters wijzigen  
...
3.  Vul op de pagina **Verkooporder** de velden in, zoals is beschreven in de volgende tabel.  
    ...
    |Naam van orderklant|Verzenddatum|Artikelnr.|Vestiging|Hoeveelheid|  
    |----------------------------|-------------------|--------------|--------------|--------------|  
...
### Een regeneratief plan maken om aan de vraag op de vestiging OOST te voldoen  
...
3.  Vul op de pagina **Plan berekenen - Planningsvoorstel** de velden in zoals beschreven in de volgende tabel.  
    ...
    |--------------------|-------------------|-----------------|-------------------|---------------------|  
    |**MPS** = Ja<br /><br /> **MRP** = Nee|01-23-2021<br /><br /> (werkdatum)|02-07-2021|1001..1300|Vestigingsfilter = OOST|  
...
### MRP berekenen om onderliggende materiaalbehoeften op te nemen  
...
3.  Vul op de pagina **Plan berekenen - Planningsvoorstel** de velden in zoals beschreven in de volgende tabel.  
    ...
    |---------------|-------------------|-----------------|-------------------|----------------------|  
    |**MPS** = Ja<br /><br /> **MRP** = Ja|01-23-2021|02-07-2021|1001..1300|Vestigingsfilter = OOST|  
...
## Het planningsresultaat analyseren  
...
### Ordertraceringposten voor artikel 1300 weergeven  
...
### De planningsparameter controleren  
...
### Meer ordertraceringsposten weergeven  
...
## Een mutatieplan maken  
 ...
 In het planningssysteem wordt de beste manier berekend om te voldoen aan de vraag naar deze twee identieke producten, zoals het samenvoegen van bepaalde inkoop- en productieorders, het opnieuw plannen van andere orders en het zo nodig maken van nieuwe orders.  

### De nieuwe verkoopvraag maken en dienovereenkomstig opnieuw plannen  
...
2.  Vul op de pagina **Verkooporder** de velden in, zoals is beschreven in de volgende tabel.  
    ...
    |Naam van orderklant|Verzenddatum|Artikelnr.|Vestiging|Hoeveelheid|  
    |----------------------------|-------------------|--------------|--------------|--------------|  
    |Libros S.A.|02-12-2021|1001|OOST|10|  
...
7.  Vul op de pagina **Plan berekenen - Planningsvoorstel** de velden in zoals beschreven in de volgende tabel.  
    ...
    |Planning berekenen|Begindatum|Einddatum|Resultaten weergeven:|Totalen beperken tot|  
    |--------------------|-------------------|-----------------|-------------------|---------------------|  
    |**MPS** = Ja<br /><br /> **MRP** = Ja|01-23-2021|02-14-2021|1001..1300|Vestigingsfilter = OOST|  
...
## Het gewijzigde planningsresultaat analyseren  
...
### Ordertraceringposten voor artikel 1250 weergeven  

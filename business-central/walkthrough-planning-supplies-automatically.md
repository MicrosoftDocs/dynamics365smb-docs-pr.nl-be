...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically"></a><a name="walkthrough-planning-supplies-automatically"></a>Procedure: Goederen automatisch plannen
...
### <a name="to-create-stockkeeping-units"></a><a name="to-create-stockkeeping-units"></a>SKU's maken
...
### <a name="to-change-selected-planning-parameters"></a><a name="to-change-selected-planning-parameters"></a>Geselecteerde planningsparameters wijzigen
...
## <a name="creating-a-regenerative-supply-plan"></a><a name="creating-a-regenerative-supply-plan"></a>Een regeneratief voorraadplan maken
...
### <a name="to-create-the-sales-order"></a><a name="to-create-the-sales-order"></a>De verkooporder maken
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a><a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east"></a>Een regeneratief plan maken om aan de vraag op de vestiging OOST te voldoen
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs"></a><a name="to-calculate-mrp-to-include-underlying-component-needs"></a>MRP berekenen om onderliggende materiaalbehoeften op te nemen
...
## <a name="analyzing-the-planning-result"></a><a name="analyzing-the-planning-result"></a>Het planningsresultaat analyseren
...
### <a name="to-view-order-tracking-entries-for-item-1300"></a><a name="to-view-order-tracking-entries-for-item-1300"></a>Ordertraceringposten voor artikel 1300 weergeven
...
### <a name="to-check-the-planning-parameter"></a><a name="to-check-the-planning-parameter"></a>De planningsparameter controleren
...
### <a name="to-view-more-order-tracking-entries"></a><a name="to-view-more-order-tracking-entries"></a>Meer ordertraceringsposten weergeven
...
## <a name="carrying-out-action-messages"></a><a name="carrying-out-action-messages"></a>Planningsboodschappen uitvoeren
...
### <a name="to-automatically-create-the-suggested-supply-orders"></a><a name="to-automatically-create-the-suggested-supply-orders"></a>Automatisch de voorgestelde voorraadorders maken
...
## <a name="creating-a-net-change-plan"></a><a name="creating-a-net-change-plan"></a>Een mutatieplan maken
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly"></a><a name="to-create-the-new-sales-demand-and-replan-accordingly"></a>De nieuwe verkoopvraag maken en dienovereenkomstig opnieuw plannen
...
## <a name="analyzing-the-changed-planning-result"></a><a name="analyzing-the-changed-planning-result"></a>Het gewijzigde planningsresultaat analyseren
...
### <a name="to-view-order-tracking-entries-for-item-1250"></a><a name="to-view-order-tracking-entries-for-item-1250"></a>Ordertraceringposten voor artikel 1250 weergeven
...
### <a name="to-view-an-existing-order"></a><a name="to-view-an-existing-order"></a>Een bestaande order bekijken

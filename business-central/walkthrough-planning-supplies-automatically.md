...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-automatically" />Procedure: Goederen automatisch plannen
...
### <a name="to-create-stockkeeping-units" />SKU's maken
...
### <a name="to-change-selected-planning-parameters" />Geselecteerde planningsparameters wijzigen
...
## <a name="creating-a-regenerative-supply-plan" />Een regeneratief voorraadplan maken
...
### <a name="to-create-a-regenerative-plan-to-fulfill-demand-at-location-east" />Een regeneratief plan maken om aan de vraag op de vestiging OOST te voldoen
...
### <a name="to-calculate-mrp-to-include-underlying-component-needs" />MRP berekenen om onderliggende materiaalbehoeften op te nemen
...
## <a name="analyzing-the-planning-result" />Het planningsresultaat analyseren
...
### <a name="to-check-the-planning-parameter" />De planningsparameter controleren
...
### <a name="to-view-more-order-tracking-entries" />Meer ordertraceringsposten weergeven
...
## <a name="carrying-out-action-messages" />Planningsboodschappen uitvoeren
...
### <a name="to-automatically-create-the-suggested-supply-orders" />Automatisch de voorgestelde voorraadorders maken
...
## <a name="creating-a-net-change-plan" />Een mutatieplan maken
...
### <a name="to-create-the-new-sales-demand-and-replan-accordingly" />De nieuwe verkoopvraag maken en dienovereenkomstig opnieuw plannen
...
## <a name="analyzing-the-changed-planning-result" />Het gewijzigde planningsresultaat analyseren
...
### <a name="to-view-an-existing-order" />Een bestaande order bekijken

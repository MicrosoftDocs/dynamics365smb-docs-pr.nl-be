...
## <a name="to-post-other-acquisition-costs"></a>Aanvullende aanschafkosten boeken
...
### <a name="example---posting-other-acquisition-costs"></a>Voorbeeld - aanvullende aanschafkosten boeken

...
ms.author: edupont
---
# <a name="set-up-the-envestnet-yodlee-bank-feeds-service" />De Envestnet Yodlee Bank Feeds-service instellen
...
## <a name="to-enable-the-bank-feed-service" />De bankfeedservice inschakelen
...
## <a name="to-create-a-new-linked-bank-account" />Een nieuwe gekoppelde bankrekening maken
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Bankrekeningen** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="to-link-a-bank-account-to-an-online-bank-account" />Een bankrekening koppelen aan een online bankrekening
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Bankrekeningen** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="to-edit-the-credentials-for-an-online-bank-account" />De inloggegevens voor een online bankrekening bewerken
...
## <a name="to-unlink-a-bank-account" />Een bankrekening ontkoppelen
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Bankrekeningen** in en kies vervolgens de gerelateerde koppeling.  
...
## <a name="to-update-bank-account-linking" />Koppeling aan bankrekening bijwerken
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Bankrekeningen** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="to-enable-automatic-import-of-bank-statements" />Automatisch importeren van bankafschriften inschakelen
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Bankrekeningen** in en kies vervolgens de gerelateerde koppeling.

...
# <a name="sharing-business-central-records-and-page-links-in-microsoft-teams" />Business Central-records en paginakoppelingen delen in Microsoft Teams
...
## <a name="include-and-view-a-business-central-card-in-a-teams-conversation" />Een Business Central-kaart opnemen en weergeven in een Teams-gesprek
...
### <a name="include-a-business-central-card-in-a-teams-conversation" />Een Business Central-kaart opnemen in een Teams-gesprek
...
### <a name="view-card-details" />Kaartdetails weergeven
...
### <a name="share-a-link" />Een koppeling delen

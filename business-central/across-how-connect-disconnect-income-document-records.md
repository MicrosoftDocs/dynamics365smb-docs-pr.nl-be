...
ms.author: edupont
---
# <a name="create-incoming-document-records-directly-from-documents-and-entries" />Inkomende documentrecords maken direct van documenten en posten
...
## <a name="create-and-connect-an-incoming-document-record-from-a-purchase-invoice" />Een inkomende documentrecord maken van een inkoopfactuur en koppelen
...
## <a name="create-and-connect-an-incoming-document-record-from-a-vendor-ledger-entry" />Een inkomende documentrecord maken van een leverancierspost en koppelen
...
## <a name="remove-a-connection-from-an-incoming-document-record-to-a-posted-document" />De relatie van een inkomende documentrecord met een geboekt document verwijderen

...
ms.author: edupont
---
# <a name="find-posted-documents-without-incoming-document-records" />Geboekte documenten zonder inkomende documentrecords zoeken
...
## <a name="to-find-posted-documents-without-incoming-document-records" />Geboekte documenten zonder inkomende documentrecords zoeken
...
## <a name="to-connect-found-documents-to-existing-incoming-document-records" />Gevonden documenten koppelen aan bestaande inkomende documentrecords

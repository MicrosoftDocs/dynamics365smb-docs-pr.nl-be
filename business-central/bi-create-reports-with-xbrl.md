...
ms.author: edupont
---
# <a name="create-reports-with-xbrl"></a><a name="create-reports-with-xbrl"></a>Lijsten met XBRL maken
...
## <a name="xbrl-comprises-the-following-components"></a><a name="xbrl-comprises-the-following-components"></a>XBRL omvat de volgende onderdelen
...
## <a name="layered-taxonomies"></a><a name="layered-taxonomies"></a>Laagsgewijze taxonomieën
...
## <a name="set-up-xbrl-lines"></a><a name="set-up-xbrl-lines"></a>XBRL-regels instellen
...
## <a name="import-an-xbrl-taxonomy"></a><a name="import-an-xbrl-taxonomy"></a>Een XBRL-taxonomie importeren
...
## <a name="update-an-xbrl-taxonomy"></a><a name="update-an-xbrl-taxonomy"></a>Een XBRL-taxonomie bijwerken
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Zie gerelateerde training op [Microsoft Learn](/learn/modules/xbrl-reports-dynamics-365-business-central/index).

...
---
# <a name="pick-items-for-warehouse-shipment" />Picken van artikelen voor magazijnverzending
...
## <a name="to-pick-items-for-a-warehouse-shipment" />Picken van artikelen voor een magazijnverzending

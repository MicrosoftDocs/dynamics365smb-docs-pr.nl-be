...
ms.author: edupont
---
# <a name="batch-post-production-consumption" />Productieverbruik in batches boeken
...
## <a name="to-post-consumption-for-one-or-more-production-order-lines" />Verbruik boeken voor een of meer productieorderregels

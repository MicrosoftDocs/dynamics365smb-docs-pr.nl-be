...
ms.author: bholtorf
---
# <a name="pick-for-production-assembly-or-jobs-in-advanced-warehouse-configurations" />Picken voor productie, assemblage of taken in geavanceerde magazijnconfiguraties
...
## <a name="to-create-pick-documents-in-bulk-with-the-pick-worksheet" />Bulksgewijs pickdocumenten maken met het pickvoorstel
...
## <a name="to-pick-items-for-a-productions-order-assembly-order-job" />Artikelen picken voor een productieorder, assemblageorder, project
...
## <a name="flushing-production-components-in-a-advanced-warehouse-configuration" />Materialen afboeken voor productie in een geavanceerde magazijnconfiguratie

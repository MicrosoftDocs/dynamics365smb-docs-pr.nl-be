...
ms.author: edupont
---
# <a name="work-with-payment-tolerances-and-payment-discount-tolerances" />Werken met betalingstolerantie en contantkortingstolerantie
...
## <a name="applying-payment-tolerance-to-multiple-documents" />Betalingstolerantie voor meerdere documenten toepassen
...
## <a name="to-set-up-tolerances" />Toleranties instellen
...
## <a name="to-enable-or-disable-payment-tolerance-warnings" />Betalingstolerantiewaarschuwingen in- of uitschakelen
...
## <a name="to-block-payment-tolerance-for-customers" />Betalingstolerantie voor klanten blokkeren

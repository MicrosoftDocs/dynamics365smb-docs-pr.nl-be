...
ms.author: edupont
---
# <a name="process-sales-returns-or-cancellations" />Verkoopretouren of annuleringen verwerken
...
## <a name="to-create-a-sales-credit-memo-from-a-posted-sales-invoice" />Een verkoopcreditnota maken op basis van een geboekte verkoopfactuur
...
## <a name="to-create-a-sales-credit-memo-by-copying-a-posted-sales-invoice" />Een verkoopcreditnota maken door een geboekte verkoopfactuur te kopiëren
...
## <a name="to-create-a-sales-allowance" />Een verkoopprijskorting maken
...
## <a name="to-combine-return-receipts" />Retourontvangsten combineren
...
### <a name="to-manually-combine-return-receipts" />Retourontvangsten handmatig combineren
...
### <a name="to-automatically-combine-return-receipts" />Retourontvangsten automatisch combineren
...
### <a name="to-remove-a-received-and-invoiced-return-order" />Ontvangen en gefactureerde retourorders verwijderen

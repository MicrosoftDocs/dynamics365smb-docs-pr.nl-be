...
ms.reviewer: jswymer
---
# <a name="trial-features-that-connect-to-other-microsoft-services"></a><a name="trial-features-that-connect-to-other-microsoft-services"></a>Proeffuncties die verbinding maken met andere Microsoft-services

...
ms.author: edupont
---
# <a name="create-bin-contents"></a><a name="create-bin-contents"></a>Opslaglocatie-inhoud maken
...
## <a name="to-create-bin-content-manually"></a><a name="to-create-bin-content-manually"></a>Opslaglocatie-inhoud handmatig maken
...
## <a name="to-create-bin-content-with-a-worksheet"></a><a name="to-create-bin-content-with-a-worksheet"></a>Opslaglocatie-inhoud met een voorstel maken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/set-up-zones-bins/)

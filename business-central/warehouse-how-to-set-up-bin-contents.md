...
ms.author: edupont
---
# <a name="create-bin-contents" />Opslaglocatie-inhoud maken
...
## <a name="to-create-bin-content-manually" />Opslaglocatie-inhoud handmatig maken
...
## <a name="to-create-bin-content-with-a-worksheet" />Opslaglocatie-inhoud met een voorstel maken

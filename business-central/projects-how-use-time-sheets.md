...
description: Leer hoe u urenstaten kunt maken en deze ter goedkeuring kunt indienen.
author: brentholtorf
ms.author: bholtorf
...
Gebruik urenstaten om afwezigheid bij te houden en om de tijd en resources die aan een project worden besteed bij te houden. Tijd bijhouden helpt u problemen vroeg te identificeren en vertragingen of budgetoverschrijdende kosten te voorkomen. Met urenstaten is het gemakkelijk voor een resource om tijdgebruik te rapporteren voor een persoon of een machine, zodat beheerders het gebruik en de toewijzing ervan kunnen bekijken. In dit artikel wordt beschreven hoe u met urenstaten kunt werken.  
...
U kunt de pagina **Urenstaten maken** gebruiken om urenstaten in te stellen voor een opgegeven aantal perioden of weken. Vervolgens kan de eigenaar van de urenstaat deze openen en tijd vastleggen die aan een taak is besteed. U kunt ook [de automatische uitvoering van de batchtaak plannen](ui-work-report.md#ScheduleReport).  

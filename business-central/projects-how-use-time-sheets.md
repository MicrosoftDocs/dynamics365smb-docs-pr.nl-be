...
ms.author: edupont
---
# <a name="use-time-sheets" />Urenstaten gebruiken
...
## <a name="to-create-time-sheets" />Urenstaten maken
...
## <a name="to-reuse-time-sheet-lines-in-other-time-sheets" />Urenstaatregels in andere urenstaten opnieuw gebruiken
...
## <a name="to-copy-job-planning-lines-to-a-time-sheet" />Projectplanningsregels kopiëren naar een urenstaat
...
## <a name="to-define-work-types-and-add-one-to-a-time-sheet" />Werksoorten definiëren en er een toevoegen aan een urenstaat
...
## <a name="to-fill-in-time-sheet-lines-and-submit-for-approval" />Urenstaatregels invullen en ter goedkeuring verzenden
...
## <a name="to-approve-or-reject-a-time-sheet" />Een urenstaat goedkeuren of weigeren
...
## <a name="to-reopen-a-time-sheet" />Een urenstaat opnieuw openen
...
## <a name="to-view-and-approve-time-sheets-by-job" />Urenstaten per project bekijken en goedkeuren
...
### <a name="to-approve-or-reject-a-time-sheet-by-job" />Een urenstaat per project goedkeuren of weigeren
...
## <a name="to-post-time-sheet-lines-in-a-resource-journal" />Urenstaatregels naar een resourcedagboek boeken
...
## <a name="to-post-time-sheet-lines-in-a-job-journal" />Urenstaatregels in een projectdagboek boeken
...
## <a name="to-archive-time-sheets" />Urenstaten verplaatsen naar archief

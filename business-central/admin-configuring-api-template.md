...
# <a name="configure-api-templates"></a><a name="configure-api-templates"></a>API-sjablonen configureren
...
## <a name="setting-up-the-entity-template"></a><a name="setting-up-the-entity-template"></a>De entiteitsjabloon instellen
...
## <a name="assign-the-template-to-an-api"></a><a name="assign-the-template-to-an-api"></a>De sjabloon toewijzen aan een API

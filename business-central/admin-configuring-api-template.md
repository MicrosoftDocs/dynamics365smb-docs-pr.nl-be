...
# <a name="configure-api-templates" />API-sjablonen configureren
...
## <a name="setting-up-the-entity-template" />De entiteitsjabloon instellen
...
## <a name="assign-the-template-to-an-api" />De sjabloon toewijzen aan een API

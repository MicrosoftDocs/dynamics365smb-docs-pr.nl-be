...
ms.author: edupont
---
# <a name="subcontract-manufacturing" />Productie uitbesteden
...
## <a name="subcontract-work-centers" />Uitbestedingsafdelingen
...
### <a name="subcontract-work-center-fields" />Velden voor uitbestedingsafdelingen
...
### <a name="routings-that-use-subcontract-work-centers" />Bewerkingsplannen die gebruikmaken van uitbestedingsafdelingen
...
## <a name="calculate-subcontracting-worksheets-and-create-subcontract-purchase-orders" />Uitbestedingsvoorstel berekenen en uitbestedingsinkooporders maken
...
### <a name="to-calculate-the-subcontracting-worksheet" />Het uitbestedingsvoorstel berekenen
...
### <a name="to-create-the-subcontract-purchase-order" />De uitbestedingsinkooporder genereren
1.  Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Uitbestedingsvoorstel** in en kies vervolgens de gerelateerde koppeling.  
...
## <a name="posting-subcontract-purchase-orders" />Uitbestedingsinkooporders boeken
...
## <a name="to-post-a-subcontract-purchase-order" />Een uitbestedingsinkooporder boeken

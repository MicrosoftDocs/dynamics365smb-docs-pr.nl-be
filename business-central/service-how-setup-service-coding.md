...
# <a name="set-up-standard-service-codes" />Standaardservicecodes instellen
...
## <a name="to-set-up-a-standard-service-code" />Standaardservicecodes instellen
...
## <a name="to-assign-a-standard-service-code-to-a-service-item-group" />Een standaardservicecode toewijzen aan een serviceartikelgroep

...
ms.author: edupont
---
# <a name="flush-components-according-to-operation-output" />Onderdelen afboeken op basis van de uitvoer van een bewerking
...
## <a name="automatic-consumption-posting-flushing-methods" />Methoden voor automatisch verbruik boeken (afboeken)
...
### <a name="automatic-reporting---forward-flush-the-entire-order" />Automatische rapportage - de hele order voorwaarts afboeken
...
### <a name="automatic-reporting---forward-flushing-by-operation" />Automatische rapportage - voorwaarts afboeken per bewerking
...
### <a name="automatic-reporting---back-flushing-by-operation" />Automatische rapportage - achterwaarts afboeken per bewerking
...
### <a name="automatic-reporting---back-flushing-the-entire-order" />Automatische rapportage - de hele order achterwaarts afboeken
...
## <a name="to-flush-components-according-to-operation-output" />Onderdelen afboeken op basis van de uitvoer van een bewerking
...
## <a name="flushing-methods" />Afboekingsmethoden

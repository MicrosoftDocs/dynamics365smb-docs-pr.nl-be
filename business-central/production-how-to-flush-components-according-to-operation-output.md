---
title: Componenten afboeken op basis van de output van een bewerking
description: In dit artikel wordt beschreven hoe u componenten moet afboeken op basis van de bewerkingsoutput en andere betrokken afboekingsmethoden.
author: brentholtorf
ms.topic: conceptual
ms.devlang: al
...
- Wanneer artikelen vanuit de voorraad worden verbruikt, maakt het niet uit wanneer outputdagboekposten worden gemaakt, want het outputdagboek heeft geen effect op deze manier van verbruikboeking.  
...
Deze techniek kan het beste worden toegepast wanneer er veel bewerkingen zijn en bepaalde onderdelen pas later in de assemblagevolgorde nodig zijn. In feite kan het bij een Just-in-Time (JIT)-omgeving zelfs zo zijn dat de artikelen niet eens voorhanden zijn wanneer de RPO van start gaat.  

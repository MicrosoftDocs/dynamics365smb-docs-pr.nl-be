...
ms.author: jswymer
---
# <a name="analyzing-report-data-with-excel-and-xml" />Rapportgegevens analyseren met Excel en XML
...
## <a name="more-about-excel-data-only" />Meer over Excel (alleen gegevens)
...
## <a name="for-administrators" />Voor beheerders
...
## <a name="for-developers-and-advanced-users" />Voor ontwikkelaars en gevorderde gebruikers

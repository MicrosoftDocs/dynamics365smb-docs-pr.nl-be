...
# <a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a><a name="report-vat-to-tax-authorities"></a>Btw rapporteren aan de belastingdienst
...
## <a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="about-the-ec-sales-list-report"></a><a name="ecsaleslist"></a>Informatie over het Verkoopoverzicht EU
...
### <a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a><a name="submit-an-ec-sales-list-report"></a>Een rapport Verkoopoverzicht EU indienen

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="about-the-vat-return-report"></a><a name="vatreturn"></a>Informatie over het rapport Btw-aangifte
...
## <a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a><a name="to-connect-to-your-tax-authoritys-web-service"></a>Verbinding maken met de webservice van uw belastingdienst
...
## <a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a><a name="to-set-up-vat-reports-in-"></a>Btw-rapporten instellen in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### <a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a><a name="to-set-up-vat-return-periods"></a>Indieningsperioden voor btw instellen
...
## <a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a><a name="to-prepare-and-submit-a-vat-report"></a>Een btw-aangifte voorbereiden en indienen
...
### <a name="vat-return-statuses"></a><a name="vat-return-statuses"></a><a name="vat-return-statuses"></a>Status van btw-aangifte
...
## <a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a><a name="viewing-communications-with-your-tax-authority"></a>Communicatie met uw belastingdienst weergeven
...
## <a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a><a name="submitting-vat-reports-manually"></a>Handmatig btw-aangiftes verzenden
...
## <a name="vat-settlement"></a><a name="vat-settlement"></a><a name="vat-settlement"></a>Btw-vereffening
...
## <a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a><a name="configuring-your-own-vat-reports"></a>Uw eigen btw-rapporten configureren

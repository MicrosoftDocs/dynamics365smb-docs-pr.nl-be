...
# Btw rapporteren aan de belastingdienst
...
## <a name="ecsaleslist"></a>Informatie over het Verkoopoverzicht EU
...
### Een rapport Verkoopoverzicht EU indienen

[!INCLUDE [finance-ecsaleslist](includes/finance-ecsaleslist.md)]

## <a name="vatreturn"></a>Informatie over het rapport Btw-aangifte
...
## Verbinding maken met de webservice van uw belastingdienst
...
## Btw-rapporten instellen in [!INCLUDE[prod_short](includes/prod_short.md)]

[!INCLUDE [vat-report-setup](includes/vat-report-setup.md)]

### Indieningsperioden voor btw instellen
...
## Een btw-aangifte voorbereiden en indienen
...
## Communicatie met uw belastingdienst weergeven
...
## Handmatig btw-aangiftes verzenden
...
## Uw eigen btw-rapporten configureren

...
ms.author: bholtorf
---
# <a name="allocate-costs-to-intercompany-partners" />Kosten toewijzen aan intercompany-partners
...
## <a name="to-allocate-costs-using-an-intercompany-general-journal" />Kosten toewijzen met behulp van een intercompany-dagboek
...
## <a name="to-allocate-costs-using-a-purchase-document" />Kosten toewijzen met behulp van een inkoopdocument
...
## <a name="to-send-the-allocated-costs-to-intercompany-partners" />De toegewezen kosten naar intercompany-partners verzenden
...
## <a name="calculating-vat-for-cost-distributions" />Btw berekenen voor kostendistributies

...
## <a name="couple-records"></a>Records koppelen
...
## <a name="fully-synchronize-records"></a>Records volledig synchroniseren
...
## <a name="handle-sales-order-data"></a>Verkoopordergegevens verwerken
...
## <a name="handle-sales-quotes-data"></a>Verkoopoffertegegevens verwerken
...
## <a name="handle-posted-sales-invoices-customer-payments-and-statistics"></a>Geboekte verkoopfacturen, klantbetalingen en statistieken verwerken
...
## <a name="handle-sales-prices"></a>Omgaan met verkoopprijzen
> [!NOTE]

...
ms.author: bholtorf
---
# <a name="use-dynamics-365-sales-from-business-central"></a><a name="use-dynamics-365-sales-from-business-central"></a>Dynamics 365 Sales gebruiken vanuit Business Central
...
## <a name="coupling-records"></a><a name="coupling-records"></a>Records koppelen
...
## <a name="fully-synchronizing-records"></a><a name="fully-synchronizing-records"></a>Records volledig synchroniseren
...
## <a name="handling-sales-order-data"></a><a name="handling-sales-order-data"></a>Verkoopordergegevens verwerken
...
## <a name="handling-sales-quotes-data"></a><a name="handling-sales-quotes-data"></a>Verkoopoffertegegevens verwerken
...
## <a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a><a name="handling-posted-sales-invoices-customer-payments-and-statistics"></a>Geboekte verkoopfacturen, klantbetalingen en statistieken verwerken
...
## <a name="handling-sales-prices"></a><a name="handling-sales-prices"></a>Omgaan met verkoopprijzen
> [!NOTE]

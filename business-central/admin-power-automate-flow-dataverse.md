...
ms.author: bholtorf
---
# <a name="use-a-power-automate-flow-for-alerts-to-dataverse-entity-changes" />Gebruik een Power Automate-stroom voor waarschuwingen voor Dataverse-entiteitswijzigingen
...
## <a name="import-the-flow-template" />De stroomsjabloon importeren
...
## <a name="define-the-flow-trigger" />De stroomtrigger definiëren
...
## <a name="define-the-flow-condition" />De stroomvoorwaarde definiëren
...
## <a name="notify-business-central-about-a-change" />Business Central op de hoogte stellen van een wijziging

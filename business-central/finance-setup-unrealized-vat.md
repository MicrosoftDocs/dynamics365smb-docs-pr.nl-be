...
# <a name="set-up-unrealized-vat-for-cash-based-accounting" />Ongerealiseerde btw voor op kas gebaseerde boekhouding instellen
...
## <a name="to-use-general-ledger-accounts-for-unrealized-vat" />Grootboekrekeningen gebruiken voor ongerealiseerde btw

...
ms.author: edupont
---
# <a name="copy-existing-items-to-create-new-items" />Bestaande items kopiëren om nieuwe items te maken
...
## <a name="to-copy-an-existing-item-to-a-new-item" />Een bestaand item naar een nieuw item kopiëren.

...
## <a name="to-set-up-a-document-sending-profile" />Een verzendprofiel voor documenten instellen
...
## <a name="to-specify-a-sending-profile-on-a-customer-card" />Een verzendprofiel op een klantenkaart opgeven

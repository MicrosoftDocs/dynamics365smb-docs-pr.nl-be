...
---
# <a name="put-items-away-with-inventory-put-aways" />Artikelen opslaan met voorraadopslag
...
## <a name="to-create-an-inventory-put-away-from-the-source-document" />Een voorraadopslag maken op basis van het brondocument
...
## <a name="to-create-multiple-inventory-put-aways-with-a-batch-job" />Meerdere voorraadopslagactiviteiten maken met een batchverwerking
...
## <a name="to-create-the-put-away-in-two-steps" />De opslag in twee stappen maken

### <a name="to-request-an-inventory-put-away-by-releasing-the-source-document" />Een voorraadopslag aanvragen door het brondocument vrij te geven
...
### <a name="to-create-an-inventory-put-away-based-on-the-source-document" />Een voorraadopslag maken op basis van het brondocument
...
## <a name="to-record-the-inventory-put-away" />De voorraadopslag registreren

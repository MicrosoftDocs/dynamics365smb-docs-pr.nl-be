...
ms.author: edupont
---
# <a name="set-up-statuses-for-service-orders-and-repairs" />Statussen instellen voor serviceorders en reparaties
...
## <a name="to-set-up-service-status-priorities" />Servicestatusprioriteiten instellen
...
## <a name="to-set-up-a-repair-status" />Herstelstatus instellen

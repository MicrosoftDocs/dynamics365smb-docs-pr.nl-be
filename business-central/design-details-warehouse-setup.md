...
ms.author: edupont
---
# <a name="design-details-warehouse-setup" />Ontwerpdetails: Magazijninstelling
...
## <a name="bin-and-bin-content" />Opslaglocatie en inhoud
...
## <a name="bin-ranking" />Opslaglocatievolgorde

...
ms.search.form: 9171
---
# <a name="manage-user-profiles"></a><a name="manage-user-profiles"></a>Gebruikersprofielen beheren
...
## <a name="page-customization"></a><a name="page-customization"></a>Pagina-aanpassing
...
## <a name="to-create-a-profile"></a><a name="to-create-a-profile"></a>Een profiel maken
...
## <a name="to-copy-a-profile"></a><a name="to-copy-a-profile"></a>Een profiel kopiëren
...
## <a name="to-edit-a-profile"></a><a name="to-edit-a-profile"></a>Een profiel bewerken
...
## <a name="to-assign-a-profile-to-a-user"></a><a name="to-assign-a-profile-to-a-user"></a>Een profiel aan een gebruiker toewijzen
...
## <a name="to-define-user-settings-for-a-profile"></a><a name="to-define-user-settings-for-a-profile"></a>Gebruikersinstellingen voor een profiel definiëren
...
## <a name="to-activate-a-profile"></a><a name="to-activate-a-profile"></a>Een profiel activeren
...
## <a name="to-export-profiles"></a><a name="to-export-profiles"></a>Profielen exporteren
...
## <a name="to-import-profiles"></a><a name="to-import-profiles"></a>Profielen importeren
...
## <a name="to-delete-a-profile"></a><a name="to-delete-a-profile"></a>Een profiel verwijderen
...
## <a name="to-delete-all-personalizations-made-by-a-user"></a><a name="to-delete-all-personalizations-made-by-a-user"></a>Alle aanpassingen verwijderen die door een gebruiker zijn aangebracht.
...
## <a name="to-delete-personalizations-for-specific-pages"></a><a name="to-delete-personalizations-for-specific-pages"></a>Personalisaties voor specifieke pagina's verwijderen
...
## <a name="managing-user-sessions"></a><a name="managing-user-sessions"></a>Gebruikerssessies beheren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/users-security-dynamics-365-business-central/)

...
ms.search.form: 9171
---
# <a name="manage-user-profiles" />Gebruikersprofielen beheren
...
## <a name="page-customization" />Pagina-aanpassing
...
## <a name="to-create-a-profile" />Een profiel maken
...
## <a name="to-copy-a-profile" />Een profiel kopiëren
...
## <a name="to-edit-a-profile" />Een profiel bewerken
...
## <a name="to-assign-a-profile-to-a-user" />Een profiel aan een gebruiker toewijzen
...
## <a name="to-define-user-settings-for-a-profile" />Gebruikersinstellingen voor een profiel definiëren
...
## <a name="to-activate-a-profile" />Een profiel activeren
...
## <a name="to-export-profiles" />Profielen exporteren
...
## <a name="to-import-profiles" />Profielen importeren
...
## <a name="to-delete-a-profile" />Een profiel verwijderen
...
## <a name="to-delete-all-personalizations-made-by-a-user" />Alle aanpassingen verwijderen die door een gebruiker zijn aangebracht.
...
## <a name="to-delete-personalizations-for-specific-pages" />Personalisaties voor specifieke pagina's verwijderen
...
## <a name="managing-user-sessions" />Gebruikerssessies beheren
...
## <a name="see-related-microsoft-trainingtrainingmodulesusers-security-dynamics-365-business-central" />Zie gerelateerde [Microsoft-training](/training/modules/users-security-dynamics-365-business-central/)

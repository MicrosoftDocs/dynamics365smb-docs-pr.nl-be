...
ms.author: edupont
---
# <a name="register-new-items" />Nieuwe artikelen registreren
...
## <a name="to-create-a-new-item-card" />Een nieuwe artikelkaart maken
...
### <a name="to-save-the-item-card-as-a-template" />De artikelkaart als sjabloon opslaan
...
### <a name="items-used-in-production-orders" />Artikelen gebruikt in productieorders
...
## <a name="to-set-up-multiple-vendors-for-an-item" />Meerdere leveranciers voor een artikel instellen
...
## <a name="set-up-item-substitutions" />Artikelvervangingen instellen
...
### <a name="to-make-an-item-substitution" />Een artikelvervanging maken
...
## <a name="categories-attributes-and-variants" />Categorieën, kenmerken en varianten

[!INCLUDE[inventory_variant](includes/inventory_variant.md)]

Zie [Productvarianten beheren](inventory-item-variants.md) voor meer informatie over varianten.  

## <a name="deleting-item-cards" />Artikelkaarten verwijderen
...
## <a name="manage-inventory-in-warehouses" />Voorraad beheren in magazijnen

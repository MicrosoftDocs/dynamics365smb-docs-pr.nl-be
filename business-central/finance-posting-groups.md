...
ms.author: bholtorf
---
# <a name="set-up-posting-groups"></a><a name="set-up-posting-groups"></a>Boekingsgroepen instellen
...
## <a name="general-posting-groups"></a><a name="general-posting-groups"></a>Algemene boekingsgroepen
...
## <a name="specific-posting-groups"></a><a name="specific-posting-groups"></a>Specifieke boekingsgroepen
...
### <a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a><a name="allowing-substitute-customer-or-vendor-posting-groups-on-documents"></a>Boekingsgroepen voor vervangende klanten of leveranciers op documenten toestaan
...
## <a name="tax-posting-groups"></a><a name="tax-posting-groups"></a>Btw-boekingsgroepen
...
## <a name="example-of-linking-posting-groups"></a><a name="example-of-linking-posting-groups"></a>Voorbeeld van het koppelen van boekingsgroepen
...
## <a name="copying-posting-setup-lines"></a><a name="copying-posting-setup-lines"></a>Boekingsinstellingsregels kopiëren
...
## <a name="set-up-posting-groups-on-the-go"></a><a name="set-up-posting-groups-on-the-go"></a>Boekingsgroepen onderweg instellen
...
## <a name="troubleshooting-posting-group-errors"></a><a name="troubleshooting-posting-group-errors"></a>Problemen met boekingsgroepfouten
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/posting-groups-dynamics-365-business-central/)

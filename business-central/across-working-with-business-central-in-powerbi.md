...
ms.author: jswymer
---
# <a name="work-with--data-in-power-bi"></a><a name="work-with--data-in-power-bi"></a>Werken met [!INCLUDE [prod_short](includes/prod_short.md)] -gegevens in Power BI
...
## <a name="get-the-latest-data"></a><a name="get-the-latest-data"></a>De meest recente gegevens ophalen
...
### <a name="refresh-manually"></a><a name="refresh-manually"></a>Handmatig vernieuwen
...
### <a name="schedule-a-refresh"></a><a name="schedule-a-refresh"></a>Het vernieuwen van gegevens plannen
...
## <a name="upload-reports-from-files"></a><a name="upload-reports-from-files"></a><a name="upload"></a>Rapporten uploaden vanuit bestanden
...
## <a name="share-reports-with-others"></a><a name="share-reports-with-others"></a><a name="share"></a>Rapporten met anderen delen

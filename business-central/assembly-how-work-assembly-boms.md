...
ms.author: edupont
---
# <a name="work-with-assembly-boms" />Werken met assemblagestuklijsten
...
## <a name="to-create-an-assembly-bom" />Een assemblagestuklijst maken
...
## <a name="to-edit-assembly-boms" />Assemblagestuklijsten bewerken
...
## <a name="to-view-components-and-resources-indented-according-to-the-bom-structure" />Onderdelen en resources ingesprongen volgens de stuklijststructuur weergeven
...
## <a name="to-replace-the-assembly-item-with-its-components-on-document-lines" />Het assemblageartikel in documentregels vervangen door de samenstellende onderdelen
...
## <a name="to-calculate-the-standard-cost-of-an-assembly-item" />De vaste verrekenprijs van een assemblageartikel berekenen
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/set-up-assembly-items-dynamics-365-business-central/).

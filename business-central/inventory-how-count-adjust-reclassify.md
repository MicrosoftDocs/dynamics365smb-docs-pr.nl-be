...
---
# <a name="count-adjust-and-reclassify-inventory-using-journals"></a><a name="count-adjust-and-reclassify-inventory-using-journals"></a>Voorraad tellen, corrigeren en herindelen met dagboeken
...
## <a name="to-count-physical-inventory"></a><a name="to-count-physical-inventory"></a>Fysieke voorraad tellen
...
### <a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a><a name="to-calculate-expected-inventory-in-basic-warehouse-configurations"></a>Verwachte voorraad in standaardmagazijnconfiguraties berekenen
...
### <a name="to-print-the-report-to-be-used-when-counting"></a><a name="to-print-the-report-to-be-used-when-counting"></a>Het rapport afdrukken dat bij het tellen moet worden gebruikt
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-basic-warehouse-configurations"></a>De werkelijk getelde voorraad in standaardmagazijnconfiguraties invoeren en boeken
...
### <a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a><a name="to-calculate-the-expected-inventory-in-advanced-warehouse-configurations"></a>De verwachte voorraad in geavanceerde magazijnconfiguraties berekenen
...
### <a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a><a name="to-enter-and-post-the-actual-counted-inventory-in-advanced-warehouse-configurations"></a>De werkelijk getelde voorraad in geavanceerde magazijnconfiguraties invoeren en boeken
...
## <a name="to-do-cycle-counting"></a><a name="to-do-cycle-counting"></a>Cyclustelling uitvoeren
...
### <a name="to-set-up-counting-periods"></a><a name="to-set-up-counting-periods"></a>U kunt als volgt tellingsperioden instellen
...
### <a name="to-assign-a-counting-period-to-an-item"></a><a name="to-assign-a-counting-period-to-an-item"></a>Een tellingsperiode toewijzen aan een artikel
...
### <a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-basic-warehouse-configurations"></a>Een telling starten op basis van tellingsperioden in standaardmagazijnconfiguraties
...
### <a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a><a name="to-start-a-count-based-on-counting-periods-in-advanced-warehouse-configurations"></a>Een telling starten op basis van tellingsperioden in geavanceerde magazijnconfiguraties
...
## <a name="to-adjust-the-quantity-of-one-item"></a><a name="to-adjust-the-quantity-of-one-item"></a>De hoeveelheid van één artikel aanpassen
...
### <a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a><a name="to-adjust-the-quantities-of-multiple-items-in-basic-warehouse-configurations"></a>De hoeveelheden van meerdere artikelen in standaardmagazijnconfiguraties corrigeren
...
### <a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a><a name="to-adjust-bin-quantities-in-advanced-warehouse-configurations"></a>Opslaglocatieaantallen in geavanceerde magazijnconfiguraties aanpassen
...
## <a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a><a name="to-synchronize-the-adjusted-warehouse-entries-with-the-related-item-ledger-entries"></a>De aangepaste magazijnposten synchroniseren met de gerelateerde artikelposten
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/adjust-inventory/)

...
# <a name="the-data-archive-extension" />De extensie Gegevensarchief
...
## <a name="start-archiving-data" />Begin met het archiveren van gegevens
...
## <a name="storage-considerations" />Overwegingen bij opslag

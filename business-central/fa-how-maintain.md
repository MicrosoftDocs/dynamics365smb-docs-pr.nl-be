...
ms.author: edupont
---
# <a name="maintain-fixed-assets" />Vaste activa onderhouden
...
## <a name="to-record-maintenance-work-on-a-fixed-asset" />Onderhoudswerk aan een vast activum registreren
...
## <a name="to-post-maintenance-costs-from-a-fixed-asset-gl-journal" />Onderhoudskosten boeken vanuit een financieel dagboek voor vaste activa
...
## <a name="to-follow-up-on-fixed-assets-service-visits" />Onderhoudsbeurten voor vaste activa opvolgen
...
## <a name="to-monitor-maintenance-costs" />Onderhoudskosten controleren
...
## <a name="to-view-or-print-maintenance-costs-for-multiple-fixed-assets" />Onderhoudskosten voor meerdere vaste activa weergeven of afdrukken
...
## <a name="to-view-maintenance-ledger-entries" />Onderhoudsposten bekijken
...
## <a name="to-view-or-print-maintenance-ledger-entries-for-multiple-fixed-assets" />Onderhoudskosten voor meerdere vaste activa weergeven of afdrukken

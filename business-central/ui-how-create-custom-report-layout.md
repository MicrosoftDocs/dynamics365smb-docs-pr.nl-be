...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts" />(verouderd) Aangepaste rapportlay-outs maken en wijzigen
...
## <a name="create-a-custom-layout" />Een aangepaste lay-out maken
...
## <a name="a-namemodifycustomlayoutamodifying-a-custom-layout" /><a name="ModifyCustomLayout"></a>Een aangepaste lay-out wijzigen
...
### <a name="modify-a-custom-layout" />Een aangepaste lay-out wijzigen

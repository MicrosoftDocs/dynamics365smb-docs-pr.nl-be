...
Standaard hebben rapporten een ingebouwde rapportlay-out. De lay-out kan een RDLC-rapportlay-out, een Word-rapportlay-out of beide zijn. U kunt ingebouwde lay-outs niet wijzigen, maar u kunt wel aangepaste lay-outs maken. Een rapport kan meerdere aangepaste rapportlay-outs hebben.
...
Nadat u aangepaste rapportlay-outs hebt gedefinieerd, kunt u deze selecteren op de pagina's Klantenkaart en Leverancierskaart. De lay-outs worden gebruikt wanneer u documenten voor de klant of leverancier maakt. Zie voor meer informatie [Documentlay-outs definiëren voor klanten en leveranciers](ui-define-customer-vendor-document-layouts.md).
...
5. Als u een nieuwe aangepaste lay-out wilt toevoegen die op een ingebouwde lay-out is gebaseerd, voert u de volgende stappen uit:  
   ...
   2. Als u een aangepaste Word-rapportlay-out wilt toevoegen, zet u de schakelaar **Word-lay-out invoegen** aan.
   3. Als u een aangepaste RDLC-rapportlay-out wilt toevoegen, zet u de schakelaar **RDLC-lay-out invoegen** aan.
   4. Kies de knop **OK**.  

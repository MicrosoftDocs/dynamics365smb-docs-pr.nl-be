...
ms.author: edupont
---
# <a name="legacy-create-and-modify-custom-report-layouts"></a><a name="legacy-create-and-modify-custom-report-layouts"></a>(verouderd) Aangepaste rapportlay-outs maken en wijzigen
...
## <a name="create-a-custom-layout"></a><a name="create-a-custom-layout"></a>Een aangepaste lay-out maken
...
## <a name="modifying-a-custom-layout"></a><a name="modifying-a-custom-layout"></a><a name="ModifyCustomLayout"></a>Een aangepaste lay-out wijzigen
...
### <a name="modify-a-custom-layout"></a><a name="modify-a-custom-layout"></a>Een aangepaste lay-out wijzigen

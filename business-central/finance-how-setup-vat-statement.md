...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names"></a><a name="set-up-vat-statement-templates-and-vat-statement-names"></a>Sjablonen voor btw-overzichten en namen voor btw-aangiften instellen
...
## <a name="to-define-a-vat-statement"></a><a name="to-define-a-vat-statement"></a>Een btw-aangifte definiëren
...
## <a name="to-preview-the-vat-statement"></a><a name="to-preview-the-vat-statement"></a>Een voorbeeld van een btw-overzicht bekijken

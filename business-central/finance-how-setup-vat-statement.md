...
ms.author: bholtorf
---
# <a name="set-up-vat-statement-templates-and-vat-statement-names" />Sjablonen voor btw-overzichten en namen voor btw-aangiften instellen
...
## <a name="to-define-a-vat-statement" />Een btw-aangifte definiëren
...
## <a name="to-preview-the-vat-statement" />Een voorbeeld van een btw-overzicht bekijken

...
ms.author: edupont
---
# <a name="set-up-shipping-agents"></a><a name="set-up-shipping-agents"></a>Expediteurs instellen
...
## <a name="to-set-up-a-shipping-agent"></a><a name="to-set-up-a-shipping-agent"></a>Een expediteur instellen

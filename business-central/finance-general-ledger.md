...
ms.author: edupont
---
# <a name="understanding-the-general-ledger-and-chart-of-accounts" />Het grootboek en het rekeningschema begrijpen
...
## <a name="general-ledger-setup-and-general-posting-setup" />Grootboekinstellingen en algemene boekingsinstellingen
...
## <a name="account-categories" />Rekeningcategorieën
...
## <a name="get-a-quick-overview" />Een snel overzicht krijgen
...
## <a name="access-to-create-and-edit-accounts-and-account-categories" />Toegang om accounts en accountcategorieën te maken en te bewerken

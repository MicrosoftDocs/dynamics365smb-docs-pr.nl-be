...
ms.author: edupont
---
# <a name="define-user-tasks"></a><a name="define-user-tasks"></a>Gebruikerstaken definiëren
...
## <a name="managing-user-tasks"></a><a name="managing-user-tasks"></a>Gebruikerstaken beheren
...
### <a name="picking-up-user-tasks"></a><a name="picking-up-user-tasks"></a>Gebruikerstaken oppakken
...
### <a name="deleting-user-tasks"></a><a name="deleting-user-tasks"></a>Gebruikerstaken verwijderen

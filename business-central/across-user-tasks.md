...
ms.author: edupont
---
# <a name="define-user-tasks" />Gebruikerstaken definiëren
...
## <a name="managing-user-tasks" />Gebruikerstaken beheren
...
### <a name="picking-up-user-tasks" />Gebruikerstaken oppakken
...
### <a name="deleting-user-tasks" />Gebruikerstaken verwijderen

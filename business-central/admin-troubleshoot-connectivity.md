...
2. Voer in het adres de URL in die u gebruikt om Business Central te openen en voeg `/connectivity` aan het einde toe. 
    ...
    Of, als de URL de tenant-ID bevat, zoals  `https://businesscentral.dynamics.com/aaaabbbb-0000-cccc-1111-dddd2222eeee`, dan zou u het volgende invoeren:
...
## <a name="business-central-environments-discovery"></a>Business Central-omgevingen ontdekken
...
|Kan beschikbare omgevingen voor uw account niet ophalen.|Bekijk de lijst met beschikbare omgevingen in het Business Central-beheercentrum.|
...
|-------|-------------|
|Er is geen geverifieerde gebruiker om deze controle voor uit te voeren|Zie de controle **Gebruikersverificatie**.|
|Kan beschikbare omgevingen voor uw account niet ophalen.|Zie **Detectie van Business Central-omgevingen**.|
|Er is geen clusteradres om deze controle voor uit te voeren|Bekijk de lijst met beschikbare omgevingen in het Business Central-beheercentrum.|
|Versie-eindpunt bestaat niet|Bekijk de lijst met beschikbare omgevingen in het Business Central-beheercentrum.|

## <a name="web-server-connectivity"></a>Verbinding met webserver
...
## <a name="service-health-status"></a>Servicestatus

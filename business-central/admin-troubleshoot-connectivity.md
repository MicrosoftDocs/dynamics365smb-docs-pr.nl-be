...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central" />Problemen met connectiviteit voor Business Central oplossen
...
## <a name="start-the-connectivity-check" />De verbindingscontrole starten
...
## <a name="basic-internet-connectivity" />Basisinternetconnectiviteit
...
## <a name="cdn-content-delivery-network-resources-loading" />CDN-bronnen (Content Delivery Network) laden
...
## <a name="user-authentication" />Gebruikersverificatie
...
## <a name="business-central-environments-discovery" />Detectie van Business Central-omgevingen
...
## <a name="application-service-connectivity" />Connectiviteit van toepassingsservice
...
## <a name="web-server-connectivity" />Verbinding met webserver
...
## <a name="service-health-status" />Servicestatus

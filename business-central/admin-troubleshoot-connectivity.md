...
ROBOTS: NOINDEX
---
# <a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a><a name="troubleshoot-connectivity-for-business-central"></a>Problemen met connectiviteit voor Business Central oplossen
...
## <a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a><a name="start-the-connectivity-check"></a>De verbindingscontrole starten
...
## <a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a><a name="basic-internet-connectivity"></a>Basisinternetconnectiviteit
...
## <a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a><a name="cdn-content-delivery-network-resources-loading"></a>CDN-bronnen (Content Delivery Network) laden
...
## <a name="user-authentication"></a><a name="user-authentication"></a><a name="user-authentication"></a>Gebruikersverificatie
...
## <a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a><a name="business-central-environments-discovery"></a>Detectie van Business Central-omgevingen
...
## <a name="application-service-connectivity"></a><a name="application-service-connectivity"></a><a name="application-service-connectivity"></a>Connectiviteit van toepassingsservice
...
## <a name="web-server-connectivity"></a><a name="web-server-connectivity"></a><a name="web-server-connectivity"></a>Verbinding met webserver
...
## <a name="service-health-status"></a><a name="service-health-status"></a><a name="service-health-status"></a>Servicestatus

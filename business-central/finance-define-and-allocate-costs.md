...
ms.author: edupont
---
# <a name="defining-and-allocating-costs" />Kosten definiëren en toewijzen
...
## <a name="setting-up-allocation-source-and-targets" />Een verdelingsbron en doelen instellen
...
### <a name="to-set-up-cost-allocations" />Kostenverdeling instellen
...
## <a name="setting-filters-for-dynamic-allocation-bases" />Filters instellen voor dynamische toewijzingsgrondslagen
...
### <a name="setting-filters" />Filters instellen
...
### <a name="to-define-the-allocation-source-prod-cost-center-on-the-general-fasttab" />De verdelingsbron van kostenplaats PROD op het sneltabblad Algemeen definiëren
...
### <a name="to-define-the-allocation-target-cost-objects-on-the-lines-fasttab" />Verdeeldoelen voor kostenobjecten op de sneltabblad Regels definiëren
...
### <a name="to-define-dynamic-allocations-based-on-items-sold-in-the-previous-year" />Dynamische toewijzingen definiëren op basis van artikelen die het vorige jaar zijn verkocht

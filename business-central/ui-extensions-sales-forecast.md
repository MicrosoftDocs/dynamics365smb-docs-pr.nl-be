...
# <a name="the-sales-and-inventory-forecast-extension" />De extensie Verkoop- en voorraadprognose
...
## <a name="setting-up-forecasting" />Prognoses instellen
...
## <a name="use-the-forecasts" />De prognoses gebruiken
...
### <a name="data-required-for-forecast" />Vereiste gegevens voor prognoses
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-sales-and-inventory-forecasts" /><a name="AnchorText"> </a>Uw eigen voorspellende webservice voor verkoop- en voorraadprognoses maken en gebruiken

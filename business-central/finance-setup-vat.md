...
#### <a name="limit-posting-based-on-allow-fromto-period"></a>Boeken beperken op basis van Toegest. vanaf/tot-periode
...
##### <a name="version-231-or-newer"></a>Versie 23.1 of nieuwer
...
##### <a name="versions-before-231"></a>Versies vóór 23.1
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countriesregions"></a>Btw-verlegging gebruiken voor handel tussen EU-landen/-regio's
...
### <a name="sales-to-eu-countriesregions"></a>Verkopen aan EU-landen/-regio's

...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a><a name="set-up-calculations-and-posting-methods-for-value-added-tax"></a>Berekeningen en boekingsmethoden voor btw instellen
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a><a name="set-up-vat-using-the-assisted-setup-guide-recommended"></a>Btw instellen met behulp van de begeleide instelling (aanbevolen)
...
### <a name="check-the-vat-posting-setup"></a><a name="check-the-vat-posting-setup"></a>De btw-boekingsinstellingen controleren
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals"></a><a name="set-up-a-default-vat-date-for-documents-and-journals"></a>Een standaard btw-datum instellen voor documenten en dagboeken
...
### <a name="enabling-or-disabling-the-vat-date-feature"></a><a name="enabling-or-disabling-the-vat-date-feature"></a>De functie btw-datum in- of uitschakelen
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date"></a><a name="limiting-periods-for-posting-and-changing-the-vat-date"></a>Beperkende termijnen voor het boeken en wijzigen van de btw-datum
...
#### <a name="to-limit-posting-based-on-vat-return-period"></a><a name="to-limit-posting-based-on-vat-return-period"></a>Boeking beperken op basis van btw-aangifteperiode
...
#### <a name="to-limit-posting-based-on-allow-fromto-period"></a><a name="to-limit-posting-based-on-allow-fromto-period"></a>Om boeken te beperken op basis van Toegest. vanaf/tot-periode
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region"></a><a name="set-up-vat-registration-numbers-for-your-country-or-region"></a>Btw-nummers instellen voor uw land of regio
...
## <a name="set-up-vat-business-posting-groups"></a><a name="set-up-vat-business-posting-groups"></a>Btw-bedrijfsboekingsgroepen instellen
...
## <a name="set-up-vat-product-posting-groups"></a><a name="set-up-vat-product-posting-groups"></a>Btw-productboekingsgroepen instellen
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups"></a><a name="combine-vat-posting-groups-in-vat-posting-setups"></a>Btw-boekingsgroepen in btw-boekingsinstellingen combineren
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a><a name="assign-vat-posting-groups-by-default-to-multiple-entities"></a>Standaard btw-boekingsgroepen toewijzen aan meerdere entiteiten
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources"></a><a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources"></a>Btw-boekingsgroepen toewijzen aan accounts, klanten, leveranciers, artikelen en resources

In de volgende gedeelten wordt beschreven hoe u btw-boekingsgroepen aan afzonderlijke entiteiten kunt toewijzen.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts"></a><a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts"></a>Btw-boekingsgroepen toewijzen aan afzonderlijke grootboekrekeningen
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a><a name="to-assign-vat-business-posting-groups-to-customers-and-vendors"></a>Btw-bedrijfsboekingsgroepen toewijzen aan klanten en leveranciers
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a><a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources"></a>Btw-productboekingsgroepen toewijzen aan afzonderlijke artikelen en resources.
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a><a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates"></a>Clausules instellen om btw-vrijstelling of niet-standaard btw-tarieven uit te leggen
...
### <a name="to-set-up-vat-clauses"></a><a name="to-set-up-vat-clauses"></a>Btw-clausules instellen
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a><a name="to-assign-a-vat-clause-to-a-vat-posting-setup"></a>Een btw-clausule aan een btw-boekingsgroepinstelling toewijzen
...
### <a name="to-specify-translations-for-vat-clauses"></a><a name="to-specify-translations-for-vat-clauses"></a>Vertalingen opgeven voor btw-clausules
...
### <a name="to-specify-extended-text-for-vat-clauses"></a><a name="to-specify-extended-text-for-vat-clauses"></a>Uitgebreide tekst voor btw-clausules specificeren
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat"></a><a name="create-a-vat-posting-setup-to-handle-import-vat"></a>Een btw-boekingsinstelling maken om import-btw te verwerken
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a><a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions"></a>Verlegging van btw gebruiken voor handel tussen EU-landen of -regio's
...
### <a name="sales-to-eu-countries-or-regions"></a><a name="sales-to-eu-countries-or-regions"></a>Verkopen aan EU-landen of -regio's
...
## <a name="vat-rounding-for-documents"></a><a name="vat-rounding-for-documents"></a>Btw-afronding voor documenten
...
## <a name="set-up-vat-reporting"></a><a name="set-up-vat-reporting"></a>Btw-aangifte instellen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/process-vat-dynamics-365-business-central/)

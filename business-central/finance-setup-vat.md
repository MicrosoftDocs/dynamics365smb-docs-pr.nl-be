...
# <a name="set-up-calculations-and-posting-methods-for-value-added-tax" />Berekeningen en boekingsmethoden voor btw instellen
...
## <a name="set-up-vat-using-the-assisted-setup-guide-recommended" />Btw instellen met behulp van de begeleide instelling (aanbevolen)
...
### <a name="check-the-vat-posting-setup" />De btw-boekingsinstellingen controleren
...
## <a name="set-up-a-default-vat-date-for-documents-and-journals" />Een standaard btw-datum instellen voor documenten en dagboeken
...
### <a name="enabling-or-disabling-the-vat-date-feature" />De functie btw-datum in- of uitschakelen
...
### <a name="limiting-periods-for-posting-and-changing-the-vat-date" />Beperkende termijnen voor het boeken en wijzigen van de btw-datum
...
#### <a name="to-limit-posting-based-on-vat-return-period" />Boeking beperken op basis van btw-aangifteperiode
...
#### <a name="to-limit-posting-based-on-allow-fromto-period" />Om boeken te beperken op basis van Toegest. vanaf/tot-periode
...
## <a name="set-up-vat-registration-numbers-for-your-country-or-region" />Btw-nummers instellen voor uw land of regio
...
## <a name="set-up-vat-business-posting-groups" />Btw-bedrijfsboekingsgroepen instellen
...
## <a name="set-up-vat-product-posting-groups" />Btw-productboekingsgroepen instellen
...
## <a name="combine-vat-posting-groups-in-vat-posting-setups" />Btw-boekingsgroepen in btw-boekingsinstellingen combineren
...
## <a name="assign-vat-posting-groups-by-default-to-multiple-entities" />Standaard btw-boekingsgroepen toewijzen aan meerdere entiteiten
...
## <a name="assign-vat-posting-groups-to-accounts-customers-vendors-items-and-resources" />Btw-boekingsgroepen toewijzen aan accounts, klanten, leveranciers, artikelen en resources

In de volgende gedeelten wordt beschreven hoe u btw-boekingsgroepen aan afzonderlijke entiteiten kunt toewijzen.

### <a name="to-assign-vat-posting-groups-to-individual-general-ledger-accounts" />Btw-boekingsgroepen toewijzen aan afzonderlijke grootboekrekeningen
...
### <a name="to-assign-vat-business-posting-groups-to-customers-and-vendors" />Btw-bedrijfsboekingsgroepen toewijzen aan klanten en leveranciers
...
### <a name="to-assign-vat-product-posting-groups-to-individual-items-and-resources" />Btw-productboekingsgroepen toewijzen aan afzonderlijke artikelen en resources.
...
## <a name="set-up-clauses-to-explain-vat-exemption-or-non-standard-vat-rates" />Clausules instellen om btw-vrijstelling of niet-standaard btw-tarieven uit te leggen
...
### <a name="to-set-up-vat-clauses" />Btw-clausules instellen
...
### <a name="to-assign-a-vat-clause-to-a-vat-posting-setup" />Een btw-clausule aan een btw-boekingsgroepinstelling toewijzen
...
### <a name="to-specify-translations-for-vat-clauses" />Vertalingen opgeven voor btw-clausules
...
### <a name="to-specify-extended-text-for-vat-clauses" />Uitgebreide tekst voor btw-clausules specificeren
...
## <a name="create-a-vat-posting-setup-to-handle-import-vat" />Een btw-boekingsinstelling maken om import-btw te verwerken
...
## <a name="use-reverse-charge-vat-for-trade-between-eu-countries-or-regions" />Verlegging van btw gebruiken voor handel tussen EU-landen of -regio's
...
### <a name="sales-to-eu-countries-or-regions" />Verkopen aan EU-landen of -regio's
...
## <a name="vat-rounding-for-documents" />Btw-afronding voor documenten
...
## <a name="set-up-vat-reporting" />Btw-aangifte instellen

...
U kunt handmatig btw-berekeningen instellen, maar dit kan lastig en tijdrovend zijn. Het is gemakkelijk andere btw-tarieven te gebruiken en onjuiste btw-gerelateerde rapporten te maken. Als u het instellen van btw eenvoudiger wilt maken, is het raadzaam de begeleide instelling **Btw-instelling** te gebruiken.
...
## Btw instellen met behulp van de begeleide instelling (aanbevolen)

> [!NOTE]
> U kunt de begeleide instelling **Btw instellen** alleen gebruiken als u een *Mijn bedrijf* hebt gemaakt en geen transacties hebt geboekt die inclusief btw zijn. Voor meer informatie over Mijn bedrijf gaat u naar [Nieuwe bedrijven maken in [!INCLUDE[prod_short](includes/prod_short.md)]](about-new-company.md).

Ga als volgt te werk om de begeleide instelling te starten:

1. Kies het pictogram ![Lampje dat de functie Vertel me opent 1.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), en voer **Begeleide instelling** in. 
...
### De btw-boekingsinstellingen controleren

Om uw snelle start te ondersteunen informeert [!INCLUDE [prod_short](includes/prod_short.md)] u over ontbrekende grootboekrekeningen in boekingsgroepen of boekingsinstellingen, zoals op de pagina **Btw-boekingsinstellingen**. U kunt dit type bericht in- of uitschakelen met **Grootboekrekening ontbreekt in boekingsgroep of instelling** op de pagina **Mijn berichten**. Ga simpelweg naar de pagina **Mijn instellingen** en kies de koppeling **Wijzigen wanneer ik berichten ontvang**.  

Als u de melding kiest, maakt [!INCLUDE [prod_short](includes/prod_short.md)] boekingsinstellingen op basis van de boekingsgroepen in het document of journaal waaraan u momenteel werkt.  

Op dit punt kunt u gewoon de ontbrekende grootboekrekeningen invullen. Later, wanneer u uw instelling verder verfijnt, realiseert u zich echter misschien dat uw initiële instelling onjuist is. [!INCLUDE [prod_short](includes/prod_short.md)] staat niet toe dat u een btw-boekingsinstelling en een algemene boekingsinstelling verwijdert nadat deze zijn gebruikt om boekingen te maken. Gebruik het veld **Geblokkeerd** op de pagina **Boekingsgroepinstellingen** om te voorkomen dat gebruikers per ongeluk een instelling gebruiken die niet langer relevant is voor nieuwe boekingen.

## Een standaard btw-datum instellen voor documenten en dagboeken
...
### De functie btw-datum in- of uitschakelen
...
### Beperkende termijnen voor het boeken en wijzigen van de btw-datum
...
#### Boeking beperken op basis van btw-aangifteperiode
...
## Btw-productboekingsgroepen instellen
...
U kunt zo veel combinaties instellen als u nodig hebt. Als u combinaties van btw-boekingsinstellingen met soortgelijke kenmerken wilt groeperen, definieert u een **Btw-identificatie** voor elke groep en wijst u de identificatie toe aan de groepsleden.  

> [!NOTE]
> Een **Btw-identificatie** is een code die u kunt gebruiken om vergelijkbare kenmerken te groeperen. We raden u aan om voor verschillende btw-percentages verschillende btw-identificaties te gebruiken.  
...
## Standaard btw-boekingsgroepen toewijzen aan meerdere entiteiten

Als u dezelfde btw-boekingsgroepen op meerdere entiteiten wilt toepassen, kunt u [!INCLUDE[prod_short](includes/prod_short.md)] instellen om dat standaard te doen.
...
## Btw-boekingsgroepen toewijzen aan accounts, klanten, leveranciers, artikelen en resources

In de volgende gedeelten wordt beschreven hoe u btw-boekingsgroepen aan afzonderlijke entiteiten kunt toewijzen.

### Btw-boekingsgroepen toewijzen aan afzonderlijke grootboekrekeningen
...
### Btw-bedrijfsboekingsgroepen toewijzen aan klanten en leveranciers
...
### Btw-productboekingsgroepen toewijzen aan afzonderlijke artikelen en resources.
...
## Clausules instellen om btw-vrijstelling of niet-standaard btw-tarieven uit te leggen

U stelt een btw-clausule in om informatie te geven over het soort btw dat wordt toegepast. Deze informatie kan nodig zijn voor overheidsregelgeving. Nadat u een btw-clausule hebt ingesteld en deze hebt gekoppeld aan een btw-boekingsinstelling, wordt de btw-clausule weergegeven op afgedrukte verkoopdocumenten waarin de btw-boekingsinstellingengroep wordt gebruikt.

Indien nodig kunt u ook opgeven hoe u btw-clausules naar andere talen vertaalt. Wanneer u een verkoopdocument maakt en afdrukt dat een btw-identificatie bevat, bevat het document de vertaalde btw-clausule. De taalcode die op de klantkaart is opgegeven, bepaalt de gebruikte taal.

Wanneer u afwijkende btw-tarieven gebruikt in verschillende soorten documenten, zoals facturen of creditnota's, moet u mogelijk een vrijstellingstekst (btw-clausule) opnemen. In de vrijstellingstekst staat waarom u een verlaagd btw- of nultarief hebt berekend. Op de pagina **Btw-clausules per documenttype** kunt u voor elk type document verschillende btw-clausules definiëren die u in bedrijfsdocumenten wilt opnemen.

U kunt een btw-clausule wijzigen of verwijderen, en uw wijzigingen worden in een gegenereerde lijst weergegeven. [!INCLUDE[prod_short](includes/prod_short.md)] houdt echter geen historie van de wijziging bij. Op de lijst worden de omschrijvingen van btw-clausules afgedrukt en weergegeven voor alle regels in de lijst naast het btw-bedrag en het btw-basisbedrag. Als er geen btw-clausule is gedefinieerd voor de regels op het verkoopdocument, wordt het hele gedeelte weggelaten wanneer u de lijst afdrukt.

### Btw-clausules instellen
...
4. Voer in het veld **Omschrijving** tekst voor de btw-vrijstelling die u wilt weergeven in documenten waarop btw-bedragen kunnen worden vermeld. Geef indien nodig in het veld **Omschrijving 2** meer tekst op. De tekst wordt weergegeven op nieuwe documentregels.
...
### Een btw-clausule aan een btw-boekingsgroepinstelling toewijzen
...
### Vertalingen opgeven voor btw-clausules
...
## Een btw-boekingsinstelling maken om import-btw te verwerken

Gebruik de functie *Import-btw* wanneer u een document moet boeken waarbij het volledige bedrag btw is. U gebruikt deze functie als u een factuur van de belastingdienst ontvangt voor btw op geïmporteerde goederen.  
...
### Verkopen aan EU-landen/-regio's
...
Wanneer u een verkoop aan een klant in een ander EU-land/-regio boekt, berekent [!INCLUDE [prod_short](includes/prod_short.md)] het btw-bedrag en wordt een btw-post gemaakt op basis van informatie over de btw-verlegging en het btw-basisbedrag. Dit bedrag wordt gebruikt om het btw-bedrag te berekenen. In het grootboek worden geen posten naar de btw-rekeningen geboekt.
...
## Btw-afronding voor documenten

Bedragen in documenten die niet zijn geboekt, worden afgerond en weergegeven zodat ze overeenkomen met de uiteindelijke afronding van bedragen die daadwerkelijk zijn geboekt. [!INCLUDE [prod_short](includes/prod_short.md)] berekent btw voor een volledig document. De btw-berekening is gebaseerd op de som van alle regels met dezelfde btw-identificatie in het document.  

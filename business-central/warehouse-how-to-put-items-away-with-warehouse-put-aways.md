...
---
# <a name="put-items-away-with-warehouse-put-aways" />Artikelen opslaan met magazijnopslag
...
## <a name="to-create-put-away-documents-in-bulk-with-the-put-away-worksheet" />Bulksgewijs opslagdocumenten maken met het opslagvoorstel
...
## <a name="to-create-a-put-away-from-a-posted-receipt" />Een magazijnopslag maken vanuit een geboekte ontvangst
...
## <a name="to-put-items-away" />Artikelen opslaan

...
# <a name="business-central-for-multi-site-and-international-organizations" />Business Central voor organisaties met meerdere vestigingen en internationale organisaties
...
## <a name="integrating-the-headquarter-company-and-the-sites" />Integratie van het hoofdkantoor en de vestigingen
...
## <a name="meet-the-needs-of-domestic-and-international-sites" />Voldoen aan de behoeften van binnenlandse en internationale vestigingen
...
## <a name="consolidate-financial-data" />Financiële gegevens consolideren
...
## <a name="share-business-insight-with-integrated-analytics" />Bedrijfsinzichten delen met geïntegreerde analyses
...
## <a name="exchange-data-using-apis-and-xmlports" />Gegevens uitwisselen met behulp van API's en XMLports
...
## <a name="promote-an-efficient-intercompany-supply-chain" />Een efficiënte toeleveringsketen tussen bedrijven promoten
...
## <a name="respond-quickly-to-new-business-conditions" />Snel reageren op nieuwe zakelijke omstandigheden

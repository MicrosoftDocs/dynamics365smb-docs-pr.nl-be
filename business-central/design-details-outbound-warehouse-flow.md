...
---
# <a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a><a name="outbound-warehouse-processes"></a>Uitgaande magazijnprocessen
...
### <a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a><a name="1-release-a-source-document"></a>1: Een brondocument vrijgeven
...
### <a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a><a name="2-create-an-inventory-pick"></a>2: Een voorraadpick maken
...
### <a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a><a name="3-post-an-inventory-pick"></a>3: Een voorraadpick boeken
...
### <a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a><a name="1-release-a-source-document-1"></a>1: Een brondocument vrijgeven
...
### <a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a><a name="2-create-a-warehouse-shipment"></a>2: Een magazijnverzending maken
...
### <a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a><a name="3-create-a-warehouse-pick"></a>3: Maak een magazijnpick
...
### <a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a><a name="4-register-a-warehouse-pick"></a>4: Een magazijnpick registreren
...
### <a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a><a name="5-post-the-warehouse-shipment"></a>5: De magazijnverzending boeken

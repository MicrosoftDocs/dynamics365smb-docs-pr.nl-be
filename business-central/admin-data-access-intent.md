...
ms.author: jswymer
---
# <a name="managing-database-access-intent" />Databasetoegangsintentie beheren
...
## <a name="to-change-the-database-access-intent" />De intentie van de databasetoegang wijzigen

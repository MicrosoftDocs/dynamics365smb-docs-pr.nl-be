...
---
# <a name="selling-inventory-items-in-assemble-to-order-flows" />Voorraadartikelen in assembleren-op-order-stromen verkopen
...
## <a name="to-sell-inventory-items-in-assemble-to-order-flows" />Voorraadartikelen in assembleren-op-order-stromen verkopen
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/assemble-to-order-dynamics-365-business-central/)

...
ms.author: jswymer
---
# <a name="entering-data"></a><a name="entering-data"></a><a name="entering-data"></a>Gegevens invoeren
...
## <a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a><a name="work-with-editable-fields"></a>Werken met bewerkbare velden
...
### <a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a><a name="modifying-a-field-value"></a>Een veldwaarde wijzigen
...
## <a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="accelerating-data-entry-using-quick-entry"></a><a name="QuickEntry"></a>Gegevensinvoer versnellen met snelinvoer
...
### <a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a><a name="how-quick-entry-works"></a>Hoe snelinvoer werkt
...
#### <a name="tips-and-tricks"></a><a name="tips-and-tricks"></a><a name="tips-and-tricks"></a>Tips en trucs
...
### <a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a><a name="to-change-quick-entry-fields"></a>Snelinvoervelden wijzigen
...
## <a name="mandatory-fields"></a><a name="mandatory-fields"></a><a name="mandatory-fields"></a>Verplichte velden
...
## <a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a><a name="finding-data-as-you-type"></a>Gegevens zoeken terwijl u typt
...
## <a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a><a name="copying-and-pasting-faq-fields-and-lines"></a>Velden en regels kopiëren en plakken
...
## <a name="filtering-line-items"></a><a name="filtering-line-items"></a><a name="filtering-line-items"></a>Regelitems filteren
...
## <a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="focusing-on-line-items"></a><a name="Focus"></a>Focussen op regelartikelen
...
### <a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a><a name="switching-the-focus-on-and-off"></a>De focus aan- en uitzetten
...
## <a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a><a name="multitasking-across-multiple-pages"></a>Multitasking over meerdere pagina's
...
## <a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a><a name="entering-quantities-by-calculation"></a>Hoeveelheden invoeren door berekening
...
## <a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a><a name="entering-negative-numbers"></a>Negatieve getallen invoeren
...
## <a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a><a name="entering-dates-and-times"></a>Datums en tijden invoeren
...
### <a name="entering-dates"></a><a name="entering-dates"></a><a name="entering-dates"></a>Datums invoeren
...
## <a name="entering-times"></a><a name="entering-times"></a><a name="entering-times"></a>Tijden invoeren
...
## <a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a><a name="entering-combined-datetimes"></a>Gecombineerde datums en tijden invoeren

[!INCLUDE [datetimes](includes/datetimes.md)]

## <a name="entering-duration"></a><a name="entering-duration"></a><a name="entering-duration"></a>Duur invoeren
...
## <a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="setting-the-decimal-separator-used-by-numeric-keyboards"></a><a name="decimal"></a>Het decimale scheidingsteken instellen dat wordt gebruikt door numerieke toetsenborden
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/explore-modify-info-dynamics-365-business-central/)

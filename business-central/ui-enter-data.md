...
ms.author: jswymer
---
# <a name="entering-data" />Gegevens invoeren
...
## <a name="work-with-editable-fields" />Werken met bewerkbare velden
...
### <a name="modifying-a-field-value" />Een veldwaarde wijzigen
...
### <a name="how-quick-entry-works" />Hoe snelinvoer werkt
...
#### <a name="tips-and-tricks" />Tips en trucs
...
### <a name="to-change-quick-entry-fields" />Snelinvoervelden wijzigen
...
## <a name="mandatory-fields" />Verplichte velden
...
## <a name="finding-data-as-you-type" />Gegevens zoeken terwijl u typt
...
## <a name="copying-and-pasting-faq-fields-and-lines" />Velden en regels kopiëren en plakken
...
## <a name="filtering-line-items" />Regelitems filteren
...
### <a name="switching-the-focus-on-and-off" />De focus aan- en uitzetten
...
## <a name="multitasking-across-multiple-pages" />Multitasking over meerdere pagina's
...
## <a name="entering-quantities-by-calculation" />Hoeveelheden invoeren door berekening
...
## <a name="entering-negative-numbers" />Negatieve getallen invoeren
...
## <a name="entering-dates-and-times" />Datums en tijden invoeren
...
## <a name="entering-combined-datetimes" />Gecombineerde datums en tijden invoeren

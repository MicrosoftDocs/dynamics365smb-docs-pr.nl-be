...
ms.author: bholtorf
---
# <a name="calculate-dates-for-purchases" />Datums berekenen voor inkoop
...
## <a name="calculating-with-a-requested-receipt-date" />Berekenen met een aangevraagde ontvangstdatum
...
## <a name="calculating-without-a-requested-receipt-date" />Berekenen zonder een aangevraagde ontvangstdatum
...
## <a name="default-values-for-lead-time-calculation" />Standaardwaarden voor levertijdtijdberekening
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/estimate-receipt-dates-dynamics-365-business-central/)

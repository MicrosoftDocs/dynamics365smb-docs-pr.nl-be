...
- Aankoop: U voegt een nieuw vast activum toe aan uw boeken.
- Afschrijving: u registreert de periodieke waardedaling van een actief, die u via een afschrijvingsmethode berekent. Ga voor meer informatie naar  [FA-afschrijvingsberekening](LocalFunctionality/India/FA_Depreciation.md).
- Herwaardering: u legt een beoordeling vast van de huidige reële marktwaarde van een actief. Ga voor meer informatie naar [Vaste activa herwaarderen](fa-how-revalue.md).
- Bijzondere waardevermindering: U boekt een waardevermindering door gebeurtenissen of omstandigheden.
- Verwijdering: u verkoopt, sloopt of gebruikt op een andere manier een actief aan het einde van zijn levensduur.
...
| Voer ad-hocanalyses uit van gegevens over vaste activa rechtstreeks op lijstpagina's en query's. | [Ad-hocanalyse van vaste-activagegevens](ad-hoc-analysis-fa.md) |
...
1. Voer een rapport uit waarin de periodieke afschrijving wordt berekend.
...
- Stel een drempel in voor hoofdlettergebruik. Wanneer u een artikel koopt, bepaalt u een vast bedrag voor kapitalisatie. Het bedrag zorgt ervoor dat uw boekhouding consistent is en maakt het voor u en uw team gemakkelijker om boekhoudfouten op te sporen.

...
---
# <a name="receive-items-with-warehouse-receipts"></a><a name="receive-items-with-warehouse-receipts"></a>Artikelen ontvangen met magazijnontvangsten
...
## <a name="receive-items-with-a-warehouse-receipt"></a><a name="receive-items-with-a-warehouse-receipt"></a>Artikelen ontvangen met een magazijnontvangst

...
| Bepaal de prioriteit van leveranciers. |[Prioriteit van leveranciers bepalen](purchasing-how-prioritize-vendors.md) |
| Voer bankrekeninggegevens, inclusief IBAN- en SWIFT-codes, in op de kaart van uw leverancier. | [Leveranciersbankrekeningen instellen](purchasing-how-set-up-vendors-bank-accounts.md) |

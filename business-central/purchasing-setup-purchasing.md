...
ms.author: edupont
---
# <a name="setting-up-purchasing"></a><a name="setting-up-purchasing"></a>Inkoop instellen
...
## <a name="purchases-and-payables-setup"></a><a name="purchases-and-payables-setup"></a>Inkoopinstellingen
...
### <a name="general-settings"></a><a name="general-settings"></a>Algemene instellingen
...
### <a name="number-series-settings"></a><a name="number-series-settings"></a>Instellingen voor nummerreeksen
...
## <a name="exact-cost-reversing"></a><a name="exact-cost-reversing"></a>Precieze kostentegenboeking
...
## <a name="more-purchasing-setups"></a><a name="more-purchasing-setups"></a>Meer inkoopconfiguraties
...
## <a name="see-related-training-at-microsoft-learn"></a><a name="see-related-training-at-microsoft-learn"></a>Zie gerelateerde training op [Microsoft Learn](/learn/paths/trade-get-started-dynamics-365-business-central/).

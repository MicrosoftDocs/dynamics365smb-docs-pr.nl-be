...
ms.author: bholtorf
---
# <a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a><a name="make-payments-with-the-amc-banking-365-fundamentals-extension-or-sepa-credit-transfer"></a>Betalingen doen met de extensie AMC Banking 365 Fundamentals of SEPA-kredietoverdracht
...
## <a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a><a name="setting-up-the-amc-banking-365-fundamentals-extension"></a>De extensie AMC Banking 365 Fundamentals instellen
...
## <a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a><a name="setting-up-sepa-credit-transfer"></a>SEPA-krediettransfer instellen
...
### <a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a><a name="to-set-up-a-bank-account-for-sepa-credit-transfer"></a>Een bankrekening instellen voor SEPA-kredietoverboekingen
...
### <a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a><a name="to-set-up-a-vendor-card-for-sepa-credit-transfer"></a>Een leverancierskaart instellen voor SEPA-kredietoverboekingen
...
### <a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a><a name="to-set-the-payment-journal-up-to-export-payment-files"></a>Het betalingsdagboek instellen om betalingsbestanden te exporteren
...
### <a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a><a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a><a name="to-connect-the-data-exchange-definition-for-one-or-more-payment-types-with-the-relevant-payment-method-or-methods"></a>De definitie van gegevensuitwisseling voor een of meer betalingstypen verbinden met de relevante betalingsmethode(n)
...
## <a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a><a name="preparing-the-payment-journal"></a>Het betalingsdagboek voorbereiden
...
## <a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a><a name="exporting-payments-to-a-bank-file"></a>Betalingen naar een bankbestand exporteren
...
### <a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a><a name="to-export-payments-to-a-bank-file"></a>Betalingen naar een bankbestand exporteren
...
### <a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a><a name="to-plan-when-to-post-exported-payments"></a>Plannen wanneer geëxporteerde betalingen worden geboekt
...
### <a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a><a name="to-re-export-payments-to-a-bank-file"></a>Betalingen naar een bankbestand opnieuw exporteren
...
## <a name="posting-the-payments"></a><a name="posting-the-payments"></a><a name="posting-the-payments"></a>De betalingen boeken

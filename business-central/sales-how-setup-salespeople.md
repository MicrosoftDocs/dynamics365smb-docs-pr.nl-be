...
ms.author: edupont
---
# <a name="set-up-salespeople"></a><a name="set-up-salespeople"></a>Verkopers instellen
...
## <a name="to-set-up-a-salesperson-code"></a><a name="to-set-up-a-salesperson-code"></a>Een verkoperscode instellen

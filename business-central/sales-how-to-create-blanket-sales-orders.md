...
ms.author: edupont
---
# <a name="work-with-blanket-sales-orders-or-blanket-purchase-orders" />Werken met verkoopraamcontracten of inkoopraamcontracten
...
## <a name="to-create-a-blanket-sales-order" />Een verkoopraamcontract maken.
...
## <a name="to-create-a-sales-order-from-a-blanket-sales-order" />Een verkooporder maken uit een verkoopraamcontract
...
## <a name="to-view-the-status-of-a-blanket-sales-order" />De status van een verkoopraamcontract weergeven
...
## <a name="to-view-unposted-and-posted-blanket-sales-order-lines" />Niet-geboekte en geboekte verkoopraamcontractregels weergeven

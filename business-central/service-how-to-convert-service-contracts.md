...
ms.author: edupont
---
# <a name="convert-service-contracts-that-include-vat-amounts" />Servicecontracten met btw-bedragen converteren
...
### <a name="to-correct-an-invoice-for-a-prepaid-service-contract" />Een factuur voor een vooruitbetaald servicecontract corrigeren
...
### <a name="to-create-a-credit-memo-for-vat-difference" />Creditnota's voor het btw-verschil maken
...
### <a name="to-create-contract-expiration-dates-in-contract-lines" />Contractvervaldatums in contractregels maken
...
### <a name="to-create-a-new-credit-memo" />Een nieuwe creditnota maken

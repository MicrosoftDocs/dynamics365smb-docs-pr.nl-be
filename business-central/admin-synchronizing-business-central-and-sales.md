...
# <a name="synchronizing-data-in-business-central-with-microsoft-dataverse" />Gegevens synchroniseren in Business Central en Microsoft Dataverse
...
## <a name="standard-table-mapping-for-synchronization" />Standaardtabeltoewijzingen voor synchronisatie
...
### <a name="tip-for-admins-viewing-table-mappings" />Tip voor beheerders: tabeltoewijzingen weergeven

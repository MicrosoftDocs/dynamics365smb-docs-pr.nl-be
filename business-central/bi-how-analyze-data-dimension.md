...
ms.author: edupont
---
# <a name="analyze-data-by-dimensions" />Gegevens analyseren per dimensie
...
## <a name="set-up-an-analysis-view" />Een analyseweergave instellen
...
## <a name="analyze-by-dimensions" />Analyseren per dimensie
...
## <a name="update-an-analysis-view" />Een analyseweergave bijwerken
...
## <a name="see-related-training-at-microsoft-learnlearnmodulesdimensions-financial-reports-dynamics-365-business-centralindex" />Zie gerelateerde training op [Microsoft Learn](/learn/modules/dimensions-financial-reports-dynamics-365-business-central/index).

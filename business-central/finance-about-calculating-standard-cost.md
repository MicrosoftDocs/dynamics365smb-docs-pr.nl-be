...
ms.author: edupont
---
# <a name="about-calculating-standard-cost" />Informatie over het berekenen van vaste verrekenprijzen
...
## <a name="setting-up-standard-costs" />Vaste verrekenprijzen instellen
...
### <a name="material-costs" />Materiaalkosten
...
### <a name="capacity-costs" />Capaciteitskosten
...
### <a name="subcontractor-costs" />Uitbestedingskosten
...
## <a name="updating-standard-costs" />De vaste verrekenprijzen aanpassen

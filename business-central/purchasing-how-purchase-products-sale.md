...
ms.author: edupont
---
# <a name="purchase-items-for-a-sale-by-creating-purchase-invoices" />Artikelen voor een verkoop inkopen door inkoopfacturen te maken
...
## <a name="to-create-one-or-more-purchase-orders-from-a-sales-order" />Een of meerdere inkooporders van een verkooporder maken
...
## <a name="to-create-a-purchase-invoice-from-a-sales-order-or-sales-invoice" />Een inkoopfactuur van een verkooporder of verkoopfactuur maken

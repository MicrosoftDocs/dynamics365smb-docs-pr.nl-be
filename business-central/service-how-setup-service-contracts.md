...
# <a name="set-up-service-contracts" />Servicecontracten instellen
...
## <a name="to-set-up-a-service-contract-group" />Servicecontractgroepen instellen
...
## <a name="to-set-up-a-service-contract-account-group" />Servicecontractboekingsgroepen instellen
...
## <a name="to-set-up-a-contract-template" />Contractsjablonen instellen
...
## <a name="to-set-up-a-customer-template" />Klantsjablonen instellen

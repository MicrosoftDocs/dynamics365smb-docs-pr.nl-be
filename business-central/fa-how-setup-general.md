...
ms.author: edupont
---
# <a name="set-up-general-fixed-assets-information" />Algemene gegevens voor vaste activa instellen
...
## <a name="to-set-up-general-default-values-for-fixed-assets" />Algemene standaardwaarden instellen voor vaste activa
...
## <a name="to-set-up-fixed-asset-posting-groups" />Boekingsgroepen voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-allocation-keys" />Verdeelsleutels voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-journal-templates" />Dagboeksjablonen voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-journal-batches" />Dagboekbatches voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-reclassification-journal-templates" />Herindelingsdagboeksjablonen voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-reclassification-journal-batches" />Herindelingsdagboekbatches voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-class-codes" />Categorieën voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-subclass-codes" />Subcategorieën voor vaste activa instellen
...
## <a name="to-set-up-fixed-asset-location-codes" />Vestigingscodes voor vaste activa instellen
...
## <a name="to-register-opening-entries" />Beginsaldi registreren

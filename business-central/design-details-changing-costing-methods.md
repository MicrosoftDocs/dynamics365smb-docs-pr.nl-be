...
|Vlak  |Wat te kopiëren  |Hoe u dit doet  |
|---------|---------|---------|
...
|Hoeveelheid |De hoeveelheid in het fysieke voorraadjournaal.<br> **OPMERKING:** de hoeveelheden berekend door de fysieke voorraadjournalen omvatten niet de hoeveelheden in orders zijn die nog niet zijn verzonden.  |
|Variantcode |Hetzelfde als in het fysieke voorraadjournaal.  |
|Vestigingscode |Hetzelfde als in het fysieke voorraadjournaal. |
|Code van de maateenheid |Hetzelfde als in het fysieke voorraadjournaal. |
|Bin Code |Hetzelfde als in het fysieke voorraadjournaal. |
...
|Vlak  |Waar te zoeken naar openstaande hoeveelheden  |
|---------|---------|

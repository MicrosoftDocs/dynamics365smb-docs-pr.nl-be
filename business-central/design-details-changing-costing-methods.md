...
# <a name="design-details-change-the-costing-method-for-items" />Ontwerpdetails - De waarderingsmethode voor artikelen wijzigen
...
## <a name="about-costing-methods" />Over waarderingsmethoden
...
## <a name="use-assembly-orders-to-change-costing-method-assignments" />Assemblageorders gebruiken om toewijzingen van waarderingsmethoden te wijzigen
...
### <a name="define-a-default-costing-method" />Een standaardwaarderingsmethode opgeven
...
### <a name="identify-the-items-to-change-the-costing-method-for-and-renumber-them" />De artikelen identificeren waarvoor u de waarderingsmethode wilt wijzigen en deze hernummeren
...
### <a name="create-new-items-with-the-old-numbering-scheme-and-copy-the-master-data-in-a-batch" />Handmatig nieuwe artikelen met het oude nummeringsschema maken en de hoofdgegevens in een batch kopiëren
...
### <a name="manually-copy-related-master-data-from-the-original-item-to-the-new-item" />Handmatig gerelateerde hoofdgegevens van het oorspronkelijke artikel naar het nieuwe artikel kopiëren
...
### <a name="determine-the-inventory-quantity-to-convert-from-the-original-item-to-the-new-item" />De voorraadhoeveelheid bepalen die u wilt converteren van het oorspronkelijke artikel naar het nieuwe artikel
...
### <a name="transfer-the-inventory-to-the-new-item" />De inventaris overbrengen naar het nieuwe artikel
...
### <a name="handle-inventory-quantities-that-are-allocated-to-demand" />Voorraadhoeveelheden verwerken die zijn toegewezen aan vraag
...
### <a name="block-the-original-item-from-further-use" />Het oorspronkelijke artikel voor verder gebruik blokkeren

...
>
> "U heeft geen toegang tot deze bron: https:\//graph.microsoft.com/.default. Neem contact op met uw systeembeheerder."
>
> Het probleem wordt veroorzaakt door de gebonden acties op de document-API's die e-mail verzenden. Ga voor meer informatie over de gebonden acties naar [Gebonden acties](/dynamics365/business-central/dev-itpro/api-reference/v2.0/resources/dynamics_salesinvoice#bound-actions). 
>

...
# <a name="set-up-email" />E-mail instellen
...
## <a name="adding-email-accounts" />E-mailaccounts toevoegen
...
## <a name="using-smtp" />SMTP gebruiken
...
## <a name="add-email-accounts" />E-mailaccounts toevoegen
...
is this still true?-->
## <a name="assign-email-scenarios-to-email-accounts" />E-mailscenario's toewijzen aan e-mailaccounts
...
## <a name="set-up-view-policies" />Weergavebeleid instellen
...
## <a name="specify-how-many-messages-an-account-can-send-per-minute" />Geef op hoeveel berichten een account per minuut kan verzenden
...
## <a name="set-up-reusable-email-texts-and-layouts" />Herbruikbare e-mailteksten en lay-outs instellen
...
## <a name="use-a-substitute-sender-address-on-outbound-email-messages" />Een vervangend afzenderadres gebruiken voor uitgaande e-mailberichten
...
## <a name="set-up-document-sending-profiles" />Verzendprofielen van documenten instellen
...
## <a name="optional-set-up-email-logging-in-exchange-online" />Optioneel: E-maillogboekregistratie instellen in Exchange Online
...
## <a name="setting-up-email-for-business-central-on-premises" />E-mail instellen voor Business Central On-Premises
...
### <a name="create-an-app-registration-for-business-central-in-azure-portal" />Een appregistratie voor Business Central maken in Azure Portal

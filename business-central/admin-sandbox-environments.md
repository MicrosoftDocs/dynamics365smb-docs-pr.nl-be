...
ms.author: solsen
---
# <a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a><a name="sandbox-environments-in-"></a>Sandboxomgevingen in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="advanced-user-experience"></a><a name="advanced-user-experience"></a><a name="advanced-user-experience"></a>Geavanceerde gebruikerservaring
...
### <a name="complete-sample-data"></a><a name="complete-sample-data"></a><a name="complete-sample-data"></a>Volledige voorbeeldgegevens
...
## <a name="designer"></a><a name="designer"></a><a name="designer"></a>Ontwerper

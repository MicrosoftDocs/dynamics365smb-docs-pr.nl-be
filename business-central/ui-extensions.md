...
ms.author: edupont
---
# <a name="customizing-business-central-online-with-apps"></a><a name="customizing-business-central-online-with-apps"></a>Business Central Online aanpassen met apps
...
## <a name="manage-apps"></a><a name="manage-apps"></a>App beheren
...
## <a name="apps-and-data-transfer"></a><a name="apps-and-data-transfer"></a>Apps en gegevensoverdracht
...
## <a name="connect-your-business"></a><a name="connect-your-business"></a>Uw bedrijf verbinden
...
## <a name="recommended-apps"></a><a name="recommended-apps"></a>Aanbevolen apps
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/customize-dynamics-365-business-central/)

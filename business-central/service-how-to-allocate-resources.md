...
# <a name="allocate-resources" />Resources toewijzen
...
## <a name="to-see-an-overview-of-service-orders-and-service-quotes" />Een overzicht weergeven van de serviceorders en serviceoffertes
...
## <a name="to-allocate-a-resource-using-resource-or-resource-group-availability" />Resources toewijzen op basis van resource- of resourcegroepbeschikbaarheid
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Planbord** in en kies vervolgens de gerelateerde koppeling.  
...
## <a name="to-allocate-a-resource-using-a-service-order" />Resources toewijzen met een serviceorder
...
## <a name="to-reallocate-resources-on-a-service-order" />Resources opnieuw toewijzen in een serviceorder
...
## <a name="to-reallocate-a-resource-using-the-dispatch-board" />Resources opnieuw toewijzen met het planbord
...
## <a name="to-register-resource-hours" />Resource-uren registreren
...
## <a name="to-assign-a-resource-to-all-service-items-in-an-order" />Een resource toewijzen aan alle serviceartikelen in een order
...
## <a name="to-cancel-an-allocation" />Toewijzingen annuleren

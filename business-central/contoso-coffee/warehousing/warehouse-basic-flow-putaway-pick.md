...
3. Maak de inkooporder, wat de meest gebruikte soort inkomend brondocument is.  
    ...
    |Artikel|Vestiging|Bin Code|Hoeveelheid|  
    |----------|----------|---------|--------------|  
    |WRB-1000|ZILVER|S-1-01|2.0|  
    |WRB-1001|ZILVER||30|
...
5. Wijzig de voorraadopslag op basis van daadwerkelijke plaatsing van artikelen en boek het document
    ...
    2.  Voer 20 in het veld **Te verwerken aantal** in op de voorraadopslagregel met artikel WRB-1000.  
    ...
    4. Vul opslaglocatiecodes in voor artikel WRB-1001:

    |Artikel|Opslaglocatie|Hoeveelheid|  
    |----------|-------------------|--------------|  
    |WRB-1001|S-1-03|2.0|  
    |WRB-1001|S-1-04|10|

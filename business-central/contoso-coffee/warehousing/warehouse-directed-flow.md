...
# <a name="walkthrough-of-inbound-and-outbound-flow-in-advanced-warehouse-configuration"></a>Procedure van inkomende en uitgaande stroom in geavanceerde magazijnconfiguratie
...
2. Opslaglocaties definiëren voor het artikel om te bepalen waar het wordt opgeslagen 
    ...
    |Artikel|Vestiging|Bin Code|Vast|Maateenheid|
    |----------|----------|---------|---|------|  
...
6. Opslaglocaties definiëren voor het artikel om te bepalen waar het wordt gepickt 

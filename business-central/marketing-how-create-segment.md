...
ms.author: jswymer
---
# <a name="create-segments"></a><a name="create-segments"></a><a name="create-segments"></a>Segmenten maken
...
## <a name="to-create-a-segment"></a><a name="to-create-a-segment"></a><a name="to-create-a-segment"></a>Een segment maken
...
3. Voer in het gedeelte **Algemeen** in het veld **Nr.** een nummer voor het segment in.
    ...
    Als u echter een nummerreeks voor segmenten hebt ingesteld op de pagina **Marketinginstellingen**, kunt u <kbd>Enter</kbd> selecteren om het volgende beschikbare segmentnummer te selecteren.

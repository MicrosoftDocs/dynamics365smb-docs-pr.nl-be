...
## <a name="to-sign-up-for-the-trial" />Registreren voor de proefversie

[!INCLUDE [trial-get](includes/trial-get.md)]

## <a name="what-to-try" />Wat uit te proberen
...
## <a name="get-started-with-a-subscription" />Aan de slag gaan met een abonnement

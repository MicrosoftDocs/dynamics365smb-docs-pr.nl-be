...
ms.author: jswymer
---
# <a name="working-with-rdlc-layouts"></a><a name="working-with-rdlc-layouts"></a>Werken met RDLC-lay-outs
...
## <a name="required-tools"></a><a name="required-tools"></a>Vereiste hulpprogramma's
...
## <a name="create-and-modify-rdlc-layouts"></a><a name="create-and-modify-rdlc-layouts"></a>RDLC-lay-outs maken en wijzigen

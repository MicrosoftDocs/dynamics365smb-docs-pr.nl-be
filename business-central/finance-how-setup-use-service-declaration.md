...
---
# <a name="the-service-declaration-extension" />De extensie Servicedeclaratie
...
## <a name="enable-the-service-declaration-extension" />De extensie Servicedeclaratie inschakelen
...
## <a name="set-up-the-service-declaration-extension" />De extensie Servicedeclaratie instellen

U kunt de extensie handmatig instellen of met behulp van een rapportagebestand in Definities voor gegevensuitwisseling.

### <a name="to-set-up-service-declaration-manually" />Servicedeclaratie handmatig instellen
...
### <a name="item-charges" />Artikeltoeslagen
...
## <a name="create-new-service-declaration" />Een nieuwe servicedeclaratie maken
...
## <a name="modify-a-service-declaration" />Een servicedeclaratie wijzigen
...
## <a name="overview-the-service-declaration-lines" />Overzicht van de servicedeclaratieregels
...
## <a name="report-service-declaration-in-a-file" />Servicedeclaratie rapporteren in een bestand
...
## <a name="other-considerations" />Overige overwegingen
...
### <a name="grouping-lines" />Regels groeperen
...
### <a name="using-services-in-document-lines" />Services gebruiken op documentregels

...
ms.author: edupont
---
# <a name="set-up-base-calendars"></a><a name="set-up-base-calendars"></a>Basisagenda's instellen
...
## <a name="to-set-up-a-base-calendar"></a><a name="to-set-up-a-base-calendar"></a>Een basisagenda instellen
...
## <a name="lead-time-calculation"></a><a name="lead-time-calculation"></a>Levertermijnberek.
...
## <a name="to-customize-a-calendar"></a><a name="to-customize-a-calendar"></a>Een agenda aanpassen
...
## <a name="to-assign-a-base-calendar"></a><a name="to-assign-a-base-calendar"></a>Een basisagenda toewijzen

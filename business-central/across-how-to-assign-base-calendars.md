...
ms.author: edupont
---
# <a name="set-up-base-calendars" />Basisagenda's instellen
...
## <a name="to-set-up-a-base-calendar" />Een basisagenda instellen
...
## <a name="lead-time-calculation" />Levertermijnberek.
...
## <a name="to-customize-a-calendar" />Een agenda aanpassen
...
## <a name="to-assign-a-base-calendar" />Een basisagenda toewijzen

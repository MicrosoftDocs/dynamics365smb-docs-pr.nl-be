...
ms.author: edupont
---
# <a name="design-details-reservation-order-tracking-and-action-messaging" />Ontwerpdetails: Reservering, ordertracering en planningsboodschappen
...
## <a name="reservation" />Reservering
...
### <a name="offsetting-in-reservations" />Compenseren in reserveringen
...
### <a name="manual-reservation" />Handmatige reservering
...
### <a name="automatic-reservations" />Automatische reserveringen
...
## <a name="order-tracking" />Ordertracering
...
### <a name="the-order-network" />Het ordernetwerk
...
### <a name="offsetting-in-order-tracking" />Compenseren in ordertracering
...
### <a name="example-order-tracking-in-sales-production-and-transfers" />Voorbeeld: Ordertracering in verkoop, productie en transfers
...
## <a name="action-messaging" />Planningsboodschap
...
## <a name="order-tracking-and-planning" />Ordertracering en planning
...
### <a name="planning-system-versus-order-tracking-and-action-messaging" />Planningssysteem versus ordertracering en planningsboodschappen

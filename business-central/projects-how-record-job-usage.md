...
---
# <a name="record-consumption-or-usage-for-jobs" />Verbruik of gebruik voor projecten registreren
...
## <a name="to-record-usage-for-a-job-planning-line-of-type-budget" />Gebruik vastleggen voor een projectplanningsregel van het soort Budget
...
## <a name="to-create-job-journal-lines-manually" />Handmatig projectdagboekregels maken
...
## <a name="to-view-job-usage-estimates-and-post-updates" />Projectgebruikschattingen weergeven en updates boeken
...
## <a name="create-inventory-and-warehouse-pick-documents-for-a-job" />Voorraad- en magazijnpickdocumenten maken voor een project
...
## <a name="to-review-planning-lines-for-a-job-ledger-entry" />Planningsregels voor een projectpost controleren

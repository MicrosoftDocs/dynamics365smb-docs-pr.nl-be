...
ms.author: bholtorf
---
# <a name="set-up-invoice-rounding" />Factuurafronding instellen
...
## <a name="set-up-general-ledger-accounts-for-invoice-rounding-differences" />Grootboekrekeningen voor factuurafrondingsverschillen instellen
...
### <a name="to-set-up-general-ledger-accounts-for-invoice-rounding-differences" />Grootboekrekeningen voor factuurafrondingsverschillen instellen
...
## <a name="set-up-rounding-for-foreign-and-local-currencies" />Afronding instellen voor vreemde en lokale valuta's
...
### <a name="to-set-up-rounding-for-foreign-currencies" />Afronding instellen voor vreemde valuta's
...
### <a name="to-set-up-rounding-for-your-local-currency" />Afronding instellen voor uw lokale valuta
...
## <a name="activate-the-invoice-rounding-function" />Functie voor factuurafronding inschakelen

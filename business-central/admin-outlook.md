...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-outlook" />De Business Central-invoegtoepassing voor Outlook verkrijgen
...
## <a name="about-the-business-central-add-in-for-outlook" />Over de Business Central-invoegtoepassing voor Outlook
...
## <a name="deploy-the-add-in-by-using-centralized-deployment-as-an-admin" />De invoegtoepassing implementeren met behulp van gecentraliseerde implementatie als beheerder
...
### <a name="deploy-the-add-in" />De invoegtoepassing implementeren

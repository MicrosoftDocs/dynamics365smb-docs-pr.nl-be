...
ms.author: edupont
---
# <a name="walkthrough-conducting-a-sales-campaign" />Procedure: Een verkoopcampagne uitvoeren
...
## <a name="setting-up-a-campaign" />Een campagne instellen
...
### <a name="to-set-up-a-campaign" />Een campagne instellen
...
## <a name="selecting-the-target-audience" />De doelgroep selecteren
...
### <a name="to-create-a-segment-with-the-relevant-contacts" />Een segment maken met de relevante contacten
...
### <a name="to-save-your-segmentation-criteria" />Uw segmentatiecriteria opslaan
...
## <a name="mining-the-data" />Gegevens toepassen
...
### <a name="to-remove-contacts-from-the-segment" />Contacten uit het segment verwijderen
...
### <a name="to-bring-back-the-removed-contacts" />De verwijderde contacten terughalen
...
## <a name="linking-a-segment-to-a-campaign" />Een segment aan een campagne koppelen
...
### <a name="to-link-a-segment-to-the-campaign" />Een segment aan de campagne koppelen
...
## <a name="sending-letters-and-email-messages-to-contacts" />Brieven en e-mailberichten verzenden naar contactpersonen
...
### <a name="to-use-a-segment-to-send-a-letter-to-a-contact" />Een segment gebruiken om een brief naar een contactpersoon te verzenden
...
### <a name="to-send-an-email-message-to-a-contact" />Een e-mailbericht verzenden naar een contactpersoon
...
## <a name="registering-campaign-responses" />Campagnerespons vastleggen
...
### <a name="to-register-campaign-responses" />Campagnerespons vastleggen

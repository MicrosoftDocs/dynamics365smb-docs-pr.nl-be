...
ms.author: solsen
---
# <a name="preview-posting-results"></a><a name="preview-posting-results"></a>Voorbeeld van boekingsresultaten weergeven
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a><a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice"></a>Een voorbeeld weergeven van grootboekposten die resulteren na boeking van een inkoopfactuur

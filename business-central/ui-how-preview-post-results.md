...
ms.author: solsen
---
# <a name="preview-posting-results" />Voorbeeld van boekingsresultaten weergeven
...
## <a name="to-preview-gl-entries-that-will-result-from-posting-a-purchase-invoice" />Een voorbeeld weergeven van grootboekposten die resulteren na boeking van een inkoopfactuur

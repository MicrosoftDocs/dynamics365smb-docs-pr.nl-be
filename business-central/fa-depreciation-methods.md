...
ms.author: edupont
---
# <a name="depreciation-methods-for-fixed-assets" />Afschrijvingsmethoden voor vaste activa
...
## <a name="straight-line-depreciation" />Lineaire afschrijving
...
### <a name="depreciation-period" />Afschrijvingsperiode
...
### <a name="fixed-yearly-percentage" />Vast jaarpercentage
...
### <a name="fixed-yearly-amount" />Vast jaarbedrag
...
### <a name="example---straight-line-depreciation" />Voorbeeld: lineaire afschrijving
...
## <a name="half-year-convention-depreciation" />Afschrijving volgens halfjaarlijkse afspraak
...
### <a name="example---half-year-convention-depreciation" />Voorbeeld - afschrijving volgens halfjaarlijkse afspraak
...
## <a name="duplicating-entries-to-more-depreciation-books" />Posten dupliceren naar meer afschrijvingsboeken

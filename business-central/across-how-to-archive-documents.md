...
description: U kunt verkoop- en inkooporders, offertes, raamcontracten, retourorders en raamcontracten archiveren, zodat u het gearchiveerde document kunt gebruiken om het document waaruit het is gearchiveerd, opnieuw te maken.
author: SorenGP
ms.topic: conceptual
ms.devlang: na
ms.tgt_pltfrm: na
...
Voor gearchiveerde verkoopdocumenten waarvan het origineel nog bestaat en niet is geboekt, kunt u de functie **Herstellen** gebruiken om het origineel te overschrijven met de gearchiveerde versie van het document. Dit is handig als u de inhoud van een document naar een eerdere status moet herstellen.
...
2. Vul op de pagina **Verkoopinstellingen** de velden in. [!INCLUDE [tooltip-inline-tip_md](includes/tooltip-inline-tip_md.md)]

Speciaal voor het veld **Offertes archiveren** geeft de volgende tabel het verschil tussen de opties weer.

|Optie|Omschrijving|
|------|-----------|
|**Nooit**| Nooit verkoopoffertes archiveren wanneer deze worden verwijderd.|
|**Vraag**|Selecteer dit om de gebruiker te laten kiezen of verkoopoffertes moeten worden gearchiveerd wanneer ze worden verwijderd.|
|**Altijd**|Selecteer dit om verkoopoffertes automatisch te archiveren wanneer deze worden verwijderd.|
...
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Verkooporderarchieven** in en kies vervolgens de gerelateerde koppeling.  
2. Kies de actie **Gearch. verk.-orderversies verwijderen** en selecteer dan, op de pagina **Gearchiveerde verkooporderversies verwijderen** de juiste filters.  
3. Kies de knop **OK**.

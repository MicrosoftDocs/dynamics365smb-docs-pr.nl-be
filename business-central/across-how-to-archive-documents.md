...
---
# <a name="archive-documents" />Documenten archiveren
...
## <a name="to-set-up-automatic-document-archiving" />Automatische documentarchivering instellen
...
## <a name="to-manually-archive-a-sales-order" />Een verkooporder handmatig archiveren
...
## <a name="to-restore-a-non-posted-sales-order-from-the-archive" />Een niet-geboekte verkooporder vanuit het archief herstellen
...
## <a name="to-delete-archived-sales-orders" />Gearchiveerde verkooporders verwijderen

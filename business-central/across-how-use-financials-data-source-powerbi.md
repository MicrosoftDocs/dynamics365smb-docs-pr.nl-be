...
## <a name="creating-accessible-reports" />Toegankelijke rapporten maken
...
## <a name="creating-reports-to-display-data-associated-with-a-list" />Rapporten maken om gegevens weer te geven die aan een lijst zijn gekoppeld
...
### <a name="download-the-theme" />Het thema downloaden
...
### <a name="import-the-theme-on-a-report" />Het thema in een rapport importeren
...
## <a name="publish-reports" />Rapporten publiceren
...
## <a name="distribute-or-share-a-report" />Een rapport distribueren of delen
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page" />"Kan geen record invoegen. De huidige verbindingsintentie is alleen-lezen." fout bij het verbinden met aangepaste API-pagina

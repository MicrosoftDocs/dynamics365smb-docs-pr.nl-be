...
# <a name="building-power-bi-reports-to-display--data"></a><a name="building-power-bi-reports-to-display--data"></a>Power BI-rapporten maken om [!INCLUDE [prod_long](includes/prod_long.md)]-gegevens weer te geven
...
## <a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="add--as-a-data-source-in-power-bi-desktop"></a><a name="getdata"></a>[!INCLUDE[prod_short](includes/prod_short.md)] als gegevensbron toevoegen in Power BI Desktop
...
## <a name="creating-accessible-reports"></a><a name="creating-accessible-reports"></a>Toegankelijke rapporten maken
...
## <a name="creating-reports-to-display-data-associated-with-a-list"></a><a name="creating-reports-to-display-data-associated-with-a-list"></a>Rapporten maken om gegevens weer te geven die aan een lijst zijn gekoppeld
...
## <a name="using-the--report-theme-optional"></a><a name="using-the--report-theme-optional"></a><a name="theme"></a>Het [!INCLUDE [prod_short](includes/prod_short.md)]-rapportthema gebruiken (optioneel)
...
### <a name="download-the-theme"></a><a name="download-the-theme"></a>Het thema downloaden
...
### <a name="import-the-theme-on-a-report"></a><a name="import-the-theme-on-a-report"></a>Het thema in een rapport importeren
...
## <a name="publish-reports"></a><a name="publish-reports"></a>Rapporten publiceren
...
## <a name="distribute-or-share-a-report"></a><a name="distribute-or-share-a-report"></a>Een rapport distribueren of delen
...
### <a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a><a name="cannot-insert-a-record-current-connection-intent-is-read-only-error-connecting-to-custom-api-page"></a>"Kan geen record invoegen. De huidige verbindingsintentie is alleen-lezen." fout bij het verbinden met aangepaste API-pagina

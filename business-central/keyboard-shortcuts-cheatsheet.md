...
# <a name="keyboard-quick-reference---pc-only" />Snelle toetsenbordnaslag - alleen pc

#### <a name="general" />Alge&amp;meen
...
#### <a name="navigate--select-rows" />Navigeren en rijen selecteren
...
#### <a name="copy--paste" />Kopiëren en plakken
...
#### <a name="search-filter--sort" />Zoeken, filteren en sorteren
...
##### <a name="report-preview" />Rapportvoorbeeld

|Selecteer deze toetsen|Actie|
|-|-|
|<kbd>Ctrl</kbd>+<kbd>Home</kbd>/<kbd>End</kbd>|Naar de eerste/laatste pagina gaan|

#### <a name="numeric-keypad" />Numeriek toetsenbord

...
ms.author: edupont
---
# <a name="invoice-sales"></a><a name="invoice-sales"></a>Verkopen factureren
...
## <a name="create-sales-invoices"></a><a name="create-sales-invoices"></a>Verkoopfacturen maken
...
### <a name="to-create-a-sales-invoice"></a><a name="to-create-a-sales-invoice"></a>Een verkoopfactuur maken
...
### <a name="calculating-invoice-discounts-on-sales"></a><a name="calculating-invoice-discounts-on-sales"></a>Factuurkortingen op verkopen berekenen
...
U kunt een geboekte verkoopfactuur gemakkelijk corrigeren of annuleren voordat het is betaald. Dit is handig als u een typfout wilt corrigeren of als de klant om een wijziging in het begin van het orderproces verzoekt. Zie [Niet-betaalde verkoopfacturen corrigeren of annuleren](sales-how-correct-cancel-sales-invoice.md) voor meer informatie. Als de geboekte verkoopfactuur is betaald, moet u een verkoopcreditnota maken om de verkoop tegen te boeken. Zie [Verkoopretouren of annuleringen verwerken](sales-how-process-sales-returns-cancellations.md) voor meer informatie.  
...
## <a name="registering-payments"></a><a name="registering-payments"></a>Betalingen registreren
...
## <a name="external-document-numbers"></a><a name="external-document-numbers"></a>Externe documentnummers

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/invoicing-customers-dynamics-365-business-central/index)

...
ms.author: edupont
---
# <a name="invoice-sales" />Verkopen factureren
...
## <a name="create-sales-invoices" />Verkoopfacturen maken
...
### <a name="to-create-a-sales-invoice" />Een verkoopfactuur maken
...
## <a name="registering-payments" />Betalingen registreren
...
## <a name="external-document-numbers" />Externe documentnummers

[!INCLUDE [ext-doc-no-sales](includes/ext-doc-no-sales.md)]

## <a name="see-related-microsoft-trainingtrainingmodulesinvoicing-customers-dynamics--business-centralindex" />Zie gerelateerde [Microsoft-training](/training/modules/invoicing-customers-dynamics-365-business-central/index)

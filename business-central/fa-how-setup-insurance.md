...
ms.author: edupont
---
# <a name="set-up-fixed-asset-insurance"></a><a name="set-up-fixed-asset-insurance"></a>Verzekering van vaste activa instellen
...
## <a name="to-set-up-general-insurance-information"></a><a name="to-set-up-general-insurance-information"></a>Algemene verzekeringsinformatie instellen
...
## <a name="to-set-up-insurance-types"></a><a name="to-set-up-insurance-types"></a>Verzekeringssoorten instellen
...
## <a name="to-set-up-insurance-cards"></a><a name="to-set-up-insurance-cards"></a>Verzekeringskaarten instellen
...
## <a name="to-set-up-insurance-journal-templates"></a><a name="to-set-up-insurance-journal-templates"></a>Verzekeringsdagboeksjablonen instellen
...
## <a name="to-set-up-insurance-journal-batches"></a><a name="to-set-up-insurance-journal-batches"></a>Verzekeringsdagboekbatches instellen

...
ms.author: jswymer
---
# <a name="set-up-opportunity-sales-cycles-and-cycle-stages" />Verkoopcycli instellen voor opportunities en cyclusfasen
...
## <a name="to-set-up-opportunity-sales-cycle-codes" />Opportunityverkoopcycluscodes instellen
...
## <a name="to-define-opportunity-sales-cycle-stages" />Fasen van opportunityverkoopcycli definiëren
...
## <a name="to-assign-stage-cycles-to-opportunities" />Verkoopfasecycli aan opportunities toewijzen
...
## <a name="to-set-up-activities-with-tasks" />Activiteiten instellen met taken
...
## <a name="to-assign-tasks-or-activities-of-tasks-to-opportunities" />Taken of activiteiten van taken toewijzen aan opportunities

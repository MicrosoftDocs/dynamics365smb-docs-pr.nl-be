...
ms.author: edupont
---
# <a name="receive-and-convert-electronic-documents" />Elektronische documenten ontvangen en converteren
...
### <a name="to-receive-and-convert-an-electronic-invoice-to-a-purchase-invoice" />Een elektronische factuur ontvangen en converteren naar een inkoopfactuur

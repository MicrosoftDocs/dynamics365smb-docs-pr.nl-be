...
---
# <a name="design-details-balancing-supply-and-demand"></a><a name="design-details-balancing-supply-and-demand"></a>Ontwerpdetails: Vraag en aanbod afstemmen
...
## <a name="supply-and-demand"></a><a name="supply-and-demand"></a>Vraag en aanbod
...
## <a name="the-concept-of-balancing-in-brief"></a><a name="the-concept-of-balancing-in-brief"></a>Het concept van afstemmen in het kort
...
## <a name="process-orders-before-the-planning-start-date"></a><a name="process-orders-before-the-planning-start-date"></a>Orders verwerken vóór de startdatum van de planning
...
### <a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a><a name="serial-and-lot-numbers-and-order-to-order-links-are-exempt-from-the-previous-period"></a>Serie-/lotnummers en order-naar-order koppelingen zijn vrijgesteld van de vorige periode
...
## <a name="load-inventory-profiles"></a><a name="load-inventory-profiles"></a>Voorraadprofielen laden
...
### <a name="item-dimensions-are-separated"></a><a name="item-dimensions-are-separated"></a>Artikeldimensies worden gescheiden
...
### <a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a><a name="serial-and-lot-numbers-are-loaded-by-specification-level"></a>Serie- en lotnummers worden geladen op specificatieniveau
...
### <a name="order-to-order-links-are-never-broken"></a><a name="order-to-order-links-are-never-broken"></a>Order-naar-order koppelingen worden nooit verbroken
...
### <a name="component-need-is-loaded-according-to-production-order-changes"></a><a name="component-need-is-loaded-according-to-production-order-changes"></a>Materiaalbehoefte wordt geladen op basis van wijzigingen in productieorders
...
### <a name="consume-safety-stock"></a><a name="consume-safety-stock"></a>Veiligheidsvoorraad verbruiken
...
### <a name="forecast-demand-is-reduced-by-sales-orders"></a><a name="forecast-demand-is-reduced-by-sales-orders"></a>Prognosevraag wordt verlaagd door verkooporders
...
### <a name="blanket-order-demand-is-reduced-by-sales-orders"></a><a name="blanket-order-demand-is-reduced-by-sales-orders"></a>Raamcontractvraag wordt verlaagd door verkooporders
...
## <a name="prioritize-orders"></a><a name="prioritize-orders"></a>Orders in prioriteitsvolgorde plaatsen
...
### <a name="priorities-on-the-demand-side"></a><a name="priorities-on-the-demand-side"></a>Prioriteiten aan de vraagkant
...
### <a name="priorities-on-the-supply-side"></a><a name="priorities-on-the-supply-side"></a>Prioriteiten aan de aanbodkant
...
### <a name="priority-related-to-the-state-of-supply-and-demand"></a><a name="priority-related-to-the-state-of-supply-and-demand"></a>Prioriteit met betrekking tot de status van vraag en aanbod
...
## <a name="balancing-supply-with-demand"></a><a name="balancing-supply-with-demand"></a>Aanbod afstemmen op vraag
...
### <a name="rules-for-actions-for-supply-events"></a><a name="rules-for-actions-for-supply-events"></a>Regels voor acties voor aanbodgebeurtenissen
...
### <a name="determine-the-supply-quantity"></a><a name="determine-the-supply-quantity"></a>De aanbodhoeveelheid bepalen
...
### <a name="order-tracking-links-during-planning"></a><a name="order-tracking-links-during-planning"></a>Ordertraceringskoppelingen tijdens planning
...
## <a name="close-balanced-supply-and-demand"></a><a name="close-balanced-supply-and-demand"></a>Afgestemde vraag en aanbod sluiten
...
### <a name="create-the-planning-line-suggested-action"></a><a name="create-the-planning-line-suggested-action"></a>De planningsregel maken (voorgestelde actie)

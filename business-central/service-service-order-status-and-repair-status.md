...
ms.author: edupont
---
# <a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a><a name="service-order-status-and-repair-status"></a>Serviceorderstatus en herstelstatus
...
## <a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a><a name="specifying-service-order-status-for-repair-status"></a>Serviceorderstatus opgeven voor herstelstatus
...
### <a name="pending"></a><a name="pending"></a><a name="pending"></a>In behandeling
...
### <a name="in-process"></a><a name="in-process"></a><a name="in-process"></a>In verwerking
...
### <a name="on-hold"></a><a name="on-hold"></a><a name="on-hold"></a>Wachten
...
### <a name="finished"></a><a name="finished"></a><a name="finished"></a>Gereedgemeld
...
## <a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a><a name="assigning-priority-to-service-order-status"></a>Prioriteit toewijzen aan serviceorderstatus

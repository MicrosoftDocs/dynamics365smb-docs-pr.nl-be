...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a><a name="change-the-annual-amount-on-service-contracts-or-contract-quotes"></a>Het jaarlijkse bedrag van servicecontracten of servicecontractoffertes wijzigen
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a><a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote"></a>Het jaarlijkse bedrag van het servicecontract of de servicecontractofferte wijzigen
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts"></a><a name="distributing-differences-between-new-and-calculated-annual-amounts"></a>Verschillen tussen nieuwe en berekende jaarlijks bedragen verdelen
...
### <a name="even-distribution"></a><a name="even-distribution"></a>Gelijke verdeling
...
### <a name="distribution-based-on-line-amount"></a><a name="distribution-based-on-line-amount"></a>Verdeling op basis van regelbedrag
...
### <a name="distribution-based-on-profit"></a><a name="distribution-based-on-profit"></a>Verdeling op basis van winst

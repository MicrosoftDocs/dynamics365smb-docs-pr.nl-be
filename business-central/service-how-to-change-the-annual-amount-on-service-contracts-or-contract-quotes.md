...
ms.author: bholtorf
---
# <a name="change-the-annual-amount-on-service-contracts-or-contract-quotes" />Het jaarlijkse bedrag van servicecontracten of servicecontractoffertes wijzigen
...
## <a name="to-change-the-annual-amount-of-the-service-contract-or-contract-quote" />Het jaarlijkse bedrag van het servicecontract of de servicecontractofferte wijzigen
...
## <a name="distributing-differences-between-new-and-calculated-annual-amounts" />Verschillen tussen nieuwe en berekende jaarlijks bedragen verdelen
...
### <a name="even-distribution" />Gelijke verdeling
...
### <a name="distribution-based-on-line-amount" />Verdeling op basis van regelbedrag
...
### <a name="distribution-based-on-profit" />Verdeling op basis van winst

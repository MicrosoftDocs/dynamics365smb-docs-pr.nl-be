...
# <a name="handling-missing-option-values"></a><a name="handling-missing-option-values"></a>Ontbrekende optiewaarden verwerken
> [!NOTE]
...
### <a name="extending-option-sets-in-"></a><a name="extending-option-sets-in-"></a>Optiesets uitbreiden in [!INCLUDE[prod_short](includes/prod_short.md)]
...
### <a name="update--option-mapping"></a><a name="update--option-mapping"></a>[!INCLUDE[prod_short](includes/cds_long_md.md)]-optietoewijzing bijwerken

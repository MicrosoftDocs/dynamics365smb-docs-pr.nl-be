...
4. Kies in het venster **Periodieke verkoopregels** de opzoekknop in het veld **Code** en selecteer een set standaardverkoopregels.
    ...
    > [!NOTE]
    > Als u de set doorlopende verkoopregels samen met de batchverwerking **Periodieke verkoopfacturen maken** wilt gebruiken, moet u ook de velden **Geldig vanaf datum** en **Geldig tot datum** in het venster **Periodieke verkoopregels** invullen. Zie voor meer informatie het gedeelte "Meerdere verkoopfacturen maken op basis van standaardverkoopregels".

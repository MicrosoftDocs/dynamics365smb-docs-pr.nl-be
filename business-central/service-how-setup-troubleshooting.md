...
# <a name="setting-up-troubleshooting-for-service-items" />Troubleshooting voor serviceartikelen instellen
...
## <a name="to-set-up-troubleshooting-guidelines" />Richtlijnen voor troubleshooting instellen
...
## <a name="to-assign-troubleshooting-guidelines-to-items-service-items-or-service-item-groups" />Richtlijnen voor troubleshooting toewijzen aan artikelen, serviceartikelen of serviceartikelgroepen

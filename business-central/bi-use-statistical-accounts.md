...
---
# <a name="analyze-data-with-statistical-accounts" />Gegevens analyseren met statistiekrekeningen
...
## <a name="set-up-a-statistical-account" />Een nieuwe statistiekrekening instellen
...
## <a name="post-amounts-to-a-statistical-account" />Bedragen op een statistiekrekening
...
## <a name="verify-statistical-account-amounts" />Bedragen op een statistiekrekening controleren
...
## <a name="include-the-statistical-account-in-a-financial-report" />De statistiekrekening opnemen in een financieel rapport

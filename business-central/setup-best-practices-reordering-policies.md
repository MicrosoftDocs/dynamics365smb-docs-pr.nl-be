...
ms.author: edupont
---
# <a name="setup-best-practices-reordering-policies" />Aanbevolen procedures instellen: Bestelbeleid
...
## <a name="see-related-microsoft-trainingtrainingpathsreplenish-items-dynamics-365-business-central" />Zie gerelateerde [Microsoft-training](/training/paths/replenish-items-dynamics-365-business-central/)

...
ms.author: edupont
---
# <a name="design-details-item-tracking-and-reservations" />Ontwerpdetails: Artikeltracering en reserveringen
...
## <a name="specific-reservation" />Specifieke reservering
...
## <a name="nonspecific-reservation" />Niet-specifieke reservering
...
## <a name="reshuffle" />Opnieuw plannen
...
## <a name="supported-business-scenarios" />Ondersteunde bedrijfsscenario's
...
### <a name="entering-serial-or-lot-numbers-on-an-outbound-document-with-wrong-nonspecific-reservation" />Serie- of lotnummers invoeren op een uitgaand document met een verkeerde niet-specifieke reservering
...
### <a name="reserve-specific-serial-or-lot-numbers" />Specifieke serie- of lotnummers reserveren
...
### <a name="posting-an-outbound-document-with-nonspecific-reservation-of-serial-or-lot-numbers" />Een uitgaand document met niet-specifieke reservering van serie- of lotnummers boeken.

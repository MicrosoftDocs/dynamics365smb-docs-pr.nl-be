...
### <a name="to-create-a-reminder-automatically"></a><a name="to-create-a-reminder-automatically"></a>Automatisch een aanmaningen maken
...
### <a name="to-create-a-reminder-manually"></a><a name="to-create-a-reminder-manually"></a>Handmatig aanmaningen maken
...
### <a name="to-replace-reminder-texts"></a><a name="to-replace-reminder-texts"></a>Aanmaningsteksten vervangen
...
### <a name="to-issue-a-reminder"></a><a name="to-issue-a-reminder"></a>Een aanmaning verzenden
...
### <a name="to-cancel-an-issued-reminder"></a><a name="to-cancel-an-issued-reminder"></a>Een verzonden aanmaning annuleren

...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts"></a><a name="set-up-prices-and-discounts"></a>Prijzen en kortingen instellen
...
## <a name="setting-up-prices-and-discounts"></a><a name="setting-up-prices-and-discounts"></a>Prijzen en kortingen instellen
...
## <a name="about-price-lists"></a><a name="about-price-lists"></a>Over prijslijsten
...
## <a name="set-up-prices"></a><a name="set-up-prices"></a>Prijzen instellen
...
## <a name="to-set-up-a-sales-line-discount-for-a-customer"></a><a name="to-set-up-a-sales-line-discount-for-a-customer"></a>Een verkoopregelkorting instellen voor een klant
...
## <a name="work-with-invoice-discounts-and-service-charges"></a><a name="work-with-invoice-discounts-and-service-charges"></a>Werken met factuurkortingen en administratiekosten
...
### <a name="to-set-up-an-invoice-discount-for-a-customer"></a><a name="to-set-up-an-invoice-discount-for-a-customer"></a>Een factuurkorting voor een klant instellen
...
## <a name="to-copy-sales-prices"></a><a name="to-copy-sales-prices"></a>Verkoopprijzen kopiëren
...
## <a name="to-bulk-update-item-prices"></a><a name="to-bulk-update-item-prices"></a>Artikelprijzen bulksgewijs bijwerken
...
## <a name="calculating-the-best-price"></a><a name="calculating-the-best-price"></a>De beste prijs berekenen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/customer-discounts-dynamics-365-business-central/)

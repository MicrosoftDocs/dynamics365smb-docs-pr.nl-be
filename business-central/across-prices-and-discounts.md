...
ms.author: bholtorf
---
# <a name="set-up-prices-and-discounts" />Prijzen en kortingen instellen
...
## <a name="setting-up-prices-and-discounts" />Prijzen en kortingen instellen
...
## <a name="about-price-lists" />Over prijslijsten
...
## <a name="set-up-prices" />Prijzen instellen
...
## <a name="work-with-invoice-discounts-and-service-charges" />Werken met factuurkortingen en administratiekosten
...
## <a name="calculating-the-best-price" />De beste prijs berekenen
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/customer-discounts-dynamics-365-business-central/)

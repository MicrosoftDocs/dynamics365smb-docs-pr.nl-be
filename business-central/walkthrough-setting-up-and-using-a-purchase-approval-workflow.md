...
---
# <a name="walkthrough-set-up-and-use-a-purchase-approval-workflow"></a>Procedure: Een goedkeuringswerkstroom voor inkoop instellen en gebruiken
...
3. Stel de twee goedkeuringsgebruikers op door de velden te vullen te vullen zoals beschreven in de volgende tabel.  
    ...
    |Gebruikers-ID|Beoordelaar-id|Onbeperkte goedkeuring van inkopen|  
    |-------|-----------|---------------------------|  
    |U||Geselecteerd|
    |ALICIA|U||

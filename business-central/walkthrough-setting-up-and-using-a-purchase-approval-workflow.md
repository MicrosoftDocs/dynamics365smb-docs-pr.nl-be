...
ms.author: edupont
---
# <a name="walkthrough-setting-up-and-using-a-purchase-approval-workflow" />Procedure: Een werkstroom voor inkoopgoedkeuring instellen en gebruiken
...
### <a name="setting-up-approval-users" />Goedkeuringsgebruikers instellen
...
#### <a name="to-set-up-yourself-and-alicia-as-approval-users" />Uzelf en Alicia instellen als goedkeuringsgebruikers
...
### <a name="setting-up-notifications" />Meldingen instellen
...
#### <a name="to-set-up-how-and-when-you-are-notified" />Instellen hoe en wanneer u bericht ontvangt
...
## <a name="creating-the-approval-workflow" />De goedkeuringswerkstroom maken
...
### <a name="to-create-and-enable-a-purchase-order-approval-workflow" />Een werkstoorm voor goedkeuring van inkooporders maken en inschakelen
...
## <a name="use-the-approval-workflow" />De goedkeuringswerkstroom gebruiken
...
### <a name="to-request-approval-of-a-purchase-order-as-alicia" />Goedkeuring aanvragen voor een inkooporder als Alicia
...
### <a name="to-approve-the-purchase-order-as-sean" />De inkooporder goedkeuren, als Sean

...
## <a name="scheduling-synchronization-between-d365fin-and-crm_md"></a>Synchronisatie plannen tussen [!INCLUDE[d365fin](includes/d365fin_md.md)] en [!INCLUDE[crm_md](includes/crm_md.md)]

...
# <a name="basic-reports-and-documents-output-quick-start" />Snelstartgids Basisrapporten en documentuitvoer
...
## <a name="add-your-company-logo-to-documents" />Uw bedrijfslogo toevoegen aan documenten
...
## <a name="run-reports" />Rapporten uitvoeren
...
## <a name="save-reports-as-pdf-excel-or-word-documents" />Rapporten opslaan als PDF-, Excel- of Word-bestand
...
### <a name="change-report-and-document-layouts" />Rapport- en documentindelingen wijzigen

...
ms.author: edupont
---
# <a name="trace-item-tracked-items" />Artikelen met artikeltracering traceren
...
## <a name="to-trace-item-tracked-items" />Artikelen met artikeltracering traceren
...
## <a name="to-find-item-tracked-items-with-find-entries" />Artikelen met artikeltracering zoeken met Posten zoeken

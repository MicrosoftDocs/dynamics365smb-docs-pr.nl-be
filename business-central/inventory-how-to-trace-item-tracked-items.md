...
ms.author: edupont
---
# <a name="trace-item-tracked-items"></a><a name="trace-item-tracked-items"></a>Artikelen met artikeltracering traceren
...
## <a name="to-trace-item-tracked-items"></a><a name="to-trace-item-tracked-items"></a>Artikelen met artikeltracering traceren
...
## <a name="to-find-item-tracked-items-with-find-entries"></a><a name="to-find-item-tracked-items-with-find-entries"></a>Artikelen met artikeltracering zoeken met Posten zoeken

...
ms.author: jswymer
---
# <a name="specify-a-default-printer"></a><a name="specify-a-default-printer"></a><a name="default"></a>Een standaardprinter opgeven
...
## <a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a><a name="set-a-printer-as-a-default-printer-for-all-print-jobs"></a>Een printer instellen als standaardprinter voor alle afdruktaken
...
## <a name="set-a-default-printer-for-specific-reports"></a><a name="set-a-default-printer-for-specific-reports"></a>Een standaardprinter instellen voor specifieke rapporten
...
## <a name="choosing-the-printer-when-running-a-report"></a><a name="choosing-the-printer-when-running-a-report"></a>De printer kiezen bij het uitvoeren van een rapport
...
## <a name="sizing-print-jobs"></a><a name="sizing-print-jobs"></a>Formaat van afdruktaken wijzigen

...
---
# <a name="monitor-job-progress-and-performance" />Voortgang en prestaties van projecten bewaken
...
## <a name="create-a-job-wip-method" />Een OHW-methode voor een project maken
...
## <a name="define-a-wip-method-for-a-job" />Een OHW-methode voor een project definiëren
...
### <a name="define-a-wip-method-for-a-job-task" />Een OHW-methode voor een project definiëren
...
## <a name="calculate-wip" />OHW berekenen
...
## <a name="calculate-and-post-job-completion-entries" />Projectvoltooiingsposten berekenen en boeken
...
## <a name="view-job-ledger-entries" />Projectposten bekijken

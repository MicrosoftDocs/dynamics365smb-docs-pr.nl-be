...
---
# <a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a><a name="monitor-job-progress-and-performance"></a>Voortgang en prestaties van projecten bewaken
...
## <a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a><a name="create-a-job-wip-method"></a>Een OHW-methode voor een project maken
...
## <a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a><a name="define-a-wip-method-for-a-job"></a>Een OHW-methode voor een project definiëren
...
### <a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a><a name="define-a-wip-method-for-a-job-task"></a>Een OHW-methode voor een project definiëren
...
## <a name="calculate-wip"></a><a name="calculate-wip"></a><a name="calculate-wip"></a>OHW berekenen
...
## <a name="post-wip"></a><a name="post-wip"></a><a name="post-wip"></a>OHW boeken
...
## <a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a><a name="calculate-and-post-job-completion-entries"></a>Projectvoltooiingsposten berekenen en boeken
...
## <a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a><a name="view-job-ledger-entries"></a>Projectposten bekijken
...
## <a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a><a name="find-related-microsoft-training"></a>Gerelateerde [Microsoft-training](/training/paths/calculate-post-job-wip/) zoeken

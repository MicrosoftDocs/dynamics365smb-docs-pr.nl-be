...
ms.author: edupont
---
# <a name="design-details-accounts-in-the-general-ledger" />Ontwerpdetails: Rekeningen in het grootboek
...
## <a name="from-the-inventory-ledger" />Vanuit het voorraadgrootboek
...
## <a name="from-the-capacity-ledger" />Van het capaciteitsgrootboek
...
## <a name="calculating-the-amount-to-post-to-the-general-ledger" />Het bedrag berekenen dat moet worden geboekt naar het grootboek

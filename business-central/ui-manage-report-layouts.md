...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a><a name="report-and-document-layouts-overview"></a>Overzicht van lay-outs van rapporten en documenten beheren
...
## <a name="introduction"></a><a name="introduction"></a><a name="introduction"></a>Inleiding
...
## <a name="layout-types"></a><a name="layout-types"></a><a name="layout-types"></a>Lay-outtypen
...
### <a name="external"></a><a name="external"></a><a name="external"></a>Extern
...
## <a name="layout-sources"></a><a name="layout-sources"></a><a name="layout-sources"></a>Lay-outbronnen

...
ms.author: jswymer
---
# <a name="report-and-document-layouts-overview" />Overzicht van lay-outs van rapporten en documenten beheren
...
## <a name="layout-types" />Lay-outtypen
...
## <a name="layout-sources" />Lay-outbronnen

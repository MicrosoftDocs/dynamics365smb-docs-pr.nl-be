...
ms.author: edupont
---
# <a name="register-employees"></a><a name="register-employees"></a>Werknemers registreren
...
## <a name="adding-new-employees"></a><a name="adding-new-employees"></a>Nieuwe werknemers toevoegen
...
> [!TIP]
> Het kan handig zijn om de pagina **Werknemerssjabloon** te personaliseren wanneer u een sjabloon maakt. U wilt bijvoorbeeld een veld toevoegen dat nog niet op de pagina wordt weergegeven. Zie [Uw werkruimte personaliseren](ui-personalization-user.md#to-start-personalizing-a-page-through-the-personalizing-banner) voor meer informatie.
...
## <a name="to-set-up-an-employee"></a><a name="to-set-up-an-employee"></a>Werknemers instellen
...
## <a name="to-insert-a-picture-of-an-employee"></a><a name="to-insert-a-picture-of-an-employee"></a>Een afbeelding van een werknemer invoegen
...
## <a name="to-register-various-information-about-an-employee"></a><a name="to-register-various-information-about-an-employee"></a>Verschillende gegevens over een werknemer registreren

...
ms.author: edupont
---
# <a name="register-employees" />Werknemers registreren
...
## <a name="adding-new-employees" />Nieuwe werknemers toevoegen
...
## <a name="to-set-up-an-employee" />Werknemers instellen
...
## <a name="to-insert-a-picture-of-an-employee" />Een afbeelding van een werknemer invoegen
...
## <a name="to-register-various-information-about-an-employee" />Verschillende gegevens over een werknemer registreren

...
## <a name="setting-up-a-job-1"></a>Een project instellen
...
## <a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/create-jobs/)

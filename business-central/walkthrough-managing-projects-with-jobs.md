...
ms.author: edupont
---
# <a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a><a name="walkthrough-managing-projects-with-jobs"></a>Procedure: Projecten plannen
...
### <a name="setting-up-a-job"></a><a name="setting-up-a-job"></a><a name="setting-up-a-job"></a>Een project instellen
...
### <a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a><a name="handling-fixed-prices"></a>Werken met vaste prijzen
...
### <a name="copying-a-job"></a><a name="copying-a-job"></a><a name="copying-a-job"></a>Een project kopiëren
...
### <a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a><a name="making-payment-by-installment"></a>Betalen in termijnen
...
## <a name="preparing-sample-data"></a><a name="preparing-sample-data"></a><a name="preparing-sample-data"></a>Voorbeeldgegevens voorbereiden

 Voordat u met dit scenario begint, moet u Tricia toevoegen als een nieuwe resource.  

### <a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a><a name="to-prepare-the-sample-data"></a>De voorbeeldgegevens voorbereiden
...
### <a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a><a name="to-create-a-job-journal-batch"></a>Een projectdagboekbatch maken
...
## <a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a><a name="setting-up-a-job-1"></a>Een project instellen
...
### <a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a><a name="to-set-up-a-job"></a>Een project instellen
...
### <a name="to-customize-pricing"></a><a name="to-customize-pricing"></a><a name="to-customize-pricing"></a>Prijzen aanpassen
...
### <a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a><a name="to-add-job-tasks"></a>Projecttaken toevoegen aan
...
### <a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a><a name="to-create-planning-lines"></a>Planningsregels maken
...
## <a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a><a name="calculating-remaining-usage"></a>Resterend gebruik berekenen
...
### <a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a><a name="to-calculate-remaining-usage"></a>Het resterende gebruik berekenen
...
## <a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a><a name="creating-and-posting-a-job-sales-invoice"></a>Een projectverkoopfactuur maken en boeken
...
### <a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a><a name="to-create-a-job-sales-invoice"></a>Een projectverkoopfactuur maken
...
### <a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a><a name="to-post-a-new-sales-invoice"></a>Een nieuwe verkoopfactuur boeken
...
### <a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a><a name="to-view-the-posted-invoice"></a>De geboekte factuur weergeven
...
### <a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a><a name="to-open-the-statistics-page"></a>De pagina Statistiek openen
...
## <a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a><a name="handling-fixed-prices-1"></a>Werken met vaste prijzen
...
### <a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a><a name="to-manage-fixed-pricing-in-jobs"></a>Vaste prijzen beheren in projecten
...
### <a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a><a name="to-enter-hours-in-the-job-journal"></a>Uren invoeren in het projectdagboek
...
## <a name="copying-jobs"></a><a name="copying-jobs"></a><a name="copying-jobs"></a>Projecten kopiëren
...
### <a name="to-copy-a-job"></a><a name="to-copy-a-job"></a><a name="to-copy-a-job"></a>Een project kopiëren
...
## <a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a><a name="making-payments-by-installments"></a>Betalen in termijnen
...
### <a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a><a name="to-set-up-a-new-account"></a>Een nieuwe rekening instellen
...
### <a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a><a name="to-make-a-payment-by-installment"></a>Betalen in termijnen
...
### <a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a><a name="to-create-an-invoice"></a>Een factuur maken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/create-jobs/)

...
### De magazijnverplaatsing als registreren
...
3. Voer indien nodig uw gebruikers-id in wanneer u aan een opslag begint.  
  ...
  > [!NOTE]  
  > Regels worden in oplopende volgorde gesorteerd op de geselecteerde criteria. Als u op document sorteert, wordt er eerst gesorteerd op documenttype op basis van de enum **Brondocument magazijnactiviteit**. Als u op verzending sorteert, wordt er gesorteerd op bestemming op basis van het veld **Type magazijnbestemming**.

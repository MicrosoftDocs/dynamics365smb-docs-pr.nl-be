...
# <a name="move-items-in-advanced-warehouse-configurations-that-use-directed-put-away-and-pick" />Artikelen verplaatsen in geavanceerde magazijnconfiguraties die gebruikmaken van gestuurde opslag en pick
...
## <a name="warehouse-movement-worksheet" />Magazijnverplaatsingsvoorstel

### <a name="to-move-items-with-the-warehouse-movement-worksheet" />artikelen met het magazijnverplaatsingswerkblad verplaatsen
...
### <a name="to-register-the-warehouse-movement" />De magazijnverplaatsing registreren
...
## <a name="internal-pick" />Interne pick

### <a name="to-create-an-internal-pick" />Een interne pick maken
...
### <a name="to-register-the-warehouse-pick" />De magazijnpick registreren
...
## <a name="internal-put-away" />Interne opslag

### <a name="to-create-an-internal-put-away" />Een interne opslag maken
...
### <a name="to-register-the-warehouse-put-away" />De magazijnopslag registreren
...
## <a name="to-register-a-movement-that-has-already-happened" />Een verplaatsing registreren die al heeft plaatsgevonden

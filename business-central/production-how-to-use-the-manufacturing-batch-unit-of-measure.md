...
ms.author: edupont
---
# <a name="work-with-manufacturing-batch-units-of-measure" />Werken met productiebatcheenheden
...
## <a name="to-create-a-production-bom-using-a-batch-unit-of-measure" />Een productiestuklijst maken met behulp van een batcheenheid
...
## <a name="to-calculate-a-manufacturing-batch-unit-of-measure-on-a-production-order" />Een productiebatcheenheid berekenen in een productieorder

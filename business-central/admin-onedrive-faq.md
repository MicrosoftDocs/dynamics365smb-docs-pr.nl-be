...
description: Krijg antwoorden op enkele typische vragen over het werken met OneDrive voor werk of school (voorheen bekend als OneDrive voor Bedrijven) en Business Central.
author: brentholtorf
...
---
# Veelgestelde vragen over OneDrive voor Bedrijven
...
## Werkt dit met alle [!INCLUDE[prod_short](includes/prod_short.md)]-clients?
...
## Is OneDrive hetzelfde als SharePoint voor het opslaan van bestanden?
...
## Ondersteunt [!INCLUDE[prod_short](includes/prod_short.md)] OneDrive voor consumenten?

Nee. Deze integratie is uitsluitend bedoeld voor OneDrive voor Bedrijven en ondersteunt alleen uw werkaccount. 

## Worden alle OneDrive voor Bedrijven-abonnementen ondersteund?
...
## Waar kan ik de status van de OneDrive-service zien?
...
## Is OneDrive-integratie beschikbaar voor [!INCLUDE[prod_short](includes/prod_short.md)] on premises?
...
## We hebben de bedrijfsnaam gewijzigd. Wat gebeurt er met mijn vorige bestanden?
...
## Bij het toevoegen van bestanden aan [!INCLUDE[prod_short](includes/prod_short.md)], hoe kies ik dan een bestand uit OneDrive?
...
## Ik wil bestanden in plaats daarvan openen in SharePoint. Hoe doe ik dit?
...
## Hoe schakel ik integratie met OneDrive uit?
...
## Moet ik de pagina Instellingen SharePoint-verbinding gebruiken om verbinding te maken met SharePoint?
...
## Welke versie van [!INCLUDE[prod_short](includes/prod_short.md)] ondersteunt OneDrive?

Integratie met OneDrive kwam beschikbaar in releasewave 2 van 2021.  

## <a name="features"></a>Welke functies worden beïnvloed door OneDrive-integratie?
...
## Zal Microsoft de integratie met OneDrive blijven verbeteren?
...
### Business Central kan mijn OneDrive niet vinden
...
### Ik heb problemen met delen vanuit Outlook
...
### Acties Openen in OneDrive en Delen ontbreken

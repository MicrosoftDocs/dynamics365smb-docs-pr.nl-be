...
ms.author: bholtorf
---
# <a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a><a name="synchronize-contacts-in-business-central-with-contacts-in-microsoft-outlook"></a>Contacten in Business Central synchroniseren met contacten in Microsoft Outlook
...
## <a name="set-up-synchronization"></a><a name="set-up-synchronization"></a>Synchronisatie instellen
...
### <a name="automate-synchronization"></a><a name="automate-synchronization"></a>Synchronisatie automatiseren
...
## <a name="synchronize-contacts"></a><a name="synchronize-contacts"></a>Contactpersonen synchroniseren

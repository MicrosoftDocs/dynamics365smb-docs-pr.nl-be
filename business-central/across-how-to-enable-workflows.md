...
ms.author: edupont
---
# <a name="enable-approval-workflows"></a><a name="enable-approval-workflows"></a>Goedkeuringswerkstromen inschakelen
...
## <a name="enable-a-workflow"></a><a name="enable-a-workflow"></a>Een werkstroom inschakelen

...
ms.author: edupont
---
# <a name="work-with-production-families" />Werken met productfamilies
...
## <a name="to-set-up-a-production-family" />Een productfamilie instellen
...
## <a name="to-produce-based-on-a-production-family" />Produceren op basis van een productfamilie

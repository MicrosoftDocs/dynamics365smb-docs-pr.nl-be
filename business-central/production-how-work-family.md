...
ms.author: edupont
---
# <a name="work-with-production-families"></a><a name="work-with-production-families"></a>Werken met productfamilies
...
## <a name="to-set-up-a-production-family"></a><a name="to-set-up-a-production-family"></a>Een productfamilie instellen
...
## <a name="to-produce-based-on-a-production-family"></a><a name="to-produce-based-on-a-production-family"></a>Produceren op basis van een productfamilie

...
ms.author: edupont
---
# <a name="set-up-shop-calendars" />Productieagenda's instellen
...
## <a name="to-create-work-shifts" />Ploegen maken
...
## <a name="to-set-up-a-shop-calendar" />Een productieagenda instellen
...
## <a name="to-calculate-a-work-center-calendar" />Een afdelingsagenda berekenen
...
## <a name="to-record-work-center-absence" />Afwezigheid op de afdeling registreren

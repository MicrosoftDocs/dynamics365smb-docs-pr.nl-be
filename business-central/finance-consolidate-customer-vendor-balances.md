...
1. Maak een nieuwe klant of leverancier. Zie voor meer informatie [Nieuwe klanten registreren](sales-how-register-new-customers.md).
...
Gebruik op de pagina **Betalingsdagboek** de actie **Nettosaldi van klanten/leveranciers** om de klant- en leverancierssaldi te consolideren tot een enkel nettobedrag. Met deze actie worden betalingsjournaalregels met de nettosaldi gemaakt, maar niet geboekt.

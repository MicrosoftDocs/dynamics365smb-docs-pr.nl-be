...
ms.author: bholtorf
---
# <a name="the-late-payment-prediction-extension" />De extensie Voorspelling van te late betaling
...
## <a name="viewing-all-payment-predictions" />Alle betalingsvoorspellingen weergeven
...
## <a name="viewing-a-payment-prediction-for-a-specific-sales-document" />Een betalingsvoorspelling weergeven voor een specifiek verkoopdocument
...
## <a name="design-details" />Ontwerpdetails
...
### <a name="data-required-to-train-and-evaluate-the-model" />Gegevens die nodig zijn om het model te trainen en te evalueren
...
### <a name="standard-model-and-my-model" />Standaardmodel en Mijn model
...
#### <a name="to-train-and-use-your-model" />Uw model trainen en gebruiken
...
## <a name="a-nameanchortext-acreate-and-use-your-own-predictive-web-service-for-late-payment-prediction" /><a name="AnchorText"> </a>Uw eigen voorspellende webservice voor voorspellingen van te laten betalingen maken en gebruiken
...
## <a name="see-related-microsoft-trainingtrainingmodulespredict-late-payments-sales-documents" />Zie gerelateerde [Microsoft-training](/training/modules/predict-late-payments-sales-documents/)

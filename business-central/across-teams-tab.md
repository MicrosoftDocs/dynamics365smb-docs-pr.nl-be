...
# <a name="add-business-central-tab-in-microsoft-teams"></a><a name="add-business-central-tab-in-microsoft-teams"></a>Een Business Central-tabblad toevoegen in Microsoft Teams
...
## <a name="about-business-central-tabs"></a><a name="about-business-central-tabs"></a>Over Business Central-tabbladen
...
## <a name="add-tab-using-recommended-content"></a><a name="add-tab-using-recommended-content"></a>Een tabblad toevoegen met aanbevolen inhoud
...
## <a name="add-tab-using-a-page-link"></a><a name="add-tab-using-a-page-link"></a>Een tabblad toevoegen met een paginakoppeling
...
## <a name="add-tab-by-pinning-card-details"></a><a name="add-tab-by-pinning-card-details"></a>Een tabblad toevoegen door kaartgegevens vast te zetten
...
## <a name="change-a-tab-and-its-content"></a><a name="change-a-tab-and-its-content"></a>Een tabblad en de inhoud ervan wijzigen

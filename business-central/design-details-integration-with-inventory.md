...
ms.author: edupont
---
# <a name="design-details-integration-with-inventory" />Ontwerpdetails: Integratie met voorraad
...
## <a name="physical-inventory" />Fysieke inventaris
...
## <a name="warehouse-adjustments-to-the-item-ledger" />Magazijncorrecties in de artikelpost

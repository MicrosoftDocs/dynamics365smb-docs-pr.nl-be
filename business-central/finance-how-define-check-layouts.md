...
ms.author: edupont
---
# <a name="select-a-check-layout"></a><a name="select-a-check-layout"></a>Een cheque-indeling selecteren
...
## <a name="to-select-a-check-layout"></a><a name="to-select-a-check-layout"></a>Een cheque-indeling selecteren
...
## <a name="use-micr-and-security-fonts"></a><a name="use-micr-and-security-fonts"></a>MICR en beveiligingslettertypen gebruiken
...
### <a name="micr-e-13b-specifications"></a><a name="micr-e-13b-specifications"></a>MICR E-13B-specificaties
...
### <a name="delimiter-characters"></a><a name="delimiter-characters"></a>Scheidingstekens
...
### <a name="micr-cmc-7-specifications"></a><a name="micr-cmc-7-specifications"></a>MICR CMC-7-specificaties
...
### <a name="delimiter-characters-1"></a><a name="delimiter-characters-1"></a>Scheidingstekens
...
### <a name="secure-font-specifications"></a><a name="secure-font-specifications"></a>Specificaties voor veilige lettertypen

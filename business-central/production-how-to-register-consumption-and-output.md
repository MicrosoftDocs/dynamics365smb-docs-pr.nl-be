...
ms.author: edupont
---
# <a name="register-consumption-and-output-for-one-released-production-order-line" />Verbruik en output registreren voor één vrijgegeven productieorderregel
...
## <a name="to-register-consumption-and-output" />Verbruik en output registreren

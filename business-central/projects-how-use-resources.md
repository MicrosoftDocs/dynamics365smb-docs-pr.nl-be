...
ms.author: edupont
---
# <a name="use-resources-for-jobs" />Resources gebruiken voor projecten
...
## <a name="to-assign-resources-to-jobs" />Resources toewijzen aan projecten
...
## <a name="to-record-resource-usage-for-a-job" />Resourceverbruik voor een project vastleggen
...
## <a name="to-adjust-resource-prices" />Resourceprijzen aanpassen
...
## <a name="to-get-resource-price-change-suggestions-based-on-existing-alternate-prices" />Suggesties voor wijzigingen van resourceprijzen krijgen op basis van bestaande alternatieve prijzen
...
## <a name="to-get-resource-price-change-suggestions-based-on-standard-prices" />Resourceprijsvoorstellen ophalen op basis van standaardverkoopprijzen
...
## <a name="to-get-resource-price-change-suggestions-based-on-alternate-prices" />Suggesties voor wijzigingen van resourceprijzen krijgen op basis van alternatieve prijzen

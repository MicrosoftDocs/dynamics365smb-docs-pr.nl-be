...
3. Maak gebruikers die leden van de btw-groep gebruiken wanneer ze verbinding maken met de [!INCLUDE[prod_short](includes/prod_short.md)] van de groepsvertegenwoordiger. De gebruikers moeten volledige gebruikerslicenties hebben voor [!INCLUDE[prod_short](includes/prod_short.md)].
...
4. Voer in het veld  **OAuth 2.0 Authority Endpoint**  het volgende in: `https://login.microsoftonline.com/common/oauth2`
5. Voer in het veld  **OAuth 2.0 Resource URL** het volgende in `https://api.businesscentral.dynamics.com/`.
6. Voer in het veld  **OAuth 2.0 Redirect URL** het volgende in: `https://businesscentral.dynamics.com/OAuthLanding.htm`.
...
8. Het veld **Goedgekeurde leden** toont het aantal groepsleden dat is ingesteld om btw-aangiften in te dienen bij de groepsvertegenwoordiger. Om nieuwe leden toe te voegen kiest u het nummer om de pagina **Goedgekeurde leden van btw-groep** te openen en voegt u de volgende informatie toe:
    ...
    3. Geef in het veld **Bedrijf** het bedrijf op van waaruit het groepslid btw-aangiften doet in [!INCLUDE[prod_short](includes/prod_short.md)], bijvoorbeeld **CRONUS UK Ltd**.
...
## <a name="issue-with-enabling-multifactor-authentication-mfa"></a>Probleem met het inschakelen van multifactorverificatie (MFA)

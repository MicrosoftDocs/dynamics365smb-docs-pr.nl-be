...
# <a name="the-vat-group-management-extension-for-the-united-kingdom" />De extensie Btw-groepsbeheer voor het Verenigd Koninkrijk
...
## <a name="forming-a-vat-group" />Een btw-groep vormen
...
### <a name="license-requirements" />Licentievereisten
...
## <a name="set-up-a-vat-group" />Een btw-groep instellen
...
### <a name="azure-active-directory-setup-for-group-members" />Azure Active Directory instellen voor groepsleden
...
### <a name="group-api-setup" />Groeps-API instellen
...
## <a name="set-up-vat-group-members" />Btw-groepsleden instellen
...
### <a name="vat-group-representative-uses-business-central-online" />Btw-groepsvertegenwoordiger gebruikt Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises" />Btw-groepsvertegenwoordiger gebruikt Business Central on-premises
...
## <a name="set-up-the-vat-group-representative" />De btw-groepsvertegenwoordiger instellen
...
## <a name="use-the-vat-group-management-features" />De functies van btw-groepsbeheer gebruiken
...
### <a name="review-vat-member-submissions" />Indieningen van groepsleden controleren
...
### <a name="create-a-group-vat-return" />Een groeps-btw-aangifte maken

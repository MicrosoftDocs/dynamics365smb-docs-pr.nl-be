...
# <a name="the-vat-group-management-extension-for-the-united-kingdom"></a><a name="the-vat-group-management-extension-for-the-united-kingdom"></a>De extensie Btw-groepsbeheer voor het Verenigd Koninkrijk
...
## <a name="forming-a-vat-group"></a><a name="forming-a-vat-group"></a>Een btw-groep vormen
...
### <a name="license-requirements"></a><a name="license-requirements"></a>Licentievereisten
...
## <a name="set-up-a-vat-group"></a><a name="set-up-a-vat-group"></a>Een btw-groep instellen
...
### <a name="azure-active-directory-setup-for-group-members"></a><a name="azure-active-directory-setup-for-group-members"></a>Azure Active Directory instellen voor groepsleden
...
### <a name="group-api-setup"></a><a name="group-api-setup"></a>Groeps-API instellen
...
## <a name="set-up-vat-group-members"></a><a name="set-up-vat-group-members"></a>Btw-groepsleden instellen
...
### <a name="vat-group-representative-uses-business-central-online"></a><a name="vat-group-representative-uses-business-central-online"></a>Btw-groepsvertegenwoordiger gebruikt Business Central online
...
### <a name="vat-group-representative-uses-business-central-on-premises"></a><a name="vat-group-representative-uses-business-central-on-premises"></a>Btw-groepsvertegenwoordiger gebruikt Business Central on-premises
...
## <a name="set-up-the-vat-group-representative"></a><a name="set-up-the-vat-group-representative"></a>De btw-groepsvertegenwoordiger instellen
...
## <a name="use-the-vat-group-management-features"></a><a name="use-the-vat-group-management-features"></a>De functies van btw-groepsbeheer gebruiken
...
### <a name="review-vat-member-submissions"></a><a name="review-vat-member-submissions"></a>Indieningen van groepsleden controleren
...
### <a name="create-a-group-vat-return"></a><a name="create-a-group-vat-return"></a>Een groeps-btw-aangifte maken

...
ms.author: jswymer
---
# <a name="run-and-print-reports" />Rapporten uitvoeren en afdrukken
...
## <a name="specifying-the-data-to-include-in-a-report" />De gegevens opgeven die in rapporten moeten worden opgenomen
...
## <a name="previewing-a-report" />Een voorbeeld van een rapport bekijken
...
### <a name="work-with-the-preview" />Werken met het voorbeeld
...
## <a name="saving-a-report-to-a-file" />Een rapport opslaan in een bestand
...
### <a name="manage-scheduled-recurring-reports" />Geplande periodieke rapporten beheren
...
### <a name="printing-reports-in-thai" />Rapporten afdrukken in Thai
...
## <a name="switching-the-report-layout" />Overgaan op een andere rapportlay-out
...
## <a name="change-language-and-format-of-numbers-dates-and-times" />Wijzig de taal en het formaat van getallen, datums en tijden
...
## <a name="advanced-options" />Geavanceerde opties

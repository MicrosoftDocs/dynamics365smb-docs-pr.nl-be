...
ms.author: jswymer
---
# <a name="run-and-print-reports"></a><a name="run-and-print-reports"></a>Rapporten uitvoeren en afdrukken
...
## <a name="using-default-valuesmdashpredefined-settings"></a><a name="using-default-valuesmdashpredefined-settings"></a><a name="SavedSettings"></a>Standaardwaarden gebruiken&mdash;vooraf gedefinieerde instellingen
...
## <a name="specifying-the-data-to-include-in-a-report"></a><a name="specifying-the-data-to-include-in-a-report"></a>De gegevens opgeven die in rapporten moeten worden opgenomen
...
## <a name="previewing-a-report"></a><a name="previewing-a-report"></a>Een voorbeeld van een rapport bekijken
...
### <a name="work-with-the-preview"></a><a name="work-with-the-preview"></a>Werken met het voorbeeld
...
## <a name="saving-a-report-to-a-file"></a><a name="saving-a-report-to-a-file"></a>Een rapport opslaan in een bestand
...
## <a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="scheduling-a-report-to-run-later-or-periodically"></a><a name="ScheduleReport"></a> Een rapport plannen om het later of periodiek uit te voeren
...
### <a name="manage-scheduled-recurring-reports"></a><a name="manage-scheduled-recurring-reports"></a>Geplande periodieke rapporten beheren
...
## <a name="printing-a-report"></a><a name="printing-a-report"></a><a name="PrintReport"></a>Een rapport afdrukken
...
### <a name="printer"></a><a name="printer"></a><a name="Printer"></a>Printer
...
### <a name="printing-reports-in-thai"></a><a name="printing-reports-in-thai"></a>Rapporten afdrukken in Thai
...
## <a name="switching-the-report-layout"></a><a name="switching-the-report-layout"></a>Overgaan op een andere rapportlay-out
...
## <a name="change-language-and-format-of-numbers-dates-and-times"></a><a name="change-language-and-format-of-numbers-dates-and-times"></a>Wijzig de taal en het formaat van getallen, datums en tijden
...
## <a name="advanced-options"></a><a name="advanced-options"></a>Geavanceerde opties
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/setup-reporting-dynamics-365-business-central/).

...
1. Ga naar https://lcs.dynamics.com en meld u aan. U ziet de projecten waartoe u toegang hebt

2. Selecteer het project **Wettelijke waarschuwingen - wereldwijd**. Hierdoor wordt het project geopend en worden allerlei zaken in verband met het project weergegeven

3. Selecteer de **Waarschuwingsservice** aan de rechterkant in de sectie **Meer hulpmiddelen**. U ziet een lijst met waarschuwingen met de kop **Dynamics-indiening van wettelijke waarschuwingen**

4. U kunt een nieuwe waarschuwing toevoegen door te klikken op het plusteken **(+)** boven aan de lijst. U ziet dan een gids met 4 stappen om de waarschuwing te maken. De gids bevat de volgende stappen:

...
ms.author: bholtorf
---
# <a name="walkthrough-tracing-seriallot-numbers"></a><a name="walkthrough-tracing-seriallot-numbers"></a>Procedure: Serie-/lotnummers traceren
...
### <a name="to-create-the-items"></a><a name="to-create-the-items"></a>De artikelen maken
...
### <a name="to-purchase-components"></a><a name="to-purchase-components"></a>Materialen kopen
...
### <a name="to-produce-end-items"></a><a name="to-produce-end-items"></a>Eindproducten produceren
...
### <a name="to-sell-the-end-items"></a><a name="to-sell-the-end-items"></a>De eindpoducten verkopen
...
## <a name="tracing-from-usage-to-origin"></a><a name="tracing-from-usage-to-origin"></a>Traceren van gebruik naar oorsprong
...
### <a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a><a name="to-determine-which-lot-included-the-faulty-frame-and-who-supplied-it"></a>Vaststellen uit welke partij het defecte frame afkomstig is en wie deze heeft geleverd
...
## <a name="tracing-from-origin-to-usage"></a><a name="tracing-from-origin-to-usage"></a>Traceren van oorsprong naar gebruik
...
### <a name="to-find-all-usage-of-the-faulty-lot"></a><a name="to-find-all-usage-of-the-faulty-lot"></a>Al het gebruik van de defecte partij opsporen
...
## <a name="finding-all-records-of-a-seriallot-number"></a><a name="finding-all-records-of-a-seriallot-number"></a>Alle records van een serie/lotnummer zoeken
...
### <a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a><a name="to-find-all-occurrences-of-lot1-in-non-posted-records-such-as-open-orders"></a>Alle gevallen van LOT1 in niet-geboekte records zoeken zoals open orders
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/use-serial-lot-numbers/)

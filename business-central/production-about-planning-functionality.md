...
ms.author: bholtorf
---
# <a name="about-planning-functionality" />Informatie over het plannen van functionaliteit
...
## <a name="demand-and-supply" />Vraag en voorzieningen
...
## <a name="planning-calculation" />Planningsberekening
...
## <a name="planning-with-manual-transfer-orders" />Planning met handmatige transferorders
...
## <a name="other-important-planning-fields" />Andere belangrijke planningsvelden
...
## <a name="planning-worksheets-and-requisition-worksheets" />Planningsvoorstellen en inkoopvoorstellen
...
### <a name="requisition-worksheet" />Inkoopvoorstel

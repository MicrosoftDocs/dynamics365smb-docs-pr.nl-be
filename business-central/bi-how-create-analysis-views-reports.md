...
ms.author: edupont
---
# <a name="create-analysis-reports"></a><a name="create-analysis-reports"></a><a name="create-analysis-reports"></a>Analyselijsten maken
...
## <a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a><a name="setting-up-line-and-column-layouts"></a>Regel- en kolomindelingen instellen
...
## <a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a><a name="set-up-analysis-column-templates"></a>Analysekolomsjablonen instellen
...
## <a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a><a name="set-up-analysis-line-templates"></a>Analyseregelsjablonen instellen
...
## <a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a><a name="create-a-new-sales-analysis-report"></a>Een nieuwe verkoopanalyselijst maken

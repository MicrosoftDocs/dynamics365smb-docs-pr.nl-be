...
ms.author: jswymer
---
# <a name="get-the-business-central-add-in-for-excel" />De Business Central-invoegtoepassing voor Excel verkrijgen
...
### <a name="about-the-add-in" />Over de invoegtoepassing
...
### <a name="about-deployment-as-an-admin" />Over implementatie als beheerder
...
## <a name="preparation-on-premises-only" />Voorbereiding (alleen voor on-premises)
...
## <a name="deploy-the-add-in-by-using-centralized-deployment" />De invoegtoepassing implementeren met behulp van gecentraliseerde implementatie
...
### <a name="before-you-begin" />Voordat u begint
...
### <a name="set-up-centralized-deployment-of-the-add-in" />Gecentraliseerde implementatie van de invoegtoepassing instellen
...
### <a name="configure-the-business-central-connection" />De Business Central-verbinding configureren
...
## <a name="prepare-devices-and-network-for-the-excel-add-in" />Apparaten en netwerk voorbereiden voor de Excel-invoegtoepassing

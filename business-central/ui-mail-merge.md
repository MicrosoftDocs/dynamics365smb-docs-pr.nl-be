...
# <a name="use-word-templates-for-bulk-communication" />Word-sjablonen gebruiken voor bulkcommunicatie
...
## <a name="set-up-the-source-of-data" />Stel de bron van gegevens in.
...
## <a name="add-entries-that-are-related-or-unrelated-to-the-source-entity" />Vermeldingen toevoegen die al dan niet gerelateerd zijn aan de bronentiteit
...
### <a name="select-the-fields-to-include" />Selecteer de velden die u wilt opnemen
...
## <a name="to-create-a-word-template-in-business-central" />Een Word-sjabloon maken in Business Central
...
## <a name="set-up-the-template-in-word" />De sjabloon instellen in Word
...
## <a name="apply-a-template" />Een sjabloon toepassen
...
## <a name="use-word-templates-with-email" />Word-sjablonen gebruiken met e-mail
...
## <a name="edit-a-word-template" />Een Word-sjabloon bewerken

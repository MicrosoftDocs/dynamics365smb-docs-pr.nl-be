...
ms.author: edupont
---
# <a name="set-up-bin-types" />Opslaglocatiesoorten instellen
...
## <a name="to-set-up-the-bin-types-you-want-to-use" />U kunt als volgt de gewenste soorten opslaglocatie instellen

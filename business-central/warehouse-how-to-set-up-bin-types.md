...
ms.author: edupont
---
# <a name="set-up-bin-types"></a><a name="set-up-bin-types"></a>Opslaglocatiesoorten instellen
...
## <a name="to-set-up-the-bin-types-you-want-to-use"></a><a name="to-set-up-the-bin-types-you-want-to-use"></a>U kunt als volgt de gewenste soorten opslaglocatie instellen

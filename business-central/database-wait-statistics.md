...
ms.date: 06/15/2022
---
# <a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a><a name="database-wait-statistics-in-"></a>Wachtstatistieken van databases in [!INCLUDE[prod_long](includes/prod_long.md)]

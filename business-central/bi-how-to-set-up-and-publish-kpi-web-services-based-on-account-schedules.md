...
---
# <a name="set-up-and-publish-kpi-web-services-based-on-financial-reports"></a><a name="set-up-and-publish-kpi-web-services-based-on-financial-reports"></a>KPI-webservices instellen en publiceren op basis van financiële rapporten
...
## <a name="set-up-and-publish-a-kpi-web-service-based-on-financial-reports"></a><a name="set-up-and-publish-a-kpi-web-service-based-on-financial-reports"></a>KPI-webservices instellen en publiceren op basis van financiële rapporten

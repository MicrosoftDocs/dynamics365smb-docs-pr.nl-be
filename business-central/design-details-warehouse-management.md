...
|Complexiteitniveau|Beschrijving|Instellingen|Bin Code|Voorbeeld van inkomende stroom|Voorbeeld van uitgaande stroom|Voorbeeld van interne stroom|  
|---|----------------|----------|---------|------------------|------------------|------------------|
...
Vestigingen die gerichte opslag en pick gebruiken, kunnen opslaglocatietypes gebruiken. Opslaglocatietypes bepalen de activiteiten die u toestaat voor een opslaglocatie. 

De volgende typen opslaglocaties zijn beschikbaar:  

|Opslaglocatiesoort|Beschrijving|  
|------------------|---------------------------------------|  
|ONTVANGEN|Artikelen die zijn ontvangen maar niet zijn opgeslagen.|  
|VERZENDEN|Artikelen die zijn gepickt voor magazijnverzendregels, maar die niet zijn geboekt als verzonden.|  
...
> [!NOTE]  
> U moet verplaatsingen gebruiken om artikelen naar ONTVANGEN- en QC-opslaglocaties te verplaatsen en ook verplaatsingen gebruiken om artikelen uit VERZENDEN- en QC-opslaglocaties te verplaatsen.  

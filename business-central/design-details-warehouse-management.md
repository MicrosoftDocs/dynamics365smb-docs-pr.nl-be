...
# <a name="warehouse-management-overview"></a><a name="warehouse-management-overview"></a>Overzicht van magazijnbeheer
...
## <a name="modeling-the-physical-warehouse"></a><a name="modeling-the-physical-warehouse"></a>Het fysieke magazijn modelleren
...
### <a name="locations-and-bins"></a><a name="locations-and-bins"></a>Vestigingen en opslaglocaties
...
### <a name="shelves-and-bins"></a><a name="shelves-and-bins"></a>Schappen en opslaglocaties
...
## <a name="typical-warehouse-workflow"></a><a name="typical-warehouse-workflow"></a>Typische magazijnwerkstroom
...
## <a name="terminology-related-to-warehouse-management"></a><a name="terminology-related-to-warehouse-management"></a>Terminologie gerelateerd aan magazijnbeheer

### <a name="complexity-levels"></a><a name="complexity-levels"></a>Complexiteitsniveaus
...
### <a name="warehouse-flows"></a><a name="warehouse-flows"></a>Magazijnstromen
...
### <a name="basic-documents"></a><a name="basic-documents"></a>Basisdocumenten
...
### <a name="advanced-documents"></a><a name="advanced-documents"></a>Geavanceerde documenten
...
### <a name="pages-and-settings"></a><a name="pages-and-settings"></a>Pagina's en instellingen

In dit gedeelte worden de concepten achter de belangrijkste pagina's en instellingen voor magazijnbeheer beschreven.

#### <a name="bins-and-bin-content"></a><a name="bins-and-bin-content"></a>Opslaglocaties en inhoud ervan
...
#### <a name="bin-type"></a><a name="bin-type"></a>Opslaglocatiesoort
...
#### <a name="bin-ranking"></a><a name="bin-ranking"></a>Volgorde van opslaglocatie
...
#### <a name="bin-setup"></a><a name="bin-setup"></a>Instelling opslaglocatie
...
#### <a name="zone"></a><a name="zone"></a>Regio
...
#### <a name="warehouse-class"></a><a name="warehouse-class"></a>Magazijnklasse
...
#### <a name="location"></a><a name="location"></a>Vestiging
...
#### <a name="first-expired-first-out"></a><a name="first-expired-first-out"></a>First-Expired-First-Out (Eerst-vervallen-eerst-uit)
...
#### <a name="put-away-template"></a><a name="put-away-template"></a>Opslagsjabloon

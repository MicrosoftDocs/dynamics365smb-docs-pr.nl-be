...
ms.author: edupont
---
# <a name="design-details-assembly-order-posting"></a><a name="design-details-assembly-order-posting"></a>Ontwerpdetails: Assemblageorderboeking
...
## <a name="posting-sequence"></a><a name="posting-sequence"></a>Boekingsvolgorde
...
## <a name="cost-adjustment"></a><a name="cost-adjustment"></a>Kostenherwaardering
...
### <a name="performing-the-adjustment"></a><a name="performing-the-adjustment"></a>De aanpassing doorvoeren
...
## <a name="assembly-costs-are-always-actual"></a><a name="assembly-costs-are-always-actual"></a>Assemblagekosten zijn altijd werkelijk
...
## <a name="assemble-to-order"></a><a name="assemble-to-order"></a>Op order assembleren
...
### <a name="posting-dates"></a><a name="posting-dates"></a>Boekingsdatums

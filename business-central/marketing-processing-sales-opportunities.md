...
ms.author: jswymer
---
# <a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a><a name="process-sales-opportunities"></a>Verkoopopportunity's verwerken
...
## <a name="to-view-opportunities"></a><a name="to-view-opportunities"></a><a name="to-view-opportunities"></a>Opportunities weergeven
...
## <a name="to-close-opportunities"></a><a name="to-close-opportunities"></a><a name="to-close-opportunities"></a>Opportunities sluiten
...
## <a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a><a name="to-create-quotes-for-opportunities"></a>Offertes maken voor opportunity's
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a><a name="to-create-sales-orders-for-opportunities"></a>Verkooporders voor opportunity's maken
...
## <a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a><a name="to-delete-opportunities"></a>Opportunities verwijderen
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a><a name="to-move-an-opportunity-through-sales-cycle-stages"></a>Een opportunity verplaatsen door verkoopcyclifasen

...
ms.author: jswymer
---
# <a name="process-sales-opportunities" />Verkoopopportunity's verwerken
...
## <a name="to-view-opportunities" />Opportunities weergeven
...
## <a name="to-close-opportunities" />Opportunities sluiten
...
## <a name="to-create-quotes-for-opportunities" />Offertes maken voor opportunity's
> [!NOTE]
...
## <a name="to-create-sales-orders-for-opportunities" />Verkooporders voor opportunity's maken
...
## <a name="to-delete-opportunities" />Opportunities verwijderen
...
## <a name="to-move-an-opportunity-through-sales-cycle-stages" />Een opportunity verplaatsen door verkoopcyclifasen

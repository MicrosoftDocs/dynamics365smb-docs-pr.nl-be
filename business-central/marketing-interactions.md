...
ms.author: jswymer
---
# <a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a><a name="record-interactions-with-contacts"></a>Interacties met contacten vastleggen
...
## <a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a><a name="setting-up-interaction-templates"></a>Interactiesjablonen instellen
...
## <a name="creating-interactions"></a><a name="creating-interactions"></a><a name="creating-interactions"></a>Interacties maken
...
## <a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a><a name="viewing-and-managing-recorded-interactions"></a>Geregistreerde interacties weergeven en beheren

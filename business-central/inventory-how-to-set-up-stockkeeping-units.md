...
# <a name="set-up-stockkeeping-units"></a><a name="set-up-stockkeeping-units"></a>SKU's instellen
...
## <a name="to-set-up-a-stockkeeping-unit"></a><a name="to-set-up-a-stockkeeping-unit"></a>SKU's instellen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/control-inventory-multiple-locations/)

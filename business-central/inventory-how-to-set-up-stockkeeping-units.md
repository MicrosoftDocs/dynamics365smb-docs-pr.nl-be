...
## <a name="to-set-up-a-sku"></a>SKU's instellen
...
3. Vul de velden in. De volgende velden zijn vereist: **Artikelnr.**, **Vestigingscode** en/of **variantcode**. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]  

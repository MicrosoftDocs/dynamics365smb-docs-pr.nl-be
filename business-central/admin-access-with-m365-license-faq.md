...
---
# <a name="access-with-microsoft-365-licenses-faq" />Veelgestelde vragen over toegang met Microsoft 365-licenties
...
### <a name="can-i-proactively-configure-different-starting-permissions-for-different-groups-of-users" />Kan ik proactief verschillende startmachtigingen configureren voor verschillende groepen gebruikers?
...
### <a name="can-i-proactively-configure-permissions-profiles-and-settings-for-individual-users-before-they-sign-in" />Kan ik proactief machtigingen, profielen en instellingen configureren voor individuele gebruikers voordat ze inloggen?
...
### <a name="after-a-user-signs-in-can-i-change-which-objects-they-have-access-to" />Kan ik nadat een gebruiker zich heeft aangemeld, wijzigen tot welke objecten ze toegang hebben?
...
### <a name="how-do-i-prevent-access-to-sensitive-tables" />Hoe voorkom ik toegang tot gevoelige tabellen?
...
### <a name="instead-of-customizing-the-license-configuration-can-i-customize-a-user-group" />Kan ik een gebruikersgroep aanpassen in plaats van de licentieconfiguratie aan te passen?
...
### <a name="when-a-business-central-user-shares-a-record-in-teams-do-they-grant-new-permissions" />Wanneer Business Central-gebruikers een record delen in Teams, verlenen ze dan nieuwe machtigingen?
...
### <a name="does-this-feature-support-row-level-security" />Ondersteunt deze functie beveiliging op rijniveau?
...
### <a name="if-i-configure-permissions-that-include-write-access-will-users-be-able-to-write-in-teams" />Als ik machtigingen configureer die schrijftoegang bevatten, kunnen gebruikers dan in Teams schrijven?
...
### <a name="why-is-the-setting-to-enable-access-not-available-for-my-environment" />Waarom is de instelling om toegang in te schakelen niet beschikbaar voor mijn omgeving?
...
### <a name="can-i-access-business-central-on-premises-with-microsoft-365-licenses" />Kan ik toegang tot Business Central krijgen met Microsoft 365-licenties?
...
### <a name="what-is-the-employee-profile" />Wat is het werknemersprofiel?
...
### <a name="what-is-the-teams-users-user-group" />Wat is de gebruikersgroep Teams-gebruikers?
...
### <a name="do-users-that-only-have-a-microsoft-365-license-show-up-in-the-users-list-in-business-central" />Worden gebruikers die alleen een Microsoft 365-licentie hebben, weergegeven in de gebruikerslijst in Business Central?
...
### <a name="does-this-feature-work-for-embed-isv-solutions" />Werkt deze functie voor ingesloten ISV-oplossingen?
...
### <a name="can-a-customer-use-this-feature-if-they-dont-have-business-central" />Kan een klant deze functie gebruiken als deze geen Business Central heeft?
...
### <a name="how-does-this-help-me-manage-subscription-costs-in-my-organization" />Hoe helpt dit mij om de abonnementskosten in mijn organisatie te beheren?
...
### <a name="is-this-100-free-of-charge" />Is dit 100% gratis?
...
### <a name="does-this-work-with-microsoft-365-trials-and-business-central-trials" />Werkt dit met Microsoft 365-proefversies en Business Central-proefversies?
...
### <a name="the-list-of-licenses-in-business-central-shows-a-microsoft-365-license-whats-that" />De lijst met licenties in Business Central toont een Microsoft 365-licentie. Wat is dat?
...
### <a name="do-i-need-to-acquire-a-new-type-of-microsoft-365-license-for-this-feature-to-work" />Moet ik een nieuw type Microsoft 365-licentie aanschaffen om deze functie te laten werken?
...
### <a name="how-do-i-find-out-which-users-have-only-a-microsoft-365-license" />Hoe kom ik erachter welke gebruikers alleen een Microsoft 365-licentie hebben?
...
### <a name="how-do-i-filter-the-users-list-in-business-central-to-see-users-that-only-have-a-microsoft-365-license" />Hoe filter ik de lijst Gebruikers in Business Central om gebruikers te zien die alleen een Microsoft 365-licentie hebben?
...
### <a name="what-about-users-that-have-both-a-microsoft-365-license-and-a-business-central-license" />Hoe zit het met gebruikers die zowel een Microsoft 365-licentie als een Business Central-licentie hebben?
...
### <a name="is-this-licensing-related-to-the-business-central-team-member-license" />Is deze licentie gerelateerd aan de Business Central Teamlid-licentie?
...
### <a name="does-business-central-enforce-any-of-the-constraints" />Dwingt Business Central een van de beperkingen af?
...
### <a name="can-i-access-records-on-teams-for-ios-and-teams-for-android" />Heb ik toegang tot records op Teams voor iOS en Teams voor Android?
...
### <a name="how-do-users-change-their-personal-settings-in-my-settings" />Hoe kunnen gebruikers hun persoonlijke instellingen wijzigen in Mijn instellingen?
...
### <a name="what-determines-the-choice-of-language-when-you-sign-in-for-the-first-time" />Wat bepaalt de taalkeuze bij de eerste keer inloggen?
...
### <a name="why-cant-i-activate-some-of-the-colored-links-in-tabs-and-card-details" />Waarom kan ik sommige gekleurde links in tabbladen en kaartgegevens niet activeren?
...
### <a name="why-cant-i-activate-page-notification-actions" />Waarom kan ik acties voor paginameldingen niet activeren?
...
### <a name="can-microsoft-365-users-remove-tabs" />Kunnen Microsoft 365-gebruikers tabbladen verwijderen?
...
### <a name="if-i-cant-filter-will-i-still-see-a-filtered-list-that-was-created-by-others" />Als ik niet kan filteren, zie ik dan nog steeds een gefilterde lijst die door anderen is gemaakt?

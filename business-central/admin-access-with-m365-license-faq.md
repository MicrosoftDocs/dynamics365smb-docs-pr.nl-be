...
### Kan ik proactief verschillende startmachtigingen configureren voor verschillende groepen gebruikers?
...
### Kan ik proactief machtigingen, profielen en instellingen configureren voor individuele gebruikers voordat ze inloggen?
...
### Kan ik nadat een gebruiker zich heeft aangemeld, wijzigen tot welke objecten ze toegang hebben?
...
### Hoe voorkom ik toegang tot gevoelige tabellen?
...
### Kan ik een gebruikersgroep aanpassen in plaats van de licentieconfiguratie aan te passen?
...
### Als ik machtigingen configureer die schrijftoegang bevatten, kunnen gebruikers dan in Teams schrijven?
...
### Waarom is de instelling om toegang in te schakelen niet beschikbaar voor mijn omgeving?
...
### Kan ik toegang tot Business Central krijgen met Microsoft 365-licenties?
...
### Wat is de gebruikersgroep Teams-gebruikers?
...
### Worden gebruikers die alleen een Microsoft 365-licentie hebben, weergegeven in de gebruikerslijst in Business Central?
...
### Werkt deze functie voor ingesloten ISV-oplossingen?
...
### Kan een klant deze functie gebruiken als deze geen Business Central heeft?
...
### Hoe helpt dit mij om de abonnementskosten in mijn organisatie te beheren?
...
### De lijst met licenties in Business Central toont een Microsoft 365-licentie. Wat is dat?
...
### Moet ik een nieuw type Microsoft 365-licentie aanschaffen om deze functie te laten werken?  
...
### Hoe kom ik erachter welke gebruikers alleen een Microsoft 365-licentie hebben?
...
### Hoe filter ik de lijst Gebruikers in Business Central om gebruikers te zien die alleen een Microsoft 365-licentie hebben?
...
### Hoe zit het met gebruikers die zowel een Microsoft 365-licentie als een Business Central-licentie hebben?
...
### Is deze licentie gerelateerd aan de Business Central Teamlid-licentie?
...
### Dwingt Business Central een van de beperkingen af?
...
### Heb ik toegang tot records op Teams voor iOS en Teams voor Android? 
...
### Hoe kunnen gebruikers hun persoonlijke instellingen wijzigen in Mijn instellingen? 
...
### Wat bepaalt de taalkeuze bij de eerste keer inloggen? 
...
### Waarom kan ik sommige gekleurde links in tabbladen en kaartgegevens niet activeren?
...
### Waarom kan ik acties voor paginameldingen niet activeren?
...
### Kunnen Microsoft 365-gebruikers tabbladen verwijderen?
...
### Als ik niet kan filteren, zie ik dan nog steeds een gefilterde lijst die door anderen is gemaakt?

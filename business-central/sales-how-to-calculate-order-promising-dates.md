...
ms.author: edupont
---
# <a name="calculate-order-promising-dates"></a><a name="calculate-order-promising-dates"></a>Ordertoezeggingsdatums berekenen
...
## <a name="about-order-promising"></a><a name="about-order-promising"></a>Informatie over ordertoezeggingen
...
### <a name="available-to-promise"></a><a name="available-to-promise"></a>Available to Promise
...
### <a name="capable-to-promise"></a><a name="capable-to-promise"></a>Capable to Promise
...
### <a name="calculations"></a><a name="calculations"></a>Berekeningen
...
## <a name="to-set-up-order-promising"></a><a name="to-set-up-order-promising"></a>Ordertoezegging instellen
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a><a name="inbound-and-outbound-warehouse-handling-times-in-order-promising"></a>In- en uitslagtijden in ordertoezeggingen
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a><a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents"></a>Standaardinslagtijd en -uitslagtijd invoeren voor verkoop- en inkoopdocumenten
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a><a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations"></a>In- en uitslagtijden invoeren voor locaties
...
## <a name="to-make-an-item-critical"></a><a name="to-make-an-item-critical"></a>Artikelen als kritiek aanmerken
...
## <a name="to-calculate-an-order-promising-date"></a><a name="to-calculate-an-order-promising-date"></a>Een ordertoezeggingsdatum berekenen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/promising-sales-order-delivery-dynamics-365-business-central/)

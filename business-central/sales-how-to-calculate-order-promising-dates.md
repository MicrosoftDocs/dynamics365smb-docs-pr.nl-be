...
ms.author: edupont
---
# <a name="calculate-order-promising-dates" />Ordertoezeggingsdatums berekenen
...
## <a name="about-order-promising" />Informatie over ordertoezeggingen
...
### <a name="available-to-promise" />Available to Promise
...
### <a name="capable-to-promise" />Capable to Promise
...
### <a name="calculations" />Berekeningen
...
## <a name="to-set-up-order-promising" />Ordertoezegging instellen
...
### <a name="inbound-and-outbound-warehouse-handling-times-in-order-promising" />In- en uitslagtijden in ordertoezeggingen
...
#### <a name="to-enter-default-inbound-and-outbound-warehouse-handling-times-for-sales-and-purchase-documents" />Standaardinslagtijd en -uitslagtijd invoeren voor verkoop- en inkoopdocumenten
...
#### <a name="to-enter-inbound-and-outbound-warehouse-handling-times-on-locations" />In- en uitslagtijden invoeren voor locaties
...
## <a name="to-make-an-item-critical" />Artikelen als kritiek aanmerken
...
## <a name="to-calculate-an-order-promising-date" />Een ordertoezeggingsdatum berekenen

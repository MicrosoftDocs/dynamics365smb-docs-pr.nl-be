...
# <a name="use-profile-questionnaires-to-classify-business-contacts" />Profielvragenlijsten gebruiken om bedrijfscontactpersonen te classificeren
...
## <a name="to-add-a-profile-questionnaire" />Een profielvragenlijst toevoegen
...
## <a name="to-add-questions-to-a-profile-questionnaire" />Vragen toevoegen aan een profielvragenlijst
...
## <a name="apply-questionnaires-to-contacts" />Vragenlijsten toepassen op contacten
...
## <a name="the-automatic-classification-of-contacts" />De automatische classificatie van contactpersonen

...
ms.author: edupont
---
# <a name="enter-external-document-numbers" />Externe documentnummers invoeren
...
## <a name="to-enter-external-document-numbers-in-a-sales-order" />Externe documentnummers invoeren in een verkooporder

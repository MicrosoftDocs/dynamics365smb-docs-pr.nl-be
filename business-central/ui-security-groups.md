...
# <a name="control-access-to-business-central-using-security-groups" />Toegang tot Business Central beheren met behulp van beveiligingsgroepen
...
## <a name="business-central-online-and-on-premises" />Business Central Online en on-premises
...
## <a name="add-a-security-group-in-business-central" />Een beveiligingsgroep in Business Central toevoegen
...
### <a name="assign-permissions-to-a-security-group" />Machtigingen aan een beveiligingsgroep toewijzen
...
## <a name="review-the-permissions-in-a-security-group" />De machtigingen in een beveiligingsgroep controleren
...
## <a name="security-groups-and-user-groups" />Beveiligingsgroepen en gebruikersgroepen
...
### <a name="optional-convert-user-groups-to-permission-sets" />Optioneel: converteer gebruikersgroepen naar machtigingssets

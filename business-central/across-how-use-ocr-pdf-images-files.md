...
ms.author: edupont
---
# <a name="use-ocr-to-turn-pdf-and-image-files-into-electronic-documents" />OCR gebruiken om PDF- en afbeeldingsbestanden te converteren naar elektronische documenten
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-from-the-incoming-documents-page" />Een PDF- of afbeeldingsbestand verzenden naar de OCR-service vanaf de pagina Inkomende documenten
...
## <a name="to-send-a-pdf-or-image-file-to-the-ocr-service-by-email" />Een PDF- of afbeeldingsbestand naar de OCR-service verzenden per e-mail
...
## <a name="to-receive-the-resulting-electronic-document-from-the-ocr-service" />Het resulterende elektronische document ontvangen van de OCR-service
...
## <a name="to-create-a-purchase-invoice-from-an-electronic-document-received-from-the-ocr-service" />Een inkoopfactuur op basis van een elektronisch document ontvangen van de OCR-service maken
...
### <a name="to-map-text-on-an-incoming-document-to-a-specific-vendor-account" />Tekst in een inkomend document aan een bepaalde leveranciersrekening toewijzen
...
## <a name="to-handle-errors-when-receiving-electronic-documents" />Fouten afhandelen bij de ontvangst van elektronische documenten
...
## <a name="to-train-the-ocr-service-to-avoid-errors" />De OCR-service trainen om fouten te voorkomen

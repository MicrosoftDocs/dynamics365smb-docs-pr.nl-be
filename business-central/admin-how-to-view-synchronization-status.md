...
# <a name="view-the-status-of-synchronization-jobs" />De status van synchronisatietaken weergeven
...
## <a name="to-view-and-resolve-synchronization-errors-for-coupled-records" />Synchronisatiefouten voor gekoppelde records weergeven en oplossen
...
## <a name="to-view-the-synchronization-log-for-a-specific-manually-synchronized-record" />Het synchronisatielogboek weergeven voor een specifieke (handmatig gesynchroniseerde) record
...
## <a name="remove-couplings-between-records" />Koppelingen tussen records verwijderen

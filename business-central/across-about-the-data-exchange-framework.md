...
De bestandsindelingen voor de uitwisseling van bankgegevens met ERP-systemen verschillen, afhankelijk van de leverancier en het land of de regio van het bestand. [!INCLUDE[prod_short](includes/prod_short.md)] ondersteunt de import en export van SEPA-bankbestanden (Single Euro Payments Area) en met de AMC Banking 365 Fundamentals-uitbreiding kunt u verbinding maken met een AMC Banking 365 Fundamentals-extensie die wordt aangeboden door een externe leverancier, AMC Consult. Om ondersteuning te bieden voor elektronische documentindelingen, gebruikt u het kader voor gegevensuitwisseling.  

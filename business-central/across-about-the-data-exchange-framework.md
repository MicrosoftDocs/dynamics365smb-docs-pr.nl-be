...
ms.author: edupont
---
# <a name="about-the-data-exchange-framework" />Over het kader voor gegevensuitwisseling
...
## <a name="electronic-documents" />Elektronische documenten
...
## <a name="bank-files" />Bankbestanden
...
## <a name="currency-exchange-rates" />Valutawisselkoersen

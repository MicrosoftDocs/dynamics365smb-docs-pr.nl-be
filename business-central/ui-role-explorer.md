...
# <a name="finding-pages-with-the-role-explorer" />Pagina's zoeken met de Rolverkenner
...
## <a name="open-the-role-explorer" />De rollenverkenner openen
...
## <a name="navigate-features" />Door functies navigeren
...
## <a name="search-for-features" />Zoeken naar functies
...
## <a name="explore-other-roles" />Andere rollen ontdekken
...
## <a name="expand-and-collapse-nodes-on-the-role-explorer" />Knooppunten in de rolverkenner uitvouwen en samenvouwen

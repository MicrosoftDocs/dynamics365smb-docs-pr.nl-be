...
ms.author: edupont
---
# <a name="set-up-a-document-exchange-service" />Een service voor documentuitwisseling instellen
...
## <a name="connecting-with-trading-partners" />Verbinding maken met handelspartners
...
## <a name="to-connect-to-the-business-central-integration-app-on-tradeshift" />Verbinding maken met de app Business Central-integratie op Tradeshift
...
## <a name="to-connect-to-a-document-exchange-service" />Verbinding maken met een documentuitwisselingsservice
...
## <a name="settings-for-business-central-on-premises" />Instellingen voor Business Central On-Premises
...
## <a name="see-related-microsoft-trainingtrainingmoduleselectronic-documents-dynamics--business-central" />Zie gerelateerde [Microsoft-training](/training/modules/electronic-documents-dynamics-365-business-central/)

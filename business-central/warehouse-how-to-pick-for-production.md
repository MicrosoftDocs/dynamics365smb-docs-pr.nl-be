...
---
# <a name="pick-for-production-assembly-or-jobs-in-basic-warehouse-configurations" />Picken voor productie, assemblage of taken in standaardmagazijnconfiguraties
...
## <a name="inventory-picks" />Voorraadpicks
...
## <a name="inventory-movements" />Voorraadverplaatsingen
...
### <a name="project-management" />Projectbeheer
...
## <a name="pick-or-move-for-production-assembly-and-jobs-in-a-basic-warehouse-configuration" />Picken of verplaatsen voor productie, assemblage en projecten in een standaard magazijnconfiguratie
...
### <a name="to-create-an-inventory-movement-from-the-source-document" />Een voorraadverplaatsing maken op basis van het brondocument
...
### <a name="to-create-multiple-inventory-picks-or-movements-with-a-batch-job" />Meerdere voorraadpicks of -verplaatsingen maken met een batchproject
...
### <a name="to-create-inventory-picks-or-movements-in-two-steps" />Voorraadpicks of -verplaatsingen in twee stappen maken
...
## <a name="to-record-the-inventory-pick" />De voorraadpick registreren
...
## <a name="flushing-production-components-in-a-basic-warehouse-configuration" />Materialen voor productie afboeken in een standaard magazijnconfiguratie

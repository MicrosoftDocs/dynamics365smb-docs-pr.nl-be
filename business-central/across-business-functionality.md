...
|Werkstromen instellen en gebruiken die taken verbinden die worden uitgevoerd door verschillende gebruikers of door het systeem, zoals automatisch boeken. Het aanvragen en verlenen van goedkeuringen om documenten te maken of te boeken, zijn veelvoorkomende werkstroomstappen.|[Werkstroom](across-workflow.md)|
...
[[!INCLUDE[prod_short](includes/prod_short.md)] instellen](setup.md)   

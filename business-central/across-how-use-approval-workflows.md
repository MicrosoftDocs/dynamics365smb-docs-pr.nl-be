...
ms.author: edupont
---
# <a name="how-to-use-approval-workflows" />Goedkeuringswerkstromen gebruiken
...
## <a name="request-a-record-approval" />Goedkeuring van een record aanvragen
...
## <a name="cancel-approval-requests" />Goedkeuringsaanvragen annuleren
...
## <a name="approve-or-reject-approval-requests" />Aanvragen voor goedkeuring goedkeuren of afwijzen
...
## <a name="delegate-approval-requests" />Goedkeuringsaanvragen delegeren
...
## <a name="manage-overdue-approval-requests" />Vervallen goedkeuringsaanvragen beheren

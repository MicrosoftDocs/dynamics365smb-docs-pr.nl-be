...
ms.author: edupont
---
# <a name="make-check-payments" />Chequebetalingen doen
...
## <a name="to-pay-a-vendor-invoice-with-a-computer-check" />Een leverancier betalen met een automatische cheque
...
## <a name="to-cancel-printed-checks-that-are-not-posted" />Afgedrukte cheques annuleren die niet zijn geboekt
...
## <a name="to-void-checks" />Cheques nietig verklaren
...
## <a name="to-view-a-summary-of-posted-checks" />Een overzicht weergeven van geboekte cheques
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/use-checks-dynamics-365-business-central/)

...
Voor beide gebeurtenissen en reacties zijn de opties door het systeem gedefinieerd. Nieuwe moeten worden toegevoegd door de ontwikkeling van een extensie.
...
7. Geef in het veld **Als gebeurtenis** de gebeurtenis op die zich moet voordoen om de werkstroomstap te starten.  
   ...
   Als u het veld kiest, wordt de pagina **Werkstroomgebeurtenissen** geopend, zodat u uit alle beschikbare werkstroomgebeurtenissen kunt selecteren.  
...
9. Geef in het veld **Dan reactie** het antwoord op dat volgt als de werkstroomgebeurtenis plaatsvindt.  
   ...
   Als u het veld kiest, wordt de pagina **Werkstroomreacties** geopend, zodat u uit alle beschikbare werkstroomreacties kunt selecteren en reactieopties kunt instellen voor de geselecteerde reactie.  
10. Op het sneltabblad **Opties voor de geselecteerde reactie** geeft u als volgt opties op voor de werkstroomreactie door waarden te selecteren in de verschillende velden die verschijnen:  
    ...
    > Deze velden variëren, afhankelijk van het door u gekozen antwoord.
       ...
       |**Type berichtitem**|Geef op of het werkstroombericht wordt geactiveerd door een recordwijziging, een goedkeuringsverzoek of een verstreken vervaldatum.|
...
11. Kies de knop **Inspringing vergroten** en **Inspringing verkleinen** om de gebeurtenisnaam in het veld **Als** in te laten springen om de positie van de stap in de werkstroom bepalen.  
    ...
    1. Geef aan dat stap de volgende in de werkstroomvolgorde is door de gebeurtenisnaam onder de gebeurtenisnaam van de vorige stap te laten inspringen.  
...
13. Schakel het selectievakje **Geactiveerd** in om aan te geven dat de werkstroom wordt gestart zodra de gebeurtenis in de eerste stap van het type **Startpunt** plaatsvindt. Zie voor meer informatie [Werkstromen gebruiken](across-use-workflows.md).  

> [!NOTE]  
> Schakel een werkstroom pas in als u zeker weet dat de werkstroom af is en dat de betreffende werkstroomstappen kunnen beginnen.  
...
4. Doe het volgende om de eerste werkstroomstap te maken.
    ...
    5. Wijzig in het gedeelte **Opties voor de geselecteerde reactie** het veld **Soort fiatteur** in *Werkstroomgebruikersgroep* en geef vervolgens in het veld **Werkstroomgebruikersgroep** de relevante gebruikersgroep op. Meer informatie op [Goedkeuringsgebruikers instellen](across-how-to-set-up-approval-users.md).  
...
5. Voeg op de volgende regel een nieuwe werkstroomstap toe voor de gebeurtenis *Er is een goedkeuringsaanvraag goedgekeurd.*  
    ...
    3. Kies in het veld **Op voorwaarde** het woord **Altijd** en geef dan in het veld **Wacht op goedkeuringen** *0* op. Het resultaat van deze stap is dat de voorwaarde *Wacht op goedkeuringen:0* luidt om aan te geven dat dit de laatste fiatteur is.  
...
6. Voeg op de volgende regel een tweede werkstroomstap toe voor de gebeurtenis *Er is een goedkeuringsaanvraag goedgekeurd*.  
    ...
    1. Geef in het veld **Als gebeurtenis** *Er is een goedkeuringsaanvraag goedgekeurd* op.
    2. Kies in het veld **Op voorwaarde** het woord **Altijd** en geef dan in het veld **Wacht op goedkeuringen** *>0* op. Het resultaat van deze stap is dat de voorwaarde *Wacht op goedkeuringen: >0* luidt om aan te geven dat dit *niet* de laatste fiatteur is.  

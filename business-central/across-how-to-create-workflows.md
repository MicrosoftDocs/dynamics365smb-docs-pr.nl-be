...
---
# <a name="create-workflows-to-connect-tasks-in-business-processes" />Werkstromen maken om taken in bedrijfsprocessen met elkaar te verbinden
...
## <a name="to-create-a-workflow" />Een workflow maken
...
## <a name="example-of-creating-a-new-workflow-using-existing-events" />Voorbeeld van het maken van een nieuwe werkstroom met bestaande gebeurtenissen

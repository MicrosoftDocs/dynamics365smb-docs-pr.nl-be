...
---
# <a name="design-details-central-concepts-of-the-planning-system" />Ontwerpdetails: Centrale begrippen van het planningssysteem
...
## <a name="planning-parameters" />Planningsparameters
...
## <a name="planning-starting-date" />Begindatum planning
...
## <a name="dynamic-order-tracking-pegging" />Dynamische ordertracering (tracering van de behoefte)
...
### <a name="dynamic-order-tracking-versus-the-planning-system" />Dynamische ordertracering tegenover het planningssysteem
...
## <a name="sequence-and-priority-in-planning" />Volgorde en prioriteit in planning
...
### <a name="item-priority--low-level-code" />Prioriteit/low-levelcode artikel
...
#### <a name="optimizing-performance-for-low-level-calculations" />Prestaties optimaliseren voor berekeningen op laag niveau
...
### <a name="locations--transfer-level-priority" />Prioriteit op niveau van vestigingen/transfers
...
### <a name="order-priority" />Orderprioriteit
...
## <a name="demand-forecasts-and-blanket-orders" />Vraagprognoses en raamcontracten
...
## <a name="planning-assignment" />Planningsopdracht
...
## <a name="item-dimensions" />Artikeldimensies
...
## <a name="item-attributes" />Artikelkenmerken
...
### <a name="specific-attributes" />Specifieke kenmerken
...
### <a name="non-specific-attributes" />Niet-specifieke kenmerken
...
## <a name="reservations" />Reserveringen
...
## <a name="warnings" />Waarschuwingen
...
## <a name="error-logs" />Foutlogboeken
...
## <a name="planning-flexibility" />Planningsflexibiliteit
...
## <a name="order-planning" />Orderplanning
...
## <a name="finite-loading" />Beperkte werklast

...
---
# <a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a><a name="design-details-central-concepts-of-the-planning-system"></a>Ontwerpdetails: Centrale begrippen van het planningssysteem
...
## <a name="planning-parameters"></a><a name="planning-parameters"></a><a name="planning-parameters"></a>Planningsparameters
...
## <a name="planning-starting-date"></a><a name="planning-starting-date"></a><a name="planning-starting-date"></a>Begindatum planning
...
## <a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a><a name="dynamic-order-tracking-pegging"></a>Dynamische ordertracering (tracering van de behoefte)
...
### <a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a><a name="dynamic-order-tracking-versus-the-planning-system"></a>Dynamische ordertracering tegenover het planningssysteem
...
## <a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a><a name="sequence-and-priority-in-planning"></a>Volgorde en prioriteit in planning
...
### <a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a><a name="item-priority--low-level-code"></a>Prioriteit/low-levelcode artikel
...
#### <a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a><a name="optimizing-performance-for-low-level-calculations"></a>Prestaties optimaliseren voor berekeningen op laag niveau
...
### <a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a><a name="locations--transfer-level-priority"></a>Prioriteit op niveau van vestigingen/transfers
...
### <a name="order-priority"></a><a name="order-priority"></a><a name="order-priority"></a>Orderprioriteit
...
## <a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a><a name="demand-forecasts-and-blanket-orders"></a>Vraagprognoses en raamcontracten
...
## <a name="planning-assignment"></a><a name="planning-assignment"></a><a name="planning-assignment"></a>Planningsopdracht
...
## <a name="item-dimensions"></a><a name="item-dimensions"></a><a name="item-dimensions"></a>Artikeldimensies
...
## <a name="item-attributes"></a><a name="item-attributes"></a><a name="item-attributes"></a>Artikelkenmerken
...
### <a name="specific-attributes"></a><a name="specific-attributes"></a><a name="specific-attributes"></a>Specifieke kenmerken
...
### <a name="non-specific-attributes"></a><a name="non-specific-attributes"></a><a name="non-specific-attributes"></a>Niet-specifieke kenmerken
...
## <a name="order-to-order-links"></a><a name="order-to-order-links"></a><a name="order-to-order-links"></a>Order-naar-order koppelingen
...
## <a name="reservations"></a><a name="reservations"></a><a name="reservations"></a>Reserveringen
...
## <a name="warnings"></a><a name="warnings"></a><a name="warnings"></a>Waarschuwingen
...
### <a name="emergency"></a><a name="emergency"></a><a name="emergency"></a>Noodgeval
...
### <a name="exception"></a><a name="exception"></a><a name="exception"></a>Uitzondering
...
### <a name="attention"></a><a name="attention"></a><a name="attention"></a>Opmerking
...
## <a name="error-logs"></a><a name="error-logs"></a><a name="error-logs"></a>Foutlogboeken
...
## <a name="planning-flexibility"></a><a name="planning-flexibility"></a><a name="planning-flexibility"></a>Planningsflexibiliteit
...
## <a name="order-planning"></a><a name="order-planning"></a><a name="order-planning"></a>Orderplanning
...
## <a name="finite-loading"></a><a name="finite-loading"></a><a name="finite-loading"></a>Beperkte werklast

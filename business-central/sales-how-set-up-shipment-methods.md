...
ms.author: edupont
---
# <a name="set-up-shipment-methods"></a><a name="set-up-shipment-methods"></a>Verzendmethoden instellen
...
## <a name="to-set-up-a-shipment-method"></a><a name="to-set-up-a-shipment-method"></a>Een verzendwijze instellen

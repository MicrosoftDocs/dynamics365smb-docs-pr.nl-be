...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts" />Toegankelijkheid en sneltoetsen
...
## <a name="a-namenavigationa-navigation" /><a name="Navigation"></a> Navigatie
...
## <a name="a-nameheadingsa-headings-in-content" /><a name="Headings"></a> Koppen in inhoud
...
## <a name="a-nameimagesa-image-and-links" /><a name="Images"></a> Afbeelding en koppelingen
...
## <a name="a-nameassistivetecha-assistive-technologies" /><a name="AssistiveTech"></a> Ondersteunende technologieën
...
## <a name="a-namezooma-zoom" /><a name="zoom"></a> In-/uitzoomen
...
#### <a name="accessing-tooltips" />Toegang tot knopinfo
...
## <a name="for-more-accessibility-information" />Meer informatie over toegankelijkheid

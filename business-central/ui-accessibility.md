...
## <a name="navigation" /><a name="Navigation"></a> Navigatie
...
## <a name="headings-in-content" /><a name="Headings"></a> Koppen in inhoud
...
## <a name="image-and-links" /><a name="Images"></a> Afbeelding en koppelingen
...
## <a name="assistive-technologies" /><a name="AssistiveTech"></a> Ondersteunende technologieën
...
## <a name="zoom" /><a name="zoom"></a> In-/uitzoomen

...
ms.author: jswymer
---
# <a name="accessibility-and-keyboard-shortcuts"></a><a name="accessibility-and-keyboard-shortcuts"></a>Toegankelijkheid en sneltoetsen
...
## <a name="navigation"></a><a name="navigation"></a><a name="Navigation"></a> Navigatie
...
## <a name="headings-in-content"></a><a name="headings-in-content"></a><a name="Headings"></a> Koppen in inhoud
...
## <a name="image-and-links"></a><a name="image-and-links"></a><a name="Images"></a> Afbeelding en koppelingen
...
## <a name="assistive-technologies"></a><a name="assistive-technologies"></a><a name="AssistiveTech"></a> Ondersteunende technologieën
...
## <a name="zoom"></a><a name="zoom"></a><a name="zoom"></a> In-/uitzoomen
...
## <a name="tooltips"></a><a name="tooltips"></a>Knopinfo
...
#### <a name="accessing-tooltips"></a><a name="accessing-tooltips"></a>Toegang tot knopinfo
...
## <a name="for-more-accessibility-information"></a><a name="for-more-accessibility-information"></a>Meer informatie over toegankelijkheid

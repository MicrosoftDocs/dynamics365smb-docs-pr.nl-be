...
# <a name="set-up-resource-allocation" />Resourcetoewijzing instellen
...
## <a name="to-set-up-skills" />Bekwaamheden instellen
...
## <a name="to-assign-skills-to-service-items-and-resources" />Bekwaamheden toewijzen aan serviceartikelen en resources
...
## <a name="to-set-up-zones" />Regio's instellen
...
## <a name="to-assign-zones-to-customers-and-resources" />Regio's toewijzen aan klanten en resources
...
## <a name="to-specify-what-to-show-when-a-resource-is-chosen" />Opgeven wat er moet worden weergegeven wanneer een resource is gekozen
...
## <a name="to-update-resource-capacity" />Resourcecapaciteit bijwerken
...
## <a name="to-update-skills-for-items-service-items-or-service-item-groups" />Bekwaamheden voor artikelen, serviceartikelen of serviceartikelgroepen bijwerken

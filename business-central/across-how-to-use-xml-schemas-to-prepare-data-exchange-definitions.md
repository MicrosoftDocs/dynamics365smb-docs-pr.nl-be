...
ms.author: edupont
---
# <a name="use-xml-schemas-to-prepare-data-exchange-definitions" />XML-schema's gebruiken om gegevensuitwisselingsdefinities voor te bereiden
...
## <a name="to-load-an-xml-schema-file" />Een XML-schemabestand laden
...
### <a name="to-select-or-clear-nodes-in-an-xml-schema" />Knooppunten in een XML-schema selecteren of wissen
...
### <a name="to-generate-a-data-exchange-definition-that-is-based-on-an-xml-schema" />De definitie van een gegevensuitwisseling genereren die is gebaseerd op een XML-schema

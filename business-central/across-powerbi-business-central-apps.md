...
ms.author: jswymer
---
# <a name="use-the--apps-in-power-bi"></a><a name="use-the--apps-in-power-bi"></a>De [!INCLUDE [prod_short](includes/prod_short.md)]-apps gebruiken in Power BI
...
## <a name="get-ready"></a><a name="get-ready"></a>Bereid u voor
...
## <a name="install-a--app-in-power-bi"></a><a name="install-a--app-in-power-bi"></a>Een [!INCLUDE[prod_short](includes/prod_short.md)]-app installeren in Power BI
...
## <a name="connect-the--app-to-your-data"></a><a name="connect-the--app-to-your-data"></a>De [!INCLUDE[prod_short](includes/prod_short.md)]-app verbinden met uw gegevens
...
## <a name="fixing-problems"></a><a name="fixing-problems"></a>Problemen oplossen
...
### <a name="you-dont-have-a-power-bi-account"></a><a name="you-dont-have-a-power-bi-account"></a>U hebt geen Power BI-account
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a><a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display"></a>Bericht: Er zijn geen ingeschakelde rapporten. Kies Rapport selecteren om een lijst met rapporten weer te geven die u kunt weergeven.
...
### <a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a><a name="you-need-a-power-bi-pro-license-to-install-the--app-in-power-bi"></a>U hebt een Power BI Pro-licentie nodig om de [!INCLUDE[prod_short](includes/prod_short.md)]-app in Power BI te installeren
...
### <a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a><a name="parameter-validation-failed-please-make-sure-all-parameters-are-valid"></a>"Parametervalidatie mislukt; zorg dat alle parameters geldig zijn"
...
### <a name="cant-sign-in"></a><a name="cant-sign-in"></a>Kan me niet aanmelden
...
### <a name="incorrect-company-name"></a><a name="incorrect-company-name"></a>Onjuiste bedrijfsnaam
...
### <a name="the-key-didnt-match-any-rows-in-the-table"></a><a name="the-key-didnt-match-any-rows-in-the-table"></a>De sleutel kwam met geen rijen uit de tabel overeen
...
### <a name="historical-data-appears-to-be-missing"></a><a name="historical-data-appears-to-be-missing"></a>Historische gegevens lijken te ontbreken
...
### <a name="i-only-see-data-for-a-single-company"></a><a name="i-only-see-data-for-a-single-company"></a>Ik zie alleen gegevens voor één bedrijf
...
### <a name="what-now"></a><a name="what-now"></a>Wat nu?

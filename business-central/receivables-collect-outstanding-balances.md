...
ms.author: edupont
---
# <a name="collect-outstanding-balances" />Openstaande saldi innen
...
### <a name="to-send-the-customer-statement-report" />Het rekeningoverzichten van de klant verzenden
...
## <a name="reminders" />Aanmaningen

[!INCLUDE [receivables-reminders](includes/receivables-reminders.md)]

## <a name="finance-charges" />Financiële kosten
...
### <a name="to-create-a-finance-charge-memo-manually" />Handmatig rentefacturen maken
...
### <a name="to-update-finance-charge-memo-texts" />De rentefactuurteksten bijwerken
...
### <a name="to-issue-finance-charge-memos" />Rentefacturen verzenden
...
### <a name="to-cancel-an-issued-finance-charge-memo" />Een verzonden rentefactuur annuleren
...
### <a name="to-view-reminder-and-finance-charge-entries" />Aanmanings- en renteposten weergeven
...
## <a name="multiple-interest-rates" />Meerdere rentepercentages
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/paths/process-financial-periodic-activities-dynamics-365-business-central/)

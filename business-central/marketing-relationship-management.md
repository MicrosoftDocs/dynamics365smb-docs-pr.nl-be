...
|Definieer de externe entiteiten waarmee u zakenrelaties onderhoudt. Bijvoorbeeld klanten, potentiële klanten, leveranciers, advocaten en consultants, hetzij als persoonstype of als bedrijfstype.|[Contactpersonen beheren](marketing-contacts.md)|
...
|Gebruik Dynamics 365 Sales voor klantbetrokkenheid en geniet van naadloze integratie in het lead-to-cash-proces. Gebruik [!INCLUDE [prod_short](includes/prod_short.md)] voor backend-activiteiten zoals het verwerken van bestellingen, het beheren van de voorraad en het regelen van uw financiën.|[Integreren met Dynamics 365 Sales](marketing-integrate-dynamicscrm.md)|

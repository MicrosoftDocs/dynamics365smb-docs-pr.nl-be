...
---
# <a name="transfer-inventory-between-locations" />Voorraad overbrengen tussen vestigingen
...
## <a name="transfer-orders" />Transferorders
...
## <a name="item-reclassification-journals" />Artikelherindelingsdagboeken
...
## <a name="to-transfer-items-with-a-transfer-order" />Artikelen overbrengen met een transferorder
...
### <a name="post-multiple-transfer-orders-in-a-batch" />Meerdere overboekingsopdrachten in een batch boeken
...
### <a name="schedule-a-job-queue-entry-to-post-multiple-documents-in-a-batch" />Plan een taakwachtrijpost om meerdere documenten in een batch te boeken
...
## <a name="to-transfer-items-with-the-item-reclassification-journal" />Artikelen overbrengen met het artikelherindelingsdagboek
...
## <a name="undo-a-transfer-shipment" />Een transferverzending ongedaan maken

...
ms.author: edupont
---
# <a name="design-details-searching-for-dimension-combinations" />Ontwerpdetails: Dimensiecombinaties zoeken
...
### <a name="finding-dimension-set-id" />Dimensieset-id zoeken

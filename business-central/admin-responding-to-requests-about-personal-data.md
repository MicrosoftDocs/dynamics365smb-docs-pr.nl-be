...
# <a name="responding-to-requests-about-users-personal-data" />Reageren op aanvragen over persoonlijke gegevens van gebruikers
...
## <a name="types-of-requests" />Soorten aanvragen
...
## <a name="restrict-data-processing-for-a-data-subject" />Gegevensverwerking voor een betrokkene beperken
...
## <a name="handling-data-subject-requests-when-using-a-trial-version" />Afhandelen van verzoeken van betrokkenen bij gebruik van een proefversie
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject" />Gegevens uit tabellen exporteren die niet zijn geclassificeerd op betrokkene
...
## <a name="handling-data-about-minors" />Gegevens over minderjarigen verwerken

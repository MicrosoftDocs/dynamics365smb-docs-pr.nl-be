...
# <a name="responding-to-requests-about-users-personal-data"></a><a name="responding-to-requests-about-users-personal-data"></a>Reageren op aanvragen over persoonlijke gegevens van gebruikers
...
## <a name="types-of-requests"></a><a name="types-of-requests"></a>Soorten aanvragen
...
## <a name="restrict-data-processing-for-a-data-subject"></a><a name="restrict-data-processing-for-a-data-subject"></a>Gegevensverwerking voor een betrokkene beperken
...
## <a name="handling-data-subject-requests-when-using-a-trial-version"></a><a name="handling-data-subject-requests-when-using-a-trial-version"></a>Afhandelen van verzoeken van betrokkenen bij gebruik van een proefversie
...
## <a name="exporting-data-from-tables-not-classified-by-data-subject"></a><a name="exporting-data-from-tables-not-classified-by-data-subject"></a>Gegevens uit tabellen exporteren die niet zijn geclassificeerd op betrokkene
...
## <a name="handling-data-about-minors"></a><a name="handling-data-about-minors"></a>Gegevens over minderjarigen verwerken

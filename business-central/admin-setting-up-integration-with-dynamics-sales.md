...
ms.author: bholtorf
---
# <a name="setting-up-user-accounts-for-integrating-with-microsoft-dataverse" />Gebruikersaccounts instellen voor integratie met Microsoft Dataverse
...
## <a name="set-up-the-administrator-user-account" />Het beheerdersaccount instellen
...
## <a name="permissions-and-security-roles-for-user-accounts-in-includeprodshortincludescdslongmdmd" />Machtigingen en beveiligingsrollen voor gebruikersaccounts in [!INCLUDE[prod_short](includes/cds_long_md.md)]

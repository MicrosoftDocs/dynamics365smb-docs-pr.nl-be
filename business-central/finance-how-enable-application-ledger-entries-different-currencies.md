...
ms.author: edupont
---
# <a name="enable-application-of-ledger-entries-in-different-currencies" />Vereffening van posten in verschillende valuta's inschakelen
...
## <a name="to-enable-application-of-vendor-ledger-entries-in-different-currencies" />Vereffening van leveranciersposten in verschillende valuta's inschakelen
...
## <a name="to-set-up-gl-accounts-for-currency-application-rounding-differences" />Grootboekrekeningen voor afrondingsverschillen bij valutaberekeningen instellen
...
## <a name="see-related-microsoft-trainingtrainingmodulesprocess-foreign-currency-payments-dynamics-365-business-central" />Zie gerelateerde [Microsoft-training](/training/modules/process-foreign-currency-payments-dynamics-365-business-central/)

...
ms.author: bholtorf
---
# <a name="integrating-with-dynamics-365-sales" />Integreren met Dynamics 365 Sales
...
## <a name="integrating-through-dataverse" />Integreren via Dataverse
...
### <a name="connection-settings-in-the-setup-guide" />Verbindingsinstellingen in de installatiehandleiding
...
### <a name="connection-settings-on-the-microsoft-dynamics-365-connection-setup-page" />Verbindingsinstellingen op de pagina Microsoft Dynamics 365-verbinding instellen
...
### <a name="standard-sales-entity-mapping-for-synchronization" />Standaardtoewijzing van Sales-entiteit voor synchronisatie
...
## <a name="synchronizing-items-and-resources-with-products-with-different-units-of-measure" />Artikelen en resources synchroniseren met producten met verschillende eenheden
...
### <a name="mapping-items-and-resources-to-products" />Artikelen en resources toewijzen aan producten
...
### <a name="synchronization-rules" />Synchronisatieregels
...
### <a name="synchronization-jobs-for-a-sales-integration" />Synchronisatietaken voor een Sales-integratie
...
### <a name="default-synchronization-job-queue-entries" />Standaardsynchronisatieposten in de taakwachtrij
...
## <a name="connecting-to-on-premises-versions-of-business-central-2019-release-wave-1-and-microsoft-dynamics-nav-2018" />Verbinding maken met on-premises versies van Business Central 2019 releasewave 1 en Microsoft Dynamics NAV 2018
...
### <a name="to-connect-business-central-2019-release-wave-1-and-dynamics-nav-2018" />Verbinding maken met Business Central 2019 releasewave 1 en Dynamics NAV 2018

...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a><a name="set-up-fixed-asset-maintenance"></a>Onderhoud van vaste activa instellen
...
## <a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a><a name="to-set-up-general-maintenance-information"></a>Algemene onderhoudsgegevens instellen
...
## <a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a><a name="to-set-up-maintenance-codes"></a>Onderhoudscodes instellen
...
## <a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a><a name="to-set-up-maintenance-expense-accounts"></a>Onderhoudskostenrekeningen instellen

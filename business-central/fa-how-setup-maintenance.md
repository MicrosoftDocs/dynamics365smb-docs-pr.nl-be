...
ms.author: edupont
---
# <a name="set-up-fixed-asset-maintenance" />Onderhoud van vaste activa instellen
...
## <a name="to-set-up-general-maintenance-information" />Algemene onderhoudsgegevens instellen
...
## <a name="to-set-up-maintenance-codes" />Onderhoudscodes instellen
...
## <a name="to-set-up-maintenance-expense-accounts" />Onderhoudskostenrekeningen instellen

...
# <a name="manage-work-across-multiple-companies-in-the-company-hub" />Werk beheren tussen meerdere bedrijven in de bedrijfshub
...
## <a name="company-hub-home-page" />Startpagina van de bedrijfshub
...
## <a name="assigned-tasks" />Toegewezen taken
...
### <a name="my-user-tasks" />Mijn gebruikerstaken
...
## <a name="access-the-company-hub" />Toegang tot de bedrijfshub
...
## <a name="set-up-the-company-hub" />De bedrijfshub instellen

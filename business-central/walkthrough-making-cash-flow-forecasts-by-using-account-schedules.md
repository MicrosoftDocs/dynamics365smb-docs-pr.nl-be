...
---
# Overzicht: Cashflowprognoses maken met behulp van financiële rapporten
...
2. Voer op de pagina **Rijdefinitie** elke regel in zoals deze in de volgende tabel wordt weergegeven.  
    ...
    | Rubriek | Beschrijving              | Samentellingssoort            | Samentelling | Rijsoort   | Bedragtype | Weergeven |
    |---------|--------------------------|--------------------------|----------|------------|-------------|------|
    | B10     | Tegoeden              | Cashflowpostrekeningen | 10       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Open verkooporders        | Cashflowpostrekeningen | 2.0       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Verhuur                  | Cashflowpostrekeningen | 30       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Financiële activa         | Cashflowpostrekeningen | 40       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Buitengebruikstelling vaste activa    | Cashflowpostrekeningen | 50       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Privé-investeringen      | Cashflowpostrekeningen | 60       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Diverse ontvangsten   | Cashflowpostrekeningen | 70       |Mutatie | Nettobedrag  | Ja  |
    | B10     | Open serviceorders      | Cashflowpostrekeningen | 80       |Mutatie | Nettobedrag  | Ja  |
...
4. Voer elke regel in zoals in de volgende tabel wordt weergegeven.
    ...
    |Kolomnr.|Kolomkop|Kolomtype|Postsoort|Bedragtype|Weergeven|  
    |----------|-------------|-----------|-----------------|-----------|----|
...
## De kolomdefinitie toewijzen aan de naam van het financiële rapport

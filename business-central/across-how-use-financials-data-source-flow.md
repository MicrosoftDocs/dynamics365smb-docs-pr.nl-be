...
---
# <a name="use-power-automate-flows-in-" />Power Automate-stromen gebruiken in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/use-power-automate/)

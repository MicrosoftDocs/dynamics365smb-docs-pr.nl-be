...
---
# <a name="use-power-automate-flows-in-includeprodshortincludesprodshortmd" />Power Automate-stromen gebruiken in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="about-power-automate-flows" />Over Power Automate-stromen
...
## <a name="power-automate-features" />Power Automate-functies
...
## <a name="run-instant-flows" />Directe stromen uitvoeren
...
## <a name="create-edit-and-manage-flows" />Stromen bewerken, maken en beheren
...
## <a name="see-related-microsoft-trainingtrainingmodulesuse-power-automate" />Zie gerelateerde [Microsoft-training](/training/modules/use-power-automate/)

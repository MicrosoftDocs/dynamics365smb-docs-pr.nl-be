...
ms.author: edupont
---
# <a name="process-sales-return-orders" />Verkoopretourorders verwerken
...
## <a name="create-a-sales-return-order-based-on-one-or-more-posted-sales-documents" />Een verkoopretourorder maken op basis van een of meer geboekte verkoopdocumenten
...
## <a name="to-create-a-replacement-sales-order-from-a-sales-return-order" />Een vervangingsverkooporder maken vanuit de verkoopretourorder
...
## <a name="to-create-return-related-documents-from-a-sales-return-order" />Retourgerelateerde documenten maken uit een verkoopretourorder
...
## <a name="to-create-a-restock-charge" />Een toeslag opnieuw bevoorraden maken

...
ms.author: bholtorf
---
# Procedure: Ontvangen en opslaan in geavanceerde magazijnconfiguraties
...
6.  Voer W-02-0001 in het veld **Opslaglocatie** in. Het veld **Zonecode** wordt automatisch ingevuld.  
    ...
    Standaard is het veld **Zone** op de verkoopregels verborgen, dus u moet het weergeven. Hiervoor moet u de pagina personaliseren. Zie voor meer informatie [Een pagina personaliseren via de banner Personaliseren](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode).

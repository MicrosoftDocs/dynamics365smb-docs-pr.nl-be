...
ms.author: edupont
---
# <a name="walkthrough-receiving-and-putting-away-in-advanced-warehouse-configurations" />Procedure: Ontvangen en opslaan in geavanceerde magazijnconfiguraties
...
## <a name="reviewing-the-white-location-setup" />Instellingen van de vestiging WIT controleren

De instellingen van de pagina **Vestiging** definiëren de magazijnstromen van het bedrijf.  

### <a name="to-review-the-location-setup" />De vestigingsinstellingen controleren
...
## <a name="creating-the-purchase-orders" />De inkooporders maken

Inkooporders zijn de meest gebruikte soort inkomend brondocument.  

### <a name="to-create-the-purchase-orders" />De inkooporders maken
...
## <a name="putting-the-items-away" />Artikelen opslaan
...
### <a name="to-put-the-items-away" />De artikelen opslaan

...
ms.author: edupont
---
# <a name="create-a-demand-forecast" />Een vraagprognose maken
...
## <a name="sales-forecasts-and-production-forecasts" />Verkoopprognoses en productieprognoses
...
## <a name="component-forecast" />Materiaalprognose
...
## <a name="forecasting-periods" />Prognoseperioden
...
## <a name="forecast-by-locations" />Prognose per locatie
...
### <a name="use-forecast-by-locations" />Prognose per vestiging gebruiken
...
### <a name="do-not-use-forecast-by-locations" />Gebruik prognose per vestiging niet
...
## <a name="to-create-a-demand-forecast" />Een vraagprognose maken

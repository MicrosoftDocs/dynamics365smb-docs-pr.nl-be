...
ms.author: edupont
---
# <a name="set-up-service-items-and-service-item-components" />Serviceartikelen en serviceartikelonderdelen instellen
Als u met serviceartikelen wilt werken, moet u het volgende instellen

* Serviceartikelgroepen.
* Optioneel

## <a name="to-set-up-service-item-groups" />Serviceartikelgroepen instellen
...
## <a name="to-set-up-service-item-components" />Serviceartikelcomponenten instellen
...
## <a name="to-set-up-service-item-components-from-a-bom" />Serviceartikelcomponenten instellen uit stuklijsten
1.  Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Serviceartikelen** in en kies vervolgens de gerelateerde koppeling  
...
## <a name="to-set-up-a-service-shelf" />Serviceschappen instellen

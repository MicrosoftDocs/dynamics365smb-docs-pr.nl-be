...
ms.author: edupont
---
# <a name="create-service-items" />Serviceartikelen maken
...
## <a name="to-create-a-service-item" />Een serviceartikel maken
...
## <a name="to-create-service-items-within-a-service-order" />Serviceartikelen maken in serviceorders
...
## <a name="to-create-a-service-item-when-shipping-items" />Serviceartikelen maken tijdens het verzenden van artikelen
...
## <a name="to-insert-a-starting-fee-for-a-service-item" />Starttarieven invoegen voor serviceartikelen

...
---
# <a name="teams-faq"></a><a name="teams-faq"></a>Veelgestelde vragen over Teams
...
### <a name="how-do-i-sign-in-to-the--app-in-teams"></a><a name="how-do-i-sign-in-to-the--app-in-teams"></a>Hoe log ik in bij de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app in Teams?
...
### <a name="how-do-i-sign-out-of-the--app-in-teams"></a><a name="how-do-i-sign-out-of-the--app-in-teams"></a>Hoe log ik uit bij de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app in Teams?
...
### <a name="does-the-app-for-teams-connect-to--on-premises"></a><a name="does-the-app-for-teams-connect-to--on-premises"></a>Maakt de app voor Teams verbinding met [!INCLUDE [prod_short.md](includes/prod_short.md)] on premises?
...
### <a name="does-the-app-work-with-multiple-companies-and-environments"></a><a name="does-the-app-work-with-multiple-companies-and-environments"></a>Werkt de app met meerdere bedrijven en omgevingen?
...
### <a name="in-which-countries-or-regions-is-the--app-available"></a><a name="in-which-countries-or-regions-is-the--app-available"></a>In welke landen of regio's is de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app beschikbaar?
...
### <a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a><a name="does-the--app-work-with-any-localization-of-include-prod_shortmd"></a>Werkt de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app met elke lokalisatie van [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="which-languages-does-the--app-support"></a><a name="which-languages-does-the--app-support"></a><a name="language"></a>Welke talen ondersteunt de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app?
...
### <a name="does-the--app-work-with-industry-solutions"></a><a name="does-the--app-work-with-industry-solutions"></a>Werkt de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app met brancheoplossingen?
...
### <a name="does--work-with-the-teams-mobile-app"></a><a name="does--work-with-the-teams-mobile-app"></a>Werkt [!INCLUDE [prod_short.md](includes/prod_short.md)] met de mobiele Teams-app?
...
### <a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a><a name="is-the--app-for-teams-the-same-as-the-include-prod_shortmd-app-for-ios-and-android"></a>Is de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams hetzelfde als de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor iOS en Android?
...
### <a name="does-the--app-work-in-all-teams-clients"></a><a name="does-the--app-work-in-all-teams-clients"></a>Werkt de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app in alle Teams-clients?
...
### <a name="which-teams-client-is-best-for-"></a><a name="which-teams-client-is-best-for-"></a>Welke Teams-client is het beste voor [!INCLUDE [prod_short.md](includes/prod_short.md)]?
...
### <a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a><a name="what-is-the-best-way-for-me-to-demonstrate--and-microsoft-teams-to-prospective-customers"></a>Wat is voor mij de beste manier om [!INCLUDE [prod_short.md](includes/prod_short.md)] en Microsoft Teams te demonstreren aan potentiële klanten?
...
### <a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a><a name="does-the--app-for-teams-cater-to-my-customization-and-personalization"></a>Voorziet de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams in aanpassing en personalisatie?
...
### <a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a><a name="how-do-the-permissions-required-by-the-app-affect-my-privacy"></a>Hoe beïnvloeden de machtigingen die vereist zijn door de app mijn privacy?
...
### <a name="where-can-i-learn-about-my-privacy"></a><a name="where-can-i-learn-about-my-privacy"></a>Waar kan ik meer te weten komen over mijn privacy?
...
### <a name="how-do-i-uninstall-the--app-for-teams"></a><a name="how-do-i-uninstall-the--app-for-teams"></a>Hoe verwijder ik de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams?
...
### <a name="will-microsoft-continue-to-improve-the--app-for-teams"></a><a name="will-microsoft-continue-to-improve-the--app-for-teams"></a>Zal Microsoft de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams blijven verbeteren?
...
### <a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a><a name="where-can-i-find-teams-integration-inside-the-business-central-web-client"></a>Waar kan ik Teams-integratie vinden in de Business Central-webclient?
...
### <a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-see-the-content-of-a-tab"></a><a name="who-can-view"></a>Wie kan de inhoud van een tabblad zien?
...
### <a name="where-does-the-recommended-content-come-from"></a><a name="where-does-the-recommended-content-come-from"></a><a name=#recommended-content></a>Waar komt de aanbevolen inhoud vandaan?
...
### <a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a><a name="when-i-create-a-tab-does-it-grant-permissions-to-the-people-in-the-channel-or-chat"></a>Als ik een tabblad maak, verleent dit dan machtigingen aan de mensen in het kanaal of de chat?
...
### <a name="can-i-chat-alongside-a-tab"></a><a name="can-i-chat-alongside-a-tab"></a>Kan ik naast een tabblad chatten?

Ja. Gebruik het chatpictogram om het gesprek te starten. Dit chatgesprek wordt dan gekoppeld aan het tabblad. 

### <a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a><a name="if-i-remove-a-tab-from-a-chat-or-channel-is-any-business-central-data-deleted"></a>Als ik een tabblad uit een chat of kanaal verwijder, worden er dan Business Central-gegevens verwijderd?

Nee

### <a name="can-i-safely-rename-a-tab"></a><a name="can-i-safely-rename-a-tab"></a>Kan ik de naam van een tabblad veilig wijzigen?

Ja. De inhoud van het tabblad staat los van de werkelijke naam van het tabblad. Wijzig de naam wanneer u maar wilt! 

### <a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a><a name="i-need-to-work-across-tasks-in-different-windows-can-i-do-this"></a>Ik moet verschillende taken in verschillende vensters uitvoeren. Kan dat?

Ja. U kunt het tabblad uitklappen naar een eigen browservenster om de Business Central-webclient weer te geven. 

### <a name="can-i-add-or-pin-tab-in-team-meetings"></a><a name="can-i-add-or-pin-tab-in-team-meetings"></a>Kan ik een tabblad toevoegen of vastzetten in Teams-vergaderingen?

Nee De Business Central-app voor Teams ondersteunt geen tabbladen in vergaderingen.

### <a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a><a name="cant-add-a-tab-if-using-isv-urls-like-bcdynamicscom-but-can-pin"></a>Kan geen tabblad toevoegen bij gebruik van ISV-URL's, zoals *.bc.dynamics.com (maar kan wel vastzetten)
...
### <a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a><a name="does-the-tab-content-refresh-automatically-if-not-how-do-i-refresh-it"></a>Wordt de inhoud van het tabblad automatisch vernieuwd? Zo niet, hoe vernieuw ik het dan?
...
### <a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a><a name="does-this-show-lists-and-records-from-my-customizations-and-add-ons"></a>Worden lijsten en records van mijn aanpassingen en add-ons weergegeven?

Ja. 

### <a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a><a name="when-i-add-a-tab-will-people-see-it-in-my-language"></a>Als ik een tabblad toevoeg, zien mensen dit dan in mijn taal?

Nee Elke gebruiker bekijkt de tabbladinhoud in de taal-, regio- en tijdzone-instellingen van Business Central. 

### <a name="can-i-have-multiple-tabs-pointing-to-different-content"></a><a name="can-i-have-multiple-tabs-pointing-to-different-content"></a>Kan ik meerdere tabbladen naar verschillende inhoud laten verwijzen?

Ja.

### <a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a><a name="can-i-also-add-tabs-to-chat-with-a-single-person"></a>Kan ik ook tabbladen toevoegen om met één persoon te chatten?
...
### <a name="can-i-switch-companies-within-a-tab"></a><a name="can-i-switch-companies-within-a-tab"></a>Kan ik binnen een tabblad van bedrijf wisselen?

Nee 

### <a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a><a name="is-this-different-than-using-teams-generic-ability-to-create-a-tab-that-hosts-a-website"></a>Is dit anders dan het gebruik van de algemene mogelijkheid van Teams om een tabblad te maken waarop een website wordt gehost?
...
### <a name="which-tables-does-the-app-search-in"></a><a name="which-tables-does-the-app-search-in"></a>In welke tabellen zoekt de app?
...
### <a name="which-fields-in-the-contacts-table-can-i-search"></a><a name="which-fields-in-the-contacts-table-can-i-search"></a>Welke velden in de contactentabel kan ik zoeken?
...
### <a name="do-search-results-include-companies-and-persons"></a><a name="do-search-results-include-companies-and-persons"></a>Bevatten zoekresultaten bedrijven en personen?
...
### <a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a><a name="do-contacts-of-any-business-relationship-appear-in-the-results"></a>Komen contacten van een zakelijke relatie in de resultaten voor?
...
### <a name="can-i-look-up-contact-details-during-meetings"></a><a name="can-i-look-up-contact-details-during-meetings"></a>Kan ik tijdens vergaderingen contactgegevens opzoeken?
...
### <a name="how-do-i-view-my-last-interactions-with-a-contact"></a><a name="how-do-i-view-my-last-interactions-with-a-contact"></a>Hoe bekijk ik mijn laatste interacties met een contact?
...
### <a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a><a name="how-do-i-register-a-teams-call-or-meeting-as-an-interaction"></a>Hoe registreer ik een Teams-gesprek of -vergadering als een interactie?
...
### <a name="can-i-call-a-contact-from-the--app-for-teams"></a><a name="can-i-call-a-contact-from-the--app-for-teams"></a>Kan ik een contactpersoon bellen vanuit de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams?
...
### <a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a><a name="how-do-i-view-recent-documents-for-a-customer-or-vendor"></a>Hoe bekijk ik recente documenten voor een klant of leverancier?
...
### <a name="how-do-i-search-for-contacts-using-special-characters"></a><a name="how-do-i-search-for-contacts-using-special-characters"></a>Hoe zoek ik contacten met speciale tekens?
...
### <a name="how-can-i-search-contacts-stored-in-a-different-company"></a><a name="how-can-i-search-contacts-stored-in-a-different-company"></a>Hoe kan ik zoeken naar contacten die in een ander bedrijf zijn opgeslagen?
...
### <a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a><a name="are--contacts-different-than-the-ones-in-the-teams-contacts-screen"></a>Zijn [!INCLUDE [prod_short.md](includes/prod_short.md)]-contacten anders dan de contacten in het Teams-contactenscherm?
...
### <a name="does--synchronize-contacts-with-teams"></a><a name="does--synchronize-contacts-with-teams"></a>Synchroniseert [!INCLUDE [prod_short.md](includes/prod_short.md)] contacten met Teams?
...
### <a name="what-is-the-minimum-version-of--for-contact-search"></a><a name="what-is-the-minimum-version-of--for-contact-search"></a>Wat is de minimumversie van [!INCLUDE [prod_short.md](includes/prod_short.md)] voor contacten zoeken?
...
### <a name="can-i-search-from-my-mobile-device"></a><a name="can-i-search-from-my-mobile-device"></a>Kan ik zoeken vanaf mijn mobiele apparaat?

Zoeken naar contacten is momenteel niet beschikbaar vanuit Teams voor iOS en Teams voor Android.

### <a name="which-permissions-do-i-need-for-contact-search"></a><a name="which-permissions-do-i-need-for-contact-search"></a>Welke machtigingen heb ik nodig om contacten te zoeken?
...
### <a name="can-i-use-contact-search-if-im-a-delegated-admin"></a><a name="can-i-use-contact-search-if-im-a-delegated-admin"></a>Kan ik contacten zoeken gebruiken als ik een gedelegeerde beheerder ben?

Ja. U kunt ook contacten en contactgegevens opzoeken als u een gedelegeerde beheerdersrol heeft in een organisatie.

### <a name="is-contact-search-affected-by-api-limits"></a><a name="is-contact-search-affected-by-api-limits"></a>Wordt het zoeken naar contacten beïnvloed door API-limieten?
...
### <a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a><a name="why-does-it-sometimes-ask-me-to-set-up-the-app"></a>Waarom word ik soms gevraagd om de app in te stellen?
...
### <a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a><a name="id-like-to-search-for-items-or-records-from-other-tables-can-i-do-this-from-teams"></a>Ik zou graag willen zoeken naar items of records uit andere tabellen. Kan ik dit vanuit Teams doen?
...
### <a name="which-types-of-links-does-the-app-support"></a><a name="which-types-of-links-does-the-app-support"></a>Welke soorten koppelingen ondersteunt de app?
...
### <a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a><a name="how-do-i-delete-a-card-i-sent-to-a-chat"></a>Hoe verwijder ik een kaart die ik naar een chat heb gestuurd?
...
### <a name="do-cards-always-show-up-to-date-information"></a><a name="do-cards-always-show-up-to-date-information"></a>Bevatten kaarten altijd up-to-date informatie?
...
### <a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a><a name="why-dont-cards-show-more-information-instead-of-just-the-page-name-and-details-button"></a>Waarom tonen kaarten niet meer informatie dan de paginanaam en de detailknop?
...
### <a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a><a name="will-others-see-my-card-if-they-dont-have-the--app-for-teams"></a>Zullen anderen mijn kaart zien als ze de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app voor Teams niet hebben?
...
### <a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a><a name="how-do-i-find-out-which-company-a-card-in-teams-belongs-to"></a>Hoe kom ik erachter tot welk bedrijf een kaart in Teams behoort?
...
### <a name="where-is-the-save-button-in-the-details-window-in-teams"></a><a name="where-is-the-save-button-in-the-details-window-in-teams"></a>Waar is de knop Opslaan in het detailvenster in Teams?
...
### <a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a><a name="if-i-choose-to-view-details-for-a-card-will-other-users-see-my-details-window"></a>Als ik ervoor kies om details van een kaart te bekijken, zien andere gebruikers dan mijn detailvenster?
...
### <a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a><a name="can-i-start-a-teams-call-from-the-details-window-in-teams"></a>Kan ik een Teams-gesprek starten vanuit het detailvenster in Teams?
...
### <a name="can-i-print-documents-from-the-details-window-in-teams"></a><a name="can-i-print-documents-from-the-details-window-in-teams"></a>Kan ik documenten afdrukken vanuit het detailvenster in Teams?
...
### <a name="can-i-access-the-camera-from-the-details-window-in-teams"></a><a name="can-i-access-the-camera-from-the-details-window-in-teams"></a>Heb ik toegang tot de camera vanuit het detailvenster in Teams?
...
### <a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="can-i-access-my-location-from-the-details-window-in-teams"></a><a name="location"></a>Heb ik toegang tot mijn locatie vanuit het detailvenster in Teams?
...
### <a name="how-do-i-open-the-details-in-a-new-window"></a><a name="how-do-i-open-the-details-in-a-new-window"></a>Hoe open ik de details in een nieuw venster?
...
### <a name="can-i-share-cards-with-users-outside-my-organization"></a><a name="can-i-share-cards-with-users-outside-my-organization"></a>Kan ik kaarten delen met gebruikers buiten mijn organisatie?
...
### <a name="is-the-experience-any-different-for-users-that-are-guests"></a><a name="is-the-experience-any-different-for-users-that-are-guests"></a>Is de ervaring anders voor gebruikers die gasten zijn?
...
### <a name="how-does-a-guest-user-install-the--app"></a><a name="how-does-a-guest-user-install-the--app"></a>Hoe installeert een gastgebruiker de [!INCLUDE [prod_short.md](includes/prod_short.md)]-app?
...
### <a name="does-share-to-teams-send-a-compact-card"></a><a name="does-share-to-teams-send-a-compact-card"></a>Verstuurt Delen met Teams een compacte kaart?

Ja. De link wordt automatisch uitgevouwen tot een kaart als u de Business Central-app voor Teams hebt geïnstalleerd. 

### <a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a><a name="will-recipients-receive-the-message-from-me-or-from-a-business-central-service-account"></a>Ontvangen ontvangers het bericht van mij of van een Business Central-serviceaccount?
...
### <a name="is-share-to-teams-available-in-business-central-on-premises"></a><a name="is-share-to-teams-available-in-business-central-on-premises"></a>Is Delen met Teams beschikbaar in Business Central on premises?
...
### <a name="does-share-to-teams-grant-permissions-to-recipients"></a><a name="does-share-to-teams-grant-permissions-to-recipients"></a>Verleent Delen met Teams machtigingen aan ontvangers?
...
### <a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a><a name="must-i-have-the-teams-desktop-app-installed-to-use-share-to-teams"></a>Moet ik de Teams desktop-app hebben geïnstalleerd om Delen met Teams te kunnen gebruiken?

Nee. Het enige wat u nodig hebt, is een geldig account dat toegang heeft tot Microsoft Teams. 

### <a name="is-share-to-teams-available-in-all-business-central-clients"></a><a name="is-share-to-teams-available-in-all-business-central-clients"></a>Is Delen met Teams beschikbaar in alle Business Central-clients?
...
### <a name="where-do-i-find-share-to-teams-in-business-central"></a><a name="where-do-i-find-share-to-teams-in-business-central"></a>Waar vind ik Delen met teams in Business Central?

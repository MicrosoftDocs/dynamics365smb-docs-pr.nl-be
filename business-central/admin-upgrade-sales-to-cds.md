...
ms.author: bholtorf
---
# <a name="upgrading-an-integration-with-dynamics-365-sales" />Een integratie met Dynamics 365 Sales upgraden
...
## <a name="to-upgrade-your-connection-to-use-dataverse" />Uw verbinding upgraden om Dataverse te gebruiken

...
ms.author: bholtorf
---
# <a name="set-up-items-and-locations-for-directed-put-away-and-pick" />Artikelen en locaties instellen voor gestuurde opslag en pick
...
## <a name="to-set-up-an-item-for-directed-put-away-and-pick" />U kunt als volgt een artikelen instellen voor gestuurde opslag en pick
...
## <a name="to-start-using-directed-put-away-and-pick" />Aan de slag gaan met gestuurde opslag en pick
...
## <a name="to-set-up-a-zone-in-your-warehouse" />U kunt als volgt een zone instellen in het magazijn

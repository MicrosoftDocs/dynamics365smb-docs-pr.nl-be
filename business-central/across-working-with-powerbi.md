...
ms.author: jswymer
---
# <a name="work-with-power-bi-reports-in-"></a><a name="work-with-power-bi-reports-in-"></a>Werken met Power BI-rapporten in [!INCLUDE [prod_short](includes/prod_short.md)]
...
### <a name="sign-up-power-bi"></a><a name="sign-up-power-bi"></a>Power BI aanmelden
...
## <a name="connect-to-power-bi---one-time-only"></a><a name="connect-to-power-bi---one-time-only"></a><a name="connect"></a>Verbinding maken met Power BI - eenmalig
...
#### <a name="from--on-premises"></a><a name="from--on-premises"></a>Vanuit [!INCLUDE [prod_short](includes/prod_short.md)] on-premises
...
## <a name="work-with-power-bi-reports"></a><a name="work-with-power-bi-reports"></a>Werken met Power BI-rapporten

### <a name="show-reports-on-list-pages"></a><a name="show-reports-on-list-pages"></a>Rapporten weergeven op lijstpagina's
...
### <a name="switch-reports"></a><a name="switch-reports"></a>Schakelen tussen rapporten
...
### <a name="get-more-reports"></a><a name="get-more-reports"></a>Meer rapporten krijgen
...
### <a name="manage-and-modify-reports"></a><a name="manage-and-modify-reports"></a>Rapporten beheren en wijzigen
...
### <a name="upload-reports"></a><a name="upload-reports"></a><a name="upload"></a>Rapporten uploaden
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a><a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page"></a>U kunt geen rapport zien op de pagina Rapport selecteren op een lijstpagina

...
### <a name="sign-up-power-bi" />Power BI aanmelden
...
## <a name="work-with-power-bi-reports" />Werken met Power BI-rapporten

### <a name="show-reports-on-list-pages" />Rapporten weergeven op lijstpagina's
...
### <a name="switch-reports" />Schakelen tussen rapporten
...
### <a name="get-more-reports" />Meer rapporten krijgen
...
### <a name="manage-and-modify-reports" />Rapporten beheren en wijzigen
...
### <a name="message-there-are-no-enabled-reports-choose-select-report-to-see-a-list-of-reports-that-you-can-display" />Bericht: Er zijn geen ingeschakelde rapporten. Kies Rapport selecteren om een lijst met rapporten te tonen die u kunt weergeven.
...
#### <a name="you-cant-see-a-report-on-the-select-report-page-on-a-list-page" />U kunt geen rapport zien op de pagina Rapport selecteren op een lijstpagina

...
ms.author: bholtorf
---
# <a name="set-up-a-loaner-program"></a><a name="set-up-a-loaner-program"></a>Uitleenprogramma instellen
...
## <a name="to-set-up-a-loaner"></a><a name="to-set-up-a-loaner"></a>Een uitleenartikel instellen

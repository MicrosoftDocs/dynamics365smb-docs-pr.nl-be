...
ms.author: edupont
---
# <a name="set-up-put-away-templates" />Opslagsjablonen instellen
...
## <a name="to-set-up-put-away-templates" />U kunt als volgt opslagsjablonen instellen
...
## <a name="see-related-microsoft-trainingtrainingmodulesput-away-templates" />Zie gerelateerde [Microsoft-training](/training/modules/put-away-templates/)

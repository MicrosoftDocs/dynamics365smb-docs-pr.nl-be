...
# <a name="scheduling-a-synchronization-between-business-central-and-dataverse" />Een synchronisatie plannen tussen Business Central en Dataverse
...
## <a name="synchronization-process" />Synchronisatieproces
...
## <a name="about-inactivity-timeouts" />Over inactiviteittime-outs
...
## <a name="to-view-the-synchronization-job-log" />Logboek met synchronisatietaken weergeven
...
## <a name="to-view-the-synchronization-job-log-from-the-table-mappings" />Het logboek van de synchronisatietaak weergeven vanuit tabeltoewijzingen
...
## <a name="to-view-the-synchronization-error-log" />Logboek met synchronisatiefouten weergeven

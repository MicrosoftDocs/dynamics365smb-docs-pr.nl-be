---
title: Klanten en bedrijven synchroniseren
...
* Als een land/regio is geselecteerd op de klantenkaart, zorg dan dat de **ISO-code** is opgegeven. Voor lokale klanten, met een blanco land/regio, gebruikt de Shopify-connector het land/de regio die is opgegeven op de pagina **Bedrijfsgegevens**.
...
|Prioriteit|Veld op klantenkaart|Beschrijving|
|------|------|-----------|
|0|**Contactnaam**|Hoogste prioriteit, als het veld **Contactnaam** is ingevuld en het veld **Contactbron** op de **Shopify-winkelkaart** de optie *Voornaam en achternaam* of *Achternaam en voornaam* bevat, die bepalen hoe de waarden moeten worden gesplitst.|
...
|Prioriteit|Veld op klantenkaart|Beschrijving|
|------|------|-----------|
|0|**Naam**|Hoogste prioriteit, als het veld **Naambron** op de **Shopify-winkelkaart** *Bedrijfsnaam* bevat.|
...
De resulterende klanten worden automatisch in Shopify gemaakt met adressen.
...
Als u B2B gebruikt in Shopify, kunt u behalve klanten ook bedrijven maken. U kunt één of meerdere individuele klanten aan een bedrijf koppelen. U kunt ook betalingsvoorwaarden, locaties en catalogi definiëren.
...
## Een B2B-bedrijf exporteren naar Shopify

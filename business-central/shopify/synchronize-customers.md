...
# <a name="synchronize-customers" />Klanten synchroniseren
...
## <a name="important-settings-when-importing-customers-from-shopify" />Belangrijke instellingen bij het importeren van klanten uit Shopify
...
### <a name="customer-template-per-country" />Klantensjabloon per land/regio
...
## <a name="export-customers-to-shopify" />Klanten exporteren naar Shopify
...
### <a name="populate-customer-information-in-shopify" />Klantgegevens invullen in Shopify
...
## <a name="sync-customers" />Klanten synchroniseren

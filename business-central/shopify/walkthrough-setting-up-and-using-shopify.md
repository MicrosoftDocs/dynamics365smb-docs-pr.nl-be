...
# <a name="walkthrough-set-up-and-use-the-shopify-connector" />Procedure: de Shopify Connector instellen en gebruiken
...
## <a name="connect-business-central-to-the-shopify-shop" />Business Central verbinden met de online Shopify-winkel
...
## <a name="walkthrough-start-selling-products-online" />Procedure: begin met het online verkopen van producten
...
#### <a name="prepare-data" />Gegevens voorbereiden
...
#### <a name="run-the-synchronization" />De synchronisatie uitvoeren

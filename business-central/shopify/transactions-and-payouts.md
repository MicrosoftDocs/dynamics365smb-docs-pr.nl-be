...
# <a name="transactions-and-payouts"></a><a name="transactions-and-payouts"></a>Transacties en uitbetalingen
...
## <a name="payouts"></a><a name="payouts"></a>Uitbetalingen
...
## <a name="payment-method-mapping"></a><a name="payment-method-mapping"></a>Toewijzing van betalingsmethoden
...
## <a name="use-cases"></a><a name="use-cases"></a>Praktijkgevallen
...
### <a name="how-money-flows"></a><a name="how-money-flows"></a>Hoe geld stroomt
...
### <a name="option-1-reconcile-incoming-transfers-to-bank-account-against-original-invoices"></a><a name="option-1-reconcile-incoming-transfers-to-bank-account-against-original-invoices"></a>Optie 1: inkomende overschrijvingen op bankrekening afstemmen met originele facturen
...
### <a name="option-2-reconcile-incoming-transfers-to-bank-account-against-interim-account-representing-money-at-the-payment-provider"></a><a name="option-2-reconcile-incoming-transfers-to-bank-account-against-interim-account-representing-money-at-the-payment-provider"></a>Optie 2: reconcilieer inkomende overschrijvingen naar bankrekening met tussentijdse rekening die geld vertegenwoordigt bij de betalingsprovider

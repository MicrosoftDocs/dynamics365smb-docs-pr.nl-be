...
# <a name="run-tasks-in-the-background" />Taken op de achtergrond uitvoeren
...
## <a name="run-tasks-in-the-background-for-a-specific-shop" />Voer taken op de achtergrond uit voor een specifieke winkel
...
## <a name="to-schedule-recurring-tasks" />Terugkerende taken plannen

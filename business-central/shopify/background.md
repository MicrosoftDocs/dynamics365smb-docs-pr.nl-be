...
> [!NOTE]
> Sommige elementen kunnen door verschillende taken worden bijgewerkt. Wanneer u orders importeert, kan het systeem, afhankelijk van de instelling op de pagina **Shopify-winkelkaart**, bijvoorbeeld ook klant- en productgegevens importeren en bijwerken. Vergeet als u conflicten wilt vermijden niet om dezelfde taakwachtrijcategorie te gebruiken.
>
> Gebruik de actie **Rapportaanvraagpagina** om filters te definiëren. U kunt bijvoorbeeld opgeven dat u alleen bestellingen importeert als de status ervan **Volledig betaald** is.

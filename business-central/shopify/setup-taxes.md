...
# <a name="set-up-taxes-for-the-shopify-connection" />Belastingen instellen voor de Shopify-verbinding
...
## <a name="if-you-sell-domestically" />Als u in het binnenland verkoopt
...
## <a name="if-you-sell-internationally" />Als u internationaal verkoopt
...
## <a name="dynamic-tax-inclusive-pricing" />Dynamische prijzen inclusief btw
...
## <a name="if-you-sell-to-eu-customers" />Als u aan klanten in de EU verkoopt
...
### <a name="collect-vat-set-to-one-stop-shop-registration" />Btw innen ingesteld op one-stop-shop registratie
...
### <a name="collect-vat-set-to-micro-business-exemption" />Btw innen ingesteld op vrijstelling voor micro-ondernemingen
...
## <a name="importing-shopify-orders-sold-to-international-customers" />Shopify-orders importeren die aan internationale klanten zijn verkocht
...
## <a name="other-tax-remarks" />Andere fiscale opmerkingen

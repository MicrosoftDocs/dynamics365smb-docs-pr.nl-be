...
- **Alle**: registreer de verzoek/antwoord-paren voor alle transacties, inclusief de succesvolle transacties.
...
### <a name="to-review-logs"></a>Logpostgegevens beheren
...
### <a name="manage-log-entry-data"></a>Logboeken controleren

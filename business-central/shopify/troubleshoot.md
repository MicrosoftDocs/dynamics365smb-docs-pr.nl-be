...
Het kan zijn dat u [App insluiten](/dynamics365/business-central/dev-itpro/deployment/embed-app-overview) heeft gebruikt, waarbij de client-URL deze indeling heeft: `https://[application name].bc.dynamics.com`. De Shopify-connector werkt niet voor Insluiten-apps. Als u meer wilt weten, gaat u naar [Voor welke Microsoft-producten is de Shopify-connector beschikbaar?](shopify-faq.md#which-microsoft-products-work-with-the-shopify-connector).

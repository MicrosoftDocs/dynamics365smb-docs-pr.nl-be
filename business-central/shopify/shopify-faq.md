...
Met de Shopify-connector kunnen bedrijven hun Shopify-winkel aan [!INCLUDE[prod_short](../includes/prod_short.md)] koppelen om de bedrijfsproductiviteit te maximaliseren. Met de Shopify-connector kunnen ze inzichten uit hun bedrijf en hun online Shopify-winkel als één eenheid bekijken en beheren.
...
- Importeren van orders uit Shopify
  - Voeg orders toe die zijn gemaakt in verschillende verkoopkanalen, zoals een online winkel, **Shopify POS** of **B2B**.
...
## <a name="which-microsoft-products-work-with-the-shopify-connector"></a>Welke Microsoft-producten werken met de Shopify-connector?
...
De Shopify-connector werkt niet met andere producten in de Dynamics 365-portfolio.
...
Deze extensie staat open voor bijdragen vanuit de community. U vindt de [broncode](https://github.com/microsoft/ALAppExtensions/tree/main/Apps/W1/Shopify) in de opslagplaats voor add-ons voor Microsoft AL-toepassingen.

## <a name="building-your-version-of-the-shopify-connector"></a>Uw versie van de Shopify-connector maken

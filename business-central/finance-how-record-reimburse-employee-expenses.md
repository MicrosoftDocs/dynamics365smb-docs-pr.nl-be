...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses"></a><a name="record-and-reimburse-employees-expenses"></a>Kosten van werknemers registreren en terugbetalen
...
## <a name="to-record-an-employees-expense"></a><a name="to-record-an-employees-expense"></a>Onkosten van een werknemer registreren
...
## <a name="to-reimburse-an-employee"></a><a name="to-reimburse-an-employee"></a>Een werknemer terugbetalen
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a><a name="to-reconcile-reimbursements-with-employee-ledger-entries"></a>Terugbetalingen reconciliëren met werknemersposten

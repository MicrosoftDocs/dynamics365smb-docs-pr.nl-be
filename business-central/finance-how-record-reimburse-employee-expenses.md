...
ms.author: edupont
---
# <a name="record-and-reimburse-employees-expenses" />Kosten van werknemers registreren en terugbetalen
...
## <a name="to-record-an-employees-expense" />Onkosten van een werknemer registreren
...
## <a name="to-reimburse-an-employee" />Een werknemer terugbetalen
...
## <a name="to-reconcile-reimbursements-with-employee-ledger-entries" />Terugbetalingen reconciliëren met werknemersposten

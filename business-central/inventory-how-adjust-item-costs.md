...
ms.author: edupont
---
# <a name="adjust-item-costs" />Artikelkosten herwaarderen
...
## <a name="to-adjust-item-costs-manually" />Artikelkosten handmatig herwaarderen
...
## <a name="to-make-general-changes-in-the-direct-unit-cost" />Ga als volgt te werk om algemene wijzigingen aan te brengen in de directe kostprijs:
...
## <a name="understanding-unit-cost-calculation" />Kostprijsberekening
...
## <a name="unit-cost-calculation-for-purchases" />Kostprijsberekening voor inkoop
...
### <a name="costing-method-standard" />Waarderingsmethode Vast
...
## <a name="unit-cost-calculation-for-sales" />Kostprijsberekening voor verkoop

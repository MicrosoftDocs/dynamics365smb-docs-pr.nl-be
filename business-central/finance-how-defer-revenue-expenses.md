...
ms.author: edupont
---
# <a name="defer-revenues-and-expenses"></a><a name="defer-revenues-and-expenses"></a><a name="defer-revenues-and-expenses"></a>Procedure: Inkomsten en kosten uitstellen
...
## <a name="to-set-up-a-gl-account-for-deferral"></a><a name="to-set-up-a-gl-account-for-deferral"></a><a name="to-set-up-a-gl-account-for-deferral"></a>Een grootboekrekening instellen voor uitstel
...
## <a name="to-set-up-a-deferral-template"></a><a name="to-set-up-a-deferral-template"></a><a name="to-set-up-a-deferral-template"></a>Een uitstelsjabloon instellen
...
## <a name="to-assign-a-deferral-template-to-an-item"></a><a name="to-assign-a-deferral-template-to-an-item"></a><a name="to-assign-a-deferral-template-to-an-item"></a>Een uitstelsjabloon toewijzen aan een artikel
...
## <a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a><a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a><a name="to-change-a-deferral-schedule-from-a-sales-invoice"></a>Een uitstelschema wijzigen vanuit een verkoopfactuur
...
## <a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a><a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a><a name="to-review-posted-deferrals-in-the-sales-deferral-summary-report"></a>Geboekte uitstellingen bekijken in het rapport Overzicht van verkoopuitstel
...
## <a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a><a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a><a name="to-specify-a-period-in-which-to-allow-deferral-posting"></a>Een periode opgeven waarin uitstelboeking wordt toegestaan
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/processing-invoices-dynamics-365-business-central/)

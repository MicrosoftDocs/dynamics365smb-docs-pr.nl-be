...
ms.author: edupont
---
# <a name="track-items-with-serial-lot-and-package-numbers" />Artikelen traceren met serie-, partij- en pakketnummers
...
## <a name="item-tracking-availability" />Beschikbaarheid van artikeltracering
...
## <a name="to-assign-serial-or-lot-numbers-during-an-inbound-transaction" />Serie- of lotnummers toewijzen tijdens inkomende transacties
...
### <a name="to-handle-serial-and-lot-numbers-when-getting-receipt-lines-from-a-purchase-invoice" />Serie- en lotnummers verwerken bij het ophalen van ontvangstregels vanuit een inkoopfactuur
...
## <a name="to-assign-a-serial-or-lot-number-during-an-outbound-transaction" />Serie- of lotnummers toewijzen tijdens een uitgaande transactie
...
### <a name="to-select-from-existing-serial-or-lot-numbers" />U kunt als volgt nummers selecteren uit bestaande serie- of lotnummers
...
### <a name="to-assign-new-serial-or-lot-numbers" />Nieuwe serie- of lotnummers toewijzen
...
### <a name="assign-tracking-numbers-on-source-documents" />Traceringsnummers toewijzen in brondocumenten
...
## <a name="to-handle-serial-and-lot-numbers-on-transfer-orders" />Serie- en lotnummers verwerken op transferorders
...
## <a name="to-record-additional-serial-or-lot-number-information" />Aanvullende gegevens over serie-/lotnummers vastleggen
...
## <a name="to-modify-existing-serial-or-lot-number-information" />Gegevens over bestaande serie- of lotnummers wijzigen
...
## <a name="to-reclassify-serial-or-lot-numbers" />Serie- of lotnummers herindelen

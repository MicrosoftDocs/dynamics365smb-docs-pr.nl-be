...
---
# <a name="track-items-with-serial-lot-and-package-numbers"></a>Artikeltracering instellen met serie-, lot- en pakketnummers
...
De hoeveelheidsvelden boven aan de pagina **Artikeltraceringsregels** geven de aantallen en totalen van artikeltraceringsnummers weer die op de regels worden gedefinieerd. De hoeveelheden moeten overeenkomen met die op de documentregels, wat wordt aangegeven met  *0* in de velden  **Undefined** .
...
|Veld|Beschrijving|
|-----|-----------|  
|**Totaal aantal**|het totale aantal van een artikel dat momenteel in voorraad is.|
...
Als u lange tijd op de pagina  **Artikeltraceringsregels**  werkt of als er veel activiteiten zijn met het item waarmee u werkt, kunt u de actie  **Beschikbaarheid vernieuwen** kiezen. De beschikbaarheid van het artikel wordt ook automatisch opnieuw gecontroleerd als u de pagina sluit om te bevestigen dat er geen beschikbaarheidsproblemen zijn.
...
3. Kies op de pagina  **Item kaart** de actie  **Gerelateerde**, kies de actie  **Gerelateerde**, kies de actie  **Posten**  en kies vervolgens  **grootboekposten**.
...
> [!NOTE]
> [!INCLUDE [prod_short](includes/prod_short.md)] verifieert dat elke regel een unieke combinatie van serie-, partij- en/of pakketnummers heeft. Als u een partij, een pakket of een partij en een pakket wilt opsplitsen in meerdere partijen of pakketten, moet u meerdere dagboekregels gebruiken.

1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), Pictogram, voer  **Artikelherclassificatiedagboeken** in en kies vervolgens de gerelateerde koppelen.  
...
4. Selecteer in het veld **Serienummers** of **Lotnummers** het huidige serie- of lotnummer.  
...
|Magazijnartikel-trackingregels     |* Serienr.<br><br>* Nieuw serienr.<br><br>* Lotnr.<br><br>* Nieuw lotnr.<br><br>* Pakketnr.<br><br>* Nieuw pakketnr.|
...
|Magazijninventarisatie inventarisatiedagboek     |* Serienr.<br><br>* Lotnr.<br><br>* Pakketnr.         |

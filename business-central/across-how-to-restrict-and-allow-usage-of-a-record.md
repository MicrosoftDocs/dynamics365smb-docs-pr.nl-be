...
ms.author: edupont
---
# <a name="restrict-and-allow-usage-of-a-record" />Gebruik van een record beperken en toestaan
...
## <a name="create-a-workflow-step-that-restricts-posting-of-unapproved-purchase-orders" />Een werkstroomstap maken die voorkomt dat niet-goedgekeurde inkooporders worden geboekt

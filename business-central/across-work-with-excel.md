...
ms.author: jswymer
---
# <a name="viewing-and-editing-in-excel-from-business-central"></a><a name="viewing-and-editing-in-excel-from-business-central"></a>Weergeven en bewerken in Excel vanuit Business Central
...
## <a name="open-in-excel"></a><a name="open-in-excel"></a>Openen in Excel
...
## <a name="edit-in-excel"></a><a name="edit-in-excel"></a>Bewerken in Excel
...
### <a name="first-time-sign-in"></a><a name="first-time-sign-in"></a>Eerste aanmelding
...
### <a name="work-across-environments-and-companies"></a><a name="work-across-environments-and-companies"></a>Werken in omgevingen en bedrijven
...
### <a name="limits-when-using-excel-for-the-web"></a><a name="limits-when-using-excel-for-the-web"></a>Limieten bij het gebruik van Excel voor het web
...
## <a name="see-the-differences-between-the-options"></a><a name="see-the-differences-between-the-options"></a>Zie de verschillen tussen de opties
<br><br>  

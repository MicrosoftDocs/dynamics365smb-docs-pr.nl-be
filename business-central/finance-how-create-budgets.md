...
ms.author: edupont
---
# <a name="create-gl-budgets"></a><a name="create-gl-budgets"></a>Grootboekbudgetten maken
...
## <a name="to-create-a-new-gl-budget"></a><a name="to-create-a-new-gl-budget"></a>Een nieuw grootboekbudget maken
...
## <a name="exporting-and-importing-gl-budgets-with-excel"></a><a name="exporting-and-importing-gl-budgets-with-excel"></a>Grootboekbudgetten exporteren en importeren met Excel
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/budgets-exchange-rates-dynamics-365-business-central/index)

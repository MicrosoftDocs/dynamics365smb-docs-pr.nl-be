...
ms.author: edupont
---
# <a name="add-comments-to-cards-and-documents" />Opmerkingen toevoegen aan kaarten en documenten
...
## <a name="to-add-a-comments-to-an-item-card" />Een opmerking toevoegen aan een artikelkaart

...
ms.author: edupont
---
# <a name="set-up-basic-warehouses-with-operations-areas" />Standaardmagazijnen met bewerkingsgebieden instellen
...
## <a name="to-enable-inventory-documents-for-internal-operation-activities" />Voorraaddocumenten inschakelen voor interne bewerkingsactiviteiten
...
## <a name="to-define-a-default-bin-structure-in-the-production-area" />Een standaard opslaglocatiestructuur in het productiegebied definiëren
...
## <a name="to-define-a-default-bin-structure-in-the-assembly-area" />Een standaard opslaglocatiestructuur in het assemblagegebied definiëren
...
### <a name="to-set-up-that-an-inventory-movement-is-automatically-created-when-the-inventory-pick-for-the-assembly-item-is-created" />Instellen dat automatisch een voorraadverplaatsing wordt gemaakt wanneer de voorraadpick voor het assemblageartikel wordt gemaakt
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-components-are-placed-by-default-before-they-can-be-consumed-in-assembly" />De opslaglocatie in het assemblagegebied instellen waarin onderdelen standaard worden geplaatst voordat ze kunnen worden gebruikt bij het assembleren
...
### <a name="to-set-up-the-bin-in-the-assembly-area-where-finished-assembly-items-are-posted-to-when-they-are-assembled-to-stock" />De opslaglocatie in het assemblagegebied instellen waarnaar gereedgemelde componenten worden geboekt wanneer ze op voorraad worden geassembleerd
...
### <a name="to-set-up-the-bin-where-finished-assembly-items-are-posted-to-when-they-are-assembled-to-a-linked-sales-order" />Instellen naar welke opslaglocatie gereedgemelde componenten worden geboekt wanneer ze worden geassembleerd met een gekoppelde verkooporder
...
## <a name="to-create-dedicated-component-bins" />Specifieke componentopslaglocaties maken

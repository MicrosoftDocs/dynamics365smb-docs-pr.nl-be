...
ms.author: edupont
---
# <a name="set-up-multiple-interest-rates-for-delayed-payment" />Meerdere rentetarieven instellen voor uitgestelde betaling
...
## <a name="to-set-up-multiple-interest-rates" />Meerdere rentetarieven instellen

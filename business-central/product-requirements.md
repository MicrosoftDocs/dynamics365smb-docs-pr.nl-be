...
**Microsoft Edge Legacy:** [!INCLUDE[d365fin](includes/d365fin_md.md)] is ontworpen om te werken met de oudere versie van Microsoft Edge, maar we raden u aan om over te schakelen naar de nieuwe Microsoft Edge.  
...
**Bewerken Excel:** als u de Excel-invoegtoepassing wilt gebruiken om wijzigingen in Excel aan te brengen en de wijzigingen naar [!INCLUDE[d365fin](includes/d365fin_md.md)] terug te sturen, hebt u Excel 2019 of hoger nodig. Zie voor meer informatie [Financiële overzichten analyseren in Microsoft Excel](finance-analyze-excel.md).  

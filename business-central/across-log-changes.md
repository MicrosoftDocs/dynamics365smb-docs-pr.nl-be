...
Nadat u het wijzigingslogbestand hebt ingesteld, hebt geactiveerd en gegevens hebt gewijzigd, kunt u de wijzigingen weergeven en filteren op de pagina **Wijzigingslogposten**. Als u posten wilt verwijderen, stelt u een bewaarbeleid in, waarbij u filters kunt instellen op basis van datums en tijden. Zie voor meer informatie over het bewaarbeleid in [Bewaarbeleid definiëren](admin-data-retention-policies.md).  

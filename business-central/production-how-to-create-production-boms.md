...
ms.author: bholtorf
---
# <a name="create-production-boms" />Productiestuklijsten maken
...
## <a name="to-create-a-production-bom" />Een productiestuklijst maken
...
## <a name="to-create-a-new-version-of-a-production-bom" />Een nieuwe versie van een productiestuklijst maken
...
## <a name="quantity-calculation-formula-on-production-boms" />Formule voor berekening van het aantal in productiestuklijsten

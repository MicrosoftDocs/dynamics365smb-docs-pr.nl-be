...
ms.author: bholtorf
---
# <a name="create-production-boms"></a><a name="create-production-boms"></a><a name="create-production-boms"></a>Productiestuklijsten maken
...
## <a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a><a name="to-create-a-production-bom"></a>Een productiestuklijst maken
...
## <a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a><a name="to-create-a-new-version-of-a-production-bom"></a>Een nieuwe versie van een productiestuklijst maken
...
## <a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a><a name="quantity-calculation-formula-on-production-boms"></a>Formule voor berekening van het aantal in productiestuklijsten

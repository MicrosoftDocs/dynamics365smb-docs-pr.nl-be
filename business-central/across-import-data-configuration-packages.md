...
ms.author: edupont
---
# <a name="import-business-data-from-other-finance-systems" />Bedrijfsgegevens importeren uit andere financiële systemen
...
## <a name="work-with-data-in-excel" />Werken met gegevens in Excel
...
## <a name="import-data-from-configuration-packages" />Gegevens importeren uit configuratiepakketten
...
### <a name="tables-in-the-default-configuration-package" />Tabellen in het standaardconfiguratiepakket

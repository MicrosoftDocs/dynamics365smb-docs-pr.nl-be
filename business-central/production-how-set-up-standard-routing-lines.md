...
ms.author: edupont
---
# <a name="set-up-standard-routing-lines" />Standaardbewerkingsplanregels instellen
...
## <a name="to-set-up-a-standard-task" />Een standaardtaak instellen
...
## <a name="to-add-a-standard-task-to-an-operation" />Een standaardtaak toevoegen aan een bewerking

...
#### [Procedure: Een verkoopcampagne organiseren](walkthrough-conducting-a-sales-campaign.md)
...
<!-- Contoso-->
### <a name="contoso-coffee-demo-data"></a>Demogegevens van Contoso Coffee
...
#### <a name="warehousing"></a>Magazijnen
...
#### <a name="design-details-posting-date-on-adjustment-value-entry"></a>Ontwerpdetails: Boekingsdatum van herwaarderingswaardepost
...
#### <a name="design-details-supply-planning"></a>Ontwerpdetails: Leveringsplanning
...
### <a name="ai-powered-item-marketing-text-with-copilot"></a>Door AI aangestuurde artikelmarketingtekst met Copilot
...
## <a name="quick-starts"></a>Snelstartgidsen
...
<!--use-->
## <a name="get-productive-in-business-central"></a>Productief worden in Business Central
...
### <a name="personalize-business-central"></a>Business Central personaliseren
...
### <a name="change-the-look-of-externally-facing-documents"></a>Wijzigen hoe extern gerichte documenten eruitzien
...
#### <a name="using-legacy-features"></a>Oude functies gebruiken
...
### <a name="sharing-business-data"></a>Bedrijfsgegevens delen
...
#### [Weergeven en bewerken in Excel](across-work-with-excel.md)
### <a name="accessibility-keyboard-shortcuts-and-touch-gestures"></a>Toegankelijkheid, sneltoetsen en aanraakbewegingen
...
### [Problemen oplossen: toegang tot camera en vestiging](ui-troubleshooting-camera-location.md)
...
<!--data exchange-->
### <a name="exchange-data-electronically"></a>Gegevens elektronisch uitwisselen
...
#### <a name="set-up-data-exchange"></a>Gegevensuitwisseling instellen
...
#### <a name="exchange-data"></a>Gegevens uitwisselen
...
#### <a name="applying-payments-automatically-and-reconcile-bank-accounts"></a>Betalingen automatisch vereffenen en bankrekeningen reconciliëren
...
### <a name="manage-payables"></a>Schulden beheren
...
#### <a name="applying-payments-automatically-and-reconcile-bank-accounts-1"></a>Betalingen automatisch vereffenen en bankrekeningen reconciliëren
##### [Overzicht van betalingsvereffening](receivables-apply-payments-auto-reconcile-bank-accounts.md)
##### [Betalingen reconciliëren met automatische vereffening](receivables-how-reconcile-payments-auto-application.md)
##### [Betalingen na automatische vereffening handmatig controleren of vereffenen](receivables-how-review-apply-payments-auto-application.md)
##### [Betalingen reconciliëren die niet automatisch kunnen worden vereffend](receivables-how-reconcile-payments-cannot-apply-auto.md)
...
### <a name="manage-vat"></a>Btw beheren
#### [Overzicht van btw-beheer](finance-manage-vat.md)
#### <a name="setup-vat"></a>Btw instellen
...
### <a name="reconcile-bank-accounts"></a>Bankrekeningen reconciliëren
...
### <a name="manage-intercompany-transactions"></a>IC-transacties beheren
...
### <a name="manage-inventory-costs"></a>Voorraadkosten beheren
#### [Overzicht van voorraadwaardering](finance-manage-inventory-costs.md)
#### [Over voorraadwaardering](finance-learn-about-costing.md)
#### [Artikeltoeslagen gebruiken om extra handelskosten te verantwoorden](payables-how-assign-item-charges.md)
#### [Over het berekenen van vaste verrekenprijzen](finance-about-calculating-standard-cost.md)
...
#### [Voorraadwaardering en waardering instellen](finance-set-up-inventory-valuation-and-costing.md)
...
#### <a name="report-costs-and-reconcile-with-the-general-ledger"></a>Kosten rapporteren en reconciliëren met het grootboek
...
### <a name="manage-cash-flow"></a>Cashflow beheren
...
#### [Afsluitende afschriften voorbereiden](year-prepare-close-statement.md)
...
### <a name="consolidate-financial-data-from-multiple-companies"></a>Financiële gegevens uit meerdere bedrijven consolideren
...
### <a name="work-with-the-chart-of-accounts-and-general-ledger"></a>Werken met het rekeningschema en het grootboek
...
## <a name="financial-business-intelligence-and-reporting"></a>Financiële Business Intelligence en rapportage
...
### <a name="manage-interactions"></a>Interacties beheren
...
### <a name="manage-sales-opportunities"></a>Verkoopkansen beheren
...
## <a name="manufacturing-1"></a>Productie
...
### <a name="inbound-warehouse-processes"></a>Inkomende magazijnprocessen
...
### <a name="outbound-warehouse-processes"></a>Uitgaande magazijnprocessen
...
### <a name="internal-warehouse-processes"></a>Inkomende magazijnprocessen
#### <a name="production-assembly-and-job-activities"></a>Productie, assembleren en projectactiviteiten
...
##### [Productie-output opslaan](warehouse-how-to-put-away-production-output.md)
#### <a name="move-items"></a>Artikelen verplaatsen
...
#### <a name="warehouse-counting"></a>Tellen in magazijn
...
### <a name="planning-service"></a>Service plannen
...
### <a name="fulfill-service-contracts"></a>Servicecontracten afhandelen
...
### <a name="deliver-service"></a>Service leveren
...
<!--Shopify-->
## <a name="online-store-with-shopify"></a>Online winkel met Shopify
...
#### <a name="banking--payments"></a>Bankieren en betalingen
...
#### <a name="core-finance"></a>Hoofdfinanciën
...
#### <a name="banking--payments-1"></a>Bankieren en betalingen
...
#### <a name="banking--payments-2"></a>Bankieren en betalingen
...
#### <a name="core-finance-1"></a>Hoofdfinanciën
...
##### <a name="deferrals-in-sales-and-purchase-ledger-reportslocalfunctionalitybelgiumhow-to-use-deferralsmd"></a>[Uitstel in verkoop- en inkoopboekrapporten](LocalFunctionality/Belgium/how-to-use-deferrals.md}

### <a name="canada"></a>Canada
#### [Lokale functionaliteit in de Canadese versie](LocalFunctionality/Canada/canada-local-functionality.md)
#### <a name="tax-1"></a>Belasting
##### [Sales Tax en Goods/Services Tax in Canada aangeven](LocalFunctionality/Canada/sales-tax-goods-services.md)
...
#### <a name="banking--payments-3"></a>Bankieren en betalingen
...
#### <a name="core-finance-2"></a>Hoofdfinanciën
...
#### <a name="fixed-assets-1"></a>Vaste activa
...
#### <a name="banking-and-payments"></a>Bankieren en betalingen
...
#### <a name="payables-and-receivables"></a>Tegoeden en schulden
...
#### <a name="inventory-1"></a>Voorraad
##### [Voorraad](LocalFunctionality/Czech/inventory.md)
#### <a name="general-4"></a>Algemeen
...
#### <a name="banking--payments-4"></a>Bankieren en betalingen
...
##### [Extensie Betalingen en reconciliaties (DK)](ui-extensions-payments-reconciliation-formats-dk.md)
#### <a name="electronic-invoicing"></a>Elektronische facturering
...
#### <a name="banking--payments-5"></a>Bankieren en betalingen
...
#### <a name="core-finance-3"></a>Hoofdfinanciën
...
#### <a name="banking--payments-6"></a>Bankieren en betalingen
...
#### <a name="core-finance-4"></a>Hoofdfinanciën
...
#### <a name="fixed-assets-2"></a>Vaste activa
...
#### <a name="banking--payments-7"></a>Bankieren en betalingen
...
#### <a name="core-finance-5"></a>Hoofdfinanciën
...
#### <a name="electronic-invoicing-1"></a>Elektronische facturering
...
##### <a name="tax-engine-configuration"></a>Configuratie van belastingberekenfunctie
...
##### <a name="gst-on-purchase"></a>GST op inkoop
...
##### <a name="gst-on-purchase-return"></a>GST op inkoopretour
...
###### [Inkoopretour aan buitenlandse leverancier](LocalFunctionality/India/GST-Purchase-Return-to-Foreign-Vendor.md)
...
##### <a name="gst-on-journalspaymentapplication"></a>GST op dagboeken/betaling/vereffening
...
##### <a name="gst-on-sales"></a>GST op verkoop
...
##### <a name="gst-on-sales-return"></a>GST op verkoopretour
...
##### <a name="gst-on-transfer"></a>GST op transfer
...
##### <a name="gst-on-bank-charge"></a>GST op bankkosten
...
##### <a name="gst-adjustmentsperiodic-activities"></a>GST-aanpassingen/periodieke activiteiten
...
##### <a name="gst-on-service-management"></a>GST op servicebeheer
###### [GST op servicebeheer](LocalFunctionality/India/GST-Service-Management.md)
##### <a name="gst-input-service-distribution"></a>GST-invoerservicedistributie
...
#### <a name="tds-for-customer"></a>TDS voor klant
...
#### <a name="voucher-interface"></a>Boekingsstukinterface
...
#### <a name="fixed-asset"></a>Vast activum
...
#### <a name="subcontracting"></a>Uitbesteding
...
#### <a name="banking--payments-8"></a>Bankieren en betalingen
...
#### <a name="core-finance-6"></a>Hoofdfinanciën
...
#### <a name="fixed-assets-3"></a>Vaste activa
...
#### <a name="electronic-invoicing-2"></a>Elektronische facturering
...
#### <a name="banking--payments-9"></a>Bankieren en betalingen
...
#### <a name="core-finance-7"></a>Hoofdfinanciën
...
#### <a name="general-9"></a>Algemeen
##### [CMR-notities](LocalFunctionality/Netherlands/cmr-notes.md)
...
##### [Vereffeningswisselkoersen aanpassen voor btw-posten](LocalFunctionality/NewZealand/how-to-adjust-settlement-exchange-rates-for-vat-entries.md)
##### [Goods and Services Tax op vooruitbetalingen berekenen](LocalFunctionality/NewZealand/how-to-calculate-goods-and-services-tax-on-prepayments.md)
...
#### <a name="banking--payments-10"></a>Bankieren en betalingen
...
#### <a name="core-finance-8"></a>Hoofdfinanciën
...
#### [Lokale functionaliteit in de Noorse versie](LocalFunctionality/Norway/norway-local-functionality.md)
#### <a name="vat-10"></a>Btw
##### [Noors standaardcontrolebestand - belastingbeheer (SAF-T)](LocalFunctionality/Norway/ui-extensions-setup-and-generate-saf-t-files-no.md)
...
#### <a name="banking--payments-11"></a>Bankieren en betalingen
...
##### [Elektronische EHF-facturering in Noorwegen](LocalFunctionality/Norway/ehf-electronic-invoicing-in-norway.md)
##### [Klanten instellen voor EHF](LocalFunctionality/Norway/how-to-set-up-customers-for-ehf.md)  
...
##### [Referentiecodes van ontvangers](LocalFunctionality/Norway/recipient-reference-codes.md)
...
#### <a name="core-finance-9"></a>Hoofdfinanciën
...
##### [Afdrukken van documenten instellen](LocalFunctionality/Norway/how-to-set-up-document-printing.md)
...
#### <a name="core-finance-10"></a>Hoofdfinanciën
...
##### [Verantwoordelijke werknemers en voorschotafschriften instellen](LocalFunctionality/Russia/How-to-Set-Up-Responsible-Employees-and-Advance-Statements.md)
#### <a name="payables-and-receivables-1"></a>Tegoeden en schulden
##### [Schulden en tegoeden in de Russische versie](LocalFunctionality/Russia/Payables-and-Receivables.md)
...
##### [Russische schuldenrapporten](LocalFunctionality/Russia/russian-payables-reports.md)
##### [Russische tegoedenrapporten](LocalFunctionality/Russia/russian-receivables-reports.md)
##### [Vooruitbetalingen klant instellen](LocalFunctionality/Russia/how-to-set-up-customer-prepayments.md)
##### [Vooruitbetalingen leverancier instellen](LocalFunctionality/Russia/how-to-set-up-vendor-prepayments.md)
...
#### <a name="fixed-assets-4"></a>Vaste activa
##### [Vaste activa in de Russische versie](LocalFunctionality/Russia/fixed-assets.md)
...
##### [VA-kosten](LocalFunctionality/Russia/Fixed-Asset-Charges.md)
##### [Kosteloze ontvangst van vaste activa](LocalFunctionality/Russia/Gratuitous-receipt-of-fixed-assets.md)
##### [VA-voorraad](LocalFunctionality/Russia/Fixed-Asset-Inventory.md)
##### [VA-vestigingen en werknemers](LocalFunctionality/Russia/Fixed-Asset-Locations-and-Employees.md)
##### [VA-omzet](LocalFunctionality/Russia/Fixed-Asset-Turnover.md)
##### [Journalen voor toekomstige onkosten maken](LocalFunctionality/Russia/How-to-Create-Future-Expense-Journals.md)
##### [Nieuwe VA-kosten maken](LocalFunctionality/Russia/How-to-Create-a-Fixed-Asset-Charge.md)
##### [Een creditnota voor een VA-toeslag maken](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
...
##### [Geboekte posten voor een VA-toeslag weergeven](LocalFunctionality/Russia/How-to-View-Posted-Entries-on-a-Fixed-Asset-Charge.md)
##### [Een rekening voor immateriële activa instellen](LocalFunctionality/Russia/How-to-Set-Up-an-Intangible-Assets-Account.md)
##### [Rekening voor de kosten van het buiten gebruik stellen van een vast activum](LocalFunctionality/Russia/How-to-Account-for-the-Cost-to-Dispose-a-Fixed-Asset.md)
##### [Niet-afschrijfbare vaste activa](LocalFunctionality/Russia/Undepreciable-Fixed-Assets.md)
#### <a name="vat-11"></a>Btw
##### [Btw in de Russische versie](LocalFunctionality/Russia/VAT.md)
...
##### [Btw per vooruitbetaling klant](LocalFunctionality/Russia/VAT-by-Customer-prepayments.md)  
##### [Btw-herstel](LocalFunctionality/Russia/VAT-reinstatement.md)  
##### [Schema btw-agent van leverancier](LocalFunctionality/Russia/Vendor-Tax-Agent-scheme.md)  
#### <a name="tax-accounting"></a>Belastingboekhouding
##### [Belastingboekhouding in de Russische versie](LocalFunctionality/Russia/Tax-Accounting.md)
##### [Belastingboekhouding instellen](LocalFunctionality/Russia/How-to-Set-Up-Tax-Accounting.md)  
##### [Belastingjournalen](LocalFunctionality/Russia/Tax-Registers.md)  
##### [Btw-journalen maken](LocalFunctionality/Russia/How-to-Create-Tax-Registers.md)  
##### [Belastingjournaalsecties instellen](LocalFunctionality/Russia/How-to-Set-Up-Tax-Register-Sections.md)
##### [Belastingverschillen](LocalFunctionality/Russia/Tax-Differences.md)  
##### [Boekhouding voor betalingen van inkomstenbelasting](LocalFunctionality/Russia/Accounting-for-personal-income-tax-payments.md)  
...
#### <a name="inventory-3"></a>Voorraad
##### [Voorraad in de Russische versie](LocalFunctionality/Russia/Inventory.md)
...
##### [Verplichte handelingen van artikel](LocalFunctionality/Russia/Item-Obligatory-Acts.md)
##### [Inventarisatiewet van tegoeden en schulden INV-17](LocalFunctionality/Russia/Inventory-Act-of-Receivables-And-Payables-INV-17.md)
##### [Omzet van artikelgrootboek](LocalFunctionality/Russia/Item-General-Ledger-Turnover.md)
##### [Het TORG-29-goederenrapport maken](LocalFunctionality/Russia/How-to-Create-the-TORG-29-Goods-Report.md)
##### [Connossement](LocalFunctionality/Russia/bill-of-lading.md)
#### <a name="human-resources-1"></a>Personeel
##### [Personeel in de Russische versie](LocalFunctionality/Russia/Human-Resources.md)
##### [Salaris](LocalFunctionality/Russia/Payroll.md)
...
#### [Lokale functionaliteit in de Spaanse versie](LocalFunctionality/Spain/spain-local-functionality.md)
#### <a name="vat-12"></a>Btw
...
##### [SII instellen voor btw-aangifte](LocalFunctionality/Spain/sii-setup.md)
...
#### <a name="banking--payments-12"></a>Bankieren en betalingen
...
##### [CCC-codes van bank instellen](LocalFunctionality/Spain/how-to-set-up-bank-ccc-codes.md)
...
#### <a name="electronic-invoicing-3"></a>Elektronische facturering
...
#### <a name="core-finance-11"></a>Hoofdfinanciën
...
##### [Kortingen negeren op grootboekrekeningen](LocalFunctionality/Spain/how-to-ignore-discounts-in-general-ledger-accounts.md)
...
##### [Verkoop- en inkoopfactuurboeken afdrukken](LocalFunctionality/Spain/how-to-print-sales-and-purchase-invoice-books.md)  
...
#### [Lokale functionaliteit in de Zweedse versie](LocalFunctionality/Sweden/sweden-local-functionality.md)
#### <a name="vat-13"></a>Btw
...
#### <a name="core-finance-12"></a>Hoofdfinanciën
##### [Automatische rekeningcodes](LocalFunctionality/Sweden/automatic-account-codes.md)  
##### [Automatische rekeningsboekingsgroepen instellen](LocalFunctionality/Sweden/how-to-set-up-automatic-account-posting-groups.md)
##### [Gegevens importeren en exporteren in standaardimport/export-indeling](LocalFunctionality/Sweden/how-to-import-and-export-data-in-standard-import-export-format.md)  
##### [Balans- en resultatenrekeningrapporten afdrukken](LocalFunctionality/Sweden/how-to-print-balance-sheet-and-income-statement-reports.md)  

### <a name="switzerland"></a>Zwitserland
#### [Lokale functionaliteit in de Zwitserse versie](LocalFunctionality/Switzerland/switzerland-local-functionality.md)
#### <a name="vat-14"></a>Btw
...
#### <a name="banking--payments-13"></a>Bankieren en betalingen
...
##### [Een LSV-incasso verwerken](LocalFunctionality/Switzerland/how-to-process-an-lsv-collection.md)
##### [LSV-betalingen boeken](LocalFunctionality/Switzerland/how-to-post-lsv-payments.md)
##### [LSV-incasso sluiten](LocalFunctionality/Switzerland/how-to-close-an-lsv-collection.md)
...
##### [Rapporten met leveranciersbetalingslijsten afdrukken](LocalFunctionality/Switzerland/how-to-print-vendor-payments-list-reports.md)
#### <a name="core-finance-13"></a>Hoofdfinanciën
...
##### [Wisselkoersen herwaarderen](LocalFunctionality/Switzerland/how-to-adjust-exchange-rates.md)
...
##### [Informatie van grootboekinstellingen afdrukken](LocalFunctionality/Switzerland/how-to-print-general-ledger-setup-information.md)
#### <a name="purchasing-4"></a>Inkoop
...
##### [Termijnen, niveaus en tekst van leveringsherinneringen instellen](LocalFunctionality/Switzerland/how-to-set-up-delivery-reminder-terms-levels-and-text.md)
...
##### [Leveringsherinneringen verzenden](LocalFunctionality/Switzerland/how-to-issue-delivery-reminders.md)
##### [Leveringsherinneringen genereren](LocalFunctionality/Switzerland/how-to-generate-delivery-reminders.md)
##### [Testrapporten afdrukken voor leveringsherinneringen](LocalFunctionality/Switzerland/how-to-print-test-reports-for-delivery-reminders.md)
#### <a name="inventory-4"></a>Voorraad
...
#### [Lokale functionaliteit in de VK-versie](LocalFunctionality/UnitedKingdom/united-kingdom-local-functionality.md)
#### <a name="vat-15"></a>Btw
##### [Belasting digitaal maken - indieningen van btw-aangiften](LocalFunctionality/UnitedKingdom/making-tax-digital-submit-vat-return.md)
...
##### [Verleggingskosten voor btw instellen](LocalFunctionality/UnitedKingdom/how-to-set-up-reverse-charges-on-vat.md)
#### <a name="banking--payments-14"></a>Bankieren en betalingen
...
#### <a name="fixed-assets-5"></a>Vaste activa
...
#### <a name="general-14"></a>Algemeen
##### [Een waarschuwing over boekingsdatums instellen](LocalFunctionality/UnitedKingdom/how-to-set-up-a-posting-date-warning.md)
...
#### <a name="banking--payments-15"></a>Bankieren en betalingen
##### [Stortingen maken](LocalFunctionality/UnitedStates/how-to-create-deposits.md)  
##### [Bankrekeningen reconciliëren](LocalFunctionality/UnitedStates/how-to-reconcile-bank-accounts.md)
##### [Elektronische betalingen doen](finance-make-payments-with-bank-data-conversion-service-or-sepa-credit-transfer.md#exporting-payments-to-a-bank-file)
#### <a name="general-15"></a>Algemeen
...
<!--setup-->
## <a name="set-up-business-central"></a>Business Central instellen
### [Overzicht van taken](setup.md)
### <a name="set-up-finance"></a>Financiën instellen
...
#### [Leveranciersbankrekeningen instellen](purchasing-how-set-up-vendors-bank-accounts.md)
...
#### [Een beleid voor het boeken van facturen voor gebruikers definiëren](admin-setup-invoice-posting-policy.md)
### <a name="set-up-inventory"></a>Voorraad instellen
...
#### [Nieuwe artikelen registreren](inventory-how-register-new-items.md)
#### [Bestaande artikelen kopiëren om nieuwe artikelen te maken](inventory-how-copy-items.md)
...
### <a name="set-up-warehouse-management"></a>Magazijnbeheer instellen
#### [Magazijnen instellen](warehouse-setup-warehouse.md)
#### [Overzicht van magazijnbeheer](design-details-warehouse-management.md)
...
#### [Inhoud van opslaglocaties maken](warehouse-how-to-set-up-bin-contents.md)
...
#### [Vestigingen instellen om opslaglocaties te gebruiken](warehouse-how-to-set-up-locations-to-use-bins.md)
#### [Bestaande vestigingen converteren naar magazijnvestigingen](warehouse-how-to-convert-existing-locations-to-warehouse-locations.md)
...
### <a name="set-up-manufacturing"></a>Productie instellen
...
#### [Werken met maateenheden van productiebatches](production-how-to-use-the-manufacturing-batch-unit-of-measure.md)
#### [Lotgroottes in productie verwerken](production-handling-lot-sizes.md)
...
#### [Productie uitbesteden](production-how-to-subcontract-manufacturing.md)
### <a name="set-up-service-management"></a>Servicebeheer instellen
#### [Servicebeheer instellen](service-setup-service.md)
...
#### [Serviceaanbod instellen](service-how-setup-service-offerings.md)
#### [Probleemoplossing instellen](service-how-setup-troubleshooting.md)
...
### <a name="set-up-complex-application-areas-using-best-practices"></a>Complexe toepassingsgebieden instellen met aanbevolen procedures
#### [Aanbevolen procedures instellen](set-up-complex-application-areas-using-best-practices.md)
#### <a name="setup-best-practices-supply-planning"></a>Aanbevolen procedures instellen: Leveringsplanning
##### [Leveringsplanning instellen](setup-best-practices-supply-planning.md)
##### [Aanbevolen procedures instellen: Planningsparameters](setup-best-practices-planning-parameters.md)
##### [Aanbevolen procedures instellen: Algemene planning instellen](setup-best-practices-global-planning-setup.md)
##### [Aanbevolen procedures instellen: Bestelbeleid](setup-best-practices-reordering-policies.md)
#### [Aanbevolen procedures instellen: Waarderingsmethoden](setup-best-practices-costing-method.md)
### <a name="set-up-email"></a>E-mail instellen
#### [E-mail instellen](admin-how-setup-email.md)
#### <a name="set-up-your-business-inbox-in-microsoft-outlook"></a>Uw bedrijfsinbox instellen in Microsoft Outlook
...
###### [Contactsynchronisatie instellen voor on-premises](admin-contact-sync-setup-onprem.md)
...
### <a name="set-up-reports"></a>Rapporten instellen
#### [Rapportselectie voor documenten](across-report-selections.md)
### <a name="set-up-approval-workflows-based-on-templates"></a>Goedkeuringswerkstromen instellen op basis van sjablonen
...
#### [Berichten van goedkeuringswerkstromen](across-setting-up-workflow-notifications.md)
#### [Opgeven wanneer en hoe werkstroomberichten worden ontvangen](across-how-to-specify-when-and-how-to-receive-notifications.md)
...
###### [Contactsynchronisatie instellen voor on-premises](admin-contact-sync-setup-onprem.md)
##### [Business Central gebruiken zonder Outlook](admin-no-outlook.md)
#### <a name="use-microsoft-teams-with-business-central"></a>Microsoft Teams gebruiken met Business Central
...
#### <a name="use-onedrive-for-business-with-business-central"></a>OneDrive for Business gebruiken met Business Central
##### [Overzicht](across-onedrive-overview.md)
##### [Integratie met OneDrive for Business beheren](admin-onedrive-integration.md)
...
#### <a name="use-power-bi-with-business-central"></a>Power BI gebruiken met Business Central
##### [Inleiding](admin-powerbi.md)
##### <a name="administrator"></a>Beheerder
###### [Overzicht van integratie](admin-powerbi-overview.md)
###### [Power BI-integratie inschakelen](admin-powerbi-setup.md)
##### <a name="report-creator"></a>Rapporten maken
...
#### <a name="use-power-automate-with-business-central"></a>Power Automate gebruiken met Business Central
...
#### <a name="use-power-apps-with-business-central"></a>Power Apps gebruiken met Business Central
...
#### [In bulk factureren voor Microsoft Bookings](finance-bookings.md)
...
#### [Overzicht](admin-printer-setup-overview.md)
#### [Printers voor Universeel afdrukken](admin-printer-setup-universal-print.md)
#### [E-mailprinters](admin-printer-setup-email.md)
#### [Een standaardprinter opgeven](ui-specify-printer-selection-reports.md)
...
# <a name="business-intelligence-and-reporting"></a>Business Intelligence en rapportage
...
## <a name="built-in-reports"></a>Ingebouwde rapporten
### [Rapportoverzicht](reports-available-reports.md)
### <a name="finance-1"></a>Financiën
...
### <a name="purchasing-5"></a>Inkoop
#### [Inkooprapporten](purchase-reports.md)
#### [Inkoopposten weergeven](purchasing-how-record-purchases.md#viewing-ledger-entries)

### <a name="inventory-and-warehouse"></a>Voorraad en magazijn
#### [Voorraad- en magazijnrapporten](inventory-wms-reports.md)
...
### <a name="fixed-assets-6"></a>Vaste activa
...
### <a name="assembly-management-1"></a>Assemblage
#### [Assemblagerapporten](assembly-reports.md)
...
## <a name="developing-reports"></a>Rapporten ontwikkelen
### [Overzicht](reports-develop-reports.md)
### <a name="developing-report-layouts"></a>Rapportlay-outs ontwikkelen
#### [Lay-outtypen (Word, Excel, RDLC)](ui-manage-report-layouts.md)
#### [Lay-outs maken en wijzigen](ui-get-started-layouts.md)
<!--#### [Create a New Layout](ui-how-create-custom-report-layout.md)-->
#### [Werken met Word-lay-outs](ui-how-add-fields-word-report-layout.md)
#### [Werken met Excel-lay-outs](ui-excel-report-layouts.md)
#### [Werken met RDLC-lay-outs](ui-rdlc-report-layouts.md)
#### [Lettertypen gebruiken in lay-outs](ui-fonts.md)  
...
#### [De standaardlay-out instellen](ui-set-report-layout.md)
...
# <a name="security-privacy-compliance"></a>Beveiliging, privacy, naleving
## <a name="security-and-protection"></a>Beveiliging en bescherming
...
### [Overzicht van conformiteit](compliance/compliance-overview.md)
...
## [Overzicht van service (alleen in het Engels)](/dynamics365/business-central/dev-itpro/service-overview?toc=/dynamics365/business-central/toc.json)
...
## <a name="administration-tasks-in-business-central"></a>Beheertaken in Business Central
...
#### <a name="access-with-microsoft-365-licenses"></a>Toegang met Microsoft 365-licenties
...
#### <a name="grant-user-permissions"></a>Gebruikersmachtigingen verlenen
##### [Gebruikers maken volgens licenties](ui-how-users-permissions.md)
##### [Machtigingen toewijzen aan gebruikers en groepen](ui-define-granular-permissions.md)
### <a name="manage-user-settings"></a>Gebruikersvoorkeuren beheren
#### [Profielen beheren](admin-users-profiles-roles.md)
#### [Gebruikersvoorkeuren en voorkeuren beheren](admin-manage-user-settings-preferences.md)
### <a name="control-your-data"></a>Uw gegevens beheren
...
### [Tabelinformatie weergeven](admin-view-table-information.md)
...
### <a name="customize-with-extensions"></a>Aanpassen met extensies
#### [Overzicht van extensies](ui-extensions.md)
...
#### [Basis van cloudmigratie](ui-extensions-intelligent-cloud.md)
#### [Voorspellingen van te late betaling](ui-extensions-late-payment-prediction.md)
...
#### [Extensie Servicedeclaratie](finance-how-setup-use-service-declaration.md)
#### [Verenigd Koninkrijk - GetAddress.io Postcodes](LocalFunctionality/UnitedKingdom/ui-extensions-getaddressio.md)
#### [Verenigd Koninkrijk - btw-groepsbeheer](ui-extensions-vat-group.md)
...
## <a name="integrate-with-dynamics-365-sales"></a>Integreren met Dynamics 365 Sales
### [Integreren met Dynamics 365 Sales](admin-prepare-dynamics-365-for-sales-for-integration.md)
## <a name="integrate-with-microsoft-dataverse"></a>Integreren met Microsoft Dataverse
...
## <a name="synchronize-master-data-across-companies"></a>Hoofdgegevens synchroniseren tussen bedrijven
...
## <a name="design-details-1"></a>Ontwerpdetails
### [Overzicht van toepassingsontwerpdetails](design-details-application-design.md)
### <a name="design-details-supply-planning-1"></a>Ontwerpdetails: Leveringsplanning
#### [Overzicht van leveringsplanning](design-details-supply-planning.md)
#### [Ontwerpdetails: Centrale begrippen van het planningssysteem](design-details-central-concepts-of-the-planning-system.md)  
#### [Ontwerpdetails: Reservering, ordertracering en planningsboodschappen](design-details-reservation-order-tracking-and-action-messaging.md)  
#### [Ontwerpdetails: Vraag en aanbod afstemmen](design-details-balancing-demand-and-supply.md)  
#### [Ontwerpdetails: Bestelbeleid verwerken](design-details-handling-reordering-policies.md)  
...
#### [Ontwerpdetails: Tabel Planningstoewijzing](design-details-planning-assignment-table.md)  
#### [Ontwerpdetails: Transfers in planning](design-details-transfers-in-planning.md)
### <a name="design-details-inventory-costing-1"></a>Ontwerpdetails: Voorraadwaardering
#### [Overzicht van kosten](design-details-inventory-costing.md)
#### [Ontwerpdetails: Waarderingsmethoden](design-details-costing-methods.md)  
#### [Ontwerpdetails: De waarderingsmethode voor artikelen wijzigen](design-details-changing-costing-methods.md)
#### [Ontwerpdetails: Artikelvereffening](design-details-item-application.md)  
#### [Ontwerpdetails: Bekend probleem met artikelvereffening](design-details-inventory-zero-level-open-item-ledger-entries.md)  
#### [Ontwerpdetails: Kostenwaardering](design-details-cost-adjustment.md)  
#### <a name="design-details-posting-date-on-adjustment-value-entry-1"></a>Ontwerpdetails: Boekingsdatum van herwaarderingswaardepost
...
<!-- #### [Design Details: Outbound Warehouse Flow](design-details-outbound-warehouse-flow.md)  -->
<!-- #### [Design Details: Integration with Inventory](design-details-integration-with-inventory.md)-->
### <a name="design-details-item-tracking-1"></a>Ontwerpdetails: Artikeltracering
#### [Overzicht van artikeltracering](design-details-item-tracking.md)
#### [Ontwerpdetails: Ontwerp van artikeltracering](design-details-item-tracking-design.md)  
#### [Ontwerpdetails: Boekingsstructuur van artikeltracering](design-details-item-tracking-posting-structure.md)  
#### [Ontwerpdetails: Actieve tegenover historische artikeltraceringsposten](design-details-active-versus-historic-item-tracking-entries.md)  
#### [Ontwerpdetails: Pagina Artikeltraceringsregels](design-details-item-tracking-lines-window.md)  
...
#### [Ontwerpdetails: Artikeltracering en reserveringen](design-details-item-tracking-and-reservations.md)  
#### [Ontwerpdetails: Artikeltracering in het magazijn](design-details-item-tracking-in-the-warehouse.md)
### <a name="design-details-general-journal-post-line-1"></a>Ontwerpdetails: Dagboekboekingsregel
#### [Grootboekpostregel](design-details-general-journal-post-line.md)
#### [Overzicht van dagboekboekingsregel](design-details-general-journal-post-line-overview.md)  
#### [Ontwerpdetails: Structuur van boekingsinterface](design-details-posting-interface-structure.md)  
#### [Ontwerpdetails: Structuur van boekingsengine](design-details-posting-engine-structure.md)  
### <a name="design-details-dimension-set-entries-1"></a>Ontwerpdetails: Dimensiesetposten
#### [Ontwerpdetails: Overzicht van dimensiesetposten](design-details-dimension-set-entries-overview.md)  
#### [Ontwerpdetails: Dimensiecombinaties zoeken](design-details-searching-for-dimension-combinations.md)  
#### [Ontwerpdetails: Tabelstructuur](design-details-table-structure.md)
<!--migrate to BC online-->
## <a name="migrate-to-business-central-online"></a>Migreren naar Business Central Online
### [On-premises gegevens migreren](/dynamics365/business-central/dev-itpro/administration/migrate-data?toc=/dynamics365/business-central/toc.json)
### [Tool voor cloudmigratie uitvoeren](/dynamics365/business-central/dev-itpro/administration/migration-tool?toc=/dynamics365/business-central/toc.json)
### [Migratie naar de cloud beheren](/dynamics365/business-central/dev-itpro/administration/migration-management?toc=/dynamics365/business-central/toc.json)

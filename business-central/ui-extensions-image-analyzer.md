...
# <a name="the-image-analyzer-extension" />De extensie Afbeeldingsanalyse
...
## <a name="switch-on-the-image-analyzer-extension" />De extensie Afbeeldingsanalyse inschakelen
...
## <a name="analyze-an-item-image" />Een artikelafbeelding analyseren
...
## <a name="analyze-a-contact-person-picture" />Een afbeelding van een contactpersoon analyseren
...
## <a name="use-your-own-computer-vision-api-account" />Uw eigen Computer Vision API-account gebruiken
...
## <a name="see-how-many-analyses-you-have-left-in-the-current-period" />Zien hoeveel analyses u in de huidige periode over hebt
...
## <a name="stop-using-the-image-analyzer-extension" />Stoppen met het gebruik van de extensie Afbeeldingsanalyse

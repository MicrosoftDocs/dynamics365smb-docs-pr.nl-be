...
ms.author: edupont
---
# <a name="suggest-vendor-payments" />Leveranciersbetalingen voorstellen
...
## <a name="to-use-the-suggest-vendor-payments-function" />De functie Leveranciersbetalingen voorstellen gebruiken
...
## <a name="to-insert-the-due-date-as-posting-date-on-payment-journal-lines" />De vervaldatum als boekingsdatum invoegen op betalingsdagboekregels
...
## <a name="see-related-microsoft-training" />Zie gerelateerde [Microsoft-training](/training/modules/suggest-vendor-payments-dynamics-365-business-central/)

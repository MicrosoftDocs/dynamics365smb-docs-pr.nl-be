...
ms.author: edupont
---
# <a name="unsubscribe-or-remove-includeprodshortincludesprodshortmd" />[!INCLUDE[prod_short](includes/prod_short.md)] verwijderen of het abonnement erop stoppen
...
## <a name="removing-includeprodshortincludesprodshortmd-from-your-app-launcher" />[!INCLUDE[prod_short](includes/prod_short.md)] verwijderen uit uw opstartprogramma voor apps

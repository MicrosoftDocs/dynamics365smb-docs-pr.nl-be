...
ms.author: edupont
---
# <a name="about-production-orders" />Informatie over productieorders
...
## <a name="production-order-creation" />Productieorders opstellen
...
## <a name="limitations-on-production-order-creation" />Beperkingen aangaande het opstellen van productieorders
...
## <a name="production-order-status" />Productieorderstatus
...
### <a name="simulated-production-order" />Gesimuleerde productieorder
...
### <a name="planned-production-order" />Geplande productieorder
...
### <a name="firm-planned-production-order" />Vast geplande productieorder
...
### <a name="released-production-order" />Vrijgegeven productieorder
...
### <a name="finished-production-order" />Gereedgemelde productieorder
...
## <a name="production-order-execution" />Uitvoering van productieorders
...
### <a name="material-consumption" />Materiaalverbruik
...
### <a name="production-output" />Productieoutput
...
### <a name="posting-consumption-and-output" />Verbruik en output boeken
...
### <a name="production-journal" />Productiedagboek

---
title: Over productieorders
description: Meer informatie over productieorders en hoe ze worden gebruikt voor het beheren van de conversie van ingekochte materialen naar geproduceerde artikelen.
author: brentholtorf
ms.author: bholtorf
...
- Opgesteld vanuit het [Planningsvoorstel](production-how-to-run-mps-and-mrp.md)  
- Gemaakt via de pagina [Verkooporderplanning](production-how-to-create-production-orders-from-sales-orders.md)  
...
Het materiaalverbruik kan worden verwerkt via het [verbruiksdagboek](production-how-to-post-consumption.md), maar kan ook automatisch worden geregistreerd door [!INCLUDE [prod_short](includes/prod_short.md)]. Dit wordt automatische rapportage genoemd (afboeking). De rapportagemethoden Handmatig, Voorwaarts en Achterwaarts zijn beschikbaar.
...
De output kan worden verwerkt via het [outputdagboek](production-how-to-post-output-quantity.md), maar kan ook automatisch worden geregistreerd. [!INCLUDE [prod_short](includes/prod_short.md)] kopieert bij het vernieuwen de afboekingsmethode van de bewerkingsplaats of de afdeling naar het productieorderbewerkingsplan. Net als bij het materiaalverbruik zijn er de rapportagemethoden Handmatig, Voorwaarts en Achterwaarts voor output.

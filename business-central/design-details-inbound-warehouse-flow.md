...
ms.author: bholtorf
---
# <a name="design-details-inbound-warehouse-flow"></a><a name="design-details-inbound-warehouse-flow"></a>Ontwerpdetails: Inkomende magazijnstroom
...
## <a name="no-dedicated-warehouse-activity"></a><a name="no-dedicated-warehouse-activity"></a>Geen specifieke magazijnactiviteit
...
## <a name="basic-warehouse-configurations"></a><a name="basic-warehouse-configurations"></a>Standaardmagazijnconfiguraties
...
### <a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a><a name="1-release-a-source-document-to-create-a-request-for-an-inventory-put-away"></a>1. Een brondocument vrijgeven om een aanvraag te maken van een voorraadopslag
...
### <a name="2-create-an-inventory-put-away"></a><a name="2-create-an-inventory-put-away"></a>2: Een voorraadopslag maken
...
### <a name="3-post-an-inventory-put-away"></a><a name="3-post-an-inventory-put-away"></a>3: Een voorraadopslag boeken
...
### <a name="1-release-the-source-document"></a><a name="1-release-the-source-document"></a>1: Het brondocument vrijgeven
...
### <a name="2-create-a-warehouse-receipt"></a><a name="2-create-a-warehouse-receipt"></a>2: Een magazijnontvangst maken
...
### <a name="3-post-the-warehouse-receipt"></a><a name="3-post-the-warehouse-receipt"></a>3. Boek de magazijnontvangst
...
### <a name="4-optional-generate-put-away-worksheet-lines"></a><a name="4-optional-generate-put-away-worksheet-lines"></a>4: (optioneel) Opslagvoorstelregels genereren
...
### <a name="5-create-a-warehouse-put-away-document"></a><a name="5-create-a-warehouse-put-away-document"></a>5. Een magazijnopslagdocument maken
...
### <a name="6-register-a-warehouse-put-away"></a><a name="6-register-a-warehouse-put-away"></a>6: Een magazijnopslag registreren
...
## <a name="related-tasks"></a><a name="related-tasks"></a>Verwante taken

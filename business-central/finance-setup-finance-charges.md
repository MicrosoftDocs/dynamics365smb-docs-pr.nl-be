...
ms.author: edupont
---
# <a name="set-up-finance-charge-terms"></a><a name="set-up-finance-charge-terms"></a>Rentefactuurcondities instellen
...
## <a name="finance-charge-terms"></a><a name="finance-charge-terms"></a>Rentefactuurcondities
...
### <a name="to-set-up-finance-charge-terms"></a><a name="to-set-up-finance-charge-terms"></a>Rentefactuurcondities instellen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/send-memos-dynamics-365-business-central/)

...
ms.author: edupont
---
# <a name="post-multiple-documents-at-the-same-time" />Meerdere documenten tegelijkertijd boeken
...
## <a name="to-post-multiple-purchase-orders-immediately" />Meerdere inkooporders onmiddellijk boeken
...
## <a name="to-batch-post-multiple-purchase-orders" />Meerdere inkooporders in een batch boeken
...
## <a name="to-set-up-background-posting-with-job-queues" />Boeking op de achtergrond instellen met taakwachtrijen
...
### <a name="to-view-status-from-a-sales-or-purchase-document" />Een status vanuit een verkoop- of inkoopdocument weergeven
...
## <a name="to-create-a-job-queue-entry-for-batch-posting-of-sales-orders" />Een taakwachtrijpost maken voort batchboeking van verkooporders
...
## <a name="monitor-the-job-queue" />De taakwachtrij bewaken

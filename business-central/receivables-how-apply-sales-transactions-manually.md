---
title: Reconcilieer klantbetalingen met het kasontvangstenjournaal of vanuit klantenposten
description: Kassabonnen of terugbetalingen van klanten toepassen op een of meer openstaande klantenposten.
author: brentholtorf
ms.author: bholtorf
...
---
# <a name="reconcile-customer-payments-with-a-cash-receipt-journal-or-from-customer-ledger-entries"></a>Reconcilieer klantbetalingen met een kasontvangstjournaal of vanuit klantenposten

Wanneer u een contante betaling van een klant ontvangt of een contante terugbetaling doet, kunt u de betaling of terugbetaling toepassen om openstaande afschrijvingen of tegoeden te sluiten. U kunt het exacte te vereffenen bedrag opgeven. U kunt bijvoorbeeld gedeeltelijke betalingen vereffenen met klantenposten. Het sluiten van klantenposten garandeert dat gegevens zoals bijvoorbeeld klantstatistieken, rekeningoverzichten en rente actueel zijn.
...
* Voer informatie in op de volgende pagina's:
   ...
   * De  **Geldontvangstjournaal** pagina. Zie [Een kasontvangstenjournaal invullen en boeken voor meer informatie](#to-fill-and-post-a-cash-receipt-journal).
* Door het veld **Vereffeningsnr.** op verkoopcreditnotadocumenten in te vullen. Zie [Een creditnota vereffenen met één enkele klantenpost voor meer informatie](#to-apply-a-credit-memo-to-a-single-customer-ledger-entry).
* Door de actie **Vereffenings-id instellen** op een klantenpost te gebruiken. Zie [Een betaling vereffenen met één klantenpost voor meer informatie](#to-apply-a-payment-to-a-single-customer-ledger-entry).
...
6. In het veld **Extern documentnr.** kunt u een identificatie opslaan, bijvoorbeeld het chequenummer van de klant.
   ...
   > [!NOTE]
   > Standaard is het veld Extern documentnr. verborgen. Als dat zo is en u wilt het gebruiken, kunt u personalisatie gebruiken om het toe te voegen. Zie [Uw werkruimte personaliseren](ui-personalization-user.md) voor meer informatie.

7. Selecteer **Klant** in het veld **Rekeningsoort** .
8. Selecteer de klant in het veld **Rekeningnr.** .
9. Om de aanvraag tegelijk met het boeken van het journaal te boeken, vult u de volgende velden in:
   1. Selecteer in het veld **Tegenrekeningsoort** de optie **Grootboekrekening** voor contante betalingen en **Bankrekening** voor andere betalingen.
   2. Selecteer in het veld **Tegenrekeningnr.** de grootboekrekening voor contante betalingen of de desbetreffende bankrekening voor andere betalingen.
10. Boek het dagboek.

## <a name="to-apply-a-payment-to-a-single-customer-ledger-entry"></a>Een betaling vereffenen met één klantenpost

1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), Pictogram, voer **Kassabonjournaal** in en kies de gerelateerde link.
2. Kies de actie **Dagboek bewerken**.
...
5. Kies de knop **Ok**. Op de pagina  **Verkoopcreditnota** wordt nu de vermelding weergegeven die u heeft geselecteerd in het  **Van toepassing zijnde document. Type** en **Van toepassing op Doc. Nee.** velden. En het bedrag van de creditnota dat moet worden geboekt, geherwaardeerd voor de mogelijke contantkortingen.
...
3. Kies de actie **grootboekposten**  en selecteer vervolgens de regel met de post die de vereffeningspost is.
...
8. Kies de knop **OK** om de vereffening te boeken.
    ...
    Als de geboekte aanvraag heeft geresulteerd in gesloten klantenposten, wordt het veld **Open** voor deze grootboekposten leeggemaakt.  
...
Hier volgt een voorbeeld. U past Entry A in de ene valuta toe op Entry B in een andere valuta. De boekingsdatum op Post A wordt gebruikt om de wisselkoers te vinden die moet worden gebruikt om bedragen op Post B om te rekenen. De wisselkoers vindt u op de pagina  **Valutawisselkoersen** .  

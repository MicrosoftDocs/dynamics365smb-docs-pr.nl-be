...
ms.author: bholtorf
---
# <a name="enable-automatic-breaking-bulk-with-directed-put-away-and-pick" />Automatisch splitsen van bulkgoederen met gestuurde opslag en pick inschakelen
...
## <a name="breakbulk-in-picks" />Bulksplitsing in picks
...
## <a name="breakbulk-in-put-aways" />Bulksplitsing in opslag
...
## <a name="breakbulk-in-movements" />Bulksplitsing in verplaatsingen

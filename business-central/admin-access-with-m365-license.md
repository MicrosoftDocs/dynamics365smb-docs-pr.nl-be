...
|Mobiele Business Central-apps|![Nr.](media/x-icon.png )|
|Business Central-API's|![Nr.](media/x-icon.png )|
|Business Central-integraties met andere Office-toepassingen|![Nr.](media/x-icon.png )|
|Business Central ingesloten in andere toepassingen |![Nr.](media/x-icon.png )|
...
|Zakelijke contacten zoeken |![Nr.](media/x-icon.png )|
|Een voorbeeld van een koppeling plakken en delen als een kaart|![Nr.](media/x-icon.png )|

Functies van de [!INCLUDE [prod_short](includes/prod_short.md)]-client ingebed in Teams:

|Functie |Beschikbaar|Voorbeeldfuncties|
|-|-|-|
|Systeemacties voor gegevensmanipulatie |![Nr.](media/x-icon.png )|Bewerken, maken, verwijderen|
|Basisfuncties in lijsten|![Ja](media/check.png)|Zoeken, sorteren, lay-out wijzigen|
|Geavanceerde functies in lijsten|![Nr.](media/x-icon.png )|Filterdeelvenster, weergaven|
|Inzoomen van lijst naar kaart |![Ja](media/check.png)||
|Gegevens openen vanuit gerelateerde tabellen|![Nr.](media/x-icon.png )|Feitenblokdeelvenster, veld-inzoomen, kijkje, opzoeken |
|Acties|![Nr.](media/x-icon.png )|Actiebalk, actiemenu's, acties voor paginameldingen|
|Systeembrede sneltoetsen|![Nr.](media/x-icon.png )|Mijn instellingen, Rolverkenner, Vertel me-zoeken  |
|Kopiëren|![Ja](media/check.png)|Rijen kopiëren, veldwaarde kopiëren, koppeling naar pagina kopiëren|
|UI-aanpassing|![Nr.](media/x-icon.png )|Personaliseren| 
|Inline-aanpassing|![Ja](media/check.png)|Grootte van kolom wijzigen, Uitvouwen/samenvouwen, Meer tonen |
|Delen van gegevens |![Nr.](media/x-icon.png )|Openen of bewerken in Excel, delen naar Teams|
|Inline gebruikersondersteuning|![Ja](media/check.png) |Knopinfo, koppelingen naar documentatie|
|Geavanceerde gebruikersondersteuning |![Nr.](media/x-icon.png )|Leertips voor pagina en veld, Help-deelvenster|

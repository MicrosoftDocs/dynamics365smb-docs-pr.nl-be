...
# <a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a><a name="business-central-access-with-microsoft-365-licenses"></a>Business Central-toegang met Microsoft 365-licenties
...
## <a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a><a name="why-enable-access-with-microsoft-365-licenses"></a>Waarom toegang met Microsoft 365-licenties inschakelen
...
## <a name="use-rights"></a><a name="use-rights"></a><a name="use-rights"></a>Gebruiksrechten
...
 
### <a name="client-access"></a><a name="client-access"></a><a name="client-access"></a>Client-toegang
...
### <a name="data-access"></a><a name="data-access"></a><a name="data-access"></a>Toegang tot gegevens
...
### <a name="use-of-objects"></a><a name="use-of-objects"></a><a name="use-of-objects"></a>Gebruik van objecten
...
## <a name="simplified-user-interface"></a><a name="simplified-user-interface"></a><a name="simplified-user-interface"></a>Vereenvoudigde gebruikersinterface
...
### <a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a><a name="requirements-to-enable-access"></a>Vereisten om toegang in te schakelen

- [!INCLUDE [prod_short](includes/prod_short.md)] online (SaaS).

- Omgevingen moeten platformversie 21.1 of hoger zijn.

### <a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a><a name="requirements-for-individual-users-to-access-data-in-teams"></a>Vereisten voor individuele gebruikers om toegang te krijgen tot gegevens in Teams

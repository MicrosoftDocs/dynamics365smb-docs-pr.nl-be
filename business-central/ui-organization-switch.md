...
# <a name="switching-to-another-company-or-environment" />Overschakelen naar een ander bedrijf of een andere omgeving
...
## <a name="about-companies-and-environments" />Bedrijven en omgevingen
...
## <a name="features-for-switching-company-or-environment" />Functies voor het overschakelen naar een ander bedrijf of een andere omgeving
...
## <a name="use-the-company-switcher" />De bedrijfsschakelaar gebruiken
...
## <a name="use-the-app-launcher" />Het app-opstartprogramma gebruiken
...
-->
## <a name="use-my-settings" />Mijn instellingen gebruiken
...
## <a name="use-company-hub" />Bedrijfshub gebruiken

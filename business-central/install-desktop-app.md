...
- Als u meer dan één [!INCLUDE [prod_short](includes/prod_short.md)]-omgeving heeft (alleen online), kunt u de app voor elke omgeving afzonderlijk installeren.
...
3. Als de app is geïnstalleerd, kiest u **Openen** en meldt u zich vervolgens aan bij [!INCLUDE [prod_short](includes/prod_short.md)].

...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Records koppelen en synchroniseren tussen Dataverse en Business Central
...
## <a name="to-synchronize-a-single-record-from-"></a>Eén record synchroniseren vanuit [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="bulk-insert-and-couple-records"></a>Records bulk-invoegen en koppelen

...
# <a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a><a name="couple-and-synchronize-records-between-dataverse-and-business-central"></a>Records koppelen en synchroniseren tussen Dataverse en Business Central
...
## <a name="video-example"></a><a name="video-example"></a>Videovoorbeeld
...
## <a name="to-couple-a-record"></a><a name="to-couple-a-record"></a>Een record koppelen
...
## <a name="to-synchronize-a-single-record"></a><a name="to-synchronize-a-single-record"></a>Eén record synchroniseren
...
## <a name="to-synchronize-a-single-record-from-"></a><a name="to-synchronize-a-single-record-from-"></a>Eén record synchroniseren vanuit [!INCLUDE[crm_md](includes/crm_md.md)]
...
## <a name="to-couple-multiple-records-using-match-based-coupling"></a><a name="to-couple-multiple-records-using-match-based-coupling"></a>Meerdere records koppelen met behulp van op overeenkomsten gebaseerde koppeling
...
## <a name="to-synchronize-multiple-records"></a><a name="to-synchronize-multiple-records"></a>Meerdere records synchroniseren
...
## <a name="bulk-insert-and-couple-records"></a><a name="bulk-insert-and-couple-records"></a>Records bulk-invoegen en koppelen
...
## <a name="uncoupling-records"></a><a name="uncoupling-records"></a>Records ontkoppelen

...
---
# <a name="sell-assemble-to-order-items-and-inventory-items-together" />Op-order-assembleren-artikelen en voorraadartikelen samen verkopen
...
## <a name="to-sell-assemble-to-order-items-and-inventory-items-together" />Op-order-assembleren-artikelen en voorraadartikelen samen verkopen

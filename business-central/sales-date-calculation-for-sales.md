...
ms.author: edupont
---
# <a name="delivery-date-calculation-for-sales" />Leveringsdatumberekening voor verkoop
...
## <a name="calculating-a-requested-delivery-date" />Een verzochte leverdatum berekenen
...
## <a name="calculating-the-earliest-possible-delivery-date" />De eerst mogelijke leverdatum berekenen

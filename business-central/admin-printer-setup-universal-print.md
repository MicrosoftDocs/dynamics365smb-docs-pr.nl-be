...
# <a name="set-up-universal-print-printers" />Printers voor Universeel afdrukken instellen
...
## <a name="set-up-universal-print-and-printers-in-microsoft-azure" />Universeel afdrukken en printers instellen in Microsoft Azure
...
## <a name="add-printers-in-business-central-online" />Printers toevoegen aan Business Central online
...
## <a name="add-printers-in-business-central-on-premises" />Printers toevoegen aan Business Central on-premises
...
<!-- To Do Adding printers individually lets you duplicate printers with custom , like different paper trays and paper size and orientation.  To add printers individually, you'll need to know printer's share name in Universal Print. -->
### <a name="connect-to-universal-print-for-the-first-time" />Voor het eerst verbinding maken met Universeel afdrukken
...
## <a name="common-problems-and-resolutions" />Algemene problemen en oplossingen
...
### <a name="you-dont-have-access-to-the-printer-your-printer" />U hebt geen toegang tot de printer \<your-printer\>.
...
## <a name="there-was-an-error-fetching-printers-shared-to-you" />Er is een fout opgetreden bij het ophalen van met u gedeelde printers.

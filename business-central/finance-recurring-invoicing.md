...
---
# <a name="work-with-recurring-revenue-in-"></a>Werken met periodieke inkomsten in [!INCLUDE[prod_short](includes/prod_short.md)]
...
## <a name="create-multiple-invoices-based-on-a-recurring-project-journal"></a>Meerdere facturen maken op basis van een periodiek projectdagboek
...
### <a name="why-use-this-option-1"></a>Waarom deze optie gebruiken?
...
### <a name="why-use-this-option-2"></a>Waarom deze optie gebruiken?
...
### <a name="why-use-this-option-3"></a>Waarom deze optie gebruiken?
...
#### <a name="why-use-this-option-4"></a>Waarom deze optie gebruiken?
...
#### <a name="why-use-this-option-5"></a>Waarom deze optie gebruiken?

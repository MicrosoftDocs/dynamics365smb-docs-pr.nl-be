...
# <a name="assign-permissions-to-users-and-groups" />Machtigingen toewijzen aan gebruikers en groepen
...
## <a name="to-create-a-permission-set" />Een machtigingenset maken
...
### <a name="example---indirect-permission" />Voorbeeld: indirecte machtiging
...
### <a name="to-add-other-permission-sets" />Andere machtigingensets toevoegen
...
## <a name="to-copy-a-permission-set" />Een machtigingenset kopiëren
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions" />Machtigingen maken of wijzigen door uw acties op te nemen
...
### <a name="to-export-and-import-a-permission-set" />Een machtigingenset exporteren en importeren
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets" />Verouderde machtigingen uit alle machtigingensets verwijderen

Kies op de pagina **Machtigingensets** de actie **Verouderde machtigingen verwijderen**.

## <a name="to-set-up-time-constraints-for-users" />Tijdsbeperkingen voor gebruikers instellen
...
## <a name="to-manage-permissions-through-user-groups" />Machtigingen beheren via gebruikersgroepen
...
### <a name="to-add-users-to-a-user-group" />Gebruikers aan een gebruikersgroep toevoegen
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets" />Een gebruikersgroep en alle bijbehorende machtigingensets kopiëren
...
### <a name="to-assign-permission-sets-to-user-groups" />Machtigingssets toewijzen aan gebruikersgroepen
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-group-page" />Een machtigingsset toewijzen op de pagina **Machtigingsset per gebruikersgroep**
...
## <a name="to-assign-permission-sets-to-users" />Machtigingssets toewijzen aan gebruikers
...
### <a name="to-assign-a-permission-set-on-a-user-card" />Een machtigingenset op een gebruikerskaart toewijzen
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page" />Een machtigingenset op de pagina Machtigingenset per gebruiker toewijzen
...
## <a name="to-get-an-overview-of-a-users-permissions" />Een overzicht krijgen van de machtigingen van een gebruiker
...
### <a name="security-filters-limit-a-users-access-to-specific-records-in-a-table" />Beveiligingsfilters beperken de toegang van een gebruiker tot specifieke records in een tabel
...
## <a name="viewing-permission-changes-telemetry" />Telemetrie van machtigingswijzigingen weergeven
...
## <a name="delegated-admin-users" />Gedelegeerde beheerders

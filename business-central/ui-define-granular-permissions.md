...
## <a name="copy-a-permission-set"></a>Een machtigingenset kopiëren
...
## <a name="create-or-modify-permissions-by-recording-your-actions"></a>Machtigingen maken of wijzigen door uw acties op te nemen
...
## <a name="remove-obsolete-permissions-from-all-permission-sets"></a>Verouderde machtigingen uit alle machtigingensets verwijderen

Kies op de pagina **Machtigingensets** de actie **Verouderde machtigingen verwijderen**.

## <a name="set-up-time-constraints-for-users"></a>Tijdsbeperkingen voor gebruikers instellen
...
## <a name="control-access-to-specific-companies"></a>Toegang tot specifieke bedrijven beheren
...
## <a name="manage-permissions-through-user-groups"></a>Machtigingen beheren via gebruikersgroepen
...
## <a name="assign-permission-sets-to-users"></a>Machtigingssets toewijzen aan gebruikers
...
## <a name="get-an-overview-of-a-users-permissions"></a>Een overzicht krijgen van de machtigingen van een gebruiker
...
## <a name="view-permission-changes-telemetry"></a>Telemetrie van machtigingswijzigingen weergeven

...
# <a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a><a name="assign-permissions-to-users-and-groups"></a>Machtigingen toewijzen aan gebruikers en groepen
...
## <a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a><a name="to-create-a-permission-set"></a>Een machtigingenset maken
...
5. Op de pagina **Machtigingenset** kunt u in het veld **Type** als volgt machtigingen opnemen of uitsluiten:
  ...
  > [!NOTE]
  > Als een toestemming zowel is opgenomen als uitgesloten, wordt de toestemming uitgesloten.
...
### <a name="example---indirect-permission"></a><a name="example---indirect-permission"></a><a name="example---indirect-permission"></a>Voorbeeld: indirecte machtiging
...
### <a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a><a name="to-add-other-permission-sets"></a>Andere machtigingensets toevoegen
...
## <a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a><a name="to-copy-a-permission-set"></a>Een machtigingenset kopiëren
...
## <a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a><a name="to-create-or-modify-permissions-by-recording-your-actions"></a>Machtigingen maken of wijzigen door uw acties op te nemen
...
### <a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a><a name="to-export-and-import-a-permission-set"></a>Een machtigingenset exporteren en importeren
...
## <a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a><a name="to-remove-obsolete-permissions-from-all-permission-sets"></a>Verouderde machtigingen uit alle machtigingensets verwijderen

Kies op de pagina **Machtigingensets** de actie **Verouderde machtigingen verwijderen**.

## <a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a><a name="to-set-up-time-constraints-for-users"></a>Tijdsbeperkingen voor gebruikers instellen
...
## <a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a><a name="to-manage-permissions-through-user-groups"></a>Machtigingen beheren via gebruikersgroepen
...
### <a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a><a name="to-add-users-to-a-user-group"></a>Gebruikers aan een gebruikersgroep toevoegen
...
### <a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a><a name="to-copy-a-user-group-and-all-its-permission-sets"></a>Een gebruikersgroep en alle bijbehorende machtigingensets kopiëren
...
### <a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a><a name="to-assign-permission-sets-to-user-groups"></a>Machtigingssets toewijzen aan gebruikersgroepen
...
## <a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a><a name="to-assign-permission-sets-to-users"></a>Machtigingssets toewijzen aan gebruikers
...
### <a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a><a name="to-assign-a-permission-set-on-a-user-card"></a>Een machtigingenset op een gebruikerskaart toewijzen
...
### <a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a><a name="to-assign-a-permission-set-on-the-permission-set-by-user-page"></a>Een machtigingenset op de pagina Machtigingenset per gebruiker toewijzen
...
## <a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a><a name="to-get-an-overview-of-a-users-permissions"></a>Een overzicht krijgen van de machtigingen van een gebruiker
...
## <a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a><a name="viewing-permission-changes-telemetry"></a>Telemetrie van machtigingswijzigingen weergeven
...
## <a name="delegated-admin-users"></a><a name="delegated-admin-users"></a><a name="delegated-admin-users"></a>Gedelegeerde beheerders

...
# <a name="work-with-word-layouts"></a><a name="work-with-word-layouts"></a>Werken met Word-lay-outs
...
## <a name="embedding-fonts-in-word-layouts-for-consistency"></a><a name="embedding-fonts-in-word-layouts-for-consistency"></a>Lettertypen insluiten in Word-lay-outs voor consistentie
...
## <a name="adding-data-fields"></a><a name="adding-data-fields"></a>Gegevensvelden toevoegen
...
### <a name="to-open-the-custom-xml-part-for-the-report-in-word"></a><a name="to-open-the-custom-xml-part-for-the-report-in-word"></a><a name="OpenXMLPart"></a> Het aangepaste XML-onderdeel voor het rapport openen in Word
...
### <a name="to-add-a-label-or-data-field"></a><a name="to-add-a-label-or-data-field"></a>Een label- of gegevensveld toevoegen
...
### <a name="to-add-repeating-rows-of-data-fields-to-create-a-list"></a><a name="to-add-repeating-rows-of-data-fields-to-create-a-list"></a>Als u herhalende rijen met gegevensvelden wilt toevoegen, maakt u een lijst
...
## <a name="adding-image-fields"></a><a name="adding-image-fields"></a>Afbeeldingsvelden toevoegen
...
### <a name="to-add-an-image"></a><a name="to-add-an-image"></a>Een afbeelding toevoegen
...
## <a name="removing-label-and-data-fields"></a><a name="removing-label-and-data-fields"></a><a name="RemoveField"></a> Label- en gegevensvelden verwijderen
...
### <a name="to-remove-a-label-or-data-field"></a><a name="to-remove-a-label-or-data-field"></a>Een label- of gegevensveld verwijderen
...
## <a name="custom-xml-part-overview"></a><a name="custom-xml-part-overview"></a>Overzicht van het aangepaste XML-onderdeel
...
### <a name="xml-structure-of-custom-xml-part"></a><a name="xml-structure-of-custom-xml-part"></a>XML-structuur van aangepast XML-onderdeel
...
### <a name="custom-xml-part-in-word"></a><a name="custom-xml-part-in-word"></a>Aangepast XML-onderdeel in Word

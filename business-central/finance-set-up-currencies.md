...
Gebruik een externe service om de laatste valutawisselkoersen op te halen in de lijst **Valuta's**. Zie [Een wisselkoersservice instellen](finance-how-update-currencies.md#set-up-a-currency-exchange-rate-service) voor meer informatie.  

[!INCLUDE [finance-currencies-lcy](includes/finance-currencies-lcy-note.md)]

## <a name="curr"></a>Valuta's
...
||**Wisselkoersen herwaarderen**|Saldi bijwerken voor grootboek-, klant-, leveranciers- en bankrekeningposten. De update is handig als de wisselkoers is gewijzigd nadat de posten zijn geboekt.|

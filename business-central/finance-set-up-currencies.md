...
ms.author: edupont
---
# <a name="set-up-currencies"></a><a name="set-up-currencies"></a>Valuta's instellen
...
## <a name="currencies"></a><a name="currencies"></a><a name="curr"></a>Valuta's
...
### <a name="available-currency-functions"></a><a name="available-currency-functions"></a>Beschikbare valutafuncties
...
## <a name="lcy-and-other-currencies"></a><a name="lcy-and-other-currencies"></a>LV en andere valuta's

[!INCLUDE [finance-currencies-lcy-def](includes/finance-currencies-lcy-def.md)]

## <a name="rounding-currencies"></a><a name="rounding-currencies"></a>Valuta's afronden
...
### <a name="unit-amount-rounding"></a><a name="unit-amount-rounding"></a>Prijsafronding
...
### <a name="amount-rounding"></a><a name="amount-rounding"></a>Bedragafronding
...
## <a name="general-ledger-accounts"></a><a name="general-ledger-accounts"></a>Grootboekrekeningen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/currencies-exchange-rates-dynamics-365-business-central/)

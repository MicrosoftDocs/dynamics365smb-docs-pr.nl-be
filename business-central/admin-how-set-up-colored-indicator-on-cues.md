...
ms.author: jswymer
---
# <a name="set-up-a-colored-indicator-on-cues-for-the-company-or-individual-users" />Een gekleurde indicator voor indicatiestapels instellen voor het bedrijf of voor afzonderlijke gebruikers
...
### <a name="to-set-up-colored-indicators-on-cues" />Gekleurde indicatoren instellen voor indicatiestapels

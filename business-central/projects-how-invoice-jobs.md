...
ms.author: edupont
---
# <a name="invoice-jobs" />Projecten factureren
...
## <a name="to-create-multiple-job-sales-invoices" />Meerdere projectverkoopfacturen maken
...
## <a name="to-create-and-post-job-sales-invoice-from-job-planning-lines" />Projectverkoopfacturen maken en boeken vanuit projectplanningsregels

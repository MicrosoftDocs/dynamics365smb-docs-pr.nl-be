...
ms.author: edupont
---
# <a name="legacy-update-custom-report-layouts" />(verouderd) Aangepaste rapportlay-outs bijwerken
...
## <a name="to-update-one-or-more-custom-report-layouts" />Een of meer aangepaste rapportlay-outs bijwerken
...
## <a name="to-test-custom-report-layout-updates" />Updates van aangepaste rapportlay-outs testen

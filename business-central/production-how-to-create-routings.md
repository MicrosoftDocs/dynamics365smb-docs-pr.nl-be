...
ms.author: edupont
---
# <a name="create-routings"></a><a name="create-routings"></a><a name="create-routings"></a>Bewerkingsplannen maken
...
## <a name="to-create-a-routing"></a><a name="to-create-a-routing"></a><a name="to-create-a-routing"></a>Een bewerkingsplan maken
...
## <a name="to-create-routing-links"></a><a name="to-create-routing-links"></a><a name="to-create-routing-links"></a>Bewerkingsplankoppelingen maken
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a><a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations"></a>Medewerkers, tools en kwaliteitsmetingen toewijzen aan bewerkingsplannen
...
## <a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a><a name="to-create-a-new-versions-of-a-routing"></a>Nieuwe versies maken van bewerkingsplannen

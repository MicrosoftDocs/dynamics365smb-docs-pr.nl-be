...
ms.author: edupont
---
# <a name="create-routings" />Bewerkingsplannen maken
...
## <a name="to-create-a-routing" />Een bewerkingsplan maken
...
## <a name="to-create-routing-links" />Bewerkingsplankoppelingen maken
...
## <a name="to-assign-personnel-tools-and-quality-measures-to-routing-operations" />Medewerkers, tools en kwaliteitsmetingen toewijzen aan bewerkingsplannen
...
## <a name="to-create-a-new-versions-of-a-routing" />Nieuwe versies maken van bewerkingsplannen

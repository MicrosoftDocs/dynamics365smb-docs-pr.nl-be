...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a><a name="work-with-intrastat-reporting"></a>Werken met Intrastat-rapportage
...
## <a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a><a name="fill-in-the-intrastat-report"></a>Het Intrastat-rapport invullen
...
7. U kunt op den duur extra configuraties instellen op het sneltabblad **Aanvullend**:
   ...
   3. **Artikeltoeslagposten weergeven** om op te geven of de directe kosten worden weergegeven die uw bedrijf heeft toegewezen en worden geboekt als artikeltoeslagen.
   4. **Niet-gefactureerde posten overslaan** om op te geven of artikelposten die zijn verzonden of ontvangen maar nog niet zijn gefactureerd moeten worden uitgesloten van het proces.
...
## <a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a><a name="modify-the-intrastat-report"></a>Het Intrastat-rapport wijzigen
...
## <a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a><a name="validate-intrastat-lines"></a>Intrastat-regels valideren
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a><a name="recalculating-weight-or-supplementary-unit-of-measure"></a>Gewicht of aanvullende maateenheid herberekenen
...
## <a name="intrastat-rules"></a><a name="intrastat-rules"></a><a name="intrastat-rules"></a>Intrastat-regels
...
### <a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a><a name="fixed-assets-reporting"></a>Vaste activa rapporteren
...
### <a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a><a name="intrastat-report-statuses"></a>Intrastat-rapportstatussen

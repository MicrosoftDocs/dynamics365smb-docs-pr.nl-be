...
ms.author: altotovi
---
# <a name="work-with-intrastat-reporting" />Werken met Intrastat-rapportage
...
## <a name="fill-in-the-intrastat-report" />Het Intrastat-rapport invullen
...
## <a name="modify-the-intrastat-report" />Het Intrastat-rapport wijzigen
...
## <a name="validate-intrastat-lines" />Intrastat-regels valideren
...
## <a name="recalculating-weight-or-supplementary-unit-of-measure" />Gewicht of aanvullende maateenheid herberekenen
...
## <a name="intrastat-rules" />Intrastat-regels
...
### <a name="fixed-assets-reporting" />Vaste activa rapporteren
...
### <a name="intrastat-report-statuses" />Intrastat-rapportstatussen

...
## <a name="to-set-up-bank-accounts" />Bankrekeningen instellen
...
## <a name="to-enter-an-opening-balance" />Een beginsaldo invoeren
...
## <a name="to-set-up-your-bank-account-for-import-or-export-of-bank-files" />Uw bankrekening instellen om bankbestanden te importeren of te exporteren
...
## <a name="to-set-up-vendor-bank-accounts-for-export-of-bank-files" />Bankrekeningen van leveranciers instellen voor de export van bankbestanden
...
## <a name="changing-your-bank-account" />Uw bankrekening wijzigen

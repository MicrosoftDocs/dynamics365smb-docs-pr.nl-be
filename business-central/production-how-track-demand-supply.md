...
ms.author: edupont
---
# <a name="track-relations-between-demand-and-supply" />Relaties tussen vraag en aanbod bijhouden
...
## <a name="to-track-linked-items" />Gekoppelde artikelen traceren
...
## <a name="untracked-planning-elements" />Niet-getraceerde planningselementen

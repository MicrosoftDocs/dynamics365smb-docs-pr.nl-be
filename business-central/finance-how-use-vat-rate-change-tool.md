...
# <a name="managing-vat-rate-changes"></a><a name="managing-vat-rate-changes"></a>Wijzigingen in btw-tarieven beheren
...
## <a name="changing-vat-rates"></a><a name="changing-vat-rates"></a>Btw-tarieven wijzigen
...
## <a name="the-vat-rate-change-tool"></a><a name="the-vat-rate-change-tool"></a>De Wijzigingstool btw-tarief
...
## <a name="understanding-the-vat-rate-conversion-process-and-limitations"></a><a name="understanding-the-vat-rate-conversion-process-and-limitations"></a>Het proces en de beperkingen voor het converteren van btw-tarieven begrijpen
...
### <a name="to-prepare-vat-rate-change-conversions"></a><a name="to-prepare-vat-rate-change-conversions"></a>Conversies van btw-tariefswijziging voorbereiden
...
### <a name="to-set-up-the-vat-rate-change-tool"></a><a name="to-set-up-the-vat-rate-change-tool"></a>Het wijzigingstool btw-tarief instellen
...
### <a name="to-set-up-product-posting-group-conversion"></a><a name="to-set-up-product-posting-group-conversion"></a>Conversie voor productboekingsgroepen instellen
...
### <a name="to-perform-vat-rate-change-conversion"></a><a name="to-perform-vat-rate-change-conversion"></a>Een conversie voor een btw-tariefswijziging uitvoeren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/rate-change-dynamics-365-business-central/)

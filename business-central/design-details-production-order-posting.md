...
ms.author: edupont
---
# <a name="design-details-production-order-posting" />Ontwerpdetails: Productieorderboeking
...
## <a name="posting-structure" />Boekingsstructuur
...
## <a name="capacity-posting" />Capaciteitsboeking
...
## <a name="production-order-costing" />Kostprijsberekening voor productieorder

...
ms.author: edupont
---
# <a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a><a name="design-details-production-order-posting"></a>Ontwerpdetails: Productieorderboeking
...
## <a name="posting-structure"></a><a name="posting-structure"></a><a name="posting-structure"></a>Boekingsstructuur
...
## <a name="capacity-posting"></a><a name="capacity-posting"></a><a name="capacity-posting"></a>Capaciteitsboeking
...
## <a name="production-order-costing"></a><a name="production-order-costing"></a><a name="production-order-costing"></a>Kostprijsberekening voor productieorder

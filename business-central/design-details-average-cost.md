...
ms.author: bholtorf
---
# <a name="design-details-average-cost" />Ontwerpdetails: Gemiddelde kosten

De gemiddelde kostprijs van een artikel wordt berekend met een periodiek gewogen gemiddelde. Het gemiddelde is gebaseerd op de gemiddelde kostenperiode die is ingesteld in [!INCLUDE[prod_short](includes/prod_short.md)].  

De herwaarderingsdatum wordt automatisch ingesteld.  

## <a name="setting-up-average-cost-calculation" />Berekening voor de gemiddelde kosten instellen
...
## <a name="calculating-average-cost" />Gemiddelde kosten berekenen
...
### <a name="example-average-cost-period--day" />Voorbeeld: Periode gemiddelde kostprijsberekening = Dag
...
> Omdat de kostprijscorrectie nog niet is opgetreden, worden de waarden in het veld **Tot. werk. kosten** van de voorraad verlaagd in overeenstemming met de positieve voorraadmutatie waarop ze worden toegepast.  
 ...
 De volgende tabel toont de posten in de tabel **Gem. kostprijsaanpassing invoerhaven** die van toepassing zijn op waardeposten die afkomstig zijn uit de artikelposten in de voorgaande tabel.  
...
### <a name="example-average-cost-period--month" />Voorbeeld: Periode gemiddelde kostprijsberekening = Maand
...
## <a name="setting-the-valuation-date" />De waarderingsdatum instellen
...
## <a name="recalculating-average-cost" />Gemiddelde kosten opnieuw berekenen
...
### <a name="example-of-recalculated-average-cost" />Voorbeeld van opnieuw berekende gemiddelde kosten

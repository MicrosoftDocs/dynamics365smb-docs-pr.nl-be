...
ms.author: edupont
---
# <a name="walkthrough-planning-supplies-manually" />Procedure: Leveringen handmatig plannen
...
## <a name="setting-up-the-sample-data" />Voorbeeldgegevens instellen
...
## <a name="use-the-order-planning-page" />De pagina Orderplanning gebruiken
...
### <a name="to-use-the-order-planning-page" />De pagina Orderplanning gebruiken
...
## <a name="planning-a-purchase-order-to-fulfill-component-demand" />Een inkooporder plannen om te voldoen aan de vraag naar onderdelen
 In deze procedure maakt u een inkooporder voor de benodigde productieonderdelen.  

### <a name="to-plan-a-purchase-order-to-fulfill-component-need-in-production" />Een inkooporder plannen om te voldoen aan de onderdelenbehoefte voor de productie
...
## <a name="planning-a-transfer-order-to-fulfill-sales-demand" />Een transferorder plannen om aan de verkoopvraag te voldoen
...
### <a name="to-plan-a-transfer-order-to-fulfill-sales-demand" />Een transferorder plannen om aan de verkoopvraag te voldoen
...
## <a name="planning-a-multilevel-production-order-to-fulfill-sales-demand" />Een productieorder met meerdere niveaus plannen om aan de verkoopvraag te voldoen
...
### <a name="to-plan-multilevel-production-to-fulfill-sales-demand" />Een productie met meerdere niveaus plannen om aan de verkoopvraag te voldoen
...
### <a name="to-plan-a-specific-production-order" />Een specifieke productieorder plannen

...
# <a name="ship-items-with-a-warehouse-shipment"></a><a name="ship-items-with-a-warehouse-shipment"></a>Artikelen verzenden met een magazijnverzending
...
## <a name="to-ship-items-using-a-warehouse-shipment-document"></a><a name="to-ship-items-using-a-warehouse-shipment-document"></a>Artikelen verzenden met een magazijnverzendingsdocument
...
## <a name="how-to-use-filters-to-get-source-documents"></a><a name="how-to-use-filters-to-get-source-documents"></a>Filters gebruiken om brondocumenten op te halen
...
## <a name="zone-and-bin-codes"></a><a name="zone-and-bin-codes"></a>Zone- en opslaglocatiecodes
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments"></a><a name="handling-assemble-to-order-items-in-warehouse-shipments"></a>Op-order-assembleren-artikelen in magazijnverzendingen afhandelen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/ship-invoice-items-dynamics-365-business-central/)

...
# <a name="ship-items-with-a-warehouse-shipment" />Artikelen verzenden met een magazijnverzending
...
## <a name="to-ship-items-using-a-warehouse-shipment-document" />Artikelen verzenden met een magazijnverzendingsdocument
...
## <a name="handling-assemble-to-order-items-in-warehouse-shipments" />Op-order-assembleren-artikelen in magazijnverzendingen afhandelen
...
## <a name="see-related-microsoft-trainingtrainingmodulesship-invoice-items-dynamics--business-central" />Zie gerelateerde [Microsoft-training](/training/modules/ship-invoice-items-dynamics-365-business-central/)

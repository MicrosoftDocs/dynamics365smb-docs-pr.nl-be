...
Als u artikel 1928-S op locatie ZUID beschikbaar wilt maken, volgt u deze stappen:  
  ...
  2. Open het standaarddagboek en maak twee artikeldagboekregels met de volgende informatie over de werkdatum (23 januari).  
        ...
        |Boekingssoort|Artikelnummer|Vestigingscode|Bin Code|Hoeveelheid|  
        |----------------|-----------------|-------------------|--------------|--------------|  
        |Positieve correctie|1928-S|ZUID|S-01-0001|2.0|  
        |Positieve correctie|1928-S|ZUID|S-01-0002|2.0|  

        Standaard is het veld **Opslaglocatie** op de verkoopregels verborgen, dus u moet het weergeven. Hiervoor moet u de pagina personaliseren. Zie voor meer informatie [Een pagina personaliseren via de banner Personaliseren](ui-personalization-user.md#start-personalizing-by-using-the-personalization-mode).
...
3. Maak een verkooporder voor klant 10000 op 23 januari (werkdatum) met de volgende verkooporderregel.  
    ...
    |Artikel|Vestigingscode|Hoeveelheid|  
    |----|-------------|--------|  
    |1928-S|ZUID|30|  

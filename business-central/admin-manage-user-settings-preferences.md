...
ms.author: soalex
---
# <a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a><a name="manage-user-settings-and-preferences"></a>Gebruikersinstellingen en voorkeuren beheren
...
## <a name="types-of-user-settings"></a><a name="types-of-user-settings"></a><a name="types-of-user-settings"></a>Soorten gebruikersinstellingen
...
## <a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a><a name="overview-of-all-user-specific-changes"></a>Overzicht van alle gebruikersspecifieke wijzigingen
...
## <a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a><a name="to-review-or-delete-user-personalizations"></a>Gebruikerspersonalisaties bekijken of verwijderen

...
ms.author: edupont
---
# <a name="walkthrough-calculating-work-in-process-for-a-job"></a><a name="walkthrough-calculating-work-in-process-for-a-job"></a>Procedure: Onderhanden werk voor een project berekenen
...
## <a name="calculating-wip"></a><a name="calculating-wip"></a>OHW berekenen
...
### <a name="to-calculate-wip"></a><a name="to-calculate-wip"></a>OHW berekenen
...
### <a name="to-review-wip-warnings"></a><a name="to-review-wip-warnings"></a>OHW-waarschuwingen bekijken
...
### <a name="to-recalculate-wip"></a><a name="to-recalculate-wip"></a>OHW opnieuw berekenen
...
## <a name="posting-wip-to-general-ledger"></a><a name="posting-wip-to-general-ledger"></a>OHW boeken naar het grootboek

 Nadat Tricia het OHW voor dit project heeft berekend, kan het naar het grootboek worden geboekt.  

### <a name="to-post-wip-to-general-ledger"></a><a name="to-post-wip-to-general-ledger"></a>OHW naar het grootboek boeken
...
## <a name="reversing-a-wip-posting"></a><a name="reversing-a-wip-posting"></a>Een OHW-boeking tegenboeken
...
### <a name="to-reverse-a-wip-posting"></a><a name="to-reverse-a-wip-posting"></a>Een OHW-boeking tegenboeken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/calculate-post-job-wip/)

...
ms.author: edupont
---
# <a name="update-standard-costs"></a><a name="update-standard-costs"></a>Vaste verrekenprijs bijwerken
...
## <a name="to-update-standard-costs"></a><a name="to-update-standard-costs"></a>Vaste verrekenprijs aanpassen

...
# <a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams"></a><a name="searching-for-customers-vendors-and-other-contacts-from-microsoft-teams"></a>Zoeken naar klanten, leveranciers en andere contacten vanuit Microsoft Teams
...
## <a name="look-up-contacts-from-the-command-box"></a><a name="look-up-contacts-from-the-command-box"></a>Contacten opzoeken vanuit het opdrachtvak
...
## <a name="look-up-contacts-from-the-message-compose-box"></a><a name="look-up-contacts-from-the-message-compose-box"></a>Contacten opzoeken vanuit het berichtvak
...
### <a name="heres-another-way"></a><a name="heres-another-way"></a>Hier is een andere manier
...
## <a name="viewing-contact-card-details"></a><a name="viewing-contact-card-details"></a>Contactkaartgegevens bekijken

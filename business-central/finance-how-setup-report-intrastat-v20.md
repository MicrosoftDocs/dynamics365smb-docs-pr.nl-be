...
2. Vul de velden in. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)] Een sjabloon maken voor elk Intrastat-formulier dat u gebruikt.  
3. Als u batches wilt maken, kiest u de actie **Batches**.  
4. Vul de velden in. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]. Een sjabloon maken voor elk Intrastat-formulier dat u gebruikt.

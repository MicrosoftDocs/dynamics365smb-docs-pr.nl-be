...
ms.author: bholtorf
---
# <a name="set-up-and-report-intrastat" />Intrastat instellen en rapporteren
...
## <a name="required-and-optional-setups" />Vereiste en optionele instellingen
...
### <a name="to-set-up-intrastat-templates-and-batches" />Intrastat-sjablonen en -batches instellen
...
### <a name="to-set-up-transport-methods" />Transportmethoden instellen
...
### <a name="to-set-up-which-intrastat-report-fields-are-mandatory" />Instellen welke Intrastat-rapportvelden verplicht zijn
...
#### <a name="to-set-up-transaction-nature-codes" />Transactieaardcodes instellen
...
## <a name="to-report-intrastat" />Intrastat rapporteren
...
### <a name="to-fill-in-intrastat-journals" />Intrastat-dagboeken invullen
...
### <a name="to-modify-intrastat-journals-lines" />Intrastat-journaalregels wijzigen
...
### <a name="report-intrastat-on-a-form-or-a-file" />Intrastat rapporteren in een formulier of een bestand
...
### <a name="report-intrastat-in-a-file" />Intrastat in een bestand rapporteren
...
## <a name="reorganize-intrastat-journals" />Intrastat-dagboeken opnieuw indelen
...
## <a name="tariff-numbers" />Tariefcodes

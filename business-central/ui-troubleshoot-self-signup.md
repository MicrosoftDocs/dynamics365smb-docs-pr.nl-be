...
| --------------------- | -------------------- |
| Voor Microsoft 365-e-mailadressen die niet in een ondersteund land/regio zijn geregistreerd, ontvangt u tijdens de aanmelding een bericht zoals het volgende:<br /><br />**Uw land of regio wordt nog niet ondersteund.** |[!INCLUDE[d365fin](includes/d365fin_md.md)] ondersteunt momenteel alleen Microsoft 365-e-mailaccounts die zijn geregistreerd in een beperkt aantal markten. Zie voor meer informatie [Regionale beschikbaarheid](#regional-availability). |
...
| Als het Microsoft 365-account is geregistreerd in een ondersteund land/regio en u zich aanmeldt voor [!INCLUDE[d365fin](includes/d365fin_md.md)] terwijl u zich in een ander land/regio bevindt, ontvangt u tijdens de aanmelding een bericht zoals het volgende:<br /><br />**Uw land of regio wordt nog niet ondersteund.**| Het abonnement op Microsoft 365 van uw organisatie is geregistreerd in een specifiek land/regio in de beheerportal van Microsoft 365. De inschrijvingservaring voor [!INCLUDE[d365fin](includes/d365fin_md.md)] gebruikt de taal en de land/regio-instellingen die uw huidige browser gebruikt en daardoor kunt u de foutmelding krijgen hoewel u zich in een ondersteund land/regio bevindt. Vraag de IT-beheerder om het land/regio te verifiëren dat is opgegeven in het organisatieprofiel in de [beheerportal van Microsoft 365](https://portal.office.com/adminportal/home#/companyprofile). U moet een ander account gebruiken voor [!INCLUDE[d365fin](includes/d365fin_md.md)].|

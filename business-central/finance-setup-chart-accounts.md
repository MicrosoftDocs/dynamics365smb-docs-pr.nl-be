...
ms.author: edupont
---
# <a name="set-up-or-change-the-chart-of-accounts"></a><a name="set-up-or-change-the-chart-of-accounts"></a>De rekeningschema's instellen of wijzigen
...
## <a name="add-or-change-accounts"></a><a name="add-or-change-accounts"></a>Rekeningen toevoegen of wijzigen
...
## <a name="delete-accounts"></a><a name="delete-accounts"></a>Rekeningen verwijderen
...
## <a name="block-deletion-of-gl-accounts"></a><a name="block-deletion-of-gl-accounts"></a>Verwijderen van grootboekrekeningen blokkeren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/chart-accounts-dynamics-365-business-central/index)

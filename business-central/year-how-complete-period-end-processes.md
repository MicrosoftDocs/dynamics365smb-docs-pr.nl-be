...
ms.author: jswymer
---
# <a name="overview-of-tasks-to-close-accounting-periods" />Overzicht van taken voor het sluiten van boekingsperioden
...
## <a name="general-ledger" />Grootboek
...
## <a name="sales-and-receivables" />Verkopen en tegoeden
...
## <a name="purchases-and-payables" />Inkopen en schulden
...
## <a name="fixed-assets" />Vaste activa
...
## <a name="intercompany" />Intercomp

* IC-transacties verwerken.

## <a name="calculate-and-process-sales-tax" />Btw berekenen en verwerken

* Belastingaangiften invullen.  

## <a name="see-related-microsoft-trainingtrainingmodulesclose-fiscal-year-dynamics--business-central" />Zie gerelateerde [Microsoft-training](/training/modules/close-fiscal-year-dynamics-365-business-central/)

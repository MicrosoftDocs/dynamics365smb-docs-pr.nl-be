...
ms.author: edupont
---
# <a name="work-on-service-tasks"></a><a name="work-on-service-tasks"></a>Werken aan servicetaken
...
## <a name="to-work-on-a-service-task"></a><a name="to-work-on-a-service-task"></a>Werken aan servicetaken
...
## <a name="to-register-service-operations"></a><a name="to-register-service-operations"></a>Servicewerkzaamheden registreren
...
## <a name="to-register-spare-parts"></a><a name="to-register-spare-parts"></a>Reserveonderdelen registreren
...
## <a name="to-register-spare-parts-from-a-service-order"></a><a name="to-register-spare-parts-from-a-service-order"></a>Reserveonderdelen registreren vanuit een serviceorder
...
## <a name="to-replace-a-service-item-or-a-service-item-component"></a><a name="to-replace-a-service-item-or-a-service-item-component"></a>Een serviceartikel of serviceartikelonderdeel vervangen
...
## <a name="to-change-the-response-time-for-a-service-item-line"></a><a name="to-change-the-response-time-for-a-service-item-line"></a>Responstijd wijzigen voor een serviceartikelregel
...
## <a name="to-register-faultresolution-codes"></a><a name="to-register-faultresolution-codes"></a>Probleem-/oplossingscodes registreren

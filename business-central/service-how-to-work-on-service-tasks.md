...
ms.author: edupont
---
# <a name="work-on-service-tasks" />Werken aan servicetaken
...
## <a name="to-work-on-a-service-task" />Werken aan servicetaken
...
## <a name="to-register-service-operations" />Servicewerkzaamheden registreren
...
## <a name="to-register-spare-parts" />Reserveonderdelen registreren
...
## <a name="to-register-spare-parts-from-a-service-order" />Reserveonderdelen registreren vanuit een serviceorder
...
## <a name="to-replace-a-service-item-or-a-service-item-component" />Een serviceartikel of serviceartikelonderdeel vervangen
...
## <a name="to-change-the-response-time-for-a-service-item-line" />Responstijd wijzigen voor een serviceartikelregel
...
## <a name="to-register-faultresolution-codes" />Probleem-/oplossingscodes registreren

...
ms.author: edupont
---
# <a name="set-up-units-of-measure" />Maateenheden instellen
...
## <a name="to-set-up-units-of-measure" />Maateenheden instellen
...
## <a name="to-set-up-multiple-item-units-of-measure" />Meerdere maateenheden voor artikelen instellen
...
## <a name="to-set-up-unit-of-measure-translations" />Eenheidsvertalingen instellen
...
## <a name="to-enter-a-default-unit-of-measure-code-for-sales-and-purchasing-transactions" />Standaardeenheidscodes invoeren voor verkoop- en inkooptransacties

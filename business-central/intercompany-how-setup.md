...
---
# <a name="set-up-intercompany-transactions" />IC-transacties beheren
...
## <a name="overview-of-the-steps-to-get-started" />Overzicht van de stappen om aan de slag te gaan
...
## <a name="set-up-a-synchronization-partner" />Een synchronisatiepartner instellen
...
## <a name="set-up-the-intercompany-charts-of-accounts" />Het IC-rekeningschema instellen
...
### <a name="import-or-export-an-intercompany-chart-of-accounts" />Het IC-rekeningschema importeren of exporteren
...
## <a name="map-the-intercompany-chart-of-accounts-to-your-companys-chart-of-accounts" />Het IC-rekeningschema toewijzen aan het rekeningschema van uw bedrijf
...
## <a name="set-up-intercompany-dimensions" />IC-dimensies instellen
...
### <a name="import-or-export-intercompany-dimensions" />IC-dimensies importeren of exporteren
...
### <a name="map-intercompany-dimensions-to-your-companys-dimensions" />IC-dimensies toewijzen aan dimensies van uw bedrijf
...
## <a name="set-up-intercompany-general-journal-templates-and-batches" />IC-dagboeksjablonen en -batches instellen
...
## <a name="set-up-a-company-for-intercompany-transactions" />Een bedrijf instellen voor IC-transacties
...
## <a name="set-up-intercompany-partners" />IC-partners instellen
...
### <a name="set-up-intercompany-partners-as-customers-and-vendors" />IC-partners instellen als klanten en leveranciers
...
### <a name="set-up-default-intercompany-partner-general-ledger-accounts" />Standaardgrootboekrekeningen voor IC-partners instellen
...
### <a name="auto-accept-transactions-from-intercompany-partners" />Transacties van IC-partners automatisch accepteren
...
### <a name="specify-the-bank-accounts-to-use-for-intercompany-partners" />De bankrekeningen opgeven die moeten worden gebruikt voor IC-partners
...
## <a name="troubleshoot-your-intercompany-setup" />Problemen met uw IC-instellingen oplossen

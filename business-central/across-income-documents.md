...
ms.author: edupont
---
# <a name="incoming-documents"></a><a name="incoming-documents"></a><a name="incoming-documents"></a>Inkomende documenten
...
## <a name="usage-scenario"></a><a name="usage-scenario"></a><a name="usage-scenario"></a>Gebruiksscenario
...
## <a name="incoming-document-features"></a><a name="incoming-document-features"></a><a name="incoming-document-features"></a>Functies voor inkomende documenten

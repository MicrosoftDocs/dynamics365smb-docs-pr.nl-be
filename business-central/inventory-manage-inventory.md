...
> [!NOTE]
> Naar de fysieke verwerking van artikelen wordt verwezen als magazijnactiviteiten. Lees meer op [Magazijnbeheer](warehouse-manage-warehouse.md).
...
## <a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/get-started-inventory-management/)

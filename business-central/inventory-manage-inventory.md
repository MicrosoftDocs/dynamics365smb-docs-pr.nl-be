...
| Voer ad-hocanalyses uit van voorraadgegevens rechtstreeks op lijstpagina's en query's. | [Ad-hocanalyse van voorraadgegevens](ad-hoc-analysis-inventory.md) |
...
|Beschikbaarheid van artikelen weergeven op vestiging, periode, verkoop- of inkoopgebeurtenis, of het gebruik in assemblage- of productiestuklijsten.|[De beschikbaarheid van artikelen weergeven](inventory-how-availability-overview.md)|
...
|Artikeltracering instellen zodat u artikelserienummers kunt volgen, bijvoorbeeld wanneer u artikelen moet traceren in geval van terugroepacties.|[Artikeltracering instellen met serie-, lot- en pakketnummers](inventory-how-setup-item-tracking.md)|

...
ms.author: edupont
---
# <a name="set-up-resources-for-projects"></a><a name="set-up-resources-for-projects"></a>Resources instellen voor projecten
...
## <a name="to-set-up-a-resource"></a><a name="to-set-up-a-resource"></a>Een resource instellen
...
## <a name="to-set-up-a-resource-group"></a><a name="to-set-up-a-resource-group"></a>Een gebruikersgroep instellen
...
## <a name="to-set-capacity-for-a-resource"></a><a name="to-set-capacity-for-a-resource"></a>Capaciteit voor een resource instellen
...
## <a name="to-set-up-alternate-resource-costs"></a><a name="to-set-up-alternate-resource-costs"></a>Alternatieve resourcekosten instellen
...
## <a name="to-set-up-alternate-resource-prices"></a><a name="to-set-up-alternate-resource-prices"></a>Alternatieve resourceprijzen instellen

...
ms.author: edupont
---
# <a name="set-up-resources-for-projects" />Resources instellen voor projecten
...
## <a name="to-set-up-a-resource" />Een resource instellen
...
## <a name="to-set-up-a-resource-group" />Een gebruikersgroep instellen
...
## <a name="to-set-capacity-for-a-resource" />Capaciteit voor een resource instellen
...
## <a name="to-set-up-alternate-resource-costs" />Alternatieve resourcekosten instellen
...
## <a name="to-set-up-alternate-resource-prices" />Alternatieve resourceprijzen instellen

...
ms.author: edupont
---
# <a name="design-details-item-application"></a><a name="design-details-item-application"></a>Ontwerpdetails: Artikelvereffening
...
## <a name="inventory-increase"></a><a name="inventory-increase"></a>Positieve voorraadmutatie
...
## <a name="inventory-decrease"></a><a name="inventory-decrease"></a>Negatieve voorraadmutatie
...
## <a name="fixed-application"></a><a name="fixed-application"></a>Vaste toepassing
...
### <a name="example--fixed-application-in-purchase-return"></a><a name="example--fixed-application-in-purchase-return"></a>Voorbeeld - Vaste vereffening in inkoopretour
...
### <a name="example--fixed-application-with-average-cost"></a><a name="example--fixed-application-with-average-cost"></a>Voorbeeld - Vaste vereffening met gemiddelde kosten
...
### <a name="example--fixed-application-in-sales-return"></a><a name="example--fixed-application-in-sales-return"></a>Voorbeeld - Vaste vereffening in verkoopretour
...
## <a name="transfer-application"></a><a name="transfer-application"></a>Transfervereffening
...
### <a name="example--average-costing-method"></a><a name="example--average-costing-method"></a>Voorbeeld - Gemiddelde waarderingsmethode
...
### <a name="example--standard-costing-method"></a><a name="example--standard-costing-method"></a>Voorbeeld: Waarderingsmethode Standaard
...
## <a name="reapplication"></a><a name="reapplication"></a>Opnieuw vereffenen

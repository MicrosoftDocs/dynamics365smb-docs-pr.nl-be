...
ms.author: edupont
---
# <a name="design-details-item-application" />Ontwerpdetails: Artikelvereffening
...
## <a name="inventory-increase" />Positieve voorraadmutatie
...
## <a name="inventory-decrease" />Negatieve voorraadmutatie
...
## <a name="fixed-application" />Vaste toepassing
...
### <a name="example--fixed-application-in-purchase-return" />Voorbeeld - Vaste vereffening in inkoopretour
...
### <a name="example--fixed-application-with-average-cost" />Voorbeeld - Vaste vereffening met gemiddelde kosten
...
### <a name="example--fixed-application-in-sales-return" />Voorbeeld - Vaste vereffening in verkoopretour
...
## <a name="transfer-application" />Transfervereffening
...
### <a name="example--average-costing-method" />Voorbeeld - Gemiddelde waarderingsmethode
...
### <a name="example--standard-costing-method" />Voorbeeld: Waarderingsmethode Standaard
...
## <a name="reapplication" />Opnieuw vereffenen

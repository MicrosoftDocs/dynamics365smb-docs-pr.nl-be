...
ms.author: bholtorf
---
# <a name="define-retention-policies"></a><a name="define-retention-policies"></a>Bewaarbeleid definiëren
...
## <a name="required-setups-and-permissions"></a><a name="required-setups-and-permissions"></a>Vereiste instellingen en machtigingen
...
### <a name="to-create-retention-periods"></a><a name="to-create-retention-periods"></a>Bewaarperioden maken
...
### <a name="set-up-a-retention-policy"></a><a name="set-up-a-retention-policy"></a>Een bewaarbeleid instellen
...
## <a name="applying-retention-policies"></a><a name="applying-retention-policies"></a>Retentiebeleid toepassen
...
## <a name="viewing-retention-policy-log-entries"></a><a name="viewing-retention-policy-log-entries"></a>Logboekvermeldingen voor bewaarbeleid bekijken
...
## <a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a><a name="including-your-extension-in-a-retention-policy-requires-help-from-a-developer"></a>Uw extensie opnemen in een bewaarbeleid (hulp van een ontwikkelaar vereist)

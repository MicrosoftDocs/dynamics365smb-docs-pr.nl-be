...
Naast het kopen van fysieke artikelen (artikelsoort **Voorraad**), wat van invloed is op de voorraadwaardering, kunt u services aanschaffen die worden weergegeven door tijdseenheden. U kunt dit doen met de artikelsoort **Service** of met de regelsoort **Resource**.

Wanneer u de voorraadartikelen ontvangt of wanneer de ingekochte service is voltooid, boekt u de inkoopfactuur of -order om de voorraad en financiële records bij te werken en betaling aan de leverancier te activeren volgens de betalingscondities. Zie voor meer informatie [Aankopen boeken](ui-post-purchases.md), [Artikelen ontvangen](warehouse-how-receive-items.md) en [Betalingen doen](payables-make-payments.md).
...
## <a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/processing-invoices-dynamics-365-business-central/index)

...
ms.author: edupont
---
# <a name="record-purchases-with-purchase-invoices-and-orders"></a><a name="record-purchases-with-purchase-invoices-and-orders"></a>Aankopen registreren met inkoopfacturen en orders
...
## <a name="record-purchases-with-purchase-invoices"></a><a name="record-purchases-with-purchase-invoices"></a>Aankopen registreren met inkoopfacturen
...
### <a name="create-a-and-post-purchase-invoice"></a><a name="create-a-and-post-purchase-invoice"></a>Een verkoopfactuur maken en boeken
...
## <a name="posted-invoices"></a><a name="posted-invoices"></a>Geboekte facturen
...
## <a name="purchasing-non-inventory-items"></a><a name="purchasing-non-inventory-items"></a>Niet-voorraadartikelen inkopen
...
## <a name="when-to-use-purchase-orders"></a><a name="when-to-use-purchase-orders"></a>Wanneer inkooporders gebruiken?
...
## <a name="receive-items-with-a-purchase-order"></a><a name="receive-items-with-a-purchase-order"></a>Artikelen ontvangen met een inkooporder
...
## <a name="receive-more-items-than-ordered"></a><a name="receive-more-items-than-ordered"></a>Meer artikelen ontvangen dan besteld
...
### <a name="set-up-over-receipts"></a><a name="set-up-over-receipts"></a>Meerontvangsten instellen
...
### <a name="assign-the-over-receipt-code-to-an-item"></a><a name="assign-the-over-receipt-code-to-an-item"></a>De meerontvangstcode toewijzen aan een artikel
...
### <a name="over-receive-an-order"></a><a name="over-receive-an-order"></a>Teveel ontvangen voor een order
...
## <a name="external-document-number"></a><a name="external-document-number"></a>Externe documentnummer

[!INCLUDE [ext-doc-no-purch](includes/ext-doc-no-purch.md)]

## <a name="posting-purchases"></a><a name="posting-purchases"></a>Inkopen boeken
...
## <a name="viewing-ledger-entries"></a><a name="viewing-ledger-entries"></a>Posten bekijken
...
## <a name="editing-ledger-entries"></a><a name="editing-ledger-entries"></a>Posten bewerken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/receive-invoice-dynamics-d365-business-central/index)

## <a name="see-related-microsoft-training-1"></a><a name="see-related-microsoft-training-1"></a>Zie gerelateerde [Microsoft-training](/training/modules/processing-invoices-dynamics-365-business-central/index)

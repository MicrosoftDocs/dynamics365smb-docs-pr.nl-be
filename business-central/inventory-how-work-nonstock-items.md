...
2. Kies op de pagina  **Catalogusartikelen**  de actie  **Nieuw** .
3. Vul op de pagina  **Catalogusartikel kaart**  de velden in zoals vereist. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]
...
[Speciale bestellingen maken](sales-how-to-create-special-orders.md)    

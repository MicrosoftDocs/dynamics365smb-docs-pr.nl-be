...
ms.author: edupont
---
# <a name="assign-default-bins-to-items" />Standaardopslaglocaties aan artikelen toewijzen
...
## <a name="to-assign-a-default-bin-to-an-item" />Een standaardopslaglocatie toewijzen aan een artikel
...
## <a name="to-change-the-default-bin-for-an-item" />De standaardopslaglocatie voor een artikel wijzigen

...
U kunt een of meer records in een lijst delen. Druk simpelweg op de sneltoetscombinatie Ctrl+C om naar uw klembord te kopiëren. Plak vervolgens wat u hebt gekopieerd in een andere toepassing door op Ctrl+V te drukken. Als u bijvoorbeeld drie verkooporders kopieert en in een e-mail plakt, worden de orders weergegeven in een fraai opgemaakte tabel.

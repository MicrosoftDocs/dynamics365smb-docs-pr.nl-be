...
ms.author: jswymer
---
# <a name="sharing-business-data-from-business-central" />Zakelijke gegevens delen vanuit Business Central
...
## <a name="copying-a-link" />Een koppeling kopiëren
...
### <a name="modify-the-page-link" />De paginakoppeling wijzigen
...
### <a name="about-filtered-lists" />Over gefilterde lijsten
...
## <a name="sharing-to-teams" />Delen met Teams
...
## <a name="sharing-through-onedrive" />Delen via OneDrive
...
## <a name="opening-in-excel" />Openen in Excel
...
## <a name="sharing-rows-or-tables" />Rijen of tabellen delen

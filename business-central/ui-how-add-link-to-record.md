...
---
# <a name="manage-attachments-links-and-notes-on-cards-and-documents" />Bijlagen, koppelingen en notities op kaarten en in documenten beheren
...
## <a name="to-attach-a-file-to-a-purchase-invoice" />Een bestand bijvoegen bij een inkoopfactuur
...
## <a name="to-view-an-attached-file" />Een gekoppeld bestand weergeven
...
## <a name="to-save-a-document-as-a-pdf-attachment" />Een document als PDF-bijlage opslaan
...
## <a name="to-add-a-link-from-an-item-card" />Een koppeling toevoegen vanuit een artikelkaart
...
## <a name="to-write-a-note-on-a-sales-order" />Een notitie over een klantorder schrijven

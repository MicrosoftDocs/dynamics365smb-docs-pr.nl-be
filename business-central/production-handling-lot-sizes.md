...
# <a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a><a name="handling-lot-sizes-in-production"></a>Omgaan met lotgroottes in productie
...
## <a name="units-of-measure-in-production-bill-of-materials"></a><a name="units-of-measure-in-production-bill-of-materials"></a><a name="units-of-measure-in-production-bill-of-materials"></a>Maateenheden in productiestuklijsten
...
## <a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a><a name="lot-size-on-routing-lines"></a>Lotgrootte op bewerkingsplanregels
...
## <a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a><a name="lot-sizes-for-items-and-stockkeeping-units"></a>Lotgroottes voor artikelen en voorraadeenheden
...
## <a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a><a name="lot-size-on-item-and-stockkeeping-units"></a>Lotgrootte voor artikelen en SKU's

...
# <a name="handling-lot-sizes-in-production" />Omgaan met lotgroottes in productie
...
## <a name="units-of-measure-in-production-bill-of-materials" />Maateenheden in productiestuklijsten
...
## <a name="lot-size-on-routing-lines" />Lotgrootte op bewerkingsplanregels
...
## <a name="lot-sizes-for-items-and-stockkeeping-units" />Lotgroottes voor artikelen en voorraadeenheden
...
## <a name="lot-size-on-item-and-stockkeeping-units" />Lotgrootte voor artikelen en SKU's

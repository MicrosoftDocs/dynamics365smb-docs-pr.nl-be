...
---
# <a name="intelligent-insights-with-includeprodshortincludesprodshortmd"></a>Intelligente inzichten met [!INCLUDE[prodshort](includes/prodshort.md)]
...
## <a name="connecting-to-business-central-from-other-dynamics-products"></a>Verbinding met Business Central maken vanuit andere Dynamics-producten

Als u een van de ondersteunde on-premises versies gebruikt, kunt u ook online verbinding met Business Central maken en intelligente inzichten on-premises krijgen. Zie voor meer informatie [Verbinding maken met de Intelligente cloud](/dynamics365/business-central/dev-itpro/administration/about-intelligent-edge) in de ITPro-inhoud voor [!INCLUDE[prodshort](includes/prodshort.md)].  

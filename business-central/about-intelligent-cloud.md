---
title: Intelligente inzichten en cloudmigratie (alleen on-premises)
...
# <a name="intelligent-insights-and-cloud-migration-on-premises-only"></a>Intelligente inzichten en cloudmigratie (alleen on-premises)

Als u [!INCLUDE[prod_short](includes/prod_short.md)] online gebruikt, hebt u volledige toegang tot scenario's die zijn gebaseerd op de intelligente cloud. Denk bijvoorbeeld aan Key Performance Indicators (KPI’s) die zijn gebaseerd op machine learning, of wanneer u uw gegevens bekijkt in Power BI.  
...
## <a name="viewing-insights-in--online"></a>Inzichten bekijken in [!INCLUDE[prod_short](includes/prod_short.md)] Online

Voor een on-premises omgeving waarvoor gegevens naar [!INCLUDE[prod_short](includes/prod_short.md)] online zijn gemigreerd, worden op de pagina **Intelligente cloud-inzichten** in de online-omgeving vier belangrijke aandachtspunten weergegeven voor de meeste bedrijven:
...
Naast de KPI-grafieken krijgt u informatie over potentiële aandachtspunten, inclusief achterstallige betalingen. Kies elk inzicht om de gegevens te verkennen.  

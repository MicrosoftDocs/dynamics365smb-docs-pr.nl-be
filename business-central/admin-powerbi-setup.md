...
### <a name="api-pages-and-queries" />API-pagina's en query's
...
### <a name="odata-web-services" />OData-webservices
...
### <a name="choosing-whether-to-use-api-pages-or-odata-web-services" />Kiezen of u API-pagina's of OData-webservices wilt gebruiken

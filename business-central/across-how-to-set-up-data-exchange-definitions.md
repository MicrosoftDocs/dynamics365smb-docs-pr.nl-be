...
ms.author: bholtorf
---
# <a name="set-up-data-exchange-definitions" />Definities voor gegevensuitwisseling instellen
...
## <a name="create-a-data-exchange-definition" />Definitie van gegevensuitwisseling maken
...
## <a name="transformation-rules" />Transformatieregels
...
### <a name="tip-for-developers-example-of-the-custom-option" />Tip voor ontwikkelaars: voorbeeld van de aangepaste optie
...
## <a name="export-a-data-exchange-definition-as-an-xml-file-for-use-by-others" />De definitie van een gegevensuitwisseling exporteren als een XML-bestand voor gebruik door anderen
...
## <a name="import-an-existing-data-exchange-definition" />Een bestaande definitie van gegevensuitwisseling importeren

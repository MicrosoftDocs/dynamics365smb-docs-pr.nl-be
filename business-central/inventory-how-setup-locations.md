...
ms.author: bholtorf
---
# <a name="set-up-locations" />Vestigingen instellen
...
## <a name="location-cards" />Vestigingskaarten
...
### <a name="to-set-up-a-location" />Een vestiging instellen
...
### <a name="to-create-a-transfer-route" />Een transferroute maken
...
## <a name="default-dimensions-for-locations" />Standaardafmetingen voor locaties
...
### <a name="example-of-default-dimensions-on-locations" />Voorbeeld van standaardafmetingen voor locaties
...
## <a name="see-related-training-at-microsoft-learnlearnmodulestrade-set-up-dynamics--business-central" />Zie gerelateerde training op [Microsoft Learn](/learn/modules/trade-set-up-dynamics-365-business-central/)

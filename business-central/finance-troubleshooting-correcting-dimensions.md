...
# <a name="troubleshooting-and-correcting-dimensions"></a><a name="troubleshooting-and-correcting-dimensions"></a>Problemen met dimensies oplossen en dimensies corrigeren
...
## <a name="troubleshooting-dimensions-errors"></a><a name="troubleshooting-dimensions-errors"></a>Problemen oplossen met dimensiefouten
...
## <a name="changing-dimension-assignments-after-posting"></a><a name="changing-dimension-assignments-after-posting"></a>Dimensietoewijzingen wijzigen na boeking
...
### <a name="setting-up-dimension-corrections"></a><a name="setting-up-dimension-corrections"></a>Dimensiecorrecties instellen
...
### <a name="correcting-a-dimension"></a><a name="correcting-a-dimension"></a>Een dimensie corrigeren
...
### <a name="validating-dimension-corrections"></a><a name="validating-dimension-corrections"></a>Dimensiecorrecties valideren
...
### <a name="undoing-a-correction"></a><a name="undoing-a-correction"></a>Een correctie ongedaan maken
...
### <a name="dimension-corrections-on-large-data-sets"></a><a name="dimension-corrections-on-large-data-sets"></a>Dimensiecorrecties op grote gegevenssets
...
### <a name="use-analysis-views-with-dimension-corrections"></a><a name="use-analysis-views-with-dimension-corrections"></a>Analyseweergaven gebruiken met dimensiecorrecties
...
### <a name="viewing-historical-dimension-corrections"></a><a name="viewing-historical-dimension-corrections"></a>Historische dimensiecorrecties bekijken

Als een grootboekpost is gecorrigeerd, kunt u de wijziging onderzoeken met de actie **Historie van dimensiecorrecties**.

### <a name="handling-incomplete-corrections"></a><a name="handling-incomplete-corrections"></a>Omgaan met onvolledige correcties
...
### <a name="use-cost-accounting-with-corrected-gl-entries"></a><a name="use-cost-accounting-with-corrected-gl-entries"></a>Kostprijsboekhouding gebruiken met gecorrigeerde grootboekboekingen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/dimensions-dynamics-365-business-central/)

---
title: Dimensieproblemen oplossen en corrigeren
...
# Dimensieproblemen oplossen en corrigeren
...
## Problemen oplossen met dimensiefouten

Wanneer u documenten of dagboekregels boekt die dimensies bevatten, kunnen er verschillende fouten optreden. Ze houden echter doorgaans verband met een onjuiste instelling of toewijzing van dimensies.
...
## Dimensietoewijzingen wijzigen na boeking

Als u ontdekt dat een onjuiste dimensie is gebruikt voor geboekte grootboekposten, kunt u de dimensiewaarden corrigeren en uw analyseweergaven bijwerken. De correctie helpt uw financiële rapporten en analyses nauwkeurig te houden.
...
1. Gebruik een van de volgende pagina's om een dimensiecorrectie te starten:
    ...
    * Op de pagina **Grootboekjournaalnr.** door een register te selecteren en vervolgens de actie **Dimensies corrigeren** te kiezen. Deze actie start een correctie voor de posten in het geselecteerde register.
...
### Dimensiecorrecties op grote gegevenssets
...
### Analyseweergaven gebruiken met dimensiecorrecties
...
### Kostprijsboekhouding gebruiken met gecorrigeerde grootboekposten

Nadat u de dimensies heeft aangepast, zijn uw gegevens voor kostprijsboekhouding niet meer gesynchroniseerd. Kostprijsboekhouding gebruikt dimensies om bedragen voor kostenplaatsen en kostenobjecten te aggregeren en om kostentoewijzingen uit te voeren. Als u de dimensies voor grootboekboekingen wijzigt, betekent dit waarschijnlijk dat u uw kostenberekeningsmodellen opnieuw moet uitvoeren. Afhankelijk van de gegevens die zijn bijgewerkt en hoe uw kostenberekeningsmogelijkheden zijn ingesteld, moet u mogelijk het volgende doen:

* Slechts enkele kostenregisters verwijderen en de toewijzingen opnieuw uitvoeren.
* Alles verwijderen en al uw modellen opnieuw uitvoeren.

U moet handmatig identificeren waar dimensiecorrecties van invloed zijn op kostenberekening en waar updates nodig zijn. [!INCLUDE[prod_short](includes/prod_short.md)] biedt momenteel geen geautomatiseerde manier om dat te doen.

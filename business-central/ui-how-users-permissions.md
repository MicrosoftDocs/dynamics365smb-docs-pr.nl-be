...
Als aan gebruikers een [!INCLUDE[d365fin](includes/d365fin_md.md)]-licentie in Office 365 wordt toegewezen, kunt u ze importeren naar de pagina **Gebruikers** in [!INCLUDE[d365fin](includes/d365fin_md.md)] door middel van de actie **Nieuwe gebruikers ophalen uit Office 365**.
...
2. Kies de actie **Nieuwe gebruikers bijwerken vanuit Office 365**.
    ...
    Als dit de eerste keer is dat u gebruikers toevoegt vanuit Office 365, kiest u de actie **Nieuwe gebruikers ophalen uit Office 365**.  
3. Volg de stappen in de gids die verschijnt.

De nieuwe gebruikers en gebruikersinformatie in uw Office 365-abonnement zal worden toegevoegd op de pagina **Gebruikers** in [!INCLUDE[d365fin](includes/d365fin_md.md)]. U kunt nu gebruikersgroepen en machtigingen toewijzen. Zie [Machtigingen toewijzen aan gebruikers en groepen](ui-define-granular-permissions.md) voor meer informatie.  

Voor meer informatie over het synchroniseren van gebruikersinformatie met Office 365 raadpleegt u de sectie [Synchronisatie met Office 365](#synchronization-with-office-365).

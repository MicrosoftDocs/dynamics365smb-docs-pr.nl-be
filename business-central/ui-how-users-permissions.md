...
Uw abonnement op [!INCLUDE[prod_short](includes/prod_short.md)] online bepaalt het aantal gebruikers dat u is toegestaan. Gebruikers worden aan uw tenant toegevoegd in het Microsoft Partnercentrum, meestal door uw Microsoft-partner. Zie voor meer informatie [Beheer van Business Central Online](/dynamics365/business-central/dev-itpro/administration/tenant-administration).

U wijst productlicenties toe aan gebruikers op basis van het werk dat elke gebruiker zal doen in [!INCLUDE[prod_short](includes/prod_short.md)]. U kunt licenties op verschillende manieren toewijzen:
...
Bijvoorbeeld de veelgebruikte licentie *Dynamics 365 Business Central-teamlid* heeft standaard de gebruikersgroepen *D365 Teamlid* en *Excel-exportactie*, plus de volgende machtigingensets:

...
ms.reviewer: jswymer
---
# <a name="create-users-according-to-licenses" />Gebruikers maken volgens licenties
...
## <a name="manage-users-and-licenses-in-online-tenants" />Gebruikers en licenties beheren in online-tenants
...
### <a name="to-remove-a-users-access-to-the-system" />De toegang van een gebruiker tot het systeem verwijderen
...
### <a name="a-namemasynchronization-with-microsoft-" /><a name="m365"></a>Synchronisatie met Microsoft 365
...
## <a name="manage-users-and-licenses-in-on-premises-deployments" />Gebruikers en licenties beheren in on-premises implementaties
...
### <a name="to-edit-or-delete-a-user-in-an-on-premises-deployment" />Een gebruiker in een on-premises implementatie bewerken of verwijderen

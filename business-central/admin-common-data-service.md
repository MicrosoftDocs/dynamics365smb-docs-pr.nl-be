...
# <a name="integrating-with-microsoft-dataverse" />Integreren met Microsoft Dataverse
...
## <a name="bi-directional-or-uni-directional-data-synchronization" />Bidirectionele of unidirectionele gegevenssynchronisatie
...
## <a name="standard-and-custom-entities" />Standaard- en aangepaste entiteiten
...
## <a name="about-the-business-central-base-integration-solution" />Over de Business Central-basisintegratieoplossing

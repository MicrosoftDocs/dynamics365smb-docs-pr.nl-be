...
## <a name="to-assign-industry-groups-to-a-contact"></a>Sectoren toewijzen aan een contact
...
## <a name="to-define-a-contacts-alternate-address"></a>Het alternatieve adres van een contact definiëren
...
## <a name="to-assign-job-responsibilities-to-a-contact"></a>Functiegroepen toewijzen aan een contact
...
## <a name="to-assign-organizational-levels-to-a-contact"></a>Organisatieniveaus toewijzen aan een contact
...
## <a name="to-assign-web-sources-to-a-contact"></a>Webbronnen toewijzen aan een contact
...
## <a name="to-assign-business-relations-to-a-contact"></a> Zakenrelaties toewijzen aan contacten

...
## <a name="transaction-and-budget-tables" />Transactie- en budgettabellen
...
### <a name="tables-that-contain-the-dimension-set-id-field" />Tabellen die het veld Dimensieset-id bevatten

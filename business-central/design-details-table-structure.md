...
ms.author: edupont
---
# <a name="design-details-table-structure"></a><a name="design-details-table-structure"></a>Ontwerpdetails: Tabelstructuur
Om te begrijpen hoe dimensieposten worden opgeslagen en geboekt, is het belangrijk om de tabelstructuur te begrijpen.  

## <a name="table-480-dimension-set-entry"></a><a name="table-480-dimension-set-entry"></a>Tabel 480, Dimensiesetpost
...
## <a name="table-481-dimension-set-tree-node"></a><a name="table-481-dimension-set-tree-node"></a>Tabel 481, Boomstructuurpunt dimensieset
...
## <a name="table-482-reclas-dimension-set-buffer"></a><a name="table-482-reclas-dimension-set-buffer"></a>Tabel 482 Herklass. dimensiesetbuffer
...
## <a name="transaction-and-budget-tables"></a><a name="transaction-and-budget-tables"></a>Transactie- en budgettabellen
...
### <a name="table-83-item-journal-line"></a><a name="table-83-item-journal-line"></a>Tabel 83, Artikeldagboekregel
...
### <a name="table-349-dimension-value"></a><a name="table-349-dimension-value"></a>Tabel 349, Dimensiewaarde
Naast andere dimensievelden in de tabel zijn deze velden belangrijk.  
...
### <a name="tables-that-contain-the-dimension-set-id-field"></a><a name="tables-that-contain-the-dimension-set-id-field"></a>Tabellen die het veld Dimensieset-id bevatten

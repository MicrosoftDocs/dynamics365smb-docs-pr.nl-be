...
---
# <a name="manage-the-intercompany-inbox-and-outbox" />De intercompany-inbox en outbox beheren
...
## <a name="organizing-the-inbox" />De IC-inbox ordenen
...
### <a name="transaction-source" />Transactiebron
...
#### <a name="created-by-intercompany-partner" />Transactie gemaakt door IC-partner
...
#### <a name="returned-from-intercompany-partner" />Geretourneerd door IC-partner
...
## <a name="recreating-inbox-entries" />Inboxitems opnieuw maken
...
## <a name="get-an-overview-of-intercompany-transactions-for-a-period" />Een overzicht van IC-transacties voor een periode krijgen
...
## <a name="import-intercompany-transactions-from-a-file" />IC-transacties importeren uit een bestand
...
## <a name="process-incoming-intercompany-transactions" />Inkomende IC-transacties verwerken
...
## <a name="to-process-outgoing-intercompany-transactions" />Uitgaande IC-transacties verwerken
...
## <a name="recreate-intercompany-inbox-transactions" />IC-inboxtransacties opnieuw maken

...
ms.author: edupont
---
# <a name="create-blanket-assembly-orders" />Afroepassemblyorders maken
...
## <a name="to-create-a-blanket-assembly-order-for-an-assemble-to-order-item" />Een afroepassemblyorder maken voor een voor-order-assembleren-artikel

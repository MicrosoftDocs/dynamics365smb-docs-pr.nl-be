...
ms.author: bholtorf
---
# <a name="record-special-purchase-prices-and-discounts" />Speciale inkoopprijzen en kortingen registreren
...
## <a name="to-set-up-a-special-purchase-price-for-a-vendor" />Een speciale inkoopprijs voor een leverancier instellen
...
## <a name="to-set-up-a-line-discount-for-a-vendor" />Een speciale regelkorting voor een leverancier instellen
...
## <a name="to-set-up-an-invoice-discount-for-a-vendor" />Een factuurkorting voor een leverancier instellen
...
## <a name="to-choose-a-principle-for-posting-purchase-discounts" />Een methode voor het boeken van inkoopkortingen kiezen
...
## <a name="purchase-invoice-discounts-and-service-charges" />Inkoopfactuurkortingen en administratiekosten
...
## <a name="see-related-microsoft-trainingtrainingmodulesset-up-prices-discounts-dynamics-365-business-centralindex" />Zie gerelateerde [Microsoft-training](/training/modules/set-up-prices-discounts-dynamics-365-business-central/index)

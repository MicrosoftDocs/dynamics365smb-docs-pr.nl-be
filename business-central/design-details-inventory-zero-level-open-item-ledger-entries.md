...
ms.author: edupont
---
# <a name="design-details-known-item-application-issue" />Ontwerpdetails: bekend probleem met artikelvereffening
...
## <a name="symptoms-of-the-issue" />Symptomen van het probleem
...
## <a name="basics-of-item-application" />Grondbeginselen van artikelvereffening
...
### <a name="quantity-application" />Aantalvereffening
...
### <a name="cost-application" />Vereffeningskosten
...
## <a name="illustration-of-a-basic-cost-flow" />Illustratie van een basiskostenstroom
...
## <a name="reasons-for-the-issue" />Redenen voor het probleem
...
## <a name="identifying-the-issue" />Het probleem identificeren
...
## <a name="workaround-for-the-issue" />Oplossing voor het probleem

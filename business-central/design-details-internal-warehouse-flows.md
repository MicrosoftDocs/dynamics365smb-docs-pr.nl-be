...
---
# <a name="flows-for-production-assembly-and-jobs" />Stromen voor productie, assemblage en projecten
...
## <a name="overview-of-different-configuration-options" />Overzicht van verschillende configuratieopties
...
### <a name="inbound-flow-put-away" />Inkomende stroom (opslag)
...
### <a name="outbound-flow-pick" />Uitgaande stroom (pick)
...
## <a name="warehouses-without-dedicated-warehouse-activity" />Magazijnen zonder speciale magazijnactiviteit
...
## <a name="basic-warehouse-configuration" />Standaardmagazijnconfiguratie
...
### <a name="flows-to-and-from-production-in-a-basic-warehouse-configuration" />Stromen naar en van productie in een standaardmagazijnconfiguratie
...
### <a name="flows-to-and-from-assembly-in-a-basic-warehouse-configuration" />Stromen naar en van assemblage in een standaardmagazijnconfiguratie
...
### <a name="flows-for-project-management-in-a-basic-warehouse-configuration" />Stromen voor projectmanagement in een basismagazijnconfiguratie
...
### <a name="flows-to-and-from-production-in-advanced-warehouse-configurations" />Stromen naar en van productie in geavanceerde magazijnconfiguraties
...
### <a name="flows-to-and-from-assembly-in-advanced-warehouse-configurations" />Stromen naar en van assemblage in geavanceerde magazijnconfiguraties
...
### <a name="flows-to-project-management-in-advanced-warehouse-configurations" />Stromen naar projectbeheer in geavanceerde magazijnconfiguraties

...
ms.author: edupont
---
# <a name="manage-saved-settings-for-reports-and-batch-jobs" />Opgeslagen instellingen beheren voor rapporten en batchtaken
...
## <a name="manage-saved-settings" />Opgeslagen instellingen beheren
...
## <a name="create-or-modify-saved-settings-for-all-users" />Opgeslagen instellingen maken of wijzigen voor alle gebruikers

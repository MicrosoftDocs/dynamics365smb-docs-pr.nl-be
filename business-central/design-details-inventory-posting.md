...
ms.author: edupont
---
# <a name="design-details-inventory-posting"></a><a name="design-details-inventory-posting"></a>Ontwerpdetails: Voorraadboeking
...
### <a name="item-ledger-entries-1"></a><a name="item-ledger-entries-1"></a>Artikelposten (1)
...
### <a name="item-application-entries-1"></a><a name="item-application-entries-1"></a>Artikelvereffeningsposten (1)
...
### <a name="item-ledger-entries-2"></a><a name="item-ledger-entries-2"></a>Artikelposten (2)
...
### <a name="item-application-entries-2"></a><a name="item-application-entries-2"></a>Artikelvereffeningsposten (2)
...
### <a name="value-entries-3"></a><a name="value-entries-3"></a>Waardeposten (3)
...
### <a name="general-ledger-entries-3"></a><a name="general-ledger-entries-3"></a>Grootboekposten (3)
...
### <a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a><a name="relation-entries-in-the-gl--item-ledger-relation-table-3"></a>Relatieposten in het grootboek - tabel Artikelpostrelatie (3)
...
## <a name="assembly-and-production-posting"></a><a name="assembly-and-production-posting"></a>Assemblage- en productieboeking

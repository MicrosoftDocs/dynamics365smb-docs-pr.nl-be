...
|Boekingsdatum|Postsoort|Kostenbedrag (werkelijk)|Hoeveelheid|Postnr.|  
|------------|----------|--------------------|--------|---------|  
|01-01-20|Inkoop|80.00|10|0|  

### <a name="value-entries-1"></a>Waardeposten (1)

|Boekingsdatum|Postsoort|Kostenbedrag (werkelijk)|Artikelpostnr.|Volgnummer|  
|------------|----------|--------------------|---------------------|---------|  
|01-01-20|Directe kosten|70.00|1|0|  
|01-01-20|Indirecte kosten|10.00|0|2|  

### <a name="item-application-entries-1"></a>Artikelvereffeningsposten (1)

|Postnr.|Artikelpostnr.|Inkomend art.-postnr.|Uitgaand art.-postnr.|Aantal|  
|---------|---------------------|----------------------|-----------------------|--------|  
|1|1|1|0|10|  
...
|Boekingsdatum|Postsoort|Kostenbedrag (werkelijk)|Artikelpostnr.|Postnr.|  
|------------|----------|--------------------|---------------------|---------|  
...
|Boekingsdatum|Postsoort|Kostenbedrag (werkelijk)|Vrd.-waarde geboekt|Artikelpostnr.|Volgnummer|  
|------------|----------|--------------------|------------------|---------------------|---------|  

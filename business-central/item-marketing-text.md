...
# <a name="add-marketing-text-to-items"></a><a name="add-marketing-text-to-items"></a>Marketingtekst aan artikelen toevoegen
...
## <a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name="create-ai-generated-marketing-text-preview-with-copilot"></a><a name=copilot></a>Door AI gegenereerde marketingtekst schrijven (preview) met Copilot
...
### <a name="create-first-draft-with-copilot"></a><a name="create-first-draft-with-copilot"></a>Een eerste concept maken met Copilot
...
### <a name="review-edit-and-save-text"></a><a name="review-edit-and-save-text"></a>Tekst controleren, bewerken en opslaan
...
### <a name="improve-and-tailor-text-suggestions"></a><a name="improve-and-tailor-text-suggestions"></a>Tekstsuggesties verbeteren en aanpassen
...
## <a name="create-marketing-text-from-scratch"></a><a name="create-marketing-text-from-scratch"></a>Een geheel nieuwe marketingtekst maken

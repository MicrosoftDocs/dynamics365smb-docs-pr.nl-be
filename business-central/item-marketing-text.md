...
# <a name="add-marketing-text-to-items" />Marketingtekst aan artikelen toevoegen
...
### <a name="create-first-draft-with-copilot" />Een eerste concept maken met Copilot
...
### <a name="review-edit-and-save-text" />Tekst controleren, bewerken en opslaan
...
### <a name="improve-and-tailor-text-suggestions" />Tekstsuggesties verbeteren en aanpassen
...
## <a name="create-marketing-text-from-scratch" />Een geheel nieuwe marketingtekst maken

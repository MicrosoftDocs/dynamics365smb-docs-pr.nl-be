...
ms.author: edupont
---
# <a name="troubleshooting-your-company-hub"></a><a name="troubleshooting-your-company-hub"></a>Problemen met uw bedrijfshub oplossen
...
## <a name="check-errors"></a><a name="check-errors"></a>Controleren op fouten
...
## <a name="connection-failed"></a><a name="connection-failed"></a>Verbinding mislukt
...
## <a name="data-does-not-refresh"></a><a name="data-does-not-refresh"></a>Gegevens worden niet vernieuwd

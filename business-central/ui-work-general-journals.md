...
4. Selecteer op de pagina **Standaardartikeldagboeken** het standaardartikeldagboek dat u opnieuw wilt gebruiken en kies vervolgens de knop **OK**.
    ...
    Als u de schakelaar **Eenheidsbedrag opslaan** niet inschakelt, bevat het veld **Eenheidsbedrag** op regels die zijn toegevoegd vanuit het standaarddagboek, de waarde uit het veld **Kostprijs** op de artikelkaart.

    > [!NOTE]  
    > Als u de schakelaars **Eenheidsbedrag opslaan** of **Aantal opslaan** hebt ingeschakeld, zorg er dan voor dat de nieuwe waarden correct zijn voordat u het artikeljournaal boekt. <!--need to say where and when these were turned on-->

    Als de ingevoegde artikeldagboekregels opgeslagen eenheidsprijzen bevatten die u niet wilt boeken, kunt u deze als volgt snel wijzigen in de huidige waarde van het artikel. <!--as follows where?-->
...
## <a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/use-journals-dynamics-365-business-central/)

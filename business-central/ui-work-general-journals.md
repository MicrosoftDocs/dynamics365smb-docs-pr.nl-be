...
---
# <a name="work-with-general-journals"></a><a name="work-with-general-journals"></a><a name="work-with-general-journals"></a>Werken met diversendagboeken
...
## <a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a><a name="use-journal-templates-and-batches"></a>Dagboeksjablonen en -batches gebruiken
...
### <a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a><a name="validating-general-journal-batches"></a>Algemene dagboekbatches valideren
...
## <a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a><a name="understanding-main-accounts-and-balancing-accounts"></a>Hoofdrekeningen en tegenrekeningen
...
## <a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a><a name="work-with-recurring-journals"></a>Werken met periodieke dagboeken
...
### <a name="recurring-method-field"></a><a name="recurring-method-field"></a><a name="recurring-method-field"></a>Veld Methode
...
### <a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a><a name="recurring-frequency-field"></a>Veld Frequentie
...
### <a name="expiration-date-field"></a><a name="expiration-date-field"></a><a name="expiration-date-field"></a>Veld Vervaldatum
...
### <a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a><a name="allocating-recurring-journal-amounts-to-several-accounts"></a>Periodieke dagboekbedragen toewijzen aan meerdere rekeningen
...
#### <a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a><a name="example-allocating-rent-payments-to-different-departments"></a>Voorbeeld: huurbetalingen aan verschillende kostenplaatsen toewijzen
...
### <a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a><a name="calculate-the-reversal-date"></a>De tegenboekingsdatum berekenen
...
## <a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a><a name="work-with-standard-journals"></a>Werken met standaarddagboeken
...
### <a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a><a name="to-save-a-standard-journal"></a>Opslaan als standaarddagboek
...
### <a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a><a name="to-reuse-a-standard-journal"></a>Een standaarddagboek opnieuw gebruiken
...
## <a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a><a name="to-renumber-document-numbers-in-journals"></a>Documentnummers in dagboeken opnieuw nummeren
...
### <a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a><a name="to-renumber-documents-in-journals"></a>Documentnummers in dagboeken opnieuw nummeren
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/use-journals-dynamics-365-business-central/)

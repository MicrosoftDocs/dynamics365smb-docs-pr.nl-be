...
# <a name="validate-vat-registration-numbers" />Btw-nummers valideren
...
## <a name="configure-the-service-to-verify-vat-registration-numbers-automatically" />Configureer de service om btw-registratienummers automatisch te verifiëren
...
## <a name="validation-templates" />Validatiesjablonen

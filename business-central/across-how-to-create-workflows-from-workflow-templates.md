...
ms.author: edupont
---
# <a name="create-workflows-from-workflow-templates" />Werkstromen maken van werkstroomsjablonen
...
## <a name="to-create-a-workflow-from-a-workflow-template" />Een werkstroom maken van een werkstroomsjabloon

...
1. Als u met opslaglocaties werkt, moet u ten minste één cross-dockopslaglocatie instellen. Stel een cross-dockzone in als u met gestuurde opslag en pick werkt.  
    ...
    Bij een cross-dockopslaglocatie is het veld **Cross-Dockopslaglocatie** geselecteerd. Ga voor meer informatie over opslaglocatie naar [Opslaglocaties maken](warehouse-how-to-create-individual-bins.md).  

    Als u zones gebruikt, maakt u een zone voor de cross-dockopslaglocaties en selecteert u het veld **Cross-dockopslaglocatiezone**. Als u gerichte opslag en picks gebruikt, selecteert u het opslaglocatietype met **Pick**. U kunt bijvoorbeeld *PICK* of *OPSLPICK* gebruiken. Voor meer informatie over zones en opslaglocatietypen gaat u naar [Locaties instellen om opslaglocaties te gebruiken](warehouse-how-to-set-up-locations-to-use-bins.md) en [Opslaglocatietypen instellen](warehouse-how-to-set-up-bin-types.md).  

2. Kies het pictogram ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Locatie** in en kies vervolgens de gerelateerde koppeling.  

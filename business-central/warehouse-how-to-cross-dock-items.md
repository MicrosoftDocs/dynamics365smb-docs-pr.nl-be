...
---
# <a name="cross-dock-items" />Artikelen cross-docken
...
## <a name="cross-dock-bins-and-zones" />Cross-dockopslaglocaties en -zones
...
## <a name="cross-dock-select-lines-for-a-receipt" />Geselecteerde regels cross-docken voor een ontvangst
...
## <a name="about-the-put-away-worksheet-page" />Informatie over de pagina Opslagvoorstel
...
## <a name="to-set-up-the-warehouse-for-cross-docking" />U kunt als volgt het magazijn instellen voor cross-docking
...
## <a name="to-cross-dock-items-without-viewing-the-opportunities" />U kunt als volgt artikelen cross-docken zonder de mogelijkheden te bekijken
...
## <a name="to-cross-dock-items-after-viewing-the-opportunities" />Artikelen cross-docken na de mogelijkheden bekeken te hebben
...
## <a name="to-view-cross-docked-items-in-a-shipment-or-pick-worksheet" />Cross-dockartikelen bekijken in verzendingen of pickvoorstellen

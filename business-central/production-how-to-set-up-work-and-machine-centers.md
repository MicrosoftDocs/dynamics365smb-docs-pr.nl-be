...
ms.author: edupont
---
# <a name="set-up-work-centers-and-machine-centers" />Afdelingen en bewerkingsplaatsen instellen
...
## <a name="to-set-up-a-work-center" />Een afdeling instellen
...
## <a name="considerations-about-capacity" />Overwegingen over capaciteit
...
### <a name="run-time" />Bewerkingstijd
...
### <a name="work-center-processing-multiple-orders-simultaneously" />Afdeling die meerdere orders tegelijk verwerkt
...
### <a name="efficient-resource-can-dedicate-only-part-of-their-work-date-to-productive-work" />Efficiënte resource kan slechts een deel van de werkdatum aan productief werk besteden
...
### <a name="consolidated-calendar" />Geconsolideerde agenda
...
### <a name="example---different-machine-centers-assigned-to-a-work-center" />Voorbeeld - Verschillende bewerkingsplaatsen die aan een afdeling zijn toegewezen
...
## <a name="to-set-up-a-capacity-constrained-machine-or-work-center" />Een bewerkingsplaats of afdeling met beperkte capaciteit instellen

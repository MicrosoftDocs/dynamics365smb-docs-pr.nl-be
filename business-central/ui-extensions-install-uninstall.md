...
# <a name="install-and-uninstall-extensions-apps-in-business-central" />Extensies (apps) installeren en verwijderen in Business Central
...
## <a name="set-up-an-app" />Een app instellen
...
## <a name="upload-a-per-tenant-extension-pte" />Een per-tenant extensie (PTE) uploaden
...
## <a name="uninstall-an-app" />Een app verwijderen

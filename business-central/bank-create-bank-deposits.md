...
ms.author: bholtorf
---
# <a name="create-bank-deposits" />Bankstortingen maken
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits" />Nummerreeksen en lump-sum stortingen
...
### <a name="general-journal-templates-for-bank-deposits" />Grootboeksjablonen voor bankstortingen
...
## <a name="dimensions-on-bank-deposit-lines" />Dimensies op bankstortingsregels
...
## <a name="create-a-bank-deposit" />Een bankstorting maken
...
## <a name="finding-posted-bank-deposits" />Geboekte bankstortingen zoeken
...
## <a name="reversing-a-posted-bank-deposit" />Een geboekte bankstorting tegenboeken

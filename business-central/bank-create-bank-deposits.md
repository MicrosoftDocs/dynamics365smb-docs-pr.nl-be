...
ms.author: bholtorf
---
# <a name="create-bank-deposits"></a><a name="create-bank-deposits"></a>Bankstortingen maken
> [!NOTE]
...
### <a name="number-series-and-lump-sum-deposits"></a><a name="number-series-and-lump-sum-deposits"></a>Nummerreeksen en lump-sum stortingen
...
### <a name="general-journal-templates-for-bank-deposits"></a><a name="general-journal-templates-for-bank-deposits"></a>Grootboeksjablonen voor bankstortingen
...
## <a name="dimensions-on-bank-deposit-lines"></a><a name="dimensions-on-bank-deposit-lines"></a>Dimensies op bankstortingsregels
...
## <a name="create-a-bank-deposit"></a><a name="create-a-bank-deposit"></a>Een bankstorting maken
...
## <a name="finding-posted-bank-deposits"></a><a name="finding-posted-bank-deposits"></a>Geboekte bankstortingen zoeken
...
## <a name="reversing-a-posted-bank-deposit"></a><a name="reversing-a-posted-bank-deposit"></a>Een geboekte bankstorting tegenboeken

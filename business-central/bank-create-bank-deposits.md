...
## <a name="finding-posted-bank-deposits"></a>Geboekte bankstortingen zoeken
...
## <a name="reversing-a-posted-bank-deposit"></a>Een geboekte bankstorting tegenboeken

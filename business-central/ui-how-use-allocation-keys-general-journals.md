...
ms.author: edupont
---
# <a name="use-allocation-keys-in-general-journals" />Verdeelsleutels in dagboeken gebruiken
...
## <a name="to-set-up-allocation-keys" />Verdeelsleutels instellen
...
## <a name="to-change-an-allocation-key-that-has-already-been-set-up" />Een reeds ingestelde verdeelsleutel wijzigen
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Periodiek dagboek** in en kies vervolgens de gerelateerde koppeling.

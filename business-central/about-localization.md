...
ms.author: edupont
---
# <a name="local-functionality-in-"></a>Lokale functionaliteit in [!INCLUDE[prod_long](includes/prod_long.md)]
...
### <a name="other-countriesregions"></a>Andere landen/regio's

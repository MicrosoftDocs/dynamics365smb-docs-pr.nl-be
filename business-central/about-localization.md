...
ms.author: edupont
---
# <a name="local-functionality-in-"></a><a name="local-functionality-in-"></a>Lokale functionaliteit in [!INCLUDE[prod_long](includes/prod_long.md)]
...
## <a name="local-functionality"></a><a name="local-functionality"></a>Lokale functionaliteit
...
### <a name="other-countries"></a><a name="other-countries"></a>Andere landen/regio's

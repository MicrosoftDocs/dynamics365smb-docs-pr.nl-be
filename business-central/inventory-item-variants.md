...
ms.author: edupont
---
# <a name="manage-product-variants" />Productvarianten beheren
...
## <a name="add-variants-to-an-item" />Varianten aan een artikel toevoegen
...
### <a name="to-add-variants" />Varianten toevoegen
...
## <a name="item-availability-by-variant" />Artikelbeschikbaarheid per variant

[!INCLUDE [inventory_variant-availability](includes/inventory_variant-availability.md)]

## <a name="require-use-of-variants" />Gebruik van varianten vereisen

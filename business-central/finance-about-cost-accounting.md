...
ms.author: edupont
---
# <a name="about-cost-accounting"></a><a name="about-cost-accounting"></a>Kostprijsboekhouding
...
## <a name="workflow-in-cost-accounting"></a><a name="workflow-in-cost-accounting"></a>Werkstroom in kostprijsboekhouding
...
## <a name="cost-types-cost-centers-and-cost-objects"></a><a name="cost-types-cost-centers-and-cost-objects"></a>Kostensoorten, kostenplaatsen en kostenobjecten
...
## <a name="cost-entries-and-cost-journals"></a><a name="cost-entries-and-cost-journals"></a>Kostenposten en kostendagboeken
...
## <a name="cost-allocations"></a><a name="cost-allocations"></a>Kostenverdelingen
...
## <a name="cost-budgets"></a><a name="cost-budgets"></a>Kostenbudgetten
...
## <a name="cost-reporting"></a><a name="cost-reporting"></a>Rapportage van kosten
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/paths/use-cost-accounting-dynamics-365-business-central/)

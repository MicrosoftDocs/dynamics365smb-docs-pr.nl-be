...
ms.author: edupont
---
# <a name="restructure-warehouses" />Magazijnen herstructureren
...
## <a name="to-restructure-a-basic-warehouse-that-uses-bins-only" />Herstructureren van een standaardmagazijn dat alleen opslaglocaties gebruikt
...
## <a name="to-restructure-an-advanced-warehouse-that-uses-directed-put-away-and-pick" />Herstructureren van een geavanceerd magazijn met gestuurde opslag en pick
...
## <a name="to-delete-a-bin" />Een opslaglocatie verwijderen
...
## <a name="to-rename-a-bin-and-change-the-bin-code-in-all-records" />Een opslaglocatie een andere naam geven en de opslaglocatie in alle records wijzigen

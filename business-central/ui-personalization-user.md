...
ms.author: bholtorf
---
# <a name="personalize-your-workspace"></a><a name="personalize-your-workspace"></a>Uw werkruimte personaliseren
...
## <a name="to-change-the-width-of-a-column"></a><a name="to-change-the-width-of-a-column"></a>De breedte van een kolom wijzigen
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a><a name="to-start-personalizing-a-page-through-the-personalizing-banner"></a>Een pagina personaliseren via de banner **Personaliseren**
...
## <a name="what-you-can-personalize"></a><a name="what-you-can-personalize"></a><a name="What"></a>Wat kunt u personaliseren
...
## <a name="personalizing-the-action-bar-and-menus"></a><a name="personalizing-the-action-bar-and-menus"></a><a name="Actions"></a>De actiebalk en menu's personaliseren
...
### <a name="to-remove-hide-and-show-actions-and-action-groups"></a><a name="to-remove-hide-and-show-actions-and-action-groups"></a>Acties en actiegroepen verwijderen, verbergen en weergeven
...
### <a name="to-move-actions-and-action-groups"></a><a name="to-move-actions-and-action-groups"></a>Acties en actiegroepen verplaatsen
...
## <a name="personalizing-parts"></a><a name="personalizing-parts"></a><a name="Parts"></a>Onderdelen personaliseren
...
## <a name="to-clear-personalization"></a><a name="to-clear-personalization"></a>Personalisatie wissen
...
## <a name="other-points-of-interest"></a><a name="other-points-of-interest"></a>Andere interessante zaken
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/personalize-ui-dynamics-365-business-central/index)

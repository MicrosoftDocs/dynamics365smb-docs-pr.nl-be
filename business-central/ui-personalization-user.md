...
ms.author: bholtorf
---
# <a name="personalize-your-workspace" />Uw werkruimte personaliseren
...
## <a name="to-change-the-width-of-a-column" />De breedte van een kolom wijzigen
...
## <a name="to-start-personalizing-a-page-through-the-personalizing-banner" />Een pagina personaliseren via de banner **Personaliseren**
...
### <a name="to-remove-hide-and-show-actions-and-action-groups" />Acties en actiegroepen verwijderen, verbergen en weergeven
...
### <a name="to-move-actions-and-action-groups" />Acties en actiegroepen verplaatsen
...
## <a name="to-clear-personalization" />Personalisatie wissen
...
## <a name="other-points-of-interest" />Andere interessante zaken

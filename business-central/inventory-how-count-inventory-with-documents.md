...
ms.author: edupont
---
# <a name="count-and-adjust-inventory-using-documents" />Voorraad tellen en aanpassen met documenten
...
## <a name="to-create-a-physical-inventory-order" />Een inventarisatieorder maken
...
## <a name="to-create-a-physical-inventory-recording" />Een inventarisatieregistratie maken
...
## <a name="to-finish-a-physical-inventory-recording" />Een inventarisatieregistratie voltooien
...
## <a name="to-complete-a-physical-inventory-order" />Een inventarisatieorder voltooien
...
### <a name="to-find-duplicate-physical-inventory-order-lines" />Dubbele inventarisatieorderregels zoeken
...
### <a name="to-post-a-physical-inventory-order" />Een inventarisatieorder boeken
...
### <a name="to-view-posted-physical-inventory-orders" />Geboekte inventarisatieorders weergeven
...
## <a name="handling-item-tracking-when-counting-inventory" />Artikeltracering verwerken tijdens inventarisatie
...
### <a name="example---prepare-a-physical-inventory-recording-for-an-item-tracked-item" />Voorbeeld - een inventarisatieregistratie voorbereiden voor een artikel met artikeltracering
...
### <a name="example---record-and-post-counted-lot-number-differences" />Voorbeeld - Getelde lotnummerverschillen registreren en boeken
...
## <a name="inventory-documents" />Voorraaddocumenten
...
### <a name="to-set-up-numbering-for-inventory-documents" />Nummering voor inventarisdocumenten instellen
...
### <a name="to-create-and-post-an-inventory-document" />Een voorraaddocument maken en boeken
...
## <a name="printing-inventory-documents" />Voorraaddocumenten afdrukken

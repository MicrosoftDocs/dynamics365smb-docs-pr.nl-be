...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook"></a><a name="use-business-central-as-your-business-inbox-in-outlook"></a>Business Central gebruiken als uw bedrijfsinbox in Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in"></a><a name="work-with-contacts-and-documents-using-the-contact-insights-add-in"></a>Werken met contacten en documenten met behulp van de invoegtoepassing Contactinzichten
...
### <a name="look-up-a-business-contact-when-composing-an-email"></a><a name="look-up-a-business-contact-when-composing-an-email"></a>Een zakelijk contact opzoeken bij het opstellen van een e-mail
...
### <a name="view-and-change-the-contact-details-or-switch-company"></a><a name="view-and-change-the-contact-details-or-switch-company"></a>De contactgegevens bekijken of wijzigen of van bedrijf wisselen
...
### <a name="track-incoming-documents"></a><a name="track-incoming-documents"></a>Inkomende documenten traceren
...
### <a name="create-and-send-new-document-to-a-contact"></a><a name="create-and-send-new-document-to-a-contact"></a>Nieuw document maken en verzenden naar een contact
...
### <a name="attach-files-to-records"></a><a name="attach-files-to-records"></a>Bestanden bijvoegen bij records
...
#### <a name="how-to-attach-a-file"></a><a name="how-to-attach-a-file"></a>Een bestand bijvoegen
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in"></a><a name="view-a-document-from-an-email-using-the-document-view-add-in"></a>Een document bekijken vanuit een e-mail met de invoegtoepassing Documentweergave
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/alternative-interfaces-dynamics-365-business-central/index)

...
ms.author: jswymer
---
# <a name="use-business-central-as-your-business-inbox-in-outlook" />Business Central gebruiken als uw bedrijfsinbox in Outlook
...
## <a name="work-with-contacts-and-documents-using-the-contact-insights-add-in" />Werken met contacten en documenten met behulp van de invoegtoepassing Contactinzichten
...
### <a name="look-up-a-business-contact-when-composing-an-email" />Een zakelijk contact opzoeken bij het opstellen van een e-mail
...
### <a name="view-and-change-the-contact-details-or-switch-company" />De contactgegevens bekijken of wijzigen of van bedrijf wisselen
...
### <a name="track-incoming-documents" />Inkomende documenten traceren
...
### <a name="create-and-send-new-document-to-a-contact" />Nieuw document maken en verzenden naar een contact
...
### <a name="attach-files-to-records" />Bestanden bijvoegen bij records
...
#### <a name="how-to-attach-a-file" />Een bestand bijvoegen
...
## <a name="view-a-document-from-an-email-using-the-document-view-add-in" />Een document bekijken vanuit een e-mail met de invoegtoepassing Documentweergave

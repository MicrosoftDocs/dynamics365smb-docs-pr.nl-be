...
ms.locfileid: "9227536"
---
# <a name="sales-tax-in-the-default-version-of-business-central"></a>Btw in de standaardversie van Business Central

**Btw** is een belasting die van toepassing is op de aankoop van goederen en diensten voor consumenten en op de verkoop van goederen en diensten voor bedrijven. Idealiter zou omzetbelasting van toepassing moeten zijn op al het eindverbruik met weinig vrijstellingen. Vrijstellingen voor eindverbruik zijn afhankelijk van de lokale autoriteiten, maar in het algemeen moeten transacties tussen bedrijven worden vrijgesteld van omzetbelasting.  

Doorgaans zijn omzetbelastingen van toepassing op de verkoop van goederen en diensten en zijn deze een percentage van het totale aankoopbedrag. Detailhandelaren zijn verantwoordelijk voor het berekenen en innen van omzetbelasting op het moment dat een aankoop wordt gedaan.  

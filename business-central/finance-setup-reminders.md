...
ms.author: edupont
---
# <a name="set-up-reminder-terms-and-levels"></a><a name="set-up-reminder-terms-and-levels"></a>De termijnen en niveaus van aanmaningen instellen
...
## <a name="reminder-terms"></a><a name="reminder-terms"></a>Aanmaningscondities
...
### <a name="to-set-up-reminder-terms"></a><a name="to-set-up-reminder-terms"></a>U kunt aanmaningscondities als volgt instellen
...
## <a name="reminder-levels"></a><a name="reminder-levels"></a>Aanmaningsniveaus
...
### <a name="to-set-up-reminder-levels"></a><a name="to-set-up-reminder-levels"></a>Aanmaningsniveaus volgt instellen
...
## <a name="see-related-microsoft-training"></a><a name="see-related-microsoft-training"></a>Zie gerelateerde [Microsoft-training](/training/modules/send-reminders-dynamics-365-business-central/)

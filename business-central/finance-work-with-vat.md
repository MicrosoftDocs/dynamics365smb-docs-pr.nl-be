...
description: 'Dit artikel beschrijft de verschillende manieren om met btw te werken, zowel handmatig als met automatische instellingen, om u te helpen aan de land/regio-specifieke regelgeving te voldoen.'
author: brentholtorf
ms.author: bholtorf
...
## <a name="calculating-and-displaying-vat-amounts-on-sales-and-purchase-documents"></a>Btw-bedragen berekenen en weergeven in verkoop- en inkoopdocumenten
...
U kunt btw-bedragen berekenen en in verkoop- en inkoopdocumenten verschillend weergeven. Het verschil hangt af van het type klant of leverancier waarmee u te maken heeft. U kunt tevens handmatig het berekende btw-bedrag wijzigen, bijvoorbeeld zodat het overeenkomt met het btw-bedrag dat door uw leverancier voor een bepaalde transactie is berekend.

### <a name="including-or-excluding-vat-in-prices-and-line-amounts"></a>Prijzen en regelbedragen inclusief of exclusief btw
...
In de volgende tabel staat een overzicht van de manier waarop eenheidsprijsbedragen voor een verkoopdocument worden berekend wanneer geen prijzen zijn ingesteld op de pagina **Verkoopprijzen**:  
...
* Als u een btw-tarief wilt gebruiken voor een specifieke groep klanten, kunt u een groep kiezen in het veld **Btw-bedrijfsboekingsgroep (Prijs)** op de pagina **Klantenprijsgroep**. Deze instelling is bijvoorbeeld handig wanneer u wilt dat een prijs geldt voor alle klanten in een bepaalde geografische regio of een specifieke branche.
...
### <a name="modifying-the-vat-date-in-posted-entries"></a>De btw-datum wijzigen in geboekte posten
...
## <a name="correcting-vat-amounts-manually-on-sales-and-purchase-documents"></a>Btw-bedragen handmatig corrigeren in verkoop- en inkoopdocumenten
...
Als een contantkorting was berekend op basis van een factuurbedrag inclusief btw, kunt u de btw over de contantkorting terugboeken wanneer u de contantkorting verleent. U moet de optie **Aanpassen bij cont.-korting** zowel op het tabblad Algemeen in het venster Boekhoudinstellingen als in het venster Boekingsgroepinstellingen inschakelen voor specifieke combinaties van btw-bedrijfsboekingsgroep en btw-productboekingsgroep.  
...
Volg deze stappen als u handmatige btw-wijzigingen in verkoopdocumenten wilt inschakelen. De stappen zijn vergelijkbaar op de pagina **Inkoopinstellingen**.
...
2. Schakel op de pagina **Verkoopinstellingen** de schakelaar **Btw-verschil toegestaan** in.  
...
U kunt btw-bedragen ook aanpassen in algemene, verkoop- en inkoopdagboeken. U hebt mogelijk een correctie nodig wanneer u een leveranciersfactuur invoert in uw dagboek en er een verschil is tussen het btw-bedrag dat in [!INCLUDE[prod_short](includes/prod_short.md)] is berekend en het btw-bedrag in de leveranciersfactuur.  

### <a name="to-set-the-system-up-for-manual-vat-entry-in-general-journals"></a>Het systeem instellen voor handmatige btw-invoer in dagboeken
...
3. Nadat u de instelling hebt voltooid, kunt u het veld **Btw-bedrag** corrigeren op de regel van het algemene dagboek of het veld **Btw-bedrag tegenrek.** in de verkoop- of inkoopdagboekregel. [!INCLUDE[prod_short](includes/prod_short.md)] controleert of het verschil niet groter is dan het opgegeven maximum.  
...
7. Maak een combinatie van **Bedrijfsboekingsgroep** voor de btw-instantie en **Alg. prod. bkgr.** voor invoer-btw. Kies voor deze combinatie in het veld **Ink.-rekening** de grootboekrekening voor invoer-btw.  

### <a name="to-create-a-new-invoice-for-the-import-authority-vendor-after-you-complete-the-setup"></a>Een nieuwe factuur voor de importinstantieleverancier maken na het voltooien van de instelling
...
4. Als u informatie uit de regels in het verzenddocument wilt opnemen in het certificaat, zet u de schakelaar **Regeldetails afdrukken** aan.  
5. Zet de schakelaar **Certificaten van levering maken als deze nog niet zijn gemaakt** aan om [!INCLUDE[prod_short](includes/prod_short.md)] certificaten te laten maken voor geboekte verzendingen die er geen hadden. Wanneer u de schakelaar aanzet, worden nieuwe certificaten gemaakt voor alle geboekte verzendingen die geen certificaten in het geselecteerde bereik hebben.  
...
Als u een groep certificaten wilt weergeven, begint u op de pagina **Certificaten van levering** en werkt u de informatie over de status van openstaande certificaten bij wanneer u ze ontvangt van uw klanten. De bijgewerkte informatie kan handig zijn als u wilt zoeken naar alle certificaten die een bepaalde status hebben, bijvoorbeeld **Vereist**, waarvoor u de status wilt bijwerken naar **Niet ontvangen**.  

...
ms.author: edupont
---
# <a name="setting-up-relationship-management" />CRM instellen
...
## <a name="automatically-copying-specific-information-from-contact-companies-to-contact-persons" />Bepaalde informatie automatisch kopiëren van contactbedrijven naar contactpersonen.
...
## <a name="use-predefined-defaults-on-new-contacts" />Vooraf bepaalde standaardwaarden van nieuwe contacten gebruiken
...
## <a name="automatically-recording-interactions" />Automatisch interacties vastleggen
...
## <a name="synchronizing-contacts-with-customers-and-more" />Contacten met klanten synchroniseren en meer
...
## <a name="assigning-a-number-series-to-contacts-and-opportunities" />Een nummerreeks toewijzen aan opportunity's en contacten
...
## <a name="searching-for-duplicate-contacts-when-contacts-are-created" />Dubbele contacten zoeken als contacten worden gemaakt

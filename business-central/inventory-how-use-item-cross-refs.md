...
ms.author: edupont
---
# <a name="use-item-references" />Artikelverwijzingen gebruiken
...
## <a name="to-start-using-item-references" />Artikelreferenties gaan gebruiken
...
## <a name="to-set-up-an-item-reference" />Een artikelverwijzing instellen
...
## <a name="to-enter-a-vendors-item-description-on-a-document" />De artikelomschrijving van een leverancier invoeren in een document

...
# <a name="sales-quick-start" />Snelstartgids Verkoop
...
## <a name="set-up-items-to-sell" />Te verkopen artikelen instellen
...
### <a name="set-up-a-new-item" />Een nieuw artikel instellen
...
## <a name="set-up-customers" />Klanten instellen
...
### <a name="set-up-a-new-customer" />Een nieuwe klant instellen
...
## <a name="create-a-sales-order" />Een verkooporder maken
...
### <a name="to-create-a-sales-order" />Een verkooporder maken
...
## <a name="create-a-sales-invoice" />Een verkoopfactuur maken
...
### <a name="to-create-and-post-a-sales-invoice" />Een verkoopfactuur maken en boeken

...
# <a name="sales-quick-start"></a><a name="sales-quick-start"></a><a name="sales-quick-start"></a>Snelstartgids Verkoop
...
## <a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a><a name="set-up-items-to-sell"></a>Te verkopen artikelen instellen
...
### <a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a><a name="set-up-a-new-item"></a>Een nieuw artikel instellen
...
## <a name="set-up-customers"></a><a name="set-up-customers"></a><a name="set-up-customers"></a>Klanten instellen
...
### <a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a><a name="set-up-a-new-customer"></a>Een nieuwe klant instellen
...
## <a name="create-a-sales-order"></a><a name="create-a-sales-order"></a><a name="create-a-sales-order"></a>Een verkooporder maken
...
### <a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a><a name="to-create-a-sales-order"></a>Een verkooporder maken
...
## <a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a><a name="create-a-sales-invoice"></a>Een verkoopfactuur maken
...
### <a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a><a name="to-create-and-post-a-sales-invoice"></a>Een verkoopfactuur maken en boeken

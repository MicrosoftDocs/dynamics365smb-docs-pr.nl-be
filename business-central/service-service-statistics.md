...
# <a name="viewing-service-statistics" />Servicestatistieken weergeven
...
## <a name="viewing-statistics-for-service-orders" />Statistieken voor serviceorders weergeven
...
### <a name="view-totals-for-a-service-order" />Totalen voor een serviceorder weergeven
...
### <a name="view-shipping-information" />Verzendgegevens weergeven
...
### <a name="view-order-details" />Ordergegevens weergeven
...
### <a name="analyze-service-order-lines" />Serviceorderregels analyseren
...
### <a name="view-customer-information" />Klantgegevens weergeven
...
## <a name="viewing-service-item-statistics" />Serviceartikelstatistieken weergeven
...
## <a name="use-trendscapes" />Trendscapes gebruiken
...
## <a name="viewing-gains-and-losses-on-contracts" />Winsten en verliezen op contracten weergeven
...
## <a name="viewing-statistics-for-posted-service-documents" />Statistieken voor geboekte servicedocumenten weergeven
...
### <a name="posted-service-shipment-statistics" />Statistiek geboekte serviceverzendingen
...
### <a name="posted-service-invoice-statistics" />Statistiek geboekte servicefacturen
...
### <a name="posted-service-credit-memo-statistics" />Statistiek Geboekte servicecreditnota

...
ms.author: edupont
---
# <a name="design-details-expected-cost-posting" />Ontwerpdetails: Verwachte kostenboeking
...
## <a name="prerequisites-for-posting-expected-costs" />Vereisten voor het boeken van verwachte kosten

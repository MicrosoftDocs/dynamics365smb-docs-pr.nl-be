...
ms.author: jswymer
---
# <a name="legacy-set-the-layout-used-by-a-report" />(verouderd) De lay-out instellen die door een rapport wordt gebruikt
...
## <a name="to-change-which-report-layout-to-use-for-a-report-or-document" />Wijzigen welke rapportlay-out moet worden gebruikt voor een rapport of document
...
## <a name="to-change-the-custom-layout-to-use-for-a-report-layout" />De aangepaste lay-out wijzigen die voor een rapportlay-out wordt gebruikt

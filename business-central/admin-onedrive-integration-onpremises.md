...
## <a name="set-up-the-connection-in-prod_short-version-19-and-20"></a>De verbinding in [!INCLUDE[prod_short](includes/prod_short.md)] instellen in versie 19 en 20

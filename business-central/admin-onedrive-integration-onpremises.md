...
ms.author: jswymer
---
# <a name="configuring-onedrive-integration-with-business-central-on-premises" />OneDrive-integratie configureren met Business Central On-Premises
...
### <a name="run-onedrive-setup" />Configuratie van OneDrive uitvoeren
...
## <a name="switching-from-legacy-sharepoint-to-new-onedrive-integration" />Overschakelen van oude SharePoint naar nieuwe OneDrive-integratie
...
#### <a name="how-the-changes-affect-the-integration" />Hoe de wijzigingen van invloed zijn op de integratie
...
### <a name="run-onedrive-setup-to-switch-to-the-new-onedrive-integration" />Configuratie van OneDrive uitvoeren om over te schakelen naar de nieuwe OneDrive-integratie

...
## De verbinding in [!INCLUDE[prod_short](includes/prod_short.md)] instellen in versie 19 en 20
...
- Als er geen app is geconfigureerd in de instelling **Uw Microsoft Entra-accounts instellen**, wordt voor de OneDrive-integratie dezelfde app gebruikt als voorheen.

   Met de begeleide instelling **Configuratie van OneDrive** wordt de app-configuratie gekopieerd naar de instelling **Uw Microsoft Entra-accounts instellen**, dus het wordt gebruikt voor andere integraties die mogelijk later worden ingesteld.

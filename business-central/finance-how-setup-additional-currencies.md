...
## <a name="displaying-reports-and-amounts-in-acy"></a>Rapporten en bedragen weergeven in de extra rapportagevaluta
...
### <a name="to-activate-the-acy"></a>De extra rapportagevaluta activeren
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen"), voer **Grootboekinstellingen** in en kies vervolgens de gerelateerde koppeling.  
...
6. Vul de velden in. [!INCLUDE[tooltip-inline-tip](includes/tooltip-inline-tip_md.md)]      

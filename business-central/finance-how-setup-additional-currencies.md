...
ms.author: edupont
---
# <a name="set-up-an-additional-reporting-currency" />Een extra rapportagevaluta instellen.
...
## <a name="displaying-reports-and-amounts-in-the-additional-reporting-currency" />Rapporten en bedragen weergeven in de extra rapportagevaluta
...
## <a name="adjusting-exchange-rates" />Wisselkoersen corrigeren
...
## <a name="setting-up-an-additional-reporting-currency" />Een extra rapportagevaluta instellen
...
### <a name="to-specify-general-ledger-accounts-for-posting-exchange-rate-adjustments" />Grootboekrekeningen opgeven voor het boeken van wisselkoerscorrecties
...
### <a name="to-specify-the-exchange-rate-adjustment-method-for-all-general-ledger-accounts" />De wisselkoerscorrectiemethode opgeven voor alle grootboekrekeningen
...
### <a name="to-specify-exchange-rate-adjustment-method-for-vat-entries" />Wisselkoersherwaarderingsmethode opgeven voor btw-boekingen
...
### <a name="to-activate-the-additional-reporting-currency" />De extra rapportagevaluta activeren
1. Kies het ![Lampje dat de functie Vertel me opent.](media/ui-search/search_small.png "Vertel me wat u wilt doen") voer **Grootboekinstellingen** in en kies vervolgens de gerelateerde koppeling.  
...
## <a name="see-related-microsoft-trainingtrainingpathsuse-multiple-currencies-dynamics--business-central" />Zie gerelateerde [Microsoft-training](/training/paths/use-multiple-currencies-dynamics-365-business-central/)

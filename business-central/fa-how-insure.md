...
ms.author: edupont
---
# <a name="insure-fixed-assets"></a><a name="insure-fixed-assets"></a>Vaste activa verzekeren
...
## <a name="to-create-or-modify-an-insurance-card"></a><a name="to-create-or-modify-an-insurance-card"></a>Een verzekeringskaart maken of wijzigen
...
## <a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a><a name="to-assign-a-fixed-asset-to-an-insurance-policy-by-posting-from-the-insurance-journal"></a>Een vast activum toewijzen aan een verzekeringspolis door het vanuit een verzekeringsdagboek te boeken
...
## <a name="to-update-the-insurance-value-of-a-fixed-asset"></a><a name="to-update-the-insurance-value-of-a-fixed-asset"></a>De verzekeringswaarde van een vast activum bijwerken
...
## <a name="to-monitor-insurance-coverage"></a><a name="to-monitor-insurance-coverage"></a>Verzekeringsdekking controleren
...
### <a name="overview-of-insurance-policies"></a><a name="overview-of-insurance-policies"></a>Overzicht van verzekeringspolissen
...
### <a name="insurance-coverage"></a><a name="insurance-coverage"></a>Verzekeringsdekking
...
### <a name="overunder-coverage"></a><a name="overunder-coverage"></a>Over-/onderverzekering
...
### <a name="uninsured-fixed-assets"></a><a name="uninsured-fixed-assets"></a>Onverzekerde vaste activa
...
## <a name="to-view-insurance-coverage-ledger-entries"></a><a name="to-view-insurance-coverage-ledger-entries"></a>Verzekeringsdekkingsposten bekijken
...
## <a name="to-view-the-total-insurance-value-of-fixed-assets"></a><a name="to-view-the-total-insurance-value-of-fixed-assets"></a>De totale verzekerde waarde van vaste activa bekijken
...
## <a name="to-correct-insurance-coverage-entries"></a><a name="to-correct-insurance-coverage-entries"></a>Dekkingsposten corrigeren

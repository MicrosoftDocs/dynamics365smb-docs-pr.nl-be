---
title: 'Procedure: Werken met cheques | Microsoft Docs'
description: 'Procedure: Werken met cheques'
...
**Opmerking**: Om ervoor te zorgen dat uw bank alleen gevalideerde cheques en bedragen vrijgeeft, kunt u deze verzenden in een bestand dat gegevens over de leverancier, cheque en betaling bevat. Zie voor meer informatie [Procedure: Een Positive Pay-bestand exporteren](finance-how-positive-pay.md).

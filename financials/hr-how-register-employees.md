---
title: 'Procedure: Werknemers registreren| Microsoft Docs'
description: Beschrijft hoe u nieuwe werknemers kunt registreren of informatie voor bestaande werknemers kunt bewerken.
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Werknemers** in en kies vervolgens de gerelateerde koppeling.
...
## <a name="to-register-an-alternate-address-for-an-employee"></a>Een alternatief adres voor een werknemer registreren

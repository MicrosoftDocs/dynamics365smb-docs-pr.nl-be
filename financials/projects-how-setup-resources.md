---
title: 'Procedure: Resources instellen| Microsoft Docs'
description: Beschrijft hoe u het systeem voorbereidt voor gebruik van resources in projecten.
...
1. In de rechterbovenhoek, kies het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Resourcegroepen** in en klik op de gerelateerde koppeling.
2. Kies de actie **Nieuw**.

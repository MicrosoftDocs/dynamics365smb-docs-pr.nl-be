---
title: 'Procedure: De feedservice van de Envestnet Yodlee Bank instellen| Microsoft Docs'
description: 'Procedure: De service Envestnet Yodlee Bank Feeds instellen'
...
De feedservice van de Envestnet Yodlee Bank wordt geïnstalleerd als een extensie voor [!INCLUDE[d365fin](includes/d365fin_md.md)] en kan worden ingeschakeld. Zie [[!INCLUDE[d365fin](includes/d365fin_md.md)] aanpassen met extensies](ui-extensions.md) voor meer informatie.
...
**Opmerking**: als u de begeleide instelling Bedrijf instellen gebruikt, worden sommige stappen in de volgende procedures automatisch uitgevoerd wanneer u de instelling van de bedrijfsbankrekening uitvoert. Zie [Welkom bij [!INCLUDE[d365fin_long](includes/d365fin_long_md.md)]](index.md) voor meer informatie.
...
6. De bankfeedservice treft voorbereidingen om de eerste online bankrekening bij de opgegeven bank te koppelen aan een nieuwe bankrekening in [!INCLUDE[d365fin](includes/d365fin_md.md)].
    ...
    **Opmerking:** als u meer dan één online bankrekening bij de bank hebt, moet u extra bankrekeningen maken in [!INCLUDE[d365fin](includes/d365fin_md.md)] voor die extra online bankrekeningen. Zie stap 8 t/m 10.  
...
**Opmerking**: als u **Ja** kiest in het bevestigingsdialoogvenster, wordt de koppeling met de online bankrekening verwijderd en worden de aanmelddetails gewist. Om de bankrekening weer te koppelen aan de online bankrekening, moet u zich weer aanmelden bij de bank. Zie voor meer informatie het gedeelte “Een bankrekening koppelen aan een online bankrekening“.

...
description: Beschrijft mailinggroepen voor contacten in Financials
...
## <a name="defining-mailing-group-codes"></a>Mailinggroepcodes definiëren
...
1. In de rechterbovenhoek, kies het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Mailinggroepen** in en klik op de gerelateerde koppeling.

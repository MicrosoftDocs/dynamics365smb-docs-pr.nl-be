...
<span data-ttu-id="69bbb-104">U geeft uw algemene voorraadinstellingen op in het venster **Voorraadinstelling**.</span><span class="sxs-lookup"><span data-stu-id="69bbb-104">You specify your general inventory setup in the **Inventory Setup** window.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="69bbb-110">Zie ook</span><span class="sxs-lookup"><span data-stu-id="69bbb-110">See Also</span></span>
[<span data-ttu-id="69bbb-111">Voorraad instellen</span><span class="sxs-lookup"><span data-stu-id="69bbb-111">Set Up Inventory</span></span>](inventory-setup-inventory.md)  
[<span data-ttu-id="69bbb-112">Voorraad beheren</span><span class="sxs-lookup"><span data-stu-id="69bbb-112">Manage Inventory</span></span>](inventory-manage-inventory.md)  
<span data-ttu-id="69bbb-113">[Werken met [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span><span class="sxs-lookup"><span data-stu-id="69bbb-113">[Working with [!INCLUDE[d365fin](includes/d365fin_md.md)]](ui-work-product.md)</span></span>  
<span data-ttu-id="69bbb-114">[Uw [!INCLUDE[d365fin](includes/d365fin_md.md)]-ervaring aanpassen](ui-experiences.md)</span><span class="sxs-lookup"><span data-stu-id="69bbb-114">[Customizing Your [!INCLUDE[d365fin](includes/d365fin_md.md)] Experience](ui-experiences.md)</span></span>  
[<span data-ttu-id="69bbb-115">Algemene bedrijfsfunctionaliteit</span><span class="sxs-lookup"><span data-stu-id="69bbb-115">General Business Functionality</span></span>](ui-across-business-areas.md)

...
# <a name="setting-up-included365finlongincludesd365finlongmdmd-to-calculate-and-post-value-added-tax"></a>[!INCLUDE[d365fin_long](includes/d365fin_long_md.md)] instellen om btw (belasting toegevoegde waarde) te berekenen en te boeken
Consumenten en bedrijven betalen belasting toegevoegde waarde (btw) wanneer goederen of services worden ingekocht. Het bedrag dat aan btw moet worden betaald, is afhankelijk van een aantal factoren. In [!INCLUDE[d365fin](includes/d365fin_md.md)] stelt u btw in om de tarieven op te geven die moeten worden gebruikt om belastingbedragen te berekenen op basis van het volgende: 
...
U kunt handmatig btw-berekeningen instellen, maar dit kan lastig en tijdrovend zijn. Voor het gemak hebben we een begeleide instelling verschaft met de naam **Btw-instellingen** die u tijdens de stappen begeleid. Het is raadzaam de begeleide instelling te gebruiken om btw in te stellen.

**Opmerking**: u kunt de begeleide instelling alleen gebruiken als u een Mijn bedrijf hebt gemaakt en geen transacties hebt geboekt die inclusief btw zijn. Anders zouden er gemakkelijk per ongeluk andere btw-tarieven worden gebruikt en onnauwkeurige btw-gerelateerde rapporten worden gemaakt.  
...
* Btw-bedrijfsboekingsgroepen instellen om btw-tarieven te definiëren voor de markten waarin u werkt. U wijst btw-bedrijfsboekingsgroepen toe aan klanten en leveranciers.  
* Btw-productboekingsgroepen instellen om btw-tarieven in te stellen voor de producten en services die u koopt of verkoopt.  
  
   **Opmerking**: de concepten achter btw-bedrijfsboekingsgroepen en btw-productboekingsgroepen zijn vergelijkbaar met algemene boekingsgroepen. Zie [Boekingsgroepinstellingen](finance-posting-groups.md) voor meer informatie.
...
* Btw-productboekingsgroepen toewijzen aan de grootboekrekeningen die u voor verkopen en inkopen, en artikelen en resources gebruikt.  
   ...
   **Opmerking**: als u btw wilt instellen voor resources, moet u de gebruikerservaring **Pakket** voor uw bedrijf inschakelen. Zie [Uw Dynamics 365 for Financials-ervaring aanpassen](ui-experiences.md) voor meer informatie.
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport") en voer **Begeleide instelling** in.  
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Btw-bedrijfsboekingsgroep** in en kies vervolgens de gerelateerde koppeling.  
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Btw-productboekingsgroepen** in en kies vervolgens de gerelateerde koppeling.  
2. Vul indien nodig de velden in.
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Btw-boekingsinstellingen** in en kies vervolgens de gerelateerde koppeling.
2. Vul indien nodig de velden in.
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Klant** of **Leverancier** in en kies vervolgens de gerelateerde koppeling.  
...
1. Kies in de rechterbovenhoek het pictogram **pictogram Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Artikel** of **Resource** in en kies vervolgens de gerelateerde koppeling.  
2. Ga op een van de volgende manieren te werk:
* Vouw op de kaart**Artikel** het sneltabblad **Prijs en boeking** uit en kies vervolgens **Meer weergeven**.  
...
1. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Btw-clausules** in en kies vervolgens de gerelateerde koppeling.  
...
3. Kies in het veld **Taalcode** de taal waarnaar u vertaalt.  
...
3. Kies in de rechterbovenhoek het pictogram **Zoeken naar pagina of rapport** ![Zoeken naar pagina of rapport](media/ui-search/search_small.png "Pictogram Zoeken naar pagina of rapport"), voer **Btw-boekingsinstellingen** in en kies vervolgens de gerelateerde koppeling.  
...
De Europese commissie verschaft de VIES-service voor btw-nummervalidatie op de website. Deze service is openbaar en gratis. U moet echter nog steeds de moeite nemen om naar de website te gaan. [!INCLUDE[d365fin](includes/d365fin_md.md)] kan u die moeite besparen. U kunt namelijk de VIES-service om btw-nummers voor klanten, leveranciers en contactpersonen te valideren en bij te houden, rechtstreeks van de klanten-, leveranciers en contactkaarten gebruiken. De service wordt in [!INCLUDE[d365fin](includes/d365fin_md.md)] EU-btw-reg. genoemd. Nr. Validatieservice. Deze service is beschikbaar op de pagina **Serviceverbindingen** en u kunt deze service gebruiken door een selectievakje in te schakelen. De service is gratis en er is geen aanmelding vereist.

Wanneer u onze service gebruikt, registreren we een overzicht van btw-nummers en verificaties voor elke klant, leverancier of contactpersoon in **Btw-log**, zodat u deze eenvoudig kunt bijhouden. Het logboek is specifiek voor elke klant. Het logboek is bijvoorbeeld handig om te bewijzen dat u hebt gecontroleerd dat het huidige btw-nummer juist is. Wanneer u een btw-nummer verifieert, wordt in de kolom **Aanvraag-id** in het logboek aangegeven dat u actie hebt ondernomen. 

U kunt het btw-log weergeven op de klanten-, leveranciers- of contactkaarten op het sneltabblad **Facturering** door de zoekknop in het veld **Btw-nummer** te kiezen.  
...
**Opmerkingen**: er zijn een paar dingen waarmee u rekening moet houden met betrekking tot de VIES-service voor btw-nummervalidatie:
...
**Opmerking**: deze regel geldt wanneer u zaken doet met bedrijven die in een ander EU-land/-regio btw-plichtig zijn. Als u rechtstreeks zakendoet met consumenten in andere EU-landen/-regio's, moet u contact opnemen met de belastingdienst over de geldende btw-regels.  

**Tip**: u kunt controleren of een bedrijf btw-plichtig is in een ander EU-land door de EU-service voor btw-nummervalidatie te gebruiken. De service is gratis beschikbaar in [!INCLUDE[d365fin](includes/d365fin_md.md)]. Zie het gedeelte met de naam _Btw-registratienummers controleren_ in dit onderwerp voor meer informatie.
...
* Stel een regel in voor verkopen met dezelfde informatie voor inkopen. Als u reeds regels hebt ingesteld in het venster Btw-boekingsinstellingen voor inkopen uit EU-landen/-regio's, kunt u de regels ook voor verkopen gebruiken.  

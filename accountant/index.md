...
U kunt toegang tot [!INCLUDE [d365acc](includes/d365acc_md.md)] krijgen door u aan te melden vanuit [Dynamics 365 — Accountant Hub op Microsoft.com](https://www.microsoft.com/en-us/dynamics365/financial-insights-for-accountants). Het is kosteloos en kan snel worden gestart en cliënten toevoegen aan het dashboard. Zie [Aan de slag met Accountant Hub](get-started.md) voor meer informatie.  
